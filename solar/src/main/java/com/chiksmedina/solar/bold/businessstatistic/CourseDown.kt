    ...
    get() {
        ...
        _courseDown = Builder(name = "CourseDown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.0036f, 18.75f, 15.6679f, 18.4142f, 15.6679f, 18.0f)
                curveTo(15.6679f, 17.5858f, 16.0036f, 17.25f, 16.4179f, 17.25f)
                ...
                curveTo(5.4127f, 11.4569f, 5.4011f, 11.4453f, 5.3895f, 11.4337f)
