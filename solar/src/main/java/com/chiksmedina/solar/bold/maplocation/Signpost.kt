...
public val MapLocationGroup.Signpost: ImageVector
    get() {
        if (_signpost != null) {
            return _signpost!!
        }
        _signpost = Builder(name = "Signpost", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.0464f, 3.5f, 5.7176f, 3.5f, 5.4159f, 3.5982f)
                curveTo(5.2828f, 3.6415f, 5.1546f, 3.6987f, 5.0335f, 3.7688f)
                curveTo(4.7588f, 3.9277f, 4.5392f, 4.1723f, 4.0998f, 4.6616f)
                curveTo(3.2491f, 5.6089f, 2.8238f, 6.0826f, 2.7214f, 6.6362f)
                curveTo(2.6769f, 6.8767f, 2.6769f, 7.1233f, 2.7214f, 7.3638f)
                curveTo(2.8238f, 7.9174f, 3.2491f, 8.3911f, 4.0998f, 9.3384f)
                curveTo(4.5392f, 9.8277f, 4.7588f, 10.0723f, 5.0335f, 10.2312f)
                curveTo(5.1546f, 10.3013f, 5.2828f, 10.3585f, 5.4159f, 10.4018f)
                curveTo(5.7176f, 10.5f, 6.0464f, 10.5f, 6.704f, 10.5f)
                ...
                curveTo(18.9045f, 10.5f, 19.6067f, 10.5f, 20.1111f, 10.1629f)
                curveTo(20.3295f, 10.017f, 20.517f, 9.8295f, 20.6629f, 9.6111f)
                curveTo(21.0f, 9.1067f, 21.0f, 8.4045f, 21.0f, 7.0f)
                curveTo(21.0f, 5.5955f, 21.0f, 4.8933f, 20.6629f, 4.3889f)
                curveTo(20.517f, 4.1705f, 20.3295f, 3.983f, 20.1111f, 3.8371f)
                curveTo(19.6067f, 3.5f, 18.9045f, 3.5f, 17.5f, 3.5f)
                horizontalLineTo(12.75f)
                verticalLineTo(2.0f)
                close()
            }
