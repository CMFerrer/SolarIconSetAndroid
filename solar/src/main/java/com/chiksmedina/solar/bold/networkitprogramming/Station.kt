    ...
    get() {
        ...
        _station = Builder(name = "Station", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.3283f, 10.261f, 10.0f, 9.6688f, 10.0f, 9.0f)
                curveTo(10.0f, 7.8954f, 10.8954f, 7.0f, 12.0f, 7.0f)
                curveTo(13.1046f, 7.0f, 14.0f, 7.8954f, 14.0f, 9.0f)
                curveTo(14.0f, 9.6688f, 13.6717f, 10.261f, 13.1674f, 10.6241f)
                lineTo(16.7147f, 21.7726f)
                curveTo(16.8231f, 22.1134f, 16.6759f, 22.4833f, 16.363f, 22.6563f)
                curveTo(16.05f, 22.8294f, 15.6584f, 22.7574f, 15.4275f, 22.4845f)
                lineTo(12.0f, 18.4338f)
                lineTo(8.5725f, 22.4845f)
                curveTo(8.3416f, 22.7574f, 7.95f, 22.8294f, 7.637f, 22.6563f)
                curveTo(7.3241f, 22.4833f, 7.1769f, 22.1134f, 7.2853f, 21.7726f)
                lineTo(10.8326f, 10.6241f)
                close()
                moveTo(12.9825f, 17.2727f)
                lineTo(14.1466f, 18.6485f)
                lineTo(13.5103f, 16.6489f)
                lineTo(12.9825f, 17.2727f)
                close()
                moveTo(12.9745f, 14.9648f)
                curveTo(12.9582f, 14.9809f, 12.9425f, 14.9978f, 12.9275f, 15.0155f)
                lineTo(12.0f, 16.1116f)
                lineTo(11.0725f, 15.0155f)
                curveTo(11.0575f, 14.9978f, 11.0418f, 14.9809f, 11.0255f, 14.9648f)
                lineTo(12.0f, 11.9022f)
                lineTo(12.9745f, 14.9648f)
                close()
                moveTo(10.4897f, 16.6489f)
