    ...
    get() {
        ...
        _bellBing = Builder(name = "BellBing", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.2726f, 2.0f, 5.2509f, 5.134f, 5.2509f, 9.0f)
                verticalLineTo(9.7041f)
                curveTo(5.2509f, 10.5491f, 5.0097f, 11.3752f, 4.5578f, 12.0782f)
                lineTo(3.4504f, 13.8012f)
                curveTo(2.4388f, 15.3749f, 3.2111f, 17.5139f, 4.9704f, 18.0116f)
                curveTo(9.5727f, 19.3134f, 14.4273f, 19.3134f, 19.0296f, 18.0116f)
                curveTo(20.789f, 17.5139f, 21.5612f, 15.3749f, 20.5496f, 13.8012f)
                lineTo(19.4422f, 12.0782f)
                curveTo(18.9903f, 11.3752f, 18.7491f, 10.5491f, 18.7491f, 9.7041f)
                close()
                moveTo(12.0f, 5.25f)
