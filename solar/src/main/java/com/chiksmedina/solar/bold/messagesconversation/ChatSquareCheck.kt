    ...
    get() {
        ...
        _chatSquareCheck = Builder(name = "ChatSquareCheck", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.2417f, 13.819f, 10.7751f, 13.8238f, 10.4806f, 13.541f)
                lineTo(8.4806f, 11.621f)
                curveTo(8.1818f, 11.3342f, 8.1721f, 10.8594f, 8.459f, 10.5606f)
                curveTo(8.7458f, 10.2618f, 9.2206f, 10.2521f, 9.5194f, 10.539f)
