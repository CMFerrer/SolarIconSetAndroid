...
public val ArrowsGroup.RoundArrowLeft: ImageVector
    get() {
        if (_roundArrowLeft != null) {
            return _roundArrowLeft!!
        }
        _roundArrowLeft = Builder(name = "RoundArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(7.4697f, 11.4697f)
                curveTo(7.1768f, 11.7626f, 7.1768f, 12.2374f, 7.4697f, 12.5303f)
                lineTo(10.4697f, 15.5303f)
                curveTo(10.7626f, 15.8232f, 11.2374f, 15.8232f, 11.5303f, 15.5303f)
                curveTo(11.8232f, 15.2374f, 11.8232f, 14.7626f, 11.5303f, 14.4697f)
                lineTo(9.8107f, 12.75f)
                ...
                lineTo(11.5303f, 9.5303f)
                curveTo(11.8232f, 9.2374f, 11.8232f, 8.7626f, 11.5303f, 8.4697f)
                close()
            }
        }
        .build()
