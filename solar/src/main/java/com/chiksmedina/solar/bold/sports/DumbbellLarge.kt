    ...
    get() {
        ...
        _dumbbellLarge = Builder(name = "DumbbellLarge", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.8251f, 14.1544f, 18.1682f, 14.4975f, 18.5713f, 14.6055f)
                curveTo(18.8353f, 14.6763f, 19.1134f, 14.6763f, 19.3774f, 14.6055f)
                curveTo(19.7805f, 14.4975f, 20.1236f, 14.1544f, 20.8097f, 13.4683f)
                curveTo(21.4959f, 12.7821f, 21.8389f, 12.4391f, 21.9469f, 12.036f)
                curveTo(22.0177f, 11.7719f, 22.0177f, 11.4939f, 21.9469f, 11.2299f)
                curveTo(21.8389f, 10.8268f, 21.4959f, 10.4837f, 20.8097f, 9.7976f)
                lineTo(20.0756f, 9.0634f)
                lineTo(19.7046f, 8.7003f)
                lineTo(20.0756f, 8.3293f)
                curveTo(20.7677f, 7.6371f, 21.1138f, 7.291f, 21.1138f, 6.861f)
                curveTo(21.1138f, 6.431f, 20.7677f, 6.0849f, 20.0756f, 5.3927f)
                lineTo(18.6073f, 3.9244f)
                ...
                lineTo(3.9244f, 15.6707f)
                curveTo(3.2323f, 16.3629f, 2.8862f, 16.709f, 2.8862f, 17.139f)
                curveTo(2.8862f, 17.5691f, 3.2323f, 17.9151f, 3.9244f, 18.6073f)
                close()
            }
        }
        .build()
