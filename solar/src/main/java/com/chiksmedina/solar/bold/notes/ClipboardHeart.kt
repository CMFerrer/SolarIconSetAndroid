    ...
    get() {
        ...
        _clipboardHeart = Builder(
            ...
            path(
                ...
                close()
                moveTo(11.0429f, 15.3656f)
                curveTo(10.1649f, 14.7213f, 9.0f, 13.6812f, 9.0f, 12.6967f)
                curveTo(9.0f, 11.0235f, 10.65f, 10.3988f, 12.0f, 11.6913f)
                curveTo(13.35f, 10.3988f, 15.0f, 11.0235f, 15.0f, 12.6967f)
                curveTo(15.0f, 13.6812f, 13.8352f, 14.7214f, 12.9571f, 15.3656f)
                curveTo(12.5374f, 15.6736f, 12.3275f, 15.8276f, 12.0f, 15.8276f)
                curveTo(11.6725f, 15.8276f, 11.4626f, 15.6736f, 11.0429f, 15.3656f)
                close()
            }
        }
            .build()
