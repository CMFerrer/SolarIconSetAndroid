    ...
    get() {
        ...
        _serverSquareUpdate = Builder(name = "ServerSquareUpdate", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.25f, 8.5f)
                curveTo(5.25f, 8.9142f, 5.5858f, 9.25f, 6.0f, 9.25f)
                curveTo(6.4142f, 9.25f, 6.75f, 8.9142f, 6.75f, 8.5f)
                verticalLineTo(6.5f)
                curveTo(6.75f, 6.0858f, 6.4142f, 5.75f, 6.0f, 5.75f)
                curveTo(5.5858f, 5.75f, 5.25f, 6.0858f, 5.25f, 6.5f)
                lineTo(5.25f, 8.5f)
                close()
                moveTo(12.75f, 7.5f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.2089f, 17.1899f, 21.6229f, 17.1899f, 21.9036f, 17.4302f)
                lineTo(22.4877f, 17.9302f)
                curveTo(22.8024f, 18.1996f, 22.8391f, 18.673f, 22.5698f, 18.9877f)
                curveTo(22.4382f, 19.1414f, 22.258f, 19.2288f, 22.0714f, 19.2466f)
                curveTo(21.6824f, 20.7441f, 20.1471f, 21.75f, 18.4952f, 21.75f)
                curveTo(17.218f, 21.75f, 16.0551f, 21.1696f, 15.3892f, 20.2352f)
                curveTo(15.1488f, 19.8979f, 15.2274f, 19.4296f, 15.5648f, 19.1892f)
                curveTo(15.9021f, 18.9488f, 16.3704f, 19.0274f, 16.6108f, 19.3648f)
                curveTo(16.9705f, 19.8696f, 17.6589f, 20.25f, 18.4952f, 20.25f)
                curveTo(19.4617f, 20.25f, 20.1819f, 19.7681f, 20.4944f, 19.1701f)
                curveTo(20.4081f, 19.1266f, 20.3288f, 19.0657f, 20.262f, 18.9877f)
                curveTo(19.9926f, 18.673f, 20.0294f, 18.1996f, 20.344f, 17.9302f)
