...
public val ArrowsGroup.RoundArrowDown: ImageVector
    get() {
        if (_roundArrowDown != null) {
            return _roundArrowDown!!
        }
        _roundArrowDown = Builder(name = "RoundArrowDown", defaultWidth = 24.0.dp, defaultHeight =
