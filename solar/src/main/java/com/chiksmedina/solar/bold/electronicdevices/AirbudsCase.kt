    ...
    get() {
        ...
        _airbudsCase = Builder(name = "AirbudsCase", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(20.9787f)
                curveTo(20.9243f, 6.2392f, 20.7312f, 5.0055f, 20.0451f, 4.0611f)
                ...
                curveTo(3.2688f, 5.0055f, 3.0756f, 6.2392f, 3.0213f, 8.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
