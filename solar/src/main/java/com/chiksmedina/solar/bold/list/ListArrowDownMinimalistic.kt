...
public val ListGroup.ListArrowDownMinimalistic: ImageVector
    get() {
        if (_listArrowDownMinimalistic != null) {
            return _listArrowDownMinimalistic!!
        }
        _listArrowDownMinimalistic = Builder(name = "ListArrowDownMinimalistic", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(16.9697f, 17.5303f)
                curveTo(17.2626f, 17.8232f, 17.7374f, 17.8232f, 18.0303f, 17.5303f)
                lineTo(20.5303f, 15.0303f)
                curveTo(20.8232f, 14.7374f, 20.8232f, 14.2626f, 20.5303f, 13.9697f)
                curveTo(20.2374f, 13.6768f, 19.7626f, 13.6768f, 19.4697f, 13.9697f)
                lineTo(18.25f, 15.1893f)
                verticalLineTo(9.0f)
                curveTo(18.25f, 8.5858f, 17.9142f, 8.25f, 17.5f, 8.25f)
                curveTo(17.0858f, 8.25f, 16.75f, 8.5858f, 16.75f, 9.0f)
                verticalLineTo(15.1893f)
                lineTo(15.5303f, 13.9697f)
                curveTo(15.2374f, 13.6768f, 14.7626f, 13.6768f, 14.4697f, 13.9697f)
                curveTo(14.1768f, 14.2626f, 14.1768f, 14.7374f, 14.4697f, 15.0303f)
                lineTo(16.9697f, 17.5303f)
                close()
            }
        }
        .build()
