...
public val ArrowsGroup.SquareDoubleAltArrowDown: ImageVector
    get() {
        if (_squareDoubleAltArrowDown != null) {
            return _squareDoubleAltArrowDown!!
        }
        _squareDoubleAltArrowDown = Builder(name = "SquareDoubleAltArrowDown", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.1768f, 12.2626f, 8.1768f, 12.7374f, 8.4697f, 13.0303f)
                lineTo(11.4697f, 16.0303f)
                curveTo(11.7626f, 16.3232f, 12.2374f, 16.3232f, 12.5303f, 16.0303f)
                lineTo(15.5303f, 13.0303f)
                curveTo(15.8232f, 12.7374f, 15.8232f, 12.2626f, 15.5303f, 11.9697f)
                curveTo(15.2374f, 11.6768f, 14.7626f, 11.6768f, 14.4697f, 11.9697f)
                lineTo(12.0f, 14.4393f)
                lineTo(9.5303f, 11.9697f)
                curveTo(9.2374f, 11.6768f, 8.7626f, 11.6768f, 8.4697f, 11.9697f)
                close()
            }
        }
        .build()
