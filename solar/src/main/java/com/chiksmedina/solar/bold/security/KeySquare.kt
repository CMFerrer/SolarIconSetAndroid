...
public val SecurityGroup.KeySquare: ImageVector
    get() {
        if (_keySquare != null) {
            return _keySquare!!
        }
        _keySquare = Builder(name = "KeySquare", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.0403f, 14.3269f, 11.9731f, 14.2539f, 11.9153f, 14.1912f)
                curveTo(11.777f, 14.041f, 11.693f, 13.9498f, 12.004f, 13.64f)
