    ...
    get() {
        ...
        _bodyShapeMinimalistic = Builder(name = "BodyShapeMinimalistic", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.2254f, 6.2951f, 6.75f, 8.5207f, 6.75f, 10.5716f)
                curveTo(6.75f, 11.1722f, 6.6626f, 11.7276f, 6.5167f, 12.2502f)
                horizontalLineTo(17.4833f)
                curveTo(17.3374f, 11.7276f, 17.25f, 11.1722f, 17.25f, 10.5716f)
                curveTo(17.25f, 8.5207f, 17.7746f, 6.2951f, 18.282f, 4.6132f)
                ...
                curveTo(19.8445f, 13.8681f, 20.0655f, 14.2317f, 20.3001f, 14.6176f)
                lineTo(20.3001f, 14.6177f)
