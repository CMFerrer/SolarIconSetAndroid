    ...
    get() {
        ...
        _sortFromBottomToTop = Builder(name = "SortFromBottomToTop", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(3.25f, 8.0f)
                curveTo(3.25f, 7.5858f, 3.5858f, 7.2501f, 4.0f, 7.2501f)
                horizontalLineTo(13.0f)
                curveTo(13.4142f, 7.2501f, 13.75f, 7.5858f, 13.75f, 8.0f)
                curveTo(13.75f, 8.4143f, 13.4142f, 8.75f, 13.0f, 8.75f)
                horizontalLineTo(4.0f)
                curveTo(3.5858f, 8.75f, 3.25f, 8.4143f, 3.25f, 8.0f)
                close()
                moveTo(5.25f, 13.0f)
                curveTo(5.25f, 12.5858f, 5.5858f, 12.25f, 6.0f, 12.25f)
                horizontalLineTo(13.0f)
                curveTo(13.4142f, 12.25f, 13.75f, 12.5858f, 13.75f, 13.0f)
                curveTo(13.75f, 13.4143f, 13.4142f, 13.75f, 13.0f, 13.75f)
                horizontalLineTo(6.0f)
                curveTo(5.5858f, 13.75f, 5.25f, 13.4143f, 5.25f, 13.0f)
                close()
                moveTo(7.25f, 18.0f)
                curveTo(7.25f, 17.5858f, 7.5858f, 17.25f, 8.0f, 17.25f)
                horizontalLineTo(13.0f)
                curveTo(13.4142f, 17.25f, 13.75f, 17.5858f, 13.75f, 18.0f)
                curveTo(13.75f, 18.4143f, 13.4142f, 18.75f, 13.0f, 18.75f)
                horizontalLineTo(8.0f)
                curveTo(7.5858f, 18.75f, 7.25f, 18.4143f, 7.25f, 18.0f)
                close()
            }
        }
        .build()
