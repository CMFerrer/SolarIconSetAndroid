    ...
    get() {
        ...
        _chatLine = Builder(
            ...
            path(
                ...
                close()
                moveTo(8.0f, 11.75f)
                curveTo(7.5858f, 11.75f, 7.25f, 12.0858f, 7.25f, 12.5f)
                curveTo(7.25f, 12.9142f, 7.5858f, 13.25f, 8.0f, 13.25f)
                horizontalLineTo(13.5f)
                curveTo(13.9142f, 13.25f, 14.25f, 12.9142f, 14.25f, 12.5f)
                curveTo(14.25f, 12.0858f, 13.9142f, 11.75f, 13.5f, 11.75f)
