    ...
    get() {
        ...
        _gamepadCharge = Builder(
            ...
            path(
                ...
                curveTo(13.4999f, 17.1099f, 13.3953f, 16.9649f, 13.2403f, 16.9132f)
                curveTo(12.4351f, 16.6448f, 11.5646f, 16.6448f, 10.7594f, 16.9132f)
                curveTo(10.6044f, 16.9649f, 10.4999f, 17.1099f, 10.4999f, 17.2733f)
                verticalLineTo(17.9996f)
                curveTo(10.4999f, 18.4655f, 10.8186f, 18.857f, 11.2499f, 18.968f)
                verticalLineTo(22.25f)
                curveTo(11.2499f, 22.6642f, 11.5856f, 23.0f, 11.9999f, 23.0f)
                curveTo(12.4141f, 23.0f, 12.7499f, 22.6642f, 12.7499f, 22.25f)
