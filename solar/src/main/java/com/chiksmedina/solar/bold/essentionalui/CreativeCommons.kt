    ...
    get() {
        ...
        _creativeCommons = Builder(name = "CreativeCommons", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.75f, 12.0f)
                curveTo(13.75f, 10.253f, 15.2834f, 8.75f, 17.2857f, 8.75f)
                curveTo(17.7974f, 8.75f, 18.281f, 8.8496f, 18.7168f, 9.0273f)
                curveTo(19.1003f, 9.1837f, 19.5381f, 8.9996f, 19.6945f, 8.616f)
                curveTo(19.8509f, 8.2325f, 19.6667f, 7.7948f, 19.2832f, 7.6384f)
                curveTo(18.669f, 7.3879f, 17.9931f, 7.25f, 17.2857f, 7.25f)
                curveTo(14.5541f, 7.25f, 12.25f, 9.3287f, 12.25f, 12.0f)
                curveTo(12.25f, 14.6712f, 14.5541f, 16.75f, 17.2857f, 16.75f)
                curveTo(17.9931f, 16.75f, 18.669f, 16.6121f, 19.2832f, 16.3616f)
                curveTo(19.6667f, 16.2052f, 19.8509f, 15.7675f, 19.6945f, 15.384f)
                curveTo(19.5381f, 15.0004f, 19.1003f, 14.8163f, 18.7168f, 14.9727f)
                curveTo(18.281f, 15.1504f, 17.7974f, 15.25f, 17.2857f, 15.25f)
                curveTo(15.2834f, 15.25f, 13.75f, 13.747f, 13.75f, 12.0f)
                close()
