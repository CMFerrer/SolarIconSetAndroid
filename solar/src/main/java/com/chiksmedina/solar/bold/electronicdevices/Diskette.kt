    ...
    get() {
        ...
        _diskette = Builder(
            ...
            path(
                ...
                moveTo(16.1835f, 18.9054f)
                curveTo(16.2484f, 19.3884f, 16.25f, 20.036f, 16.25f, 21.0f)
                verticalLineTo(21.9313f)
                curveTo(15.0942f, 22.0f, 13.7004f, 22.0f, 12.0f, 22.0f)
                curveTo(10.2996f, 22.0f, 8.9058f, 22.0f, 7.75f, 21.9313f)
                verticalLineTo(21.0f)
                curveTo(7.75f, 20.036f, 7.7516f, 19.3884f, 7.8165f, 18.9054f)
                curveTo(7.8786f, 18.4439f, 7.9858f, 18.2464f, 8.1161f, 18.1161f)
                curveTo(8.2464f, 17.9858f, 8.4439f, 17.8786f, 8.9054f, 17.8165f)
                curveTo(9.3884f, 17.7516f, 10.036f, 17.75f, 11.0f, 17.75f)
                horizontalLineTo(13.0f)
                curveTo(13.964f, 17.75f, 14.6116f, 17.7516f, 15.0946f, 17.8165f)
                curveTo(15.5561f, 17.8786f, 15.7536f, 17.9858f, 15.8839f, 18.1161f)
                curveTo(16.0142f, 18.2464f, 16.1214f, 18.4439f, 16.1835f, 18.9054f)
                close()
            }
        }
            .build()
