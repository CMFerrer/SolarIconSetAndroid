    ...
    get() {
        ...
        _fileLeft = Builder(name = "FileLeft", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.1824f, 16.2245f, 5.1824f, 15.7755f, 5.4528f, 15.487f)
                lineTo(7.3278f, 13.487f)
                curveTo(7.6111f, 13.1849f, 8.0858f, 13.1695f, 8.388f, 13.4528f)
                curveTo(8.6901f, 13.7361f, 8.7055f, 14.2108f, 8.4221f, 14.513f)
                ...
                lineTo(8.4221f, 17.487f)
                curveTo(8.7055f, 17.7892f, 8.6901f, 18.2639f, 8.388f, 18.5472f)
                curveTo(8.0858f, 18.8304f, 7.6111f, 18.8151f, 7.3278f, 18.513f)
