    ...
    get() {
        ...
        _reorder = Builder(name = "Reorder", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.701f, 15.75f)
                curveTo(9.5f, 16.0981f, 9.5f, 16.5654f, 9.5f, 17.5f)
                curveTo(9.5f, 18.4346f, 9.5f, 18.9019f, 9.701f, 19.25f)
                curveTo(9.8326f, 19.478f, 10.022f, 19.6674f, 10.25f, 19.799f)
                curveTo(10.5981f, 20.0f, 11.0654f, 20.0f, 12.0f, 20.0f)
                curveTo(12.9346f, 20.0f, 13.4019f, 20.0f, 13.75f, 19.799f)
                curveTo(13.978f, 19.6674f, 14.1674f, 19.478f, 14.299f, 19.25f)
                curveTo(14.5f, 18.9019f, 14.5f, 18.4346f, 14.5f, 17.5f)
                curveTo(14.5f, 16.5654f, 14.5f, 16.0981f, 14.299f, 15.75f)
                curveTo(14.1674f, 15.522f, 13.978f, 15.3326f, 13.75f, 15.201f)
                curveTo(13.4019f, 15.0f, 12.9346f, 15.0f, 12.0f, 15.0f)
                curveTo(11.0654f, 15.0f, 10.5981f, 15.0f, 10.25f, 15.201f)
                curveTo(10.022f, 15.3326f, 9.8326f, 15.522f, 9.701f, 15.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
