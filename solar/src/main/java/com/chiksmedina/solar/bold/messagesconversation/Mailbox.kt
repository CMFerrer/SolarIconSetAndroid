    ...
    get() {
        ...
        _mailbox = Builder(
            ...
            path(
                ...
                moveTo(14.5f, 6.0f)
                verticalLineTo(10.2807f)
                curveTo(14.5f, 11.4518f, 15.428f, 12.5f, 16.6923f, 12.5f)
                curveTo(17.9566f, 12.5f, 18.8846f, 11.4518f, 18.8846f, 10.2807f)
                verticalLineTo(8.228f)
                curveTo(19.6455f, 8.4333f, 20.4446f, 8.4573f, 21.22f, 8.295f)
                curveTo(21.7122f, 9.1367f, 22.0f, 10.1541f, 22.0f, 11.25f)
                verticalLineTo(17.4253f)
                curveTo(22.0f, 18.8473f, 21.0119f, 20.0f, 19.7931f, 20.0f)
                horizontalLineTo(12.5f)
                verticalLineTo(11.25f)
                curveTo(12.5f, 9.2201f, 11.6679f, 7.276f, 10.2826f, 6.0f)
