    ...
    get() {
        ...
        _hikingRound = Builder(
            ...
            path(
                ...
                curveTo(9.5913f, 16.8799f, 9.8307f, 17.29f, 9.7254f, 17.6906f)
                lineTo(9.0f, 17.5f)
                curveTo(9.7254f, 17.6906f, 9.7254f, 17.6906f, 9.7254f, 17.6906f)
