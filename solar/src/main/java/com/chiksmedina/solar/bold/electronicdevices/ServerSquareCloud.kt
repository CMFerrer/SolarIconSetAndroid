    ...
    get() {
        ...
        _serverSquareCloud = Builder(name = "ServerSquareCloud", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.6543f, 20.5272f, 13.5f, 19.9792f, 13.5f, 19.4118f)
                curveTo(13.5f, 18.5958f, 13.8191f, 17.8199f, 14.3571f, 17.25f)
                horizontalLineTo(13.5f)
                curveTo(13.0858f, 17.25f, 12.75f, 16.9142f, 12.75f, 16.5f)
                curveTo(12.75f, 16.0858f, 13.0858f, 15.75f, 13.5f, 15.75f)
                horizontalLineTo(15.4282f)
                curveTo(15.9395f, 14.4601f, 17.1549f, 13.5f, 18.6667f, 13.5f)
                curveTo(20.2273f, 13.5f, 21.4762f, 14.5283f, 21.955f, 15.8805f)
                lineTo(21.9694f, 15.8905f)
                curveTo(22.0f, 15.0727f, 22.0f, 14.1194f, 22.0f, 13.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.7161f, 16.5804f, 16.6667f, 16.8429f, 16.6667f, 17.1176f)
                curveTo(16.6667f, 17.3763f, 16.7105f, 17.6242f, 16.7907f, 17.8533f)
                curveTo(16.6966f, 17.8338f, 16.5994f, 17.8235f, 16.5f, 17.8235f)
                curveTo(16.0601f, 17.8235f, 15.6644f, 18.024f, 15.3901f, 18.3434f)
                curveTo(15.1477f, 18.6255f, 15.0f, 19.0004f, 15.0f, 19.4118f)
