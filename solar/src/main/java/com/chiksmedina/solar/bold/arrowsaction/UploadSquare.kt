...
public val ArrowsActionGroup.UploadSquare: ImageVector
    get() {
        if (_uploadSquare != null) {
            return _uploadSquare!!
        }
        _uploadSquare = Builder(name = "UploadSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(14.4697f, 13.5303f)
                curveTo(14.7626f, 13.8232f, 15.2374f, 13.8232f, 15.5303f, 13.5303f)
                curveTo(15.8232f, 13.2374f, 15.8232f, 12.7626f, 15.5303f, 12.4697f)
                lineTo(12.5303f, 9.4697f)
                curveTo(12.3897f, 9.329f, 12.1989f, 9.25f, 12.0f, 9.25f)
                curveTo(11.8011f, 9.25f, 11.6103f, 9.329f, 11.4697f, 9.4697f)
                lineTo(8.4697f, 12.4697f)
                curveTo(8.1768f, 12.7626f, 8.1768f, 13.2374f, 8.4697f, 13.5303f)
