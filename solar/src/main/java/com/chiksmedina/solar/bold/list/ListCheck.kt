...
public val ListGroup.ListCheck: ImageVector
    get() {
        if (_listCheck != null) {
            return _listCheck!!
        }
        _listCheck = Builder(name = "ListCheck", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.2113f, 12.6586f)
                curveTo(20.5379f, 12.9134f, 20.5961f, 13.3847f, 20.3414f, 13.7113f)
                lineTo(16.4414f, 18.7113f)
                curveTo(16.3022f, 18.8897f, 16.0899f, 18.9958f, 15.8636f, 18.9999f)
                curveTo(15.6373f, 19.004f, 15.4213f, 18.9057f, 15.2757f, 18.7324f)
                lineTo(13.1757f, 16.2324f)
                curveTo(12.9093f, 15.9152f, 12.9504f, 15.4421f, 13.2676f, 15.1757f)
                curveTo(13.5848f, 14.9093f, 14.0579f, 14.9504f, 14.3243f, 15.2676f)
                lineTo(15.8284f, 17.0582f)
                lineTo(19.1586f, 12.7887f)
                curveTo(19.4134f, 12.4621f, 19.8847f, 12.4039f, 20.2113f, 12.6586f)
                close()
                moveTo(2.0f, 13.75f)
