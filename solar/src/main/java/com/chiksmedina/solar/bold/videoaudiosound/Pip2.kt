    ...
    get() {
        ...
        _pip2 = Builder(name = "Pip2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.174f, 12.4404f)
                curveTo(11.0f, 12.8692f, 11.0f, 13.4128f, 11.0f, 14.5f)
                curveTo(11.0f, 15.5872f, 11.0f, 16.1308f, 11.174f, 16.5596f)
                curveTo(11.406f, 17.1313f, 11.8509f, 17.5856f, 12.411f, 17.8224f)
                curveTo(12.8311f, 18.0f, 13.3636f, 18.0f, 14.4286f, 18.0f)
                horizontalLineTo(15.5714f)
                curveTo(16.6364f, 18.0f, 17.1689f, 18.0f, 17.589f, 17.8224f)
                curveTo(18.1491f, 17.5856f, 18.594f, 17.1313f, 18.826f, 16.5596f)
                curveTo(19.0f, 16.1308f, 19.0f, 15.5872f, 19.0f, 14.5f)
                curveTo(19.0f, 13.4128f, 19.0f, 12.8692f, 18.826f, 12.4404f)
                curveTo(18.594f, 11.8687f, 18.1491f, 11.4144f, 17.589f, 11.1776f)
                curveTo(17.1689f, 11.0f, 16.6364f, 11.0f, 15.5714f, 11.0f)
                horizontalLineTo(14.4286f)
                curveTo(13.3636f, 11.0f, 12.8311f, 11.0f, 12.411f, 11.1776f)
                curveTo(11.8509f, 11.4144f, 11.406f, 11.8687f, 11.174f, 12.4404f)
                close()
            }
        }
        .build()
