...
public val ArrowsGroup.SquareAltArrowUp: ImageVector
    get() {
        if (_squareAltArrowUp != null) {
            return _squareAltArrowUp!!
        }
        _squareAltArrowUp = Builder(name = "SquareAltArrowUp", defaultWidth = 24.0.dp, defaultHeight
