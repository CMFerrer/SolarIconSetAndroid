    ...
    get() {
        ...
        _jarOfPills2 = Builder(
            ...
            path(
                ...
                moveTo(16.3663f, 16.179f)
                lineTo(16.8782f, 15.6671f)
                curveTo(17.794f, 14.7513f, 19.3098f, 14.7822f, 20.2638f, 15.7362f)
                curveTo(21.2178f, 16.6902f, 21.2487f, 18.206f, 20.3329f, 19.1218f)
                lineTo(19.821f, 19.6338f)
                curveTo(19.7778f, 19.5242f, 19.7227f, 19.3974f, 19.6527f, 19.2566f)
                curveTo(19.4264f, 18.8018f, 19.0463f, 18.2044f, 18.421f, 17.5791f)
                curveTo(17.7957f, 16.9537f, 17.1982f, 16.5736f, 16.7434f, 16.3473f)
                curveTo(16.6026f, 16.2773f, 16.4758f, 16.2221f, 16.3663f, 16.179f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(15.1401f, 17.4052f)
                lineTo(14.6671f, 17.8782f)
                curveTo(13.7513f, 18.794f, 13.7822f, 20.3098f, 14.7362f, 21.2638f)
                curveTo(15.6902f, 22.2178f, 17.206f, 22.2487f, 18.1218f, 21.3329f)
                lineTo(18.5947f, 20.86f)
                lineTo(18.495f, 20.3902f)
                lineTo(18.4921f, 20.3789f)
                curveTo(18.4879f, 20.3637f, 18.4797f, 20.335f, 18.4661f, 20.2947f)
                curveTo(18.4388f, 20.2139f, 18.3901f, 20.0864f, 18.3097f, 19.9247f)
                curveTo(18.1492f, 19.602f, 17.861f, 19.1404f, 17.3603f, 18.6397f)
                curveTo(16.8597f, 18.139f, 16.398f, 17.8508f, 16.0753f, 17.6903f)
                curveTo(15.9135f, 17.6098f, 15.7859f, 17.5611f, 15.7052f, 17.5338f)
                curveTo(15.6648f, 17.5202f, 15.6362f, 17.5119f, 15.6209f, 17.5078f)
                lineTo(15.6096f, 17.5048f)
                lineTo(15.1401f, 17.4052f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(
                ...
                curveTo(13.3452f, 17.0993f, 13.4694f, 16.9547f, 13.6067f, 16.8174f)
                lineTo(15.8177f, 14.6064f)
                curveTo(16.9608f, 13.4634f, 18.6118f, 13.2295f, 20.0f, 13.7954f)
            ...
            path(
                ...
                moveTo(12.5729f, 18.7499f)
                curveTo(12.3513f, 19.8711f, 12.6386f, 21.0722f, 13.3846f, 21.9999f)
