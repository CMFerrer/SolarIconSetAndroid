...
public val TimeGroup.AlarmRemove: ImageVector
    get() {
        if (_alarmRemove != null) {
            return _alarmRemove!!
        }
        _alarmRemove = Builder(name = "AlarmRemove", defaultWidth = 24.0.dp, defaultHeight =
