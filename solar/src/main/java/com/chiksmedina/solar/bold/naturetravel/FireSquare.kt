    ...
    get() {
        ...
        _fireSquare = Builder(name = "FireSquare", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.0f, 12.6667f)
                curveTo(17.0f, 16.9333f, 13.4444f, 18.0f, 11.6667f, 18.0f)
                curveTo(10.1111f, 18.0f, 7.0f, 16.9333f, 7.0f, 12.6667f)
                curveTo(7.0f, 10.8109f, 8.0629f, 9.6327f, 8.9559f, 9.0397f)
                curveTo(9.3642f, 8.7686f, 9.872f, 8.9419f, 9.8984f, 9.4313f)
                curveTo(9.9562f, 10.5021f, 10.7814f, 11.3622f, 11.4205f, 10.5011f)
                curveTo(12.0054f, 9.713f, 12.2941f, 8.6427f, 12.2941f, 8.0f)
                curveTo(12.2941f, 7.0532f, 13.2525f, 6.4516f, 14.0008f, 7.0317f)
                curveTo(15.4593f, 8.1623f, 17.0f, 10.0558f, 17.0f, 12.6667f)
                close()
            }
        }
        .build()
