    ...
    get() {
        ...
        _alignLeft = Builder(
            ...
            path(
                ...
                moveTo(3.375f, 1.625f)
                curveTo(3.7892f, 1.625f, 4.125f, 1.9608f, 4.125f, 2.375f)
                lineTo(4.125f, 22.375f)
                curveTo(4.125f, 22.7892f, 3.7892f, 23.125f, 3.375f, 23.125f)
                curveTo(2.9608f, 23.125f, 2.625f, 22.7892f, 2.625f, 22.375f)
                lineTo(2.625f, 2.375f)
                curveTo(2.625f, 1.9608f, 2.9608f, 1.625f, 3.375f, 1.625f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
