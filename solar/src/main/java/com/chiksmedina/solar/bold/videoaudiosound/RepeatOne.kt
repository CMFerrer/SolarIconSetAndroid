    ...
    get() {
        ...
        _repeatOne = Builder(name = "RepeatOne", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.287f, 9.3071f)
                curveTo(12.5673f, 9.4232f, 12.75f, 9.6966f, 12.75f, 10.0f)
                ...
                lineTo(11.0303f, 12.0303f)
                curveTo(10.7374f, 12.3232f, 10.2626f, 12.3232f, 9.9697f, 12.0303f)
                curveTo(9.6768f, 11.7374f, 9.6768f, 11.2626f, 9.9697f, 10.9697f)
                lineTo(11.4697f, 9.4697f)
                curveTo(11.6842f, 9.2552f, 12.0068f, 9.191f, 12.287f, 9.3071f)
                close()
            }
        }
        .build()
