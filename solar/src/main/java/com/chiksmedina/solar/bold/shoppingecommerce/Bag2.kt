    ...
    get() {
        ...
        _bag2 = Builder(
            ...
            path(
                ...
                verticalLineTo(5.0f)
                close()
                moveTo(15.7399f, 10.8768f)
                curveTo(15.6718f, 10.4682f, 15.2854f, 10.1922f, 14.8768f, 10.2603f)
                curveTo(14.4682f, 10.3284f, 14.1922f, 10.7148f, 14.2603f, 11.1234f)
                lineTo(15.2603f, 17.1234f)
                curveTo(15.3284f, 17.532f, 15.7148f, 17.808f, 16.1234f, 17.7399f)
                curveTo(16.532f, 17.6718f, 16.808f, 17.2854f, 16.7399f, 16.8768f)
                lineTo(15.7399f, 10.8768f)
                close()
                moveTo(9.1232f, 10.2603f)
                curveTo(8.7146f, 10.1922f, 8.3282f, 10.4682f, 8.2601f, 10.8768f)
                lineTo(7.2601f, 16.8768f)
                curveTo(7.192f, 17.2854f, 7.468f, 17.6718f, 7.8766f, 17.7399f)
                curveTo(8.2851f, 17.808f, 8.6716f, 17.532f, 8.7397f, 17.1234f)
                lineTo(9.7397f, 11.1234f)
                curveTo(9.8078f, 10.7148f, 9.5317f, 10.3284f, 9.1232f, 10.2603f)
                close()
            }
        }
            .build()
