    ...
    get() {
        ...
        _folderSecurity = Builder(name = "FolderSecurity", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.6904f, 14.25f, 13.25f, 13.6904f, 13.25f, 13.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 10.25f)
                curveTo(10.4812f, 10.25f, 9.25f, 11.4812f, 9.25f, 13.0f)
                curveTo(9.25f, 14.2588f, 10.0957f, 15.32f, 11.25f, 15.6465f)
                ...
                curveTo(13.9043f, 15.32f, 14.75f, 14.2588f, 14.75f, 13.0f)
                curveTo(14.75f, 11.4812f, 13.5188f, 10.25f, 12.0f, 10.25f)
                close()
            }
        }
        .build()
