    ...
    get() {
        ...
        _dropper2 = Builder(name = "Dropper2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(21.9983f)
                curveTo(21.9881f, 7.8531f, 21.9166f, 7.0881f, 21.4142f, 6.5858f)
                ...
                curveTo(12.0492f, 19.4037f, 13.6299f, 20.0673f, 15.25f, 20.2234f)
                ...
                curveTo(18.3701f, 20.0673f, 19.9508f, 19.4037f, 21.2371f, 18.2329f)
                ...
                close()
                moveTo(16.0f, 15.0f)
                curveTo(17.1046f, 15.0f, 18.0f, 14.0673f, 18.0f, 12.9167f)
                curveTo(18.0f, 12.1968f, 17.217f, 11.2359f, 16.6309f, 10.6174f)
                curveTo(16.2839f, 10.2513f, 15.7161f, 10.2513f, 15.3691f, 10.6174f)
                curveTo(14.783f, 11.2359f, 14.0f, 12.1968f, 14.0f, 12.9167f)
                curveTo(14.0f, 14.0673f, 14.8954f, 15.0f, 16.0f, 15.0f)
                close()
            }
        }
        .build()
