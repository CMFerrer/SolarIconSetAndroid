    ...
    get() {
        ...
        _homeAngle = Builder(
            ...
            path(
                ...
                close()
                moveTo(8.2501f, 17.9998f)
                curveTo(8.2501f, 17.5856f, 8.5859f, 17.2498f, 9.0001f, 17.2498f)
                horizontalLineTo(15.0001f)
                curveTo(15.4143f, 17.2498f, 15.7501f, 17.5856f, 15.7501f, 17.9998f)
                curveTo(15.7501f, 18.414f, 15.4143f, 18.7498f, 15.0001f, 18.7498f)
                horizontalLineTo(9.0001f)
                curveTo(8.5859f, 18.7498f, 8.2501f, 18.414f, 8.2501f, 17.9998f)
                close()
            }
        }
            .build()
