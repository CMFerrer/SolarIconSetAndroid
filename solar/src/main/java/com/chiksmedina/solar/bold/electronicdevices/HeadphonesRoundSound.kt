    ...
    get() {
        ...
        _headphonesRoundSound = Builder(name = "HeadphonesRoundSound", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.9999f, 5.75f)
                curveTo(12.4142f, 5.75f, 12.7499f, 6.0858f, 12.7499f, 6.5f)
                lineTo(12.7499f, 11.5f)
                curveTo(12.7499f, 11.9142f, 12.4142f, 12.25f, 11.9999f, 12.25f)
                curveTo(11.5857f, 12.25f, 11.2499f, 11.9142f, 11.2499f, 11.5f)
                lineTo(11.2499f, 6.5f)
                curveTo(11.2499f, 6.0858f, 11.5857f, 5.75f, 11.9999f, 5.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(15.4142f, 7.25f, 15.7499f, 7.5858f, 15.7499f, 8.0f)
                verticalLineTo(10.0f)
                curveTo(15.7499f, 10.4142f, 15.4142f, 10.75f, 14.9999f, 10.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.5857f, 10.75f, 8.25f, 10.4142f, 8.25f, 10.0f)
                lineTo(8.25f, 8.0f)
                curveTo(8.25f, 7.5858f, 8.5857f, 7.25f, 9.0f, 7.25f)
                close()
            }
        }
        .build()
