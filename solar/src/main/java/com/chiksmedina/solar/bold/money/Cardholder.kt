    ...
    get() {
        ...
        _cardholder = Builder(name = "Cardholder", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.5858f, 6.5858f)
                curveTo(8.1716f, 6.0f, 9.1144f, 6.0f, 11.0f, 6.0f)
                horizontalLineTo(13.0f)
                curveTo(14.8856f, 6.0f, 15.8284f, 6.0f, 16.4142f, 6.5858f)
                curveTo(17.0f, 7.1716f, 17.0f, 8.1144f, 17.0f, 10.0f)
                ...
                curveTo(7.0f, 8.1144f, 7.0f, 7.1716f, 7.5858f, 6.5858f)
                close()
            }
        }
        .build()
