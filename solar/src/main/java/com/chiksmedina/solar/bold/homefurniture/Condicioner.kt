    ...
    get() {
        ...
        _condicioner = Builder(name = "Condicioner", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.5496f, 15.0f, 7.135f, 15.0f, 6.7527f, 14.9965f)
                curveTo(6.7572f, 14.3477f, 6.7686f, 13.6743f, 6.7982f, 13.454f)
                curveTo(6.842f, 13.1287f, 6.9126f, 13.0268f, 6.9697f, 12.9697f)
                curveTo(7.0268f, 12.9126f, 7.1287f, 12.842f, 7.454f, 12.7982f)
                curveTo(7.8009f, 12.7516f, 8.2717f, 12.75f, 9.0f, 12.75f)
                horizontalLineTo(15.0f)
                curveTo(15.7283f, 12.75f, 16.1991f, 12.7516f, 16.546f, 12.7982f)
                curveTo(16.8713f, 12.842f, 16.9732f, 12.9126f, 17.0303f, 12.9697f)
                curveTo(17.0874f, 13.0268f, 17.158f, 13.1287f, 17.2018f, 13.454f)
                curveTo(17.2314f, 13.6743f, 17.2428f, 14.3477f, 17.2473f, 14.9965f)
                curveTo(16.865f, 15.0f, 16.4504f, 15.0f, 16.0f, 15.0f)
                close()
            }
        }
        .build()
