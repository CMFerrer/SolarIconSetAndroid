    ...
    get() {
        ...
        _maskSad = Builder(name = "MaskSad", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(21.0f, 6.2077f)
                verticalLineTo(11.4061f)
                curveTo(21.0f, 16.8106f, 16.761f, 19.4332f, 14.1014f, 20.5469f)
                curveTo(13.38f, 20.849f, 13.0193f, 21.0f, 12.0f, 21.0f)
                curveTo(10.9807f, 21.0f, 10.62f, 20.849f, 9.8986f, 20.5469f)
                curveTo(7.239f, 19.4332f, 3.0f, 16.8106f, 3.0f, 11.4061f)
                verticalLineTo(6.2077f)
                curveTo(3.0f, 4.052f, 3.0f, 2.9742f, 3.7073f, 2.3844f)
                curveTo(4.4145f, 1.7947f, 5.4955f, 1.972f, 7.6576f, 2.3267f)
                lineTo(8.712f, 2.4997f)
                curveTo(10.3523f, 2.7688f, 11.1724f, 2.9034f, 12.0f, 2.9034f)
                curveTo(12.8276f, 2.9034f, 13.6477f, 2.7688f, 15.288f, 2.4997f)
                lineTo(16.3424f, 2.3267f)
                curveTo(18.5045f, 1.972f, 19.5855f, 1.7947f, 20.2927f, 2.3844f)
                curveTo(21.0f, 2.9742f, 21.0f, 4.052f, 21.0f, 6.2077f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.1711f, 8.7831f)
                curveTo(7.2945f, 8.5399f, 7.7569f, 8.207f, 8.5002f, 8.207f)
                curveTo(9.2434f, 8.207f, 9.7058f, 8.5399f, 9.8293f, 8.7831f)
                curveTo(10.0144f, 9.1478f, 10.4649f, 9.2957f, 10.8354f, 9.1135f)
                curveTo(11.2059f, 8.9312f, 11.3562f, 8.4878f, 11.1711f, 8.1231f)
                curveTo(10.7123f, 7.2193f, 9.6037f, 6.7305f, 8.5002f, 6.7305f)
                curveTo(7.3967f, 6.7305f, 6.288f, 7.2193f, 5.8293f, 8.1231f)
                curveTo(5.6441f, 8.4878f, 5.7944f, 8.9312f, 6.1649f, 9.1135f)
                curveTo(6.5354f, 9.2957f, 6.9859f, 9.1478f, 7.1711f, 8.7831f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
