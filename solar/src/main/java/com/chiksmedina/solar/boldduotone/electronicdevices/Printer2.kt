    ...
    get() {
        ...
        _printer2 = Builder(name = "Printer2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.0f, 20.2426f, 6.0f, 18.3284f, 6.0f, 15.5f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(5.0f, 17.2038f, 5.0f, 16.3522f, 5.0f, 15.5f)
                curveTo(4.7239f, 15.5f, 4.5f, 15.2761f, 4.5f, 15.0f)
                curveTo(4.5f, 14.7239f, 4.7239f, 14.5f, 5.0f, 14.5f)
                horizontalLineTo(19.0f)
                curveTo(19.2761f, 14.5f, 19.5f, 14.7239f, 19.5f, 15.0f)
                curveTo(19.5f, 15.2761f, 19.2761f, 15.5003f, 19.0f, 15.5003f)
                curveTo(19.0f, 16.3525f, 19.0f, 17.2039f, 18.9721f, 17.9266f)
