    ...
    get() {
        ...
        _listCheckMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(17.3022f, 17.3898f, 17.0899f, 17.4958f, 16.8636f, 17.4999f)
                curveTo(16.6373f, 17.504f, 16.4213f, 17.4057f, 16.2757f, 17.2324f)
                lineTo(14.1757f, 14.7324f)
                curveTo(13.9093f, 14.4153f, 13.9505f, 13.9422f, 14.2676f, 13.6758f)
                curveTo(14.5848f, 13.4093f, 15.0579f, 13.4505f, 15.3243f, 13.7676f)
                lineTo(16.8284f, 15.5583f)
                lineTo(20.1586f, 11.2888f)
                curveTo(20.4134f, 10.9622f, 20.8847f, 10.9039f, 21.2113f, 11.1587f)
                close()
            }
        }
            .build()
