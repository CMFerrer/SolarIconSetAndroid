    ...
    get() {
        ...
        _microphone2 = Builder(name = "Microphone2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                horizontalLineTo(6.2985f)
                curveTo(6.666f, 4.1787f, 9.0786f, 2.0f, 12.0f, 2.0f)
                curveTo(14.9214f, 2.0f, 17.334f, 4.1787f, 17.7015f, 7.0f)
                ...
                curveTo(17.334f, 14.3213f, 14.9214f, 16.5f, 12.0f, 16.5f)
                curveTo(9.0786f, 16.5f, 6.666f, 14.3213f, 6.2985f, 11.5f)
                horizontalLineTo(7.816f)
                horizontalLineTo(9.0f)
                curveTo(9.4142f, 11.5f, 9.75f, 11.1642f, 9.75f, 10.75f)
