    ...
    get() {
        ...
        _refresh = Builder(name = "Refresh", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(20.8412f, 10.4666f)
                curveTo(20.5491f, 10.1778f, 20.0789f, 10.1778f, 19.7868f, 10.4666f)
                lineTo(18.1005f, 12.1333f)
                curveTo(17.8842f, 12.3471f, 17.8185f, 12.6703f, 17.934f, 12.9517f)
                curveTo(18.0496f, 13.233f, 18.3236f, 13.4167f, 18.6278f, 13.4167f)
                horizontalLineTo(19.5269f)
                curveTo(19.1456f, 17.2462f, 15.876f, 20.25f, 11.8828f, 20.25f)
                curveTo(9.1003f, 20.25f, 6.6659f, 18.7903f, 5.318f, 16.6061f)
                curveTo(5.1005f, 16.2536f, 4.6384f, 16.1442f, 4.2859f, 16.3618f)
                curveTo(3.9334f, 16.5793f, 3.824f, 17.0414f, 4.0415f, 17.3939f)
                curveTo(5.6542f, 20.007f, 8.5641f, 21.75f, 11.8828f, 21.75f)
                curveTo(16.6907f, 21.75f, 20.6476f, 18.0892f, 21.0332f, 13.4167f)
                horizontalLineTo(22.0002f)
                curveTo(22.3044f, 13.4167f, 22.5784f, 13.233f, 22.694f, 12.9517f)
                curveTo(22.8096f, 12.6703f, 22.7438f, 12.3471f, 22.5275f, 12.1333f)
                lineTo(20.8412f, 10.4666f)
                close()
            }
        }
        .build()
