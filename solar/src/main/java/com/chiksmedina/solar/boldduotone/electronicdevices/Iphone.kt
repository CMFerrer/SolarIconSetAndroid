    ...
    get() {
        ...
        _iphone = Builder(
            ...
            path(
                ...
                horizontalLineTo(12.0f)
                curveTo(8.2288f, 22.0f, 6.3431f, 22.0f, 5.1716f, 20.809f)
            ...
            path(
                ...
                moveTo(8.25f, 18.9836f)
                curveTo(8.25f, 18.5671f, 8.5858f, 18.2295f, 9.0f, 18.2295f)
                horizontalLineTo(15.0f)
                curveTo(15.4142f, 18.2295f, 15.75f, 18.5671f, 15.75f, 18.9836f)
                curveTo(15.75f, 19.4001f, 15.4142f, 19.7377f, 15.0f, 19.7377f)
                horizontalLineTo(9.0f)
                curveTo(8.5858f, 19.7377f, 8.25f, 19.4001f, 8.25f, 18.9836f)
                close()
            }
        }
            .build()
