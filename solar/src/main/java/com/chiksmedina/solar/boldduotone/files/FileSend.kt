    ...
    get() {
        ...
        _fileSend = Builder(
            ...
            path(
                ...
                moveTo(7.9871f, 12.9528f)
                curveTo(8.2755f, 12.6824f, 8.7245f, 12.6824f, 9.013f, 12.9528f)
                lineTo(11.013f, 14.8278f)
                curveTo(11.3151f, 15.1111f, 11.3305f, 15.5858f, 11.0472f, 15.888f)
                curveTo(10.7639f, 16.1901f, 10.2892f, 16.2054f, 9.9871f, 15.9222f)
                lineTo(9.25f, 15.2312f)
                lineTo(9.25f, 18.5f)
                curveTo(9.25f, 18.9142f, 8.9142f, 19.25f, 8.5f, 19.25f)
                curveTo(8.0858f, 19.25f, 7.75f, 18.9142f, 7.75f, 18.5f)
                lineTo(7.75f, 15.2312f)
                lineTo(7.013f, 15.9222f)
                curveTo(6.7108f, 16.2055f, 6.2361f, 16.1901f, 5.9528f, 15.888f)
                curveTo(5.6695f, 15.5858f, 5.6849f, 15.1111f, 5.9871f, 14.8278f)
                lineTo(7.9871f, 12.9528f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
