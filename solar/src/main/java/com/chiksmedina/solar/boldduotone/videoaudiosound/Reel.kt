    ...
    get() {
        ...
        _reel = Builder(name = "Reel", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(9.0f, 12.0f)
                curveTo(9.0f, 11.1716f, 8.3284f, 10.5f, 7.5f, 10.5f)
                curveTo(6.6716f, 10.5f, 6.0f, 11.1716f, 6.0f, 12.0f)
                curveTo(6.0f, 12.8284f, 6.6716f, 13.5f, 7.5f, 13.5f)
                curveTo(8.3284f, 13.5f, 9.0f, 12.8284f, 9.0f, 12.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
