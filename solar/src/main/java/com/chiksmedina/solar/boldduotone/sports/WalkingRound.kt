    ...
    get() {
        ...
        _walkingRound = Builder(name = "WalkingRound", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.7153f, 9.6077f, 15.8674f, 10.7305f, 16.3278f, 12.1117f)
                curveTo(16.4321f, 12.4245f, 16.7484f, 12.6149f, 17.0736f, 12.5607f)
                ...
                curveTo(16.2669f, 14.2159f, 15.2424f, 13.599f, 14.9048f, 12.586f)
                curveTo(14.5975f, 11.6642f, 13.8619f, 11.0005f, 12.9805f, 10.8739f)
                curveTo(12.7129f, 10.8354f, 12.4404f, 10.8029f, 12.1757f, 10.7809f)
                lineTo(11.9045f, 13.4923f)
                curveTo(11.8205f, 14.332f, 11.8107f, 14.5537f, 11.8674f, 14.7518f)
                curveTo(11.9241f, 14.9498f, 12.0497f, 15.1328f, 12.5652f, 15.8009f)
                lineTo(16.9942f, 21.5419f)
                curveTo(17.2472f, 21.8698f, 17.1865f, 22.3408f, 16.8585f, 22.5938f)
                ...
                curveTo(10.2796f, 14.6551f, 10.3329f, 14.1265f, 10.4003f, 13.4585f)
                curveTo(10.4042f, 13.4205f, 10.4081f, 13.382f, 10.412f, 13.3431f)
                lineTo(10.666f, 10.8023f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                    = 0.5f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.1471f, 16.7647f)
                curveTo(10.5533f, 16.8459f, 10.8167f, 17.2411f, 10.7355f, 17.6472f)
                curveTo(10.3779f, 19.435f, 9.4014f, 21.0395f, 7.9777f, 22.1785f)
                lineTo(7.4686f, 22.5858f)
                curveTo(7.1451f, 22.8446f, 6.6731f, 22.7921f, 6.4144f, 22.4687f)
                curveTo(6.1556f, 22.1452f, 6.2081f, 21.6732f, 6.5315f, 21.4145f)
                lineTo(7.0407f, 21.0072f)
                curveTo(8.1888f, 20.0887f, 8.9762f, 18.7948f, 9.2646f, 17.3531f)
                curveTo(9.3458f, 16.9469f, 9.7409f, 16.6835f, 10.1471f, 16.7647f)
                close()
            }
        }
        .build()
