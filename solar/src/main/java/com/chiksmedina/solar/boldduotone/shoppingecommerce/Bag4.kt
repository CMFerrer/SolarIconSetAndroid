    ...
    get() {
        ...
        _bag4 = Builder(name = "Bag4", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(4.0353f, 11.5733f)
                curveTo(4.4971f, 9.2644f, 4.728f, 8.11f, 5.5574f, 7.43f)
                curveTo(6.3869f, 6.75f, 7.5642f, 6.75f, 9.9188f, 6.75f)
                horizontalLineTo(14.0812f)
                curveTo(16.4358f, 6.75f, 17.6131f, 6.75f, 18.4425f, 7.43f)
                curveTo(19.272f, 8.11f, 19.5029f, 9.2644f, 19.9646f, 11.5733f)
                lineTo(20.5646f, 14.5733f)
                curveTo(21.2287f, 17.8937f, 21.5608f, 19.5539f, 20.6606f, 20.652f)
                curveTo(19.7604f, 21.75f, 18.0673f, 21.75f, 14.6812f, 21.75f)
                horizontalLineTo(9.3188f)
                curveTo(5.9326f, 21.75f, 4.2395f, 21.75f, 3.3394f, 20.652f)
                curveTo(2.4392f, 19.5539f, 2.7712f, 17.8937f, 3.4353f, 14.5733f)
                lineTo(4.0353f, 11.5733f)
                close()
            }
