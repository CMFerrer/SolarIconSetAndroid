    ...
    get() {
        ...
        _dropper2 = Builder(name = "Dropper2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(21.9983f, 9.25f)
                horizontalLineTo(19.0f)
                curveTo(18.5858f, 9.25f, 18.25f, 9.5858f, 18.25f, 10.0f)
                curveTo(18.25f, 10.4142f, 18.5858f, 10.75f, 19.0f, 10.75f)
                horizontalLineTo(22.0f)
                verticalLineTo(12.25f)
                horizontalLineTo(20.0f)
                curveTo(19.5858f, 12.25f, 19.25f, 12.5858f, 19.25f, 13.0f)
                ...
                close()
                moveTo(18.0f, 12.9166f)
                curveTo(18.0f, 14.0672f, 17.1046f, 14.9999f, 16.0f, 14.9999f)
                curveTo(14.8954f, 14.9999f, 14.0f, 14.0672f, 14.0f, 12.9166f)
                curveTo(14.0f, 12.1967f, 14.783f, 11.2358f, 15.3691f, 10.6174f)
                curveTo(15.7161f, 10.2512f, 16.2839f, 10.2512f, 16.6309f, 10.6174f)
                curveTo(17.217f, 11.2358f, 18.0f, 12.1967f, 18.0f, 12.9166f)
                close()
            }
