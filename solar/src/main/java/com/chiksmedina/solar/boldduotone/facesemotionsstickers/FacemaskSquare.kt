    ...
    get() {
        ...
        _facemaskSquare = Builder(name = "FacemaskSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(20.7956f, 19.811f)
                curveTo(20.8778f, 19.8462f, 20.9505f, 19.8944f, 21.0123f, 19.9522f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(13.5785f, 14.439f)
                curveTo(12.5653f, 14.0338f, 11.435f, 14.0338f, 10.4217f, 14.439f)
                lineTo(7.7873f, 15.4928f)
                lineTo(8.2482f, 21.9469f)
                curveTo(8.2485f, 21.9501f, 8.2487f, 21.9533f, 8.2489f, 21.9566f)
                curveTo(9.3015f, 22.0003f, 10.5373f, 22.0003f, 12.0001f, 22.0003f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(6.2855f, 15.5219f)
                lineTo(2.0039f, 13.8096f)
                curveTo(2.0243f, 16.8399f, 2.1545f, 18.6897f, 2.9879f, 19.9522f)
                close()
            }
        }
        .build()
