...
public val ArrowsGroup.SquareArrowRight: ImageVector
    get() {
        if (_squareArrowRight != null) {
            return _squareArrowRight!!
        }
        _squareArrowRight = Builder(name = "SquareArrowRight", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.671f, 12.3897f, 16.75f, 12.1989f, 16.75f, 12.0f)
                curveTo(16.75f, 11.8011f, 16.671f, 11.6103f, 16.5303f, 11.4697f)
