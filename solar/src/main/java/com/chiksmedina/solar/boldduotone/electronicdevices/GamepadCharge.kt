    ...
    get() {
        ...
        _gamepadCharge = Builder(
            ...
            path(
                ...
                moveTo(12.7498f, 18.968f)
                curveTo(13.1811f, 18.857f, 13.4998f, 18.4655f, 13.4998f, 17.9996f)
                verticalLineTo(17.2733f)
                curveTo(13.4998f, 17.1099f, 13.3952f, 16.9649f, 13.2402f, 16.9132f)
                curveTo(12.435f, 16.6448f, 11.5645f, 16.6448f, 10.7593f, 16.9132f)
                curveTo(10.6043f, 16.9649f, 10.4998f, 17.1099f, 10.4998f, 17.2733f)
                verticalLineTo(17.9996f)
                curveTo(10.4998f, 18.4655f, 10.8184f, 18.857f, 11.2498f, 18.968f)
                verticalLineTo(22.25f)
                curveTo(11.2498f, 22.6642f, 11.5855f, 23.0f, 11.9998f, 23.0f)
                curveTo(12.414f, 23.0f, 12.7498f, 22.6642f, 12.7498f, 22.25f)
