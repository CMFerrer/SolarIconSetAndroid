    ...
    get() {
        ...
        _hikingRound = Builder(
            ...
            path(
                ...
                curveTo(16.5564f, 12.9799f, 14.456f, 13.0665f, 12.6646f, 12.1708f)
                curveTo(12.6474f, 12.1622f, 12.6306f, 12.153f, 12.6141f, 12.1431f)
                curveTo(11.9234f, 11.7287f, 11.0363f, 12.1741f, 10.9562f, 12.9756f)
                lineTo(10.8876f, 13.6617f)
                curveTo(10.8294f, 14.243f, 11.1062f, 14.807f, 11.6016f, 15.1166f)
                lineTo(11.9349f, 15.3249f)
                curveTo(13.6852f, 16.4188f, 14.8215f, 18.2701f, 15.0044f, 20.3261f)
                lineTo(15.1474f, 21.9335f)
                curveTo(15.1842f, 22.3461f, 14.8794f, 22.7103f, 14.4669f, 22.747f)
            ...
            path(
                ...
                curveTo(6.2435f, 10.9173f, 5.8909f, 11.2045f, 5.7831f, 11.608f)
                curveTo(5.6881f, 11.9632f, 5.8017f, 12.3412f, 6.0752f, 12.5843f)
                lineTo(8.162f, 14.4395f)
                curveTo(8.4716f, 14.7147f, 8.4994f, 15.1888f, 8.2242f, 15.4983f)
                curveTo(7.949f, 15.8079f, 7.4749f, 15.8358f, 7.1654f, 15.5605f)
            ...
            path(
                ...
                lineTo(9.7192f, 17.7138f)
                lineTo(9.7033f, 17.7718f)
                curveTo(9.6896f, 17.8213f, 9.6696f, 17.892f, 9.6439f, 17.9791f)
                curveTo(9.5925f, 18.153f, 9.5179f, 18.3943f, 9.4242f, 18.665f)
                curveTo(9.2425f, 19.1899f, 8.9684f, 19.8882f, 8.6282f, 20.4097f)
                curveTo(8.2708f, 20.9577f, 7.7098f, 21.5113f, 7.2771f, 21.903f)
                curveTo(7.0538f, 22.1051f, 6.8509f, 22.2764f, 6.7035f, 22.3973f)
                curveTo(6.6297f, 22.4579f, 6.5694f, 22.5063f, 6.527f, 22.5398f)
                lineTo(6.4773f, 22.579f)
                lineTo(6.4634f, 22.5898f)
                lineTo(6.4582f, 22.5938f)
                curveTo(6.1299f, 22.8464f, 5.6583f, 22.7857f, 5.4057f, 22.4574f)
                curveTo(5.1531f, 22.1292f, 5.2143f, 21.6585f, 5.5424f, 21.4058f)
                lineTo(5.5447f, 21.4041f)
                lineTo(5.5544f, 21.3965f)
                lineTo(5.5954f, 21.3642f)
                curveTo(5.6317f, 21.3354f, 5.6853f, 21.2925f, 5.7518f, 21.2379f)
                curveTo(5.8852f, 21.1285f, 6.0691f, 20.9732f, 6.2704f, 20.791f)
                curveTo(6.6869f, 20.4139f, 7.1258f, 19.9675f, 7.3718f, 19.5903f)
                curveTo(7.6061f, 19.2311f, 7.8319f, 18.6794f, 8.0067f, 18.1745f)
                curveTo(8.0912f, 17.9303f, 8.1588f, 17.7117f, 8.2052f, 17.5545f)
                curveTo(8.2284f, 17.476f, 8.2461f, 17.4133f, 8.2579f, 17.3708f)
                lineTo(8.271f, 17.3231f)
                lineTo(8.274f, 17.3118f)
                lineTo(8.2746f, 17.3094f)
                curveTo(8.38f, 16.9089f, 8.7901f, 16.6694f, 9.1907f, 16.7747f)
                close()
            }
        }
            .build()
