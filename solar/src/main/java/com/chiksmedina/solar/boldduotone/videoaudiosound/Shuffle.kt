    ...
    get() {
        ...
        _shuffle = Builder(name = "Shuffle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(15.1415f)
                curveTo(14.8289f, 15.5835f, 14.5769f, 15.5837f, 14.3358f, 15.538f)
                curveTo(13.7967f, 15.436f, 13.3028f, 15.1655f, 12.9306f, 14.7632f)
                curveTo(12.7637f, 14.5829f, 12.6321f, 14.3694f, 12.4722f, 14.1099f)
                lineTo(12.4722f, 14.1098f)
