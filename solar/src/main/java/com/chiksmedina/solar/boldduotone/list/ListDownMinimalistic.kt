...
public val ListGroup.ListDownMinimalistic: ImageVector
    get() {
        if (_listDownMinimalistic != null) {
            return _listDownMinimalistic!!
        }
        _listDownMinimalistic = Builder(name = "ListDownMinimalistic", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.0119f, 18.5695f)
                curveTo(17.2928f, 18.8102f, 17.7072f, 18.8102f, 17.9881f, 18.5695f)
                lineTo(21.4881f, 15.5695f)
                curveTo(21.8026f, 15.2999f, 21.839f, 14.8264f, 21.5695f, 14.5119f)
                ...
                curveTo(13.161f, 14.8264f, 13.1974f, 15.2999f, 13.5119f, 15.5695f)
                lineTo(17.0119f, 18.5695f)
                close()
            }
        }
        .build()
