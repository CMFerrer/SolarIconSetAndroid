...
public val DesignToolsGroup.AlignHorizontalCenter: ImageVector
    get() {
        ...
        _alignHorizontalCenter = Builder(name = "AlignHorizontalCenter", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.5654f, 14.0f, 8.0981f, 14.0f, 7.75f, 14.201f)
                curveTo(7.522f, 14.3326f, 7.3326f, 14.522f, 7.201f, 14.75f)
                curveTo(7.0f, 15.0981f, 7.0f, 15.5654f, 7.0f, 16.5f)
                curveTo(7.0f, 17.4346f, 7.0f, 17.9019f, 7.201f, 18.25f)
                curveTo(7.3326f, 18.478f, 7.522f, 18.6674f, 7.75f, 18.799f)
                curveTo(8.0981f, 19.0f, 8.5654f, 19.0f, 9.5f, 19.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(19.0f, 7.5f)
                curveTo(19.0f, 6.5654f, 19.0f, 6.0981f, 18.799f, 5.75f)
                curveTo(18.6674f, 5.522f, 18.478f, 5.3326f, 18.25f, 5.201f)
                curveTo(17.9019f, 5.0f, 17.4346f, 5.0f, 16.5f, 5.0f)
                lineTo(7.5f, 5.0f)
                ...
                curveTo(5.0f, 8.4346f, 5.0f, 8.9019f, 5.201f, 9.25f)
                curveTo(5.3326f, 9.478f, 5.522f, 9.6674f, 5.75f, 9.799f)
                curveTo(6.0981f, 10.0f, 6.5654f, 10.0f, 7.5f, 10.0f)
                lineTo(16.5f, 10.0f)
                curveTo(17.4346f, 10.0f, 17.9019f, 10.0f, 18.25f, 9.799f)
                curveTo(18.478f, 9.6674f, 18.6674f, 9.478f, 18.799f, 9.25f)
                curveTo(19.0f, 8.9019f, 19.0f, 8.4346f, 19.0f, 7.5f)
                close()
            }
