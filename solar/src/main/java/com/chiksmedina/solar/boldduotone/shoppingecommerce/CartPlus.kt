    ...
    get() {
        ...
        _cartPlus = Builder(name = "CartPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(13.75f, 9.0f)
                curveTo(13.75f, 8.5858f, 13.4142f, 8.25f, 13.0f, 8.25f)
                curveTo(12.5858f, 8.25f, 12.25f, 8.5858f, 12.25f, 9.0f)
                verticalLineTo(10.25f)
                horizontalLineTo(11.0f)
                curveTo(10.5858f, 10.25f, 10.25f, 10.5858f, 10.25f, 11.0f)
                curveTo(10.25f, 11.4142f, 10.5858f, 11.75f, 11.0f, 11.75f)
                horizontalLineTo(12.25f)
                verticalLineTo(13.0f)
                curveTo(12.25f, 13.4142f, 12.5858f, 13.75f, 13.0f, 13.75f)
                curveTo(13.4142f, 13.75f, 13.75f, 13.4142f, 13.75f, 13.0f)
                verticalLineTo(11.75f)
                horizontalLineTo(15.0f)
                curveTo(15.4142f, 11.75f, 15.75f, 11.4142f, 15.75f, 11.0f)
