    ...
    get() {
        ...
        _videoFrameCut = Builder(name = "VideoFrameCut", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(9.4999f, 3.0029f)
                horizontalLineTo(11.25f)
                horizontalLineTo(12.75f)
                horizontalLineTo(14.5f)
                curveTo(15.1483f, 3.0077f, 15.7286f, 3.019f, 16.25f, 3.0462f)
                verticalLineTo(20.9529f)
                curveTo(15.7286f, 20.9801f, 15.1483f, 20.9914f, 14.5f, 20.9962f)
                horizontalLineTo(12.75f)
                horizontalLineTo(11.25f)
                horizontalLineTo(9.4999f)
                curveTo(8.8516f, 20.9914f, 8.2714f, 20.9801f, 7.75f, 20.9529f)
                verticalLineTo(3.0462f)
                curveTo(8.2714f, 3.019f, 8.8516f, 3.0077f, 9.4999f, 3.0029f)
                close()
            }
