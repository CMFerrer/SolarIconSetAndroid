    ...
    get() {
        ...
        _safe2 = Builder(
            ...
            path(
                ...
                moveTo(12.75f, 8.837f)
                verticalLineTo(9.878f)
                curveTo(13.6239f, 10.1869f, 14.25f, 11.0203f, 14.25f, 12.0f)
                curveTo(14.25f, 12.0492f, 14.2484f, 12.0979f, 14.2453f, 12.1463f)
                lineTo(15.2025f, 12.5565f)
                curveTo(15.2337f, 12.3757f, 15.25f, 12.1898f, 15.25f, 12.0f)
                curveTo(15.25f, 10.4632f, 14.1833f, 9.1756f, 12.75f, 8.837f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.75f, 12.1898f, 8.7663f, 12.3757f, 8.7975f, 12.5565f)
                lineTo(9.7547f, 12.1463f)
                curveTo(9.7516f, 12.0979f, 9.75f, 12.0492f, 9.75f, 12.0f)
                curveTo(9.75f, 11.0203f, 10.3761f, 10.1869f, 11.25f, 9.878f)
            ...
            path(
                ...
                moveTo(14.6113f, 13.9351f)
                lineTo(13.6544f, 13.525f)
                curveTo(13.2432f, 13.9708f, 12.6542f, 14.25f, 12.0f, 14.25f)
                curveTo(11.3458f, 14.25f, 10.7568f, 13.9708f, 10.3456f, 13.525f)
                lineTo(9.3886f, 13.9351f)
                curveTo(9.9809f, 14.733f, 10.9301f, 15.25f, 12.0f, 15.25f)
                curveTo(13.0699f, 15.25f, 14.0191f, 14.733f, 14.6113f, 13.9351f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.2919f, 19.5125f, 18.0497f, 19.2536f, 18.6516f, 18.6517f)
                ...
                curveTo(19.5125f, 6.7081f, 19.2536f, 5.9503f, 18.6516f, 5.3484f)
