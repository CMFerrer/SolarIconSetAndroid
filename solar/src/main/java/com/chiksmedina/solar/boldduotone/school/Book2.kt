    ...
    get() {
        ...
        _book2 = Builder(name = "Book2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(19.4705f, 21.254f, 19.6249f, 21.0517f, 19.7385f, 20.75f)
                horizontalLineTo(8.0f)
                curveTo(7.5858f, 20.75f, 7.25f, 20.4142f, 7.25f, 20.0f)
                curveTo(7.25f, 19.5858f, 7.5858f, 19.25f, 8.0f, 19.25f)
                horizontalLineTo(19.9754f)
                curveTo(19.9926f, 18.8868f, 19.9982f, 18.4741f, 20.0f, 18.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
