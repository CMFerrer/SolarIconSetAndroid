    ...
    get() {
        ...
        _chatRoundVideo = Builder(name = "ChatRoundVideo", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.2196f, 9.4469f)
                curveTo(15.0732f, 10.586f, 16.0f, 11.1555f, 16.0f, 12.0f)
                curveTo(16.0f, 12.8445f, 15.0732f, 13.414f, 13.2196f, 14.5531f)
                curveTo(11.3406f, 15.7077f, 10.4011f, 16.285f, 9.7006f, 15.8611f)
                curveTo(9.0f, 15.4372f, 9.0f, 14.2915f, 9.0f, 12.0f)
                curveTo(9.0f, 9.7085f, 9.0f, 8.5628f, 9.7006f, 8.1389f)
                curveTo(10.4011f, 7.715f, 11.3406f, 8.2923f, 13.2196f, 9.4469f)
                close()
            }
        }
        .build()
