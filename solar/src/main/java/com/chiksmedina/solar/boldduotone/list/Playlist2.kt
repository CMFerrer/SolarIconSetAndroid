    ...
    get() {
        ...
        _playlist2 = Builder(
            ...
            path(
                ...
                curveTo(19.6232f, 5.8903f, 19.9559f, 5.8022f, 20.3149f, 5.8679f)
                curveTo(20.7572f, 5.9488f, 21.1513f, 6.1968f, 21.4156f, 6.5605f)
                curveTo(21.6302f, 6.8558f, 21.6948f, 7.1937f, 21.7228f, 7.4893f)
                curveTo(21.75f, 7.7771f, 21.75f, 8.1358f, 21.75f, 8.5447f)
                lineTo(21.75f, 8.579f)
                lineTo(21.7501f, 8.6546f)
                curveTo(21.7509f, 8.9547f, 21.7518f, 9.2752f, 21.644f, 9.5705f)
                curveTo(21.559f, 9.8036f, 21.4254f, 10.016f, 21.252f, 10.1935f)
                curveTo(21.0324f, 10.4184f, 20.7431f, 10.5563f, 20.4722f, 10.6855f)
                lineTo(20.404f, 10.7181f)
                lineTo(18.6185f, 11.5751f)
                curveTo(18.25f, 11.752f, 17.9266f, 11.9073f, 17.6554f, 12.0072f)
                curveTo(17.3936f, 12.1036f, 17.0842f, 12.1872f, 16.75f, 12.1425f)
                verticalLineTo(16.4286f)
                curveTo(16.75f, 18.2429f, 15.3147f, 19.7501f, 13.5f, 19.7501f)
                curveTo(11.6853f, 19.7501f, 10.25f, 18.2429f, 10.25f, 16.4286f)
                curveTo(10.25f, 14.6143f, 11.6853f, 13.1072f, 13.5f, 13.1072f)
                curveTo(14.1477f, 13.1072f, 14.747f, 13.2992f, 15.25f, 13.6286f)
                verticalLineTo(10.0001f)
                horizontalLineTo(15.2529f)
                curveTo(15.25f, 9.8312f, 15.25f, 9.6489f, 15.25f, 9.4555f)
                lineTo(15.25f, 9.4211f)
                lineTo(15.2499f, 9.3455f)
                curveTo(15.2491f, 9.0454f, 15.2482f, 8.7249f, 15.356f, 8.4296f)
                curveTo(15.441f, 8.1965f, 15.5746f, 7.9842f, 15.748f, 7.8066f)
                curveTo(15.9676f, 7.5818f, 16.2569f, 7.4438f, 16.5278f, 7.3147f)
                lineTo(16.596f, 7.2821f)
