...
public val WeatherGroup.CloudDownload: ImageVector
    get() {
        ...
        _cloudDownload = Builder(name = "CloudDownload", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.8047f, 18.9158f)
                lineTo(12.4714f, 20.2492f)
                curveTo(12.2111f, 20.5095f, 11.7889f, 20.5095f, 11.5286f, 20.2492f)
                lineTo(10.1953f, 18.9158f)
                curveTo(9.9349f, 18.6555f, 9.9349f, 18.2334f, 10.1953f, 17.973f)
                curveTo(10.4556f, 17.7127f, 10.8777f, 17.7127f, 11.1381f, 17.973f)
                lineTo(11.3333f, 18.1683f)
                verticalLineTo(16.2222f)
                curveTo(11.3333f, 15.854f, 11.6318f, 15.5556f, 12.0f, 15.5556f)
                curveTo(12.3682f, 15.5556f, 12.6667f, 15.854f, 12.6667f, 16.2222f)
                verticalLineTo(18.1683f)
                lineTo(12.8619f, 17.973f)
                curveTo(13.1223f, 17.7127f, 13.5444f, 17.7127f, 13.8047f, 17.973f)
                curveTo(14.0651f, 18.2334f, 14.0651f, 18.6555f, 13.8047f, 18.9158f)
                close()
            }
        }
        .build()
