    ...
    get() {
        ...
        `_fileSmile)` = Builder(name = "FileSmile)", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.0f, 14.5f)
                curveTo(8.0f, 15.3284f, 7.5523f, 16.0f, 7.0f, 16.0f)
                curveTo(6.4477f, 16.0f, 6.0f, 15.3284f, 6.0f, 14.5f)
                curveTo(6.0f, 13.6716f, 6.4477f, 13.0f, 7.0f, 13.0f)
                curveTo(7.5523f, 13.0f, 8.0f, 13.6716f, 8.0f, 14.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(9.0715f, 16.6463f, 8.6058f, 16.7394f, 8.376f, 17.0841f)
                curveTo(8.1463f, 17.4287f, 8.2394f, 17.8944f, 8.5841f, 18.1241f)
                curveTo(10.6526f, 19.5032f, 13.3475f, 19.5032f, 15.4161f, 18.1241f)
                curveTo(15.7608f, 17.8944f, 15.8539f, 17.4287f, 15.6241f, 17.0841f)
                curveTo(15.3944f, 16.7394f, 14.9287f, 16.6463f, 14.5841f, 16.876f)
                curveTo(13.0193f, 17.9192f, 10.9808f, 17.9192f, 9.4161f, 16.876f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.0f, 14.5f)
                curveTo(18.0f, 15.3284f, 17.5523f, 16.0f, 17.0f, 16.0f)
                curveTo(16.4477f, 16.0f, 16.0f, 15.3284f, 16.0f, 14.5f)
                curveTo(16.0f, 13.6716f, 16.4477f, 13.0f, 17.0f, 13.0f)
                curveTo(17.5523f, 13.0f, 18.0f, 13.6716f, 18.0f, 14.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
