...
public val EssentionalUiGroup.Power: ImageVector
    get() {
        if (_power != null) {
            return _power!!
        }
        _power = Builder(name = "Power", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(4.7083f, 5.2439f, 2.25f, 8.7091f, 2.25f, 12.7502f)
                curveTo(2.25f, 18.1349f, 6.6152f, 22.5002f, 12.0f, 22.5002f)
                curveTo(17.3848f, 22.5002f, 21.75f, 18.1349f, 21.75f, 12.7502f)
                ...
                curveTo(18.1722f, 6.3993f, 20.25f, 9.3329f, 20.25f, 12.7502f)
                curveTo(20.25f, 17.3065f, 16.5563f, 21.0002f, 12.0f, 21.0002f)
                curveTo(7.4436f, 21.0002f, 3.75f, 17.3065f, 3.75f, 12.7502f)
