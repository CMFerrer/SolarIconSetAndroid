    ...
    get() {
        ...
        _pipette = Builder(
            ...
            path(
                ...
                lineTo(11.3329f, 6.8448f)
                lineTo(17.1552f, 12.667f)
            ...
            path(
                ...
                curveTo(3.7836f, 14.608f, 3.715f, 14.8037f, 3.6766f, 15.0062f)
                curveTo(3.619f, 15.3099f, 3.6546f, 15.6304f, 3.7258f, 16.2713f)
                lineTo(3.7786f, 16.7466f)
                curveTo(3.7981f, 16.9215f, 3.8078f, 17.0089f, 3.8102f, 17.0928f)
                curveTo(3.825f, 17.6013f, 3.6511f, 18.0973f, 3.3219f, 18.4851f)
                curveTo(3.2675f, 18.549f, 3.2053f, 18.6113f, 3.0809f, 18.7357f)
                lineTo(2.4522f, 19.3644f)
                curveTo(1.8493f, 19.9673f, 1.8493f, 20.9448f, 2.4522f, 21.5477f)
                curveTo(3.0551f, 22.1507f, 4.0326f, 22.1507f, 4.6355f, 21.5477f)
                ...
                lineTo(7.7286f, 20.2741f)
                curveTo(8.3696f, 20.3453f, 8.69f, 20.3809f, 8.9937f, 20.3234f)
                curveTo(9.1963f, 20.2849f, 9.3919f, 20.2163f, 9.5741f, 20.1198f)
                curveTo(9.8472f, 19.975f, 10.0752f, 19.747f, 10.5312f, 19.291f)
                lineTo(11.9696f, 17.8525f)
                lineTo(13.0303f, 16.7919f)
                lineTo(13.9696f, 15.8525f)
                lineTo(15.0303f, 14.7919f)
                lineTo(17.1552f, 12.667f)
                lineTo(11.3329f, 6.8447f)
            ...
            path(
                ...
                moveTo(12.1162f, 13.9991f)
                lineTo(13.9696f, 15.8525f)
                lineTo(15.0303f, 14.7919f)
                lineTo(13.1768f, 12.9384f)
                curveTo(12.8839f, 12.6455f, 12.409f, 12.6455f, 12.1162f, 12.9384f)
                curveTo(11.8233f, 13.2313f, 11.8233f, 13.7062f, 12.1162f, 13.9991f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(10.1162f, 15.9991f)
                lineTo(11.9696f, 17.8525f)
                lineTo(13.0303f, 16.7919f)
                lineTo(11.1768f, 14.9384f)
                curveTo(10.8839f, 14.6455f, 10.409f, 14.6455f, 10.1162f, 14.9384f)
                curveTo(9.8233f, 15.2313f, 9.8233f, 15.7062f, 10.1162f, 15.9991f)
                close()
            }
        }
            .build()
