    ...
    get() {
        ...
        _laptop3 = Builder(name = "Laptop3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(3.5f, 13.3856f, 3.5f, 14.3284f, 4.0858f, 14.9142f)
                curveTo(4.6716f, 15.5f, 5.6144f, 15.5f, 7.5f, 15.5f)
                horizontalLineTo(16.5f)
                curveTo(18.3856f, 15.5f, 19.3284f, 15.5f, 19.9142f, 14.9142f)
                curveTo(20.5f, 14.3284f, 20.5f, 13.3856f, 20.5f, 11.5f)
                verticalLineTo(8.0f)
