    ...
    get() {
        ...
        _maximizeSquare2 = Builder(name = "MaximizeSquare2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(8.8107f)
                lineTo(11.0303f, 9.9697f)
                curveTo(11.3232f, 10.2626f, 11.3232f, 10.7374f, 11.0303f, 11.0303f)
                curveTo(10.7374f, 11.3232f, 10.2626f, 11.3232f, 9.9697f, 11.0303f)
                lineTo(7.75f, 8.8107f)
                verticalLineTo(10.0f)
                curveTo(7.75f, 10.4142f, 7.4142f, 10.75f, 7.0f, 10.75f)
                curveTo(6.5858f, 10.75f, 6.25f, 10.4142f, 6.25f, 10.0f)
                verticalLineTo(7.0f)
                curveTo(6.25f, 6.5858f, 6.5858f, 6.25f, 7.0f, 6.25f)
                horizontalLineTo(10.0f)
