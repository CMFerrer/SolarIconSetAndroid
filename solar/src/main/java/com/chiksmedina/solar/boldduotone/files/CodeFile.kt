...
public val FilesGroup.CodeFile: ImageVector
    get() {
        if (_codeFile != null) {
            return _codeFile!!
        }
        _codeFile = Builder(name = "CodeFile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(10.7022f, 14.2635f)
                curveTo(10.8477f, 13.8757f, 10.6512f, 13.4434f, 10.2633f, 13.298f)
                curveTo(9.8755f, 13.1525f, 9.4432f, 13.349f, 9.2978f, 13.7369f)
                lineTo(7.7977f, 17.7369f)
                curveTo(7.6523f, 18.1247f, 7.8488f, 18.557f, 8.2367f, 18.7024f)
                curveTo(8.6245f, 18.8479f, 9.0568f, 18.6514f, 9.2022f, 18.2635f)
                lineTo(10.7022f, 14.2635f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.5303f, 14.5305f)
                curveTo(7.8232f, 14.2376f, 7.8232f, 13.7628f, 7.5303f, 13.4699f)
                curveTo(7.2374f, 13.177f, 6.7626f, 13.177f, 6.4697f, 13.4699f)
                lineTo(5.4697f, 14.4699f)
                curveTo(5.1768f, 14.7628f, 5.1768f, 15.2376f, 5.4697f, 15.5305f)
                lineTo(6.4697f, 16.5305f)
                curveTo(6.7626f, 16.8234f, 7.2374f, 16.8234f, 7.5303f, 16.5305f)
                curveTo(7.8232f, 16.2376f, 7.8232f, 15.7628f, 7.5303f, 15.4699f)
                lineTo(7.0607f, 15.0002f)
                lineTo(7.5303f, 14.5305f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0303f, 15.4699f)
                curveTo(11.7374f, 15.177f, 11.2626f, 15.177f, 10.9697f, 15.4699f)
                curveTo(10.6768f, 15.7628f, 10.6768f, 16.2376f, 10.9697f, 16.5305f)
                lineTo(11.4393f, 17.0002f)
                lineTo(10.9697f, 17.4699f)
                curveTo(10.6768f, 17.7628f, 10.6768f, 18.2376f, 10.9697f, 18.5305f)
                curveTo(11.2626f, 18.8234f, 11.7374f, 18.8234f, 12.0303f, 18.5305f)
                lineTo(13.0303f, 17.5305f)
                curveTo(13.3232f, 17.2376f, 13.3232f, 16.7628f, 13.0303f, 16.4699f)
                lineTo(12.0303f, 15.4699f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
