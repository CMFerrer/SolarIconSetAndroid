...
public val ArrowsActionGroup.ReciveTwiceSquare: ImageVector
    get() {
        if (_reciveTwiceSquare != null) {
            return _reciveTwiceSquare!!
        }
        _reciveTwiceSquare = Builder(name = "ReciveTwiceSquare", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(11.9285f, 7.75f)
                lineTo(10.5199f, 6.5762f)
                curveTo(10.2017f, 6.311f, 10.1587f, 5.8381f, 10.4238f, 5.5199f)
                curveTo(10.689f, 5.2017f, 11.1619f, 5.1587f, 11.4801f, 5.4239f)
                lineTo(14.4801f, 7.9239f)
                ...
                curveTo(11.1619f, 11.8414f, 10.689f, 11.7984f, 10.4238f, 11.4802f)
                curveTo(10.1587f, 11.1619f, 10.2017f, 10.689f, 10.5199f, 10.4239f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.689f, 12.2017f, 11.1619f, 12.1587f, 11.4801f, 12.4239f)
                lineTo(14.4801f, 14.9239f)
                ...
                curveTo(11.1619f, 18.8414f, 10.689f, 18.7984f, 10.4238f, 18.4802f)
                curveTo(10.1587f, 18.162f, 10.2017f, 17.689f, 10.5199f, 17.4239f)
