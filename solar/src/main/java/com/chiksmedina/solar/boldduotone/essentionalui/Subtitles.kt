    ...
    get() {
        ...
        _subtitles = Builder(name = "Subtitles", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(12.25f, 13.0f)
                curveTo(12.25f, 12.5858f, 11.9142f, 12.25f, 11.5f, 12.25f)
                horizontalLineTo(9.5f)
                curveTo(9.0858f, 12.25f, 8.75f, 12.5858f, 8.75f, 13.0f)
                curveTo(8.75f, 13.4142f, 9.0858f, 13.75f, 9.5f, 13.75f)
                horizontalLineTo(11.5f)
                curveTo(11.9142f, 13.75f, 12.25f, 13.4142f, 12.25f, 13.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
