    ...
    get() {
        ...
        _downloadMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(16.833f, 11.8254f, 16.8118f, 11.351f, 16.5061f, 11.0715f)
                curveTo(16.2004f, 10.792f, 15.726f, 10.8132f, 15.4465f, 11.1189f)
                lineTo(12.75f, 14.0682f)
                verticalLineTo(3.0f)
                ...
                lineTo(8.5535f, 11.1189f)
                curveTo(8.274f, 10.8132f, 7.7996f, 10.792f, 7.4939f, 11.0715f)
                curveTo(7.1882f, 11.351f, 7.167f, 11.8254f, 7.4465f, 12.1311f)
                lineTo(11.4465f, 16.5061f)
                curveTo(11.5886f, 16.6615f, 11.7894f, 16.75f, 12.0f, 16.75f)
                close()
            }
        }
            .build()
