    ...
    get() {
        ...
        _crownMinimalistic = Builder(name = "CrownMinimalistic", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(11.3898f, 2.0f, 10.9888f, 2.8216f, 10.1869f, 4.4648f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(2.6328f)
                curveTo(2.9055f, 18.4447f, 3.2259f, 19.8553f, 4.1399f, 20.7902f)
                curveTo(5.3225f, 22.0f, 7.095f, 22.0f, 10.6399f, 22.0f)
                horizontalLineTo(13.3597f)
                close()
            }
        }
        .build()
