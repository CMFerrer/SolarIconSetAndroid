    ...
    get() {
        ...
        _specialEffects = Builder(name = "SpecialEffects", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.75f, 8.4143f, 10.4142f, 8.75f, 10.0f, 8.75f)
                horizontalLineTo(6.75f)
                verticalLineTo(11.25f)
                horizontalLineTo(10.0f)
                curveTo(10.4142f, 11.25f, 10.75f, 11.5858f, 10.75f, 12.0f)
                curveTo(10.75f, 12.4143f, 10.4142f, 12.75f, 10.0f, 12.75f)
                horizontalLineTo(6.75f)
                verticalLineTo(16.0f)
                curveTo(6.75f, 16.4143f, 6.4142f, 16.75f, 6.0f, 16.75f)
                curveTo(5.5858f, 16.75f, 5.25f, 16.4143f, 5.25f, 16.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(11.55f, 7.4f)
                curveTo(11.8814f, 7.1515f, 12.3515f, 7.2187f, 12.6f, 7.55f)
                lineTo(15.0f, 10.75f)
                lineTo(17.4f, 7.55f)
                curveTo(17.6485f, 7.2187f, 18.1186f, 7.1515f, 18.45f, 7.4f)
                curveTo(18.7814f, 7.6486f, 18.8485f, 8.1187f, 18.6f, 8.45f)
                lineTo(15.9375f, 12.0f)
                lineTo(18.6f, 15.55f)
                curveTo(18.8485f, 15.8814f, 18.7814f, 16.3515f, 18.45f, 16.6f)
                curveTo(18.1186f, 16.8486f, 17.6485f, 16.7814f, 17.4f, 16.45f)
                lineTo(15.0f, 13.25f)
                lineTo(12.6f, 16.45f)
                curveTo(12.3515f, 16.7814f, 11.8814f, 16.8486f, 11.55f, 16.6f)
                curveTo(11.2186f, 16.3515f, 11.1515f, 15.8814f, 11.4f, 15.55f)
                lineTo(14.0625f, 12.0f)
                lineTo(11.4f, 8.45f)
                curveTo(11.1515f, 8.1187f, 11.2186f, 7.6486f, 11.55f, 7.4f)
                close()
            }
        }
        .build()
