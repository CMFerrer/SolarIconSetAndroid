    ...
    get() {
        ...
        _sun = Builder(name = "Sun", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(19.8938f, 18.8331f, 19.8938f, 19.308f, 19.6009f, 19.6009f)
                curveTo(19.308f, 19.8938f, 18.8331f, 19.8938f, 18.5402f, 19.6009f)
                lineTo(18.1474f, 19.2081f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(5.1662f, 19.8941f, 4.6913f, 19.8941f, 4.3984f, 19.6012f)
                curveTo(4.1055f, 19.3083f, 4.1055f, 18.8334f, 4.3984f, 18.5405f)
                lineTo(4.7912f, 18.1477f)
                curveTo(5.0841f, 17.8548f, 5.559f, 17.8548f, 5.8519f, 18.1477f)
                close()
            }
        }
        .build()
