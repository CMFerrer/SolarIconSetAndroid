    ...
    get() {
        ...
        _chart2 = Builder(name = "Chart2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(3.0f, 17.9428f, 3.0f, 18.4142f, 3.2929f, 18.7071f)
                curveTo(3.5858f, 19.0f, 4.0572f, 19.0f, 5.0f, 19.0f)
                curveTo(5.9428f, 19.0f, 6.4142f, 19.0f, 6.7071f, 18.7071f)
                curveTo(7.0f, 18.4142f, 7.0f, 17.9428f, 7.0f, 17.0f)
                verticalLineTo(11.0f)
                curveTo(7.0f, 10.0572f, 7.0f, 9.5858f, 6.7071f, 9.2929f)
                curveTo(6.4142f, 9.0f, 5.9428f, 9.0f, 5.0f, 9.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.4f, strokeAlpha
                ...
                verticalLineTo(17.0f)
                curveTo(17.0f, 17.9428f, 17.0f, 18.4142f, 17.2929f, 18.7071f)
                curveTo(17.5858f, 19.0f, 18.0572f, 19.0f, 19.0f, 19.0f)
                curveTo(19.9428f, 19.0f, 20.4142f, 19.0f, 20.7071f, 18.7071f)
                curveTo(21.0f, 18.4142f, 21.0f, 17.9428f, 21.0f, 17.0f)
                verticalLineTo(4.0f)
                curveTo(21.0f, 3.0572f, 21.0f, 2.5858f, 20.7071f, 2.2929f)
                curveTo(20.4142f, 2.0f, 19.9428f, 2.0f, 19.0f, 2.0f)
