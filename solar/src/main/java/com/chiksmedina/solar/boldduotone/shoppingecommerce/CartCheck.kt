    ...
    get() {
        ...
        _cartCheck = Builder(name = "CartCheck", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.5421f, 9.5172f)
                curveTo(15.8278f, 9.2173f, 15.8162f, 8.7426f, 15.5163f, 8.4569f)
                curveTo(15.2163f, 8.1712f, 14.7416f, 8.1828f, 14.4559f, 8.4828f)
                lineTo(12.1419f, 10.9125f)
                lineTo(11.5421f, 10.2828f)
                curveTo(11.2565f, 9.9828f, 10.7817f, 9.9712f, 10.4818f, 10.2569f)
                curveTo(10.1818f, 10.5426f, 10.1703f, 11.0173f, 10.4559f, 11.3172f)
                lineTo(11.5988f, 12.5172f)
                curveTo(11.7403f, 12.6659f, 11.9366f, 12.75f, 12.1419f, 12.75f)
                curveTo(12.3471f, 12.75f, 12.5434f, 12.6659f, 12.685f, 12.5172f)
                lineTo(15.5421f, 9.5172f)
                close()
            }
        }
        .build()
