    ...
    get() {
        ...
        _undoRightRound = Builder(name = "UndoRightRound", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(18.1893f, 6.25f)
                horizontalLineTo(9.0f)
                curveTo(5.8244f, 6.25f, 3.25f, 8.8244f, 3.25f, 12.0f)
                curveTo(3.25f, 15.1756f, 5.8244f, 17.75f, 9.0f, 17.75f)
                horizontalLineTo(16.0f)
                curveTo(16.4142f, 17.75f, 16.75f, 17.4142f, 16.75f, 17.0f)
                curveTo(16.75f, 16.5858f, 16.4142f, 16.25f, 16.0f, 16.25f)
                horizontalLineTo(9.0f)
                curveTo(6.6528f, 16.25f, 4.75f, 14.3472f, 4.75f, 12.0f)
                curveTo(4.75f, 9.6528f, 6.6528f, 7.75f, 9.0f, 7.75f)
