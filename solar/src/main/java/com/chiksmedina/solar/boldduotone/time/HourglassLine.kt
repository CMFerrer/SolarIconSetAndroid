    ...
    get() {
        ...
        _hourglassLine = Builder(name = "HourglassLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.6586f, 5.0333f, 6.1198f, 6.6411f, 9.0423f, 9.8567f)
                lineTo(11.0f, 12.0f)
                horizontalLineTo(13.0f)
                lineTo(14.9577f, 9.8567f)
                curveTo(17.8802f, 6.6411f, 19.3414f, 5.0333f, 18.9323f, 3.6461f)
                curveTo(18.8972f, 3.5269f, 18.8535f, 3.4109f, 18.8017f, 3.2992f)
                curveTo(18.1995f, 2.0f, 16.133f, 2.0f, 12.0f, 2.0f)
                close()
                moveTo(10.0f, 4.75f)
                curveTo(9.5858f, 4.75f, 9.25f, 5.0858f, 9.25f, 5.5f)
                curveTo(9.25f, 5.9142f, 9.5858f, 6.25f, 10.0f, 6.25f)
                horizontalLineTo(14.0f)
                curveTo(14.4142f, 6.25f, 14.75f, 5.9142f, 14.75f, 5.5f)
                curveTo(14.75f, 5.0858f, 14.4142f, 4.75f, 14.0f, 4.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(18.8535f, 20.5891f, 18.8972f, 20.4731f, 18.9323f, 20.3539f)
                curveTo(19.3414f, 18.9667f, 17.8802f, 17.3589f, 14.9577f, 14.1433f)
                lineTo(13.0f, 12.0f)
                horizontalLineTo(11.0f)
                lineTo(9.0423f, 14.1433f)
                curveTo(6.1198f, 17.3589f, 4.6586f, 18.9667f, 5.0676f, 20.3539f)
