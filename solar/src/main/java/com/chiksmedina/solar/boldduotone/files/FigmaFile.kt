    ...
    get() {
        ...
        _figmaFile = Builder(name = "FigmaFile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(6.3764f, 11.5f)
                curveTo(5.6162f, 11.5f, 5.0f, 12.1377f, 5.0f, 12.9244f)
                curveTo(5.0f, 13.4045f, 5.2295f, 13.8292f, 5.5812f, 14.0872f)
                curveTo(5.2295f, 14.3453f, 5.0f, 14.7699f, 5.0f, 15.25f)
                curveTo(5.0f, 15.7301f, 5.2295f, 16.1547f, 5.5812f, 16.4128f)
                curveTo(5.2295f, 16.6708f, 5.0f, 17.0955f, 5.0f, 17.5756f)
                curveTo(5.0f, 18.3623f, 5.6162f, 19.0f, 6.3764f, 19.0f)
                curveTo(7.1366f, 19.0f, 7.7528f, 18.3623f, 7.7528f, 17.5756f)
                verticalLineTo(16.3532f)
                curveTo(7.99f, 16.554f, 8.2932f, 16.6744f, 8.6236f, 16.6744f)
                curveTo(9.3838f, 16.6744f, 10.0f, 16.0367f, 10.0f, 15.25f)
                curveTo(10.0f, 14.7699f, 9.7705f, 14.3453f, 9.4188f, 14.0872f)
                curveTo(9.7705f, 13.8292f, 10.0f, 13.4045f, 10.0f, 12.9244f)
                curveTo(10.0f, 12.1377f, 9.3838f, 11.5f, 8.6236f, 11.5f)
