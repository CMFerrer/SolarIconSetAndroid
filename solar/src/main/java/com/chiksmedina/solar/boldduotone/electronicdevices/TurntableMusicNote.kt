...
public val ElectronicDevicesGroup.TurntableMusicNote: ImageVector
    get() {
        if (_turntableMusicNote != null) {
            return _turntableMusicNote!!
        }
        _turntableMusicNote = Builder(name = "TurntableMusicNote", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                horizontalLineTo(13.3759f)
                curveTo(13.1344f, 21.4663f, 13.0f, 20.8739f, 13.0f, 20.25f)
                curveTo(13.0f, 17.9867f, 14.7692f, 16.1366f, 17.0f, 16.0072f)
                verticalLineTo(12.25f)
                curveTo(17.0f, 11.0074f, 18.0074f, 10.0f, 19.25f, 10.0f)
                curveTo(20.4926f, 10.0f, 21.5f, 11.0074f, 21.5f, 12.25f)
                curveTo(21.5f, 12.5764f, 21.7085f, 12.8541f, 21.9996f, 12.9572f)
                curveTo(22.0f, 12.6494f, 22.0f, 12.3305f, 22.0f, 12.0f)
