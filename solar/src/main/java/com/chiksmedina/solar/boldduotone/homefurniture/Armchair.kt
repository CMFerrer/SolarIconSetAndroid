    ...
    get() {
        ...
        _armchair = Builder(name = "Armchair", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(18.0f, 5.8533f, 18.0f, 4.703f, 17.5177f, 3.8461f)
                curveTo(17.2017f, 3.2848f, 16.7473f, 2.8187f, 16.2f, 2.4947f)
                curveTo(15.3646f, 2.0f, 14.2431f, 2.0f, 12.0f, 2.0f)
                curveTo(9.7569f, 2.0f, 8.6354f, 2.0f, 7.8f, 2.4947f)
                curveTo(7.2527f, 2.8187f, 6.7983f, 3.2848f, 6.4823f, 3.8461f)
                curveTo(6.0f, 4.703f, 6.0f, 5.8533f, 6.0f, 8.1538f)
                close()
            }
        }
        .build()
