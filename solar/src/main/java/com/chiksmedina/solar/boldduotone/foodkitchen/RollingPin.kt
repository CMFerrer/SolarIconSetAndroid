    ...
    get() {
        ...
        _rollingPin = Builder(name = "RollingPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                curveTo(16.1319f, 6.1069f, 16.5327f, 6.5076f, 17.0125f, 6.9875f)
                curveTo(17.4924f, 7.4674f, 17.8931f, 7.8681f, 18.2146f, 8.222f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                    = 0.5f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(2.5621f, 21.0658f)
                curveTo(2.5995f, 21.1072f, 2.6484f, 21.1561f, 2.7462f, 21.2539f)
                curveTo(2.8438f, 21.3516f, 2.8929f, 21.4006f, 2.9342f, 21.4379f)
                curveTo(3.8685f, 22.2812f, 5.3206f, 22.161f, 6.1035f, 21.1756f)
                curveTo(6.1382f, 21.132f, 6.1784f, 21.0757f, 6.2587f, 20.9631f)
                lineTo(8.222f, 18.2146f)
                curveTo(7.8681f, 17.8931f, 7.4674f, 17.4924f, 6.9875f, 17.0125f)
                curveTo(6.5076f, 16.5327f, 6.1069f, 16.1319f, 5.7854f, 15.778f)
                lineTo(3.0369f, 17.7413f)
                curveTo(2.9244f, 17.8215f, 2.868f, 17.8619f, 2.8244f, 17.8965f)
                curveTo(1.839f, 18.6794f, 1.7188f, 20.1315f, 2.5621f, 21.0658f)
                close()
            }
        }
        .build()
