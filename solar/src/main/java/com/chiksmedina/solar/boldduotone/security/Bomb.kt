    ...
    get() {
        ...
        _bomb = Builder(name = "Bomb", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.7f, strokeAlpha
                ...
                lineTo(14.2466f, 8.6928f)
                curveTo(14.6344f, 9.0102f, 14.9899f, 9.3657f, 15.3072f, 9.7535f)
                lineTo(17.5378f, 7.5228f)
                lineTo(17.3267f, 6.9875f)
                curveTo(17.27f, 6.8438f, 17.1562f, 6.7299f, 17.0124f, 6.6733f)
