package com.chiksmedina.solar.lineduotone.users
...
import com.chiksmedina.solar.lineduotone.UsersGroup

public val UsersGroup.UserId: ImageVector
    get() {
        if (_userId != null) {
            return _userId!!
        }
        _userId = Builder(name = "UserId", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(13.0f, 15.0f)
                curveTo(13.0f, 16.1046f, 13.0f, 17.0f, 9.0f, 17.0f)
                curveTo(5.0f, 17.0f, 5.0f, 16.1046f, 5.0f, 15.0f)
                curveTo(5.0f, 13.8954f, 6.7909f, 13.0f, 9.0f, 13.0f)
                curveTo(11.2091f, 13.0f, 13.0f, 13.8954f, 13.0f, 15.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
