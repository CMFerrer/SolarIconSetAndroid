...
public val EssentionalUiGroup.ShareCircle: ImageVector
    get() {
        ...
        _shareCircle = Builder(name = "ShareCircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(5.5f, 21.0f)
                curveTo(3.8431f, 21.0f, 2.5f, 19.6569f, 2.5f, 18.0f)
                curveTo(2.5f, 16.3431f, 3.8431f, 15.0f, 5.5f, 15.0f)
                curveTo(7.1568f, 15.0f, 8.5f, 16.3431f, 8.5f, 18.0f)
                curveTo(8.5f, 19.6569f, 7.1568f, 21.0f, 5.5f, 21.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(21.5f, 19.6569f, 20.1569f, 21.0f, 18.5f, 21.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
