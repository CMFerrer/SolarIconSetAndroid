    ...
    get() {
        ...
        _figma = Builder(
            ...
            path(
                ...
                curveTo(6.8258f, 2.0f, 5.3334f, 3.4924f, 5.3334f, 5.3333f)
                curveTo(5.3334f, 7.1743f, 6.8258f, 8.6667f, 8.6667f, 8.6667f)
            ...
            path(
                ...
                horizontalLineTo(8.6667f)
                curveTo(6.8258f, 8.6667f, 5.3334f, 10.1591f, 5.3334f, 12.0f)
                curveTo(5.3334f, 13.841f, 6.8258f, 15.3334f, 8.6667f, 15.3334f)
                horizontalLineTo(12.0f)
            ...
            path(
                ...
                moveTo(8.6667f, 15.3333f)
                horizontalLineTo(12.0f)
                verticalLineTo(18.6666f)
                curveTo(12.0f, 20.5076f, 10.5077f, 22.0f, 8.6667f, 22.0f)
                curveTo(6.8258f, 22.0f, 5.3334f, 20.5076f, 5.3334f, 18.6666f)
                curveTo(5.3334f, 16.8257f, 6.8258f, 15.3333f, 8.6667f, 15.3333f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
