    ...
    get() {
        ...
        _usersGroupRounded = Builder(name = "UsersGroupRounded", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(12.5f, 4.3411f)
                curveTo(13.0375f, 3.5327f, 13.9565f, 3.0f, 15.0f, 3.0f)
                curveTo(16.6569f, 3.0f, 18.0f, 4.3432f, 18.0f, 6.0f)
                curveTo(18.0f, 7.6568f, 16.6569f, 9.0f, 15.0f, 9.0f)
                curveTo(13.9565f, 9.0f, 13.0375f, 8.4672f, 12.5f, 7.6589f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
