    ...
    get() {
        ...
        _serverPath = Builder(
            ...
            path(
                ...
                moveTo(2.0f, 11.0f)
                curveTo(2.0f, 9.3432f, 3.3431f, 8.0f, 5.0f, 8.0f)
                horizontalLineTo(19.0f)
                curveTo(20.6569f, 8.0f, 22.0f, 9.3432f, 22.0f, 11.0f)
                curveTo(22.0f, 12.6569f, 20.6569f, 14.0f, 19.0f, 14.0f)
                horizontalLineTo(5.0f)
                curveTo(3.3431f, 14.0f, 2.0f, 12.6569f, 2.0f, 11.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
