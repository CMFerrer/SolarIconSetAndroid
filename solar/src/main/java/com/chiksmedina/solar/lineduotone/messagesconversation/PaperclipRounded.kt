    ...
    get() {
        ...
        _paperclipRounded = Builder(
            ...
            path(
                ...
                moveTo(12.6885f, 11.3952f)
                lineTo(9.8579f, 14.2513f)
                curveTo(9.5026f, 14.6098f, 9.3249f, 14.7891f, 9.1954f, 14.9594f)
                curveTo(8.3011f, 16.1353f, 8.3011f, 17.7708f, 9.1954f, 18.9468f)
                curveTo(9.3249f, 19.1171f, 9.5026f, 19.2963f, 9.8579f, 19.6548f)
                curveTo(10.2132f, 20.0133f, 10.3908f, 20.1926f, 10.5596f, 20.3232f)
                curveTo(11.7251f, 21.2256f, 13.346f, 21.2256f, 14.5115f, 20.3232f)
                curveTo(14.6802f, 20.1926f, 14.8579f, 20.0133f, 15.2132f, 19.6548f)
                lineTo(18.8854f, 15.9496f)
