...
public val ShoppingEcommerceGroup.Cart2: ImageVector
    get() {
        if (_cart2 != null) {
            return _cart2!!
        }
        _cart2 = Builder(name = "Cart2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(3.8638f, 16.4552f)
                curveTo(3.0058f, 13.0234f, 2.5768f, 11.3075f, 3.4777f, 10.1538f)
                curveTo(4.3785f, 9.0f, 6.1472f, 9.0f, 9.6846f, 9.0f)
                horizontalLineTo(14.3153f)
                curveTo(17.8527f, 9.0f, 19.6214f, 9.0f, 20.5222f, 10.1538f)
                curveTo(21.4231f, 11.3075f, 20.9941f, 13.0234f, 20.1362f, 16.4552f)
                curveTo(19.5905f, 18.6379f, 19.3176f, 19.7292f, 18.5039f, 20.3646f)
                curveTo(17.6901f, 21.0f, 16.5652f, 21.0f, 14.3153f, 21.0f)
                horizontalLineTo(9.6846f)
                curveTo(7.4348f, 21.0f, 6.3098f, 21.0f, 5.496f, 20.3646f)
                curveTo(4.6823f, 19.7292f, 4.4094f, 18.6379f, 3.8638f, 16.4552f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
