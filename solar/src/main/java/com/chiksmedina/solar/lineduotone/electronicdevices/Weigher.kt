    ...
    get() {
        ...
        _weigher = Builder(name = "Weigher", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.4115f, 9.9713f)
                lineTo(17.0771f, 8.3072f)
                curveTo(17.5513f, 7.1217f, 16.8084f, 5.8015f, 15.549f, 5.5916f)
                lineTo(15.1235f, 5.5207f)
                curveTo(13.0554f, 5.176f, 10.9445f, 5.176f, 8.8764f, 5.5207f)
                lineTo(8.4509f, 5.5916f)
                curveTo(7.1915f, 5.8015f, 6.4486f, 7.1217f, 6.9228f, 8.3072f)
                lineTo(7.5884f, 9.9713f)
                curveTo(7.8242f, 10.5607f, 8.4591f, 10.8853f, 9.075f, 10.7314f)
                curveTo(10.9954f, 10.2513f, 13.0045f, 10.2513f, 14.9249f, 10.7314f)
                curveTo(15.5408f, 10.8853f, 16.1757f, 10.5607f, 16.4115f, 9.9713f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
