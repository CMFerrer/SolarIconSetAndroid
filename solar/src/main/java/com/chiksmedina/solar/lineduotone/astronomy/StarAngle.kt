    ...
    get() {
        ...
        _starAngle = Builder(name = "StarAngle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(18.9058f, 16.1633f, 18.8677f, 16.4104f, 18.7916f, 16.9044f)
                lineTo(18.7224f, 17.3542f)
                curveTo(18.6408f, 17.8839f, 18.5205f, 18.3555f, 18.3925f, 18.7553f)
                curveTo(18.1952f, 19.3721f, 18.0965f, 19.6806f, 17.7377f, 19.8866f)
                curveTo(17.379f, 20.0927f, 17.0321f, 19.9921f, 16.3385f, 19.7908f)
                moveTo(10.4398f, 6.7276f)
                lineTo(10.5416f, 7.1653f)
                curveTo(10.6535f, 7.646f, 10.7094f, 7.8864f, 10.8431f, 8.073f)
                curveTo(10.9769f, 8.2597f, 11.1733f, 8.3716f, 11.5662f, 8.5954f)
                lineTo(11.9238f, 8.7991f)
                ...
                curveTo(10.9281f, 13.8492f, 10.8901f, 14.0962f, 10.814f, 14.5903f)
                lineTo(10.7447f, 15.0401f)
                curveTo(10.477f, 16.7787f, 10.3431f, 17.648f, 9.7915f, 17.8917f)
                ...
                curveTo(9.8494f, 4.1901f, 10.0462f, 5.036f, 10.4398f, 6.7276f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(19.5438f, 10.9091f)
                moveTo(9.7916f, 17.8913f)
                lineTo(16.3385f, 19.7904f)
