    ...
    get() {
        ...
        _airbudsRight = Builder(name = "AirbudsRight", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(20.9999f, 7.5594f)
                curveTo(20.9841f, 4.4956f, 18.5044f, 2.0159f, 15.4406f, 2.0001f)
                lineTo(15.375f, 2.0f)
                lineTo(15.3356f, 2.0f)
                curveTo(13.4974f, 2.0095f, 12.0095f, 3.4974f, 12.0f, 5.3356f)
                lineTo(12.0f, 5.375f)
                verticalLineTo(8.0f)
                curveTo(12.0f, 9.6568f, 13.3431f, 11.0f, 15.0f, 11.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    fillAlpha = 0.5f, strokeAlpha = 0.5f, strokeLineWidth = 1.67647f, strokeLineCap
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(9.0f, 5.1001f)
                curveTo(7.0408f, 5.4978f, 5.4977f, 7.0409f, 5.1f, 9.0001f)
            }
