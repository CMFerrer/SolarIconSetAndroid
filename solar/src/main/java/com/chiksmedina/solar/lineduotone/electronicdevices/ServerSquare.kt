    ...
    get() {
        ...
        _serverSquare = Builder(name = "ServerSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                lineTo(21.3588f, 20.3588f)
                curveTo(22.1071f, 19.6104f, 22.4392f, 18.6614f, 22.5969f, 17.489f)
                curveTo(22.7516f, 16.3382f, 22.75f, 14.8644f, 22.75f, 13.0f)
                horizontalLineTo(21.25f)
                close()
                moveTo(14.0f, 21.75f)
                curveTo(15.8644f, 21.75f, 17.3382f, 21.7516f, 18.489f, 21.5969f)
                curveTo(19.6614f, 21.4392f, 20.6104f, 21.1071f, 21.3588f, 20.3588f)
                lineTo(20.2981f, 19.2981f)
