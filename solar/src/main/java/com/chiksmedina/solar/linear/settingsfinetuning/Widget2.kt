    ...
    get() {
        ...
        _widget2 = Builder(name = "Widget2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(21.5f, 6.5f)
                curveTo(21.5f, 4.6144f, 21.5f, 3.6716f, 20.9142f, 3.0858f)
                curveTo(20.3284f, 2.5f, 19.3856f, 2.5f, 17.5f, 2.5f)
                curveTo(15.6144f, 2.5f, 14.6716f, 2.5f, 14.0858f, 3.0858f)
                curveTo(13.5f, 3.6716f, 13.5f, 4.6144f, 13.5f, 6.5f)
                curveTo(13.5f, 8.3856f, 13.5f, 9.3284f, 14.0858f, 9.9142f)
                curveTo(14.6716f, 10.5f, 15.6144f, 10.5f, 17.5f, 10.5f)
                curveTo(19.3856f, 10.5f, 20.3284f, 10.5f, 20.9142f, 9.9142f)
                curveTo(21.5f, 9.3284f, 21.5f, 8.3856f, 21.5f, 6.5f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.5f, 17.5f)
                curveTo(10.5f, 15.6144f, 10.5f, 14.6716f, 9.9142f, 14.0858f)
                curveTo(9.3284f, 13.5f, 8.3856f, 13.5f, 6.5f, 13.5f)
                curveTo(4.6144f, 13.5f, 3.6716f, 13.5f, 3.0858f, 14.0858f)
                curveTo(2.5f, 14.6716f, 2.5f, 15.6144f, 2.5f, 17.5f)
