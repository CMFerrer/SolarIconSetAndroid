    ...
    get() {
        ...
        _iphone = Builder(name = "Iphone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.7482f, 2.3774f)
                lineTo(16.6641f, 2.5036f)
                curveTo(15.908f, 3.6377f, 15.53f, 4.2048f, 14.9778f, 4.5479f)
                curveTo(14.868f, 4.6161f, 14.7539f, 4.6771f, 14.6363f, 4.7307f)
                curveTo(14.0445f, 4.9998f, 13.363f, 4.9998f, 12.0f, 4.9998f)
                curveTo(10.637f, 4.9998f, 9.9555f, 4.9998f, 9.3637f, 4.7307f)
