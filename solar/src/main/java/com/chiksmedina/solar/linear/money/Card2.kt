    ...
    get() {
        ...
        _card2 = Builder(name = "Card2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(14.0f, 15.0f)
                curveTo(14.0f, 14.0572f, 14.0f, 13.5858f, 14.2929f, 13.2929f)
                curveTo(14.5858f, 13.0f, 15.0572f, 13.0f, 16.0f, 13.0f)
                curveTo(16.9428f, 13.0f, 17.4142f, 13.0f, 17.7071f, 13.2929f)
                curveTo(18.0f, 13.5858f, 18.0f, 14.0572f, 18.0f, 15.0f)
                curveTo(18.0f, 15.9428f, 18.0f, 16.4142f, 17.7071f, 16.7071f)
                curveTo(17.4142f, 17.0f, 16.9428f, 17.0f, 16.0f, 17.0f)
                curveTo(15.0572f, 17.0f, 14.5858f, 17.0f, 14.2929f, 16.7071f)
                curveTo(14.0f, 16.4142f, 14.0f, 15.9428f, 14.0f, 15.0f)
                close()
            }
        }
        .build()
