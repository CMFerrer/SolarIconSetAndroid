    ...
    get() {
        ...
        _magicStick3 = Builder(name = "MagicStick3", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(3.8445f, 7.9223f)
                curveTo(2.7185f, 6.7962f, 2.7185f, 4.9706f, 3.8445f, 3.8445f)
                curveTo(4.9706f, 2.7185f, 6.7962f, 2.7185f, 7.9223f, 3.8445f)
                lineTo(20.1555f, 16.0777f)
                curveTo(21.2815f, 17.2038f, 21.2815f, 19.0294f, 20.1555f, 20.1555f)
                curveTo(19.0294f, 21.2815f, 17.2038f, 21.2815f, 16.0777f, 20.1555f)
                lineTo(3.8445f, 7.9223f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
