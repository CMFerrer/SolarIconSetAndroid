...
public val ShoppingEcommerceGroup.BagSmile: ImageVector
    get() {
        if (_bagSmile != null) {
            return _bagSmile!!
        }
        _bagSmile = Builder(name = "BagSmile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(9.1709f, 15.0f)
                curveTo(9.5827f, 16.1652f, 10.694f, 17.0f, 12.0002f, 17.0f)
                curveTo(13.3064f, 17.0f, 14.4177f, 16.1652f, 14.8295f, 15.0f)
            }
        }
        .build()
        return _bagSmile!!
