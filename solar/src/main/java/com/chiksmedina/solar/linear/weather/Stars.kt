    ...
    get() {
        ...
        _stars = Builder(
            ...
            path(
                ...
                moveTo(8.0334f, 3.6578f)
                curveTo(8.3793f, 2.7807f, 9.6207f, 2.7807f, 9.9666f, 3.6579f)
                lineTo(11.0386f, 6.376f)
                curveTo(11.1442f, 6.6438f, 11.3562f, 6.8558f, 11.624f, 6.9614f)
                lineTo(14.3422f, 8.0334f)
                curveTo(15.2193f, 8.3793f, 15.2193f, 9.6207f, 14.3422f, 9.9666f)
                lineTo(11.624f, 11.0386f)
                curveTo(11.3562f, 11.1442f, 11.1442f, 11.3562f, 11.0386f, 11.624f)
                lineTo(9.9666f, 14.3422f)
                curveTo(9.6207f, 15.2193f, 8.3793f, 15.2193f, 8.0334f, 14.3422f)
                lineTo(6.9614f, 11.624f)
                curveTo(6.8558f, 11.3562f, 6.6438f, 11.1442f, 6.376f, 11.0386f)
                lineTo(3.6578f, 9.9666f)
                curveTo(2.7807f, 9.6207f, 2.7807f, 8.3793f, 3.6579f, 8.0334f)
                lineTo(6.376f, 6.9614f)
                curveTo(6.6438f, 6.8558f, 6.8558f, 6.6438f, 6.9614f, 6.376f)
                lineTo(8.0334f, 3.6578f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
