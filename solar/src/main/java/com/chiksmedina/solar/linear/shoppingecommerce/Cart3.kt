    ...
    get() {
        ...
        _cart3 = Builder(
            ...
            path(
                ...
                curveTo(3.0059f, 13.0234f, 2.5769f, 11.3075f, 3.4777f, 10.1538f)
                curveTo(4.3786f, 9.0f, 6.1473f, 9.0f, 9.6847f, 9.0f)
                horizontalLineTo(14.3153f)
                curveTo(17.8528f, 9.0f, 19.6215f, 9.0f, 20.5223f, 10.1538f)
