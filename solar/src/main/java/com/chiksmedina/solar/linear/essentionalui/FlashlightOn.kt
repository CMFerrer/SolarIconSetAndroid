    ...
    get() {
        ...
        _flashlightOn = Builder(
            ...
            path(
                ...
                curveTo(15.0f, 16.8394f, 15.0f, 16.4306f, 15.1522f, 16.0631f)
                curveTo(15.3045f, 15.6955f, 15.5935f, 15.4065f, 16.1716f, 14.8284f)
                lineTo(19.4142f, 11.5858f)
                curveTo(19.7032f, 11.2968f, 19.8478f, 11.1522f, 19.9239f, 10.9685f)
                ...
                curveTo(4.1522f, 11.1522f, 4.2968f, 11.2968f, 4.5858f, 11.5858f)
                lineTo(7.8284f, 14.8284f)
                curveTo(8.4065f, 15.4065f, 8.6955f, 15.6955f, 8.8478f, 16.0631f)
                curveTo(9.0f, 16.4306f, 9.0f, 16.8394f, 9.0f, 17.6569f)
