    ...
    get() {
        ...
        _running2 = Builder(name = "Running2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.65f, 22.0001f)
                curveTo(13.65f, 22.4143f, 13.9858f, 22.7501f, 14.4f, 22.7501f)
                curveTo(14.8142f, 22.7501f, 15.15f, 22.4143f, 15.15f, 22.0001f)
                ...
                lineTo(15.0324f, 18.1956f)
                lineTo(15.0324f, 18.1956f)
                lineTo(14.3059f, 18.382f)
                close()
                moveTo(13.5042f, 11.5552f)
                curveTo(13.8107f, 11.2766f, 13.8333f, 10.8022f, 13.5546f, 10.4957f)
                curveTo(13.276f, 10.1892f, 12.8017f, 10.1667f, 12.4952f, 10.4453f)
                lineTo(13.5042f, 11.5552f)
                close()
                ...
                curveTo(12.7753f, 17.3466f, 12.9989f, 17.5229f, 13.1617f, 17.7278f)
                lineTo(14.3362f, 16.7947f)
                curveTo(14.0279f, 16.4067f, 13.6189f, 16.1038f, 13.0175f, 15.6482f)
                lineTo(12.1117f, 16.8438f)
                close()
                moveTo(15.15f, 19.9391f)
                curveTo(15.15f, 19.1846f, 15.1555f, 18.6756f, 15.0324f, 18.1956f)
                lineTo(13.5794f, 18.5683f)
                curveTo(13.6445f, 18.8219f, 13.65f, 19.1065f, 13.65f, 19.9391f)
                horizontalLineTo(15.15f)
                close()
                moveTo(13.1617f, 17.7278f)
                curveTo(13.3585f, 17.9755f, 13.5008f, 18.2619f, 13.5794f, 18.5683f)
                lineTo(15.0324f, 18.1956f)
                curveTo(14.9014f, 17.6849f, 14.6642f, 17.2076f, 14.3362f, 16.7947f)
                lineTo(13.1617f, 17.7278f)
                close()
                moveTo(12.4952f, 10.4453f)
                ...
                lineTo(11.5552f, 13.4255f)
                curveTo(11.5475f, 13.4463f, 11.5693f, 13.3902f, 11.7008f, 13.2387f)
                curveTo(11.8172f, 13.1046f, 11.9768f, 12.9434f, 12.1723f, 12.7583f)
                curveTo(12.5728f, 12.3792f, 13.0368f, 11.9801f, 13.5042f, 11.5552f)
                lineTo(12.4952f, 10.4453f)
                close()
                moveTo(13.0175f, 15.6482f)
                curveTo(12.53f, 15.2789f, 12.1997f, 15.028f, 11.962f, 14.8164f)
                curveTo(11.7285f, 14.6085f, 11.6411f, 14.4867f, 11.5988f, 14.3977f)
                lineTo(10.2446f, 15.0429f)
                curveTo(10.4117f, 15.3937f, 10.6681f, 15.6728f, 10.9647f, 15.9368f)
                curveTo(11.2571f, 16.1971f, 11.6436f, 16.4892f, 12.1117f, 16.8438f)
                lineTo(13.0175f, 15.6482f)
                close()
                moveTo(10.1488f, 12.9039f)
                curveTo(9.8905f, 13.6006f, 9.925f, 14.3721f, 10.2446f, 15.0429f)
                lineTo(11.5988f, 14.3977f)
                curveTo(11.4535f, 14.0928f, 11.4378f, 13.7421f, 11.5552f, 13.4255f)
