    ...
    get() {
        ...
        _cupHot = Builder(name = "CupHot", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.0507f, 5.0614f)
                lineTo(6.4613f, 4.4857f)
                curveTo(6.6881f, 4.1678f, 6.6142f, 3.7262f, 6.2963f, 3.4994f)
                curveTo(5.9783f, 3.2727f, 5.9044f, 2.8311f, 6.1312f, 2.5132f)
                lineTo(6.5418f, 1.9375f)
                moveTo(14.0507f, 5.0614f)
                lineTo(14.4613f, 4.4857f)
                curveTo(14.6881f, 4.1678f, 14.6142f, 3.7262f, 14.2963f, 3.4994f)
                curveTo(13.9783f, 3.2727f, 13.9044f, 2.8311f, 14.1312f, 2.5132f)
                lineTo(14.5418f, 1.9375f)
                moveTo(10.0507f, 5.0614f)
                lineTo(10.4613f, 4.4857f)
                curveTo(10.6881f, 4.1678f, 10.6142f, 3.7262f, 10.2963f, 3.4994f)
                curveTo(9.9783f, 3.2727f, 9.9044f, 2.8311f, 10.1312f, 2.5132f)
                lineTo(10.5418f, 1.9375f)
            }
        }
        .build()
        return _cupHot!!
