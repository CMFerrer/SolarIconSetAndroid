    ...
    get() {
        ...
        _hikingRound = Builder(
            ...
            path(
                ...
                lineTo(18.0966f, 10.2766f)
                lineTo(18.0966f, 10.2766f)
                lineTo(18.5767f, 10.8528f)
                close()
                moveTo(19.4801f, 11.0762f)
                curveTo(19.7983f, 10.811f, 19.8413f, 10.3381f, 19.5762f, 10.0199f)
                curveTo(19.311f, 9.7016f, 18.8381f, 9.6587f, 18.5199f, 9.9238f)
                ...
                close()
                moveTo(14.2574f, 20.3926f)
                lineTo(15.0044f, 20.3261f)
                lineTo(15.0044f, 20.3261f)
                lineTo(14.2574f, 20.3926f)
                close()
                moveTo(13.6533f, 22.0665f)
                curveTo(13.6901f, 22.4791f, 14.0543f, 22.7838f, 14.4669f, 22.747f)
                curveTo(14.8794f, 22.7103f, 15.1842f, 22.3461f, 15.1474f, 21.9335f)
                ...
                curveTo(14.7535f, 13.2153f, 17.2627f, 12.9241f, 19.0568f, 11.4289f)
                lineTo(18.0966f, 10.2766f)
                curveTo(16.7602f, 11.3902f, 14.8913f, 11.6071f, 13.3354f, 10.8292f)
                lineTo(12.6646f, 12.1708f)
                close()
                moveTo(11.1399f, 16.5969f)
                curveTo(12.4916f, 17.4417f, 13.3691f, 18.8713f, 13.5103f, 20.4591f)
                lineTo(15.0044f, 20.3261f)
                curveTo(14.8215f, 18.2701f, 13.6852f, 16.4188f, 11.9349f, 15.3249f)
                lineTo(11.1399f, 16.5969f)
                close()
                moveTo(9.395f, 13.5125f)
                curveTo(9.2801f, 14.6616f, 9.8273f, 15.7765f, 10.8066f, 16.3886f)
                lineTo(11.6016f, 15.1166f)
                curveTo(11.1062f, 14.807f, 10.8294f, 14.243f, 10.8876f, 13.6617f)
                lineTo(9.395f, 13.5125f)
                close()
                moveTo(10.9562f, 12.9756f)
                curveTo(11.0363f, 12.1741f, 11.9234f, 11.7287f, 12.6141f, 12.1431f)
                lineTo(13.3859f, 10.8569f)
