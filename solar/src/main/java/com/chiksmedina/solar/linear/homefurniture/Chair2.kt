    ...
    get() {
        ...
        _chair2 = Builder(name = "Chair2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(14.0258f, 2.0f, 15.0387f, 2.0f, 15.7902f, 2.4957f)
                curveTo(16.0287f, 2.653f, 16.2436f, 2.8435f, 16.4282f, 3.0616f)
                curveTo(17.0098f, 3.7487f, 17.1305f, 4.7544f, 17.3719f, 6.7658f)
                lineTo(17.4628f, 7.5234f)
                curveTo(17.7133f, 9.6109f, 17.8385f, 10.6546f, 17.2417f, 11.3273f)
                curveTo(16.6449f, 12.0f, 15.5937f, 12.0f, 13.4913f, 12.0f)
                horizontalLineTo(10.5087f)
                curveTo(8.4063f, 12.0f, 7.3551f, 12.0f, 6.7583f, 11.3273f)
                curveTo(6.1614f, 10.6546f, 6.2867f, 9.6109f, 6.5372f, 7.5234f)
