    ...
    get() {
        ...
        _refreshSquare = Builder(name = "RefreshSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.0441f, 10.7937f, 16.8523f, 10.703f, 16.6485f, 10.6949f)
                curveTo(16.4447f, 10.6868f, 16.2464f, 10.7621f, 16.0993f, 10.9034f)
                lineTo(16.6188f, 11.4443f)
                close()
                moveTo(14.4805f, 12.4581f)
                curveTo(14.1818f, 12.745f, 14.1722f, 13.2198f, 14.4591f, 13.5185f)
                curveTo(14.7461f, 13.8173f, 15.2208f, 13.8269f, 15.5196f, 13.54f)
                lineTo(14.4805f, 12.4581f)
                close()
                moveTo(17.4394f, 13.4972f)
                curveTo(17.7145f, 13.8068f, 18.1885f, 13.8348f, 18.4982f, 13.5597f)
                curveTo(18.8078f, 13.2846f, 18.8359f, 12.8106f, 18.5607f, 12.5009f)
                lineTo(17.4394f, 13.4972f)
                close()
                moveTo(9.0469f, 15.0047f)
                curveTo(8.7635f, 14.7027f, 8.2888f, 14.6876f, 7.9868f, 14.9711f)
                curveTo(7.6848f, 15.2545f, 7.6697f, 15.7292f, 7.9532f, 16.0312f)
                lineTo(9.0469f, 15.0047f)
                close()
                moveTo(11.9349f, 17.7499f)
                curveTo(14.9277f, 17.7499f, 17.3688f, 15.3496f, 17.3688f, 12.3703f)
                horizontalLineTo(15.8688f)
                curveTo(15.8688f, 14.5047f, 14.1158f, 16.2499f, 11.9349f, 16.2499f)
                ...
                lineTo(14.4805f, 12.4581f)
                lineTo(15.5196f, 13.54f)
                lineTo(17.1384f, 11.9853f)
                lineTo(16.0993f, 10.9034f)
                close()
                moveTo(16.0582f, 11.9425f)
                lineTo(17.4394f, 13.4972f)
                lineTo(18.5607f, 12.5009f)
                lineTo(17.1795f, 10.9462f)
                lineTo(16.0582f, 11.9425f)
                close()
                moveTo(7.9532f, 16.0312f)
                curveTo(8.9455f, 17.0885f, 10.3636f, 17.7499f, 11.9349f, 17.7499f)
                verticalLineTo(16.2499f)
                curveTo(10.792f, 16.2499f, 9.7655f, 15.7704f, 9.0469f, 15.0047f)
                lineTo(7.9532f, 16.0312f)
                close()
            }
