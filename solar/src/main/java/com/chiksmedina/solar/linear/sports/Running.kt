    ...
    get() {
        ...
        _running = Builder(name = "Running", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(10.9428f, 12.321f, 10.5246f, 12.8438f, 10.4579f, 13.413f)
                curveTo(10.4204f, 13.733f, 10.4607f, 14.0573f, 10.5755f, 14.3584f)
                curveTo(10.7797f, 14.8939f, 11.3134f, 15.2981f, 12.3806f, 16.1066f)
                curveTo(13.1935f, 16.7225f, 13.6f, 17.0304f, 13.8754f, 17.4329f)
                curveTo(14.0325f, 17.6625f, 14.157f, 17.9129f, 14.2451f, 18.1767f)
