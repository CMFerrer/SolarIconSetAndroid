    ...
    get() {
        ...
        _sledgehammer = Builder(name = "Sledgehammer", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(7.6128f, 11.9684f)
                lineTo(12.0316f, 16.3872f)
                curveTo(13.7674f, 18.123f, 14.6354f, 18.991f, 15.7139f, 18.991f)
                curveTo(16.7924f, 18.991f, 17.6604f, 18.123f, 19.3962f, 16.3872f)
                curveTo(21.1321f, 14.6513f, 22.0f, 13.7834f, 22.0f, 12.7049f)
                curveTo(22.0f, 11.6263f, 21.1321f, 10.7584f, 19.3962f, 9.0226f)
                lineTo(14.9774f, 4.6038f)
                curveTo(13.2416f, 2.8679f, 12.3737f, 2.0f, 11.2951f, 2.0f)
                curveTo(10.2166f, 2.0f, 9.3487f, 2.8679f, 7.6128f, 4.6038f)
                curveTo(5.877f, 6.3397f, 5.009f, 7.2076f, 5.009f, 8.2861f)
                curveTo(5.009f, 9.3646f, 5.877f, 10.2326f, 7.6128f, 11.9684f)
                close()
            }
        }
        .build()
