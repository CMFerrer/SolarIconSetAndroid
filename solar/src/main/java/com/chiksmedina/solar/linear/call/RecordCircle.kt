...
public val CallGroup.RecordCircle: ImageVector
    get() {
        ...
        _recordCircle = Builder(name = "RecordCircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(18.5002f, 13.3807f, 17.3809f, 14.4999f, 16.0002f, 14.4999f)
                curveTo(14.6195f, 14.4999f, 13.5002f, 13.3807f, 13.5002f, 11.9999f)
                curveTo(13.5002f, 10.6192f, 14.6195f, 9.4999f, 16.0002f, 9.4999f)
                curveTo(17.3809f, 9.4999f, 18.5002f, 10.6192f, 18.5002f, 11.9999f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
