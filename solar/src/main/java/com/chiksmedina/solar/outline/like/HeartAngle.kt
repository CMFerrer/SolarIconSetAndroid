    ...
    get() {
        ...
        _heartAngle = Builder(name = "HeartAngle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.9023f, 3.7506f, 14.9662f, 3.8558f, 13.0725f, 5.5122f)
                lineTo(14.5302f, 6.9694f)
                curveTo(14.8232f, 7.2622f, 14.8233f, 7.7371f, 14.5304f, 8.0301f)
                curveTo(14.2376f, 8.323f, 13.7627f, 8.3231f, 13.4698f, 8.0302f)
                lineTo(11.4698f, 6.031f)
                lineTo(11.4596f, 6.0206f)
