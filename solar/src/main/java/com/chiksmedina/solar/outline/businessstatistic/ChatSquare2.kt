...
val BusinessStatisticGroup.ChatSquare2: ImageVector
    get() {
        if (_chatSquare2 != null) {
            return _chatSquare2!!
        }
        _chatSquare2 = Builder(
            name = "ChatSquare2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(
                ...
                moveTo(7.75f, 15.0f)
                curveTo(7.75f, 14.5858f, 7.4142f, 14.25f, 7.0f, 14.25f)
                curveTo(6.5858f, 14.25f, 6.25f, 14.5858f, 6.25f, 15.0f)
