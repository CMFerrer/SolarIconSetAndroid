...
public val FilesGroup.FileLeft: ImageVector
    get() {
        if (_fileLeft != null) {
            return _fileLeft!!
        }
        _fileLeft = Builder(name = "FileLeft", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(5.4528f, 16.513f)
                curveTo(5.1824f, 16.2245f, 5.1824f, 15.7756f, 5.4528f, 15.4871f)
                lineTo(7.3278f, 13.4871f)
                curveTo(7.6111f, 13.1849f, 8.0858f, 13.1696f, 8.388f, 13.4529f)
                curveTo(8.6901f, 13.7362f, 8.7055f, 14.2108f, 8.4221f, 14.513f)
                lineTo(7.7312f, 15.25f)
                lineTo(11.0f, 15.2501f)
                curveTo(11.4142f, 15.2501f, 11.75f, 15.5858f, 11.75f, 16.0001f)
                curveTo(11.75f, 16.4143f, 11.4142f, 16.7501f, 11.0f, 16.7501f)
                horizontalLineTo(7.7312f)
                lineTo(8.4221f, 17.4871f)
                curveTo(8.7055f, 17.7893f, 8.6901f, 18.2639f, 8.388f, 18.5472f)
                curveTo(8.0858f, 18.8305f, 7.6111f, 18.8152f, 7.3278f, 18.513f)
                lineTo(5.4528f, 16.513f)
                close()
            }
        }
        .build()
