...
public val BusinessStatisticGroup.ChartSquare: ImageVector
    get() {
        ...
        _chartSquare = Builder(name = "ChartSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(17.75f, 13.0f)
                curveTo(17.75f, 12.5858f, 17.4142f, 12.25f, 17.0f, 12.25f)
                curveTo(16.5858f, 12.25f, 16.25f, 12.5858f, 16.25f, 13.0f)
                verticalLineTo(18.0f)
