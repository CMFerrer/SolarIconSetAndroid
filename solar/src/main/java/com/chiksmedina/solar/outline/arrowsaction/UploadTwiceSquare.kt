...
public val ArrowsActionGroup.UploadTwiceSquare: ImageVector
    get() {
        if (_uploadTwiceSquare != null) {
            return _uploadTwiceSquare!!
        }
        _uploadTwiceSquare = Builder(name = "UploadTwiceSquare", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(5.25f, 7.0f)
                curveTo(5.25f, 7.4142f, 5.5858f, 7.75f, 6.0f, 7.75f)
                horizontalLineTo(18.0f)
                curveTo(18.4142f, 7.75f, 18.75f, 7.4142f, 18.75f, 7.0f)
                curveTo(18.75f, 6.5858f, 18.4142f, 6.25f, 18.0f, 6.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(16.25f, 17.0f)
                curveTo(16.25f, 17.4142f, 15.9142f, 17.75f, 15.5f, 17.75f)
                curveTo(15.0858f, 17.75f, 14.75f, 17.4142f, 14.75f, 17.0f)
                verticalLineTo(12.0715f)
                lineTo(13.5762f, 13.4801f)
                curveTo(13.311f, 13.7983f, 12.8381f, 13.8413f, 12.5199f, 13.5762f)
                curveTo(12.2017f, 13.311f, 12.1587f, 12.8381f, 12.4238f, 12.5199f)
                lineTo(14.9238f, 9.5199f)
                curveTo(15.0663f, 9.3489f, 15.2774f, 9.25f, 15.5f, 9.25f)
                curveTo(15.7226f, 9.25f, 15.9337f, 9.3489f, 16.0762f, 9.5199f)
                lineTo(18.5762f, 12.5199f)
                curveTo(18.8413f, 12.8381f, 18.7983f, 13.311f, 18.4801f, 13.5762f)
                curveTo(18.1619f, 13.8413f, 17.689f, 13.7983f, 17.4238f, 13.4801f)
