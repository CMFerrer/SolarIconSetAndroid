    ...
    get() {
        ...
        _turntableMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(17.75f, 8.5499f, 17.4576f, 9.0963f, 16.9707f, 9.4209f)
                lineTo(14.416f, 11.124f)
                curveTo(14.0714f, 11.3538f, 13.6057f, 11.2607f, 13.376f, 10.916f)
                curveTo(13.1462f, 10.5714f, 13.2393f, 10.1057f, 13.584f, 9.876f)
                lineTo(16.1387f, 8.1728f)
                curveTo(16.2082f, 8.1265f, 16.25f, 8.0484f, 16.25f, 7.9648f)
