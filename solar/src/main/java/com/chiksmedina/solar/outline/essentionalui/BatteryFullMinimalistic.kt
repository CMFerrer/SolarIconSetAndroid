    ...
    get() {
        ...
        _batteryFullMinimalistic = Builder(name = "BatteryFullMinimalistic", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(14.6556f, 8.6358f)
                curveTo(14.4545f, 8.2737f, 13.9979f, 8.1432f, 13.6358f, 8.3444f)
                curveTo(13.2768f, 8.5438f, 13.1455f, 8.9944f, 13.3393f, 9.355f)
                lineTo(13.3443f, 9.3652f)
                curveTo(13.3512f, 9.3796f, 13.3643f, 9.4083f, 13.3818f, 9.452f)
                curveTo(13.4167f, 9.5392f, 13.4691f, 9.6865f, 13.5235f, 9.8988f)
                curveTo(13.6322f, 10.3228f, 13.75f, 11.0101f, 13.75f, 12.0f)
                curveTo(13.75f, 12.9899f, 13.6322f, 13.6772f, 13.5235f, 14.1012f)
                curveTo(13.4691f, 14.3135f, 13.4167f, 14.4608f, 13.3818f, 14.548f)
                curveTo(13.3643f, 14.5917f, 13.3512f, 14.6204f, 13.3443f, 14.6348f)
                lineTo(13.3393f, 14.645f)
                curveTo(13.1455f, 15.0056f, 13.2768f, 15.4562f, 13.6358f, 15.6556f)
                curveTo(13.9979f, 15.8568f, 14.4545f, 15.7263f, 14.6556f, 15.3642f)
                lineTo(14.0f, 15.0f)
                curveTo(14.6556f, 15.3642f, 14.6554f, 15.3646f, 14.6556f, 15.3642f)
                lineTo(14.6563f, 15.3629f)
                lineTo(14.6571f, 15.3615f)
                lineTo(14.6588f, 15.3585f)
                lineTo(14.6626f, 15.3514f)
                lineTo(14.6723f, 15.333f)
                curveTo(14.6795f, 15.3189f, 14.6884f, 15.3012f, 14.6986f, 15.2797f)
                curveTo(14.7191f, 15.2367f, 14.7451f, 15.1787f, 14.7745f, 15.1051f)
                curveTo(14.8333f, 14.9579f, 14.9059f, 14.749f, 14.9765f, 14.4738f)
                curveTo(15.1178f, 13.9228f, 15.25f, 13.1101f, 15.25f, 12.0f)
                curveTo(15.25f, 10.8899f, 15.1178f, 10.0772f, 14.9765f, 9.5262f)
                curveTo(14.9059f, 9.251f, 14.8333f, 9.0421f, 14.7745f, 8.8949f)
                curveTo(14.7451f, 8.8214f, 14.7191f, 8.7633f, 14.6986f, 8.7203f)
                curveTo(14.6884f, 8.6988f, 14.6795f, 8.6811f, 14.6723f, 8.667f)
                lineTo(14.6626f, 8.6486f)
                lineTo(14.6588f, 8.6415f)
                lineTo(14.6571f, 8.6385f)
                lineTo(14.6563f, 8.6371f)
                curveTo(14.6562f, 8.6368f, 14.6556f, 8.6358f, 14.0f, 9.0f)
                lineTo(14.6556f, 8.6358f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
