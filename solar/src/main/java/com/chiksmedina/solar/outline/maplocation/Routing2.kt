...
public val MapLocationGroup.Routing2: ImageVector
    get() {
        if (_routing2 != null) {
            return _routing2!!
        }
        _routing2 = Builder(name = "Routing2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(1.25f, 5.2573f)
                curveTo(1.25f, 2.9943f, 3.2045f, 1.25f, 5.5f, 1.25f)
                curveTo(7.7955f, 1.25f, 9.75f, 2.9943f, 9.75f, 5.2573f)
                curveTo(9.75f, 7.2836f, 8.5042f, 9.6751f, 6.4348f, 10.5594f)
                curveTo(5.8402f, 10.8135f, 5.1598f, 10.8135f, 4.5652f, 10.5594f)
                curveTo(2.4958f, 9.6751f, 1.25f, 7.2836f, 1.25f, 5.2573f)
                close()
                moveTo(5.5f, 2.75f)
                curveTo(3.9295f, 2.75f, 2.75f, 3.9224f, 2.75f, 5.2573f)
                curveTo(2.75f, 6.8008f, 3.7383f, 8.5749f, 5.1547f, 9.1801f)
                curveTo(5.3727f, 9.2733f, 5.6273f, 9.2733f, 5.8453f, 9.1801f)
                curveTo(7.2617f, 8.5749f, 8.25f, 6.8008f, 8.25f, 5.2573f)
                curveTo(8.25f, 3.9224f, 7.0704f, 2.75f, 5.5f, 2.75f)
                close()
                moveTo(11.25f, 5.0f)
                ...
                curveTo(10.2626f, 16.6768f, 10.7374f, 16.6768f, 11.0303f, 16.9697f)
                ...
                close()
                moveTo(14.25f, 17.2573f)
                curveTo(14.25f, 14.9943f, 16.2045f, 13.25f, 18.5f, 13.25f)
                curveTo(20.7955f, 13.25f, 22.75f, 14.9943f, 22.75f, 17.2573f)
                curveTo(22.75f, 19.2836f, 21.5042f, 21.6751f, 19.4348f, 22.5594f)
                curveTo(18.8402f, 22.8135f, 18.1598f, 22.8135f, 17.5652f, 22.5594f)
                curveTo(15.4958f, 21.6751f, 14.25f, 19.2836f, 14.25f, 17.2573f)
                close()
                moveTo(18.5f, 14.75f)
                curveTo(16.9295f, 14.75f, 15.75f, 15.9224f, 15.75f, 17.2573f)
                curveTo(15.75f, 18.8008f, 16.7384f, 20.5748f, 18.1547f, 21.1801f)
                curveTo(18.3727f, 21.2733f, 18.6273f, 21.2733f, 18.8453f, 21.1801f)
                curveTo(20.2617f, 20.5748f, 21.25f, 18.8008f, 21.25f, 17.2573f)
                curveTo(21.25f, 15.9224f, 20.0705f, 14.75f, 18.5f, 14.75f)
                close()
            }
        }
        .build()
