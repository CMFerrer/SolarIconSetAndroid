    ...
    get() {
        ...
        _notes = Builder(
            ...
            path(
                ...
                curveTo(11.1596f, 9.4058f, 11.5709f, 9.1683f, 11.971f, 9.2755f)
                lineTo(16.8006f, 10.5696f)
                curveTo(17.2007f, 10.6768f, 17.4381f, 11.0881f, 17.3309f, 11.4882f)
                ...
                close()
                moveTo(10.2755f, 12.7036f)
                curveTo(10.3828f, 12.3035f, 10.794f, 12.066f, 11.1941f, 12.1733f)
                lineTo(14.0919f, 12.9497f)
                curveTo(14.492f, 13.0569f, 14.7294f, 13.4682f, 14.6222f, 13.8683f)
                curveTo(14.515f, 14.2684f, 14.1038f, 14.5058f, 13.7037f, 14.3986f)
                lineTo(10.8059f, 13.6221f)
                curveTo(10.4058f, 13.5149f, 10.1683f, 13.1037f, 10.2755f, 12.7036f)
                close()
            }
        }
            .build()
