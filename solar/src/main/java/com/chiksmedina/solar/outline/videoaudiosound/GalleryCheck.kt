    ...
    get() {
        ...
        _galleryCheck = Builder(name = "GalleryCheck", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(20.5303f, 3.4697f)
                curveTo(20.8232f, 3.7626f, 20.8232f, 4.2374f, 20.5303f, 4.5303f)
                lineTo(15.5303f, 9.5303f)
                curveTo(15.2374f, 9.8232f, 14.7626f, 9.8232f, 14.4697f, 9.5303f)
                lineTo(12.4697f, 7.5303f)
                curveTo(12.1768f, 7.2374f, 12.1768f, 6.7626f, 12.4697f, 6.4697f)
                curveTo(12.7626f, 6.1768f, 13.2374f, 6.1768f, 13.5303f, 6.4697f)
                lineTo(15.0f, 7.9393f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.969f, 1.634f, 3.829f, 2.0393f, 2.9341f, 2.9341f)
                curveTo(2.0393f, 3.8289f, 1.634f, 4.969f, 1.4398f, 6.4137f)
                curveTo(1.25f, 7.8252f, 1.25f, 9.6342f, 1.25f, 11.9426f)
                verticalLineTo(12.0574f)
                curveTo(1.25f, 14.3658f, 1.25f, 16.1748f, 1.4398f, 17.5863f)
                curveTo(1.634f, 19.031f, 2.0393f, 20.1711f, 2.9341f, 21.0659f)
                curveTo(3.829f, 21.9607f, 4.969f, 22.366f, 6.4137f, 22.5603f)
                ...
                curveTo(12.8182f, 15.3193f, 12.1421f, 15.2608f, 11.7126f, 14.8313f)
                lineTo(7.4228f, 10.5415f)
                curveTo(6.2874f, 9.4061f, 4.4661f, 9.3455f, 3.2577f, 10.4028f)
                lineTo(2.751f, 10.8462f)
                curveTo(2.7555f, 9.054f, 2.7813f, 7.693f, 2.9264f, 6.6136f)
                curveTo(3.0983f, 5.3352f, 3.4251f, 4.5644f, 3.9948f, 3.9948f)
                ...
                curveTo(3.0983f, 18.6648f, 3.4251f, 19.4355f, 3.9948f, 20.0052f)
                curveTo(4.5645f, 20.5749f, 5.3352f, 20.9018f, 6.6136f, 21.0736f)
                curveTo(7.9136f, 21.2484f, 9.6218f, 21.25f, 12.0f, 21.25f)
                curveTo(14.3782f, 21.25f, 16.0865f, 21.2484f, 17.3864f, 21.0736f)
                ...
                lineTo(17.2748f, 16.1562f)
                curveTo(16.4951f, 15.4545f, 15.334f, 15.3846f, 14.4759f, 15.9877f)
                lineTo(14.1777f, 16.1973f)
