    ...
    get() {
        ...
        _checklistMinimalistic = Builder(
            ...
            path(
                ...
                close()
                moveTo(10.5172f, 6.4569f)
                curveTo(10.8172f, 6.7426f, 10.8288f, 7.2173f, 10.5431f, 7.5172f)
                lineTo(7.686f, 10.5172f)
                curveTo(7.5444f, 10.6659f, 7.3481f, 10.75f, 7.1429f, 10.75f)
                curveTo(6.9376f, 10.75f, 6.7413f, 10.6659f, 6.5998f, 10.5172f)
                lineTo(5.4569f, 9.3172f)
                curveTo(5.1712f, 9.0173f, 5.1828f, 8.5426f, 5.4828f, 8.2569f)
                curveTo(5.7827f, 7.9712f, 6.2574f, 7.9828f, 6.5431f, 8.2828f)
                lineTo(7.1429f, 8.9125f)
                lineTo(9.4569f, 6.4828f)
                curveTo(9.7426f, 6.1828f, 10.2173f, 6.1712f, 10.5172f, 6.4569f)
                close()
                moveTo(12.25f, 9.0f)
                curveTo(12.25f, 8.5858f, 12.5858f, 8.25f, 13.0f, 8.25f)
                ...
                close()
                moveTo(10.5172f, 13.4569f)
                curveTo(10.8172f, 13.7426f, 10.8288f, 14.2173f, 10.5431f, 14.5172f)
                lineTo(7.686f, 17.5172f)
                curveTo(7.5444f, 17.6659f, 7.3481f, 17.75f, 7.1429f, 17.75f)
                curveTo(6.9376f, 17.75f, 6.7413f, 17.6659f, 6.5998f, 17.5172f)
                lineTo(5.4569f, 16.3172f)
                curveTo(5.1712f, 16.0173f, 5.1828f, 15.5426f, 5.4828f, 15.2569f)
                curveTo(5.7827f, 14.9712f, 6.2574f, 14.9828f, 6.5431f, 15.2828f)
                lineTo(7.1429f, 15.9125f)
                lineTo(9.4569f, 13.4828f)
                curveTo(9.7426f, 13.1828f, 10.2173f, 13.1712f, 10.5172f, 13.4569f)
                close()
                moveTo(12.25f, 16.0f)
                curveTo(12.25f, 15.5858f, 12.5858f, 15.25f, 13.0f, 15.25f)
                horizontalLineTo(18.0f)
                curveTo(18.4142f, 15.25f, 18.75f, 15.5858f, 18.75f, 16.0f)
                curveTo(18.75f, 16.4142f, 18.4142f, 16.75f, 18.0f, 16.75f)
                horizontalLineTo(13.0f)
                curveTo(12.5858f, 16.75f, 12.25f, 16.4142f, 12.25f, 16.0f)
                close()
            }
        }
            .build()
