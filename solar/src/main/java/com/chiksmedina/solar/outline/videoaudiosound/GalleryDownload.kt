    ...
    get() {
        ...
        _galleryDownload = Builder(name = "GalleryDownload", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(9.1893f)
                lineTo(19.4697f, 7.4697f)
                curveTo(19.7626f, 7.1768f, 20.2374f, 7.1768f, 20.5303f, 7.4697f)
                curveTo(20.8232f, 7.7626f, 20.8232f, 8.2374f, 20.5303f, 8.5303f)
                lineTo(17.5303f, 11.5303f)
                curveTo(17.2374f, 11.8232f, 16.7626f, 11.8232f, 16.4697f, 11.5303f)
                lineTo(13.4697f, 8.5303f)
                curveTo(13.1768f, 8.2374f, 13.1768f, 7.7626f, 13.4697f, 7.4697f)
                curveTo(13.7626f, 7.1768f, 14.2374f, 7.1768f, 14.5303f, 7.4697f)
                lineTo(16.25f, 9.1893f)
                verticalLineTo(2.0f)
