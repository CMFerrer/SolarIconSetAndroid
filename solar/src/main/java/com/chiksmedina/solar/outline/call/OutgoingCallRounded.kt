...
public val CallGroup.OutgoingCallRounded: ImageVector
    get() {
        if (_outgoingCallRounded != null) {
            return _outgoingCallRounded!!
        }
        _outgoingCallRounded = Builder(name = "OutgoingCallRounded", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.0f, 4.25f)
                curveTo(15.5858f, 4.25f, 15.25f, 4.5858f, 15.25f, 5.0f)
                curveTo(15.25f, 5.4142f, 15.5858f, 5.75f, 16.0f, 5.75f)
                horizontalLineTo(17.1893f)
                lineTo(14.4697f, 8.4697f)
                curveTo(14.1768f, 8.7626f, 14.1768f, 9.2375f, 14.4697f, 9.5303f)
                curveTo(14.7626f, 9.8232f, 15.2374f, 9.8232f, 15.5303f, 9.5303f)
                lineTo(18.25f, 6.8107f)
                verticalLineTo(8.0f)
                curveTo(18.25f, 8.4142f, 18.5858f, 8.75f, 19.0f, 8.75f)
                curveTo(19.4142f, 8.75f, 19.75f, 8.4142f, 19.75f, 8.0f)
                verticalLineTo(5.0f)
                curveTo(19.75f, 4.5858f, 19.4142f, 4.25f, 19.0f, 4.25f)
...
private var _outgoingCallRounded: ImageVector? = null
