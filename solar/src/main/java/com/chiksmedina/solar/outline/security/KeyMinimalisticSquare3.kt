...
public val SecurityGroup.KeyMinimalisticSquare3: ImageVector
    get() {
        if (_keyMinimalisticSquare3 != null) {
            return _keyMinimalisticSquare3!!
        }
        _keyMinimalisticSquare3 = Builder(name = "KeyMinimalisticSquare3", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.25f, 12.0f)
                curveTo(5.25f, 10.2051f, 6.7051f, 8.75f, 8.5f, 8.75f)
                curveTo(10.0368f, 8.75f, 11.3245f, 9.8167f, 11.663f, 11.25f)
                horizontalLineTo(17.0f)
                curveTo(17.9665f, 11.25f, 18.75f, 12.0335f, 18.75f, 13.0f)
                verticalLineTo(14.0f)
                curveTo(18.75f, 14.4142f, 18.4142f, 14.75f, 18.0f, 14.75f)
                curveTo(17.5858f, 14.75f, 17.25f, 14.4142f, 17.25f, 14.0f)
                verticalLineTo(13.0f)
                curveTo(17.25f, 12.8619f, 17.1381f, 12.75f, 17.0f, 12.75f)
                horizontalLineTo(16.25f)
                verticalLineTo(13.5f)
                curveTo(16.25f, 13.9142f, 15.9142f, 14.25f, 15.5f, 14.25f)
                curveTo(15.0858f, 14.25f, 14.75f, 13.9142f, 14.75f, 13.5f)
                verticalLineTo(12.75f)
                horizontalLineTo(11.663f)
                curveTo(11.3245f, 14.1834f, 10.0368f, 15.25f, 8.5f, 15.25f)
                curveTo(6.7051f, 15.25f, 5.25f, 13.7949f, 5.25f, 12.0f)
                close()
            }
        }
        .build()
