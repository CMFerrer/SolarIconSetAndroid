...
val FoldersGroup.Folder2: ImageVector
    get() {
        if (_folder2 != null) {
            return _folder2!!
        }
        _folder2 = Builder(
            name = "Folder2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                curveTo(10.5455f, 2.4848f, 10.7055f, 2.6448f, 10.9539f, 2.8933f)
                lineTo(11.5303f, 3.4697f)
                curveTo(12.376f, 4.3154f, 12.7012f, 4.6311f, 13.0768f, 4.8401f)
                ...
                curveTo(17.5259f, 5.25f, 18.5521f, 5.25f, 19.364f, 5.3521f)
                curveTo(20.2054f, 5.4578f, 20.9204f, 5.6836f, 21.5077f, 6.2119f)
                curveTo(21.6061f, 6.3003f, 21.6997f, 6.3939f, 21.7882f, 6.4923f)
                curveTo(22.3164f, 7.0796f, 22.5422f, 7.7946f, 22.648f, 8.636f)
                curveTo(22.7281f, 9.2736f, 22.7453f, 10.0433f, 22.749f, 10.961f)
                curveTo(22.7497f, 10.9739f, 22.75f, 10.9869f, 22.75f, 11.0f)
                curveTo(22.75f, 11.0112f, 22.7498f, 11.0224f, 22.7493f, 11.0335f)
                curveTo(22.75f, 11.2622f, 22.75f, 11.5f, 22.75f, 11.747f)
                ...
                curveTo(4.3386f, 22.4393f, 3.3896f, 22.1071f, 2.6412f, 21.3588f)
                ...
                curveTo(21.25f, 11.7819f, 21.25f, 11.7659f, 21.25f, 11.75f)
                horizontalLineTo(2.75f)
                close()
                moveTo(21.2418f, 10.25f)
                horizontalLineTo(2.75f)
                verticalLineTo(6.9498f)
                curveTo(2.75f, 6.0331f, 2.7533f, 5.6787f, 2.8063f, 5.3975f)
                curveTo(3.0544f, 4.0828f, 4.0827f, 3.0544f, 5.3974f, 2.8064f)
                curveTo(5.6787f, 2.7533f, 6.0331f, 2.75f, 6.9497f, 2.75f)
                curveTo(7.3504f, 2.75f, 7.5029f, 2.7508f, 7.6457f, 2.7641f)
                curveTo(8.2966f, 2.825f, 8.914f, 3.0807f, 9.4173f, 3.4979f)
                curveTo(9.5278f, 3.5895f, 9.6361f, 3.6968f, 9.9194f, 3.9801f)
                lineTo(10.4697f, 4.5304f)
                curveTo(10.496f, 4.5567f, 10.522f, 4.5827f, 10.5476f, 4.6083f)
                curveTo(11.2885f, 5.3495f, 11.7663f, 5.8275f, 12.3475f, 6.1508f)
                curveTo(12.6661f, 6.3281f, 13.0041f, 6.4681f, 13.3548f, 6.5681f)
                curveTo(13.9944f, 6.7504f, 14.6702f, 6.7502f, 15.7182f, 6.75f)
                curveTo(15.7545f, 6.75f, 15.7912f, 6.75f, 15.8284f, 6.75f)
                horizontalLineTo(16.2021f)
                curveTo(17.5379f, 6.75f, 18.4695f, 6.7514f, 19.1769f, 6.8403f)
                curveTo(19.8655f, 6.9269f, 20.2365f, 7.0859f, 20.5046f, 7.3271f)
                curveTo(20.5637f, 7.3802f, 20.6198f, 7.4364f, 20.6729f, 7.4954f)
                curveTo(20.9141f, 7.7636f, 21.0731f, 8.1345f, 21.1597f, 8.8231f)
                curveTo(21.2094f, 9.2183f, 21.2317f, 9.6835f, 21.2418f, 10.25f)
                close()
            }
        }
            .build()
