...
public val FilesGroup.FileRemove: ImageVector
    get() {
        if (_fileRemove != null) {
            return _fileRemove!!
        }
        _fileRemove = Builder(name = "FileRemove", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(8.5607f, 16.5001f)
                lineTo(9.5303f, 17.4697f)
                curveTo(9.8232f, 17.7626f, 9.8232f, 18.2375f, 9.5303f, 18.5304f)
                curveTo(9.2374f, 18.8233f, 8.7626f, 18.8233f, 8.4697f, 18.5304f)
                lineTo(7.5f, 17.5607f)
                lineTo(6.5303f, 18.5304f)
                curveTo(6.2374f, 18.8233f, 5.7626f, 18.8233f, 5.4697f, 18.5304f)
                curveTo(5.1768f, 18.2375f, 5.1768f, 17.7626f, 5.4697f, 17.4697f)
                lineTo(6.4393f, 16.5001f)
