    ...
    get() {
        ...
        _folderSecurity = Builder(name = "FolderSecurity", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 11.75f)
                curveTo(11.3097f, 11.75f, 10.75f, 12.3097f, 10.75f, 13.0f)
                curveTo(10.75f, 13.6904f, 11.3097f, 14.25f, 12.0f, 14.25f)
                curveTo(12.6904f, 14.25f, 13.25f, 13.6904f, 13.25f, 13.0f)
                curveTo(13.25f, 12.3097f, 12.6904f, 11.75f, 12.0f, 11.75f)
                close()
                moveTo(9.25f, 13.0f)
                ...
                curveTo(10.0958f, 15.32f, 9.25f, 14.2588f, 9.25f, 13.0f)
                close()
            }
        }
        .build()
