...
public val MessagesConversationGroup.InboxOut: ImageVector
    get() {
        if (_inboxOut != null) {
            return _inboxOut!!
        }
        _inboxOut = Builder(name = "InboxOut", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(11.4697f, 1.4697f)
                curveTo(11.7626f, 1.1768f, 12.2374f, 1.1768f, 12.5303f, 1.4697f)
                ...
                curveTo(16.2941f, 1.6412f, 16.6612f, 1.3399f, 17.0734f, 1.3805f)
                curveTo(18.7643f, 1.5468f, 20.0677f, 1.9359f, 21.0659f, 2.9341f)
                ...
                curveTo(3.9323f, 1.9359f, 5.2357f, 1.5468f, 6.9266f, 1.3805f)
                curveTo(7.3388f, 1.3399f, 7.7059f, 1.6412f, 7.7464f, 2.0535f)
                curveTo(7.787f, 2.4657f, 7.4856f, 2.8327f, 7.0734f, 2.8733f)
                curveTo(5.514f, 3.0266f, 4.6295f, 3.36f, 3.9948f, 3.9948f)
                ...
                curveTo(19.3705f, 3.36f, 18.486f, 3.0266f, 16.9266f, 2.8733f)
                curveTo(16.5144f, 2.8327f, 16.2131f, 2.4657f, 16.2536f, 2.0535f)
                close()
