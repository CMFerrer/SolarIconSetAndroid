...
public val TimeGroup.CalendarMark: ImageVector
    get() {
        if (_calendarMark != null) {
            return _calendarMark!!
        }
        _calendarMark = Builder(name = "CalendarMark", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.5f, 15.75f)
                curveTo(16.0858f, 15.75f, 15.75f, 16.0858f, 15.75f, 16.5f)
                curveTo(15.75f, 16.9142f, 16.0858f, 17.25f, 16.5f, 17.25f)
                curveTo(16.9142f, 17.25f, 17.25f, 16.9142f, 17.25f, 16.5f)
                curveTo(17.25f, 16.0858f, 16.9142f, 15.75f, 16.5f, 15.75f)
                close()
                moveTo(14.25f, 16.5f)
                curveTo(14.25f, 15.2574f, 15.2574f, 14.25f, 16.5f, 14.25f)
                curveTo(17.7426f, 14.25f, 18.75f, 15.2574f, 18.75f, 16.5f)
                curveTo(18.75f, 17.7426f, 17.7426f, 18.75f, 16.5f, 18.75f)
                curveTo(15.2574f, 18.75f, 14.25f, 17.7426f, 14.25f, 16.5f)
                close()
            }
        }
        .build()
