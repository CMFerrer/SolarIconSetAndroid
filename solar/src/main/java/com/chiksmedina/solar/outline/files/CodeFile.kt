    ...
    get() {
        ...
        _codeFile = Builder(name = "CodeFile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(10.2633f, 13.2978f)
                curveTo(10.6512f, 13.4432f, 10.8477f, 13.8756f, 10.7022f, 14.2634f)
                lineTo(9.2022f, 18.2634f)
                curveTo(9.0568f, 18.6512f, 8.6245f, 18.8477f, 8.2367f, 18.7023f)
                curveTo(7.8488f, 18.5569f, 7.6523f, 18.1245f, 7.7977f, 17.7367f)
                lineTo(9.2978f, 13.7367f)
                curveTo(9.4432f, 13.3489f, 9.8755f, 13.1524f, 10.2633f, 13.2978f)
                close()
                moveTo(7.5303f, 13.4697f)
                curveTo(7.8232f, 13.7626f, 7.8232f, 14.2375f, 7.5303f, 14.5304f)
                lineTo(7.0607f, 15.0f)
                lineTo(7.5303f, 15.4697f)
                curveTo(7.8232f, 15.7626f, 7.8232f, 16.2375f, 7.5303f, 16.5304f)
                curveTo(7.2374f, 16.8233f, 6.7626f, 16.8233f, 6.4697f, 16.5304f)
                lineTo(5.4697f, 15.5304f)
                curveTo(5.1768f, 15.2375f, 5.1768f, 14.7626f, 5.4697f, 14.4697f)
                ...
                curveTo(13.3232f, 16.7626f, 13.3232f, 17.2375f, 13.0303f, 17.5304f)
                lineTo(12.0303f, 18.5304f)
                curveTo(11.7374f, 18.8233f, 11.2626f, 18.8233f, 10.9697f, 18.5304f)
                curveTo(10.6768f, 18.2375f, 10.6768f, 17.7626f, 10.9697f, 17.4697f)
                lineTo(11.4393f, 17.0f)
                lineTo(10.9697f, 16.5304f)
                curveTo(10.6768f, 16.2375f, 10.6768f, 15.7626f, 10.9697f, 15.4697f)
                close()
            }
        }
        .build()
