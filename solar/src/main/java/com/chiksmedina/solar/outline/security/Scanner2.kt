    ...
    get() {
        ...
        _scanner2 = Builder(
            ...
            path(
                ...
                moveTo(5.4983f, 13.5575f)
                curveTo(5.1904f, 13.2804f, 5.1654f, 12.8062f, 5.4425f, 12.4983f)
                lineTo(6.0f, 13.0f)
                curveTo(5.4425f, 12.4983f, 5.4422f, 12.4986f, 5.4425f, 12.4983f)
                lineTo(5.4437f, 12.4969f)
                lineTo(5.4451f, 12.4954f)
                lineTo(5.4485f, 12.4918f)
                lineTo(5.4571f, 12.4824f)
                curveTo(5.4639f, 12.4752f, 5.4724f, 12.4661f, 5.4829f, 12.4553f)
                curveTo(5.5038f, 12.4338f, 5.5322f, 12.4053f, 5.5683f, 12.371f)
                curveTo(5.6405f, 12.3022f, 5.7434f, 12.2098f, 5.8784f, 12.1018f)
                curveTo(6.1483f, 11.8859f, 6.5465f, 11.6076f, 7.0828f, 11.3326f)
                curveTo(8.1589f, 10.7808f, 9.7757f, 10.25f, 12.0f, 10.25f)
                curveTo(14.2243f, 10.25f, 15.8411f, 10.7808f, 16.9172f, 11.3326f)
                curveTo(17.4535f, 11.6076f, 17.8517f, 11.8859f, 18.1216f, 12.1018f)
                curveTo(18.2566f, 12.2098f, 18.3595f, 12.3022f, 18.4317f, 12.371f)
                curveTo(18.4678f, 12.4053f, 18.4962f, 12.4338f, 18.5171f, 12.4553f)
                curveTo(18.5276f, 12.4661f, 18.5361f, 12.4752f, 18.5429f, 12.4824f)
                lineTo(18.5515f, 12.4918f)
                lineTo(18.5549f, 12.4954f)
                lineTo(18.5562f, 12.4969f)
                curveTo(18.5565f, 12.4973f, 18.5575f, 12.4983f, 18.0f, 13.0f)
                lineTo(18.5575f, 12.4983f)
                curveTo(18.8346f, 12.8062f, 18.8096f, 13.2804f, 18.5017f, 13.5575f)
                curveTo(18.1952f, 13.8333f, 17.7239f, 13.8098f, 17.4463f, 13.5059f)
                lineTo(17.4404f, 13.4997f)
                curveTo(17.4329f, 13.492f, 17.4185f, 13.4775f, 17.3972f, 13.4572f)
                curveTo(17.3545f, 13.4165f, 17.284f, 13.3527f, 17.1846f, 13.2732f)
                curveTo(16.9858f, 13.1141f, 16.6715f, 12.8924f, 16.2328f, 12.6674f)
                curveTo(15.3589f, 12.2192f, 13.9757f, 11.75f, 12.0f, 11.75f)
                curveTo(10.0243f, 11.75f, 8.6411f, 12.2192f, 7.7672f, 12.6674f)
                curveTo(7.3285f, 12.8924f, 7.0142f, 13.1141f, 6.8154f, 13.2732f)
                curveTo(6.716f, 13.3527f, 6.6455f, 13.4165f, 6.6028f, 13.4572f)
                curveTo(6.5815f, 13.4775f, 6.5671f, 13.492f, 6.5596f, 13.4997f)
                lineTo(6.5537f, 13.5059f)
                curveTo(6.2761f, 13.8098f, 5.8048f, 13.8333f, 5.4983f, 13.5575f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
