    ...
    get() {
        ...
        _sendTwiceSquare = Builder(name = "SendTwiceSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.0f, 7.75f)
                curveTo(17.4142f, 7.75f, 17.75f, 8.0858f, 17.75f, 8.5f)
                curveTo(17.75f, 8.9142f, 17.4142f, 9.25f, 17.0f, 9.25f)
                horizontalLineTo(12.0715f)
                lineTo(13.4801f, 10.4238f)
                curveTo(13.7983f, 10.689f, 13.8413f, 11.1619f, 13.5762f, 11.4801f)
                curveTo(13.311f, 11.7983f, 12.8381f, 11.8413f, 12.5199f, 11.5762f)
                lineTo(9.5199f, 9.0762f)
                curveTo(9.3489f, 8.9337f, 9.25f, 8.7226f, 9.25f, 8.5f)
                curveTo(9.25f, 8.2774f, 9.3489f, 8.0663f, 9.5199f, 7.9238f)
                lineTo(12.5199f, 5.4238f)
                curveTo(12.8381f, 5.1587f, 13.311f, 5.2017f, 13.5762f, 5.5199f)
                curveTo(13.8413f, 5.8381f, 13.7983f, 6.311f, 13.4801f, 6.5762f)
                lineTo(12.0715f, 7.75f)
