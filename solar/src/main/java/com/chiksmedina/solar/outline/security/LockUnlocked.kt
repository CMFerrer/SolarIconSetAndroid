...
public val SecurityGroup.LockUnlocked: ImageVector
    get() {
        if (_lockUnlocked != null) {
            return _lockUnlocked!!
        }
        _lockUnlocked = Builder(name = "LockUnlocked", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(8.0f)
                close()
                moveTo(3.409f, 11.409f)
                curveTo(3.6858f, 11.1322f, 4.0743f, 10.9518f, 4.8081f, 10.8531f)
                curveTo(5.5635f, 10.7516f, 6.5646f, 10.75f, 8.0f, 10.75f)
                horizontalLineTo(16.0f)
                curveTo(17.4354f, 10.75f, 18.4365f, 10.7516f, 19.1919f, 10.8531f)
                curveTo(19.9257f, 10.9518f, 20.3142f, 11.1322f, 20.591f, 11.409f)
                curveTo(20.8678f, 11.6858f, 21.0482f, 12.0743f, 21.1469f, 12.8081f)
                curveTo(21.2484f, 13.5635f, 21.25f, 14.5646f, 21.25f, 16.0f)
                curveTo(21.25f, 17.4354f, 21.2484f, 18.4365f, 21.1469f, 19.1919f)
                curveTo(21.0482f, 19.9257f, 20.8678f, 20.3142f, 20.591f, 20.591f)
                curveTo(20.3142f, 20.8678f, 19.9257f, 21.0482f, 19.1919f, 21.1469f)
                curveTo(18.4365f, 21.2484f, 17.4354f, 21.25f, 16.0f, 21.25f)
                horizontalLineTo(8.0f)
                curveTo(6.5646f, 21.25f, 5.5635f, 21.2484f, 4.8081f, 21.1469f)
                curveTo(4.0743f, 21.0482f, 3.6858f, 20.8678f, 3.409f, 20.591f)
                curveTo(3.1323f, 20.3142f, 2.9518f, 19.9257f, 2.8531f, 19.1919f)
                curveTo(2.7516f, 18.4365f, 2.75f, 17.4354f, 2.75f, 16.0f)
                curveTo(2.75f, 14.5646f, 2.7516f, 13.5635f, 2.8531f, 12.8081f)
                curveTo(2.9518f, 12.0743f, 3.1323f, 11.6858f, 3.409f, 11.409f)
                close()
            }
        }
        .build()
