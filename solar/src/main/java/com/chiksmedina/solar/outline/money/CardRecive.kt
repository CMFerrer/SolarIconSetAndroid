...
public val MoneyGroup.CardRecive: ImageVector
    get() {
        if (_cardRecive != null) {
            return _cardRecive!!
        }
        _cardRecive = Builder(name = "CardRecive", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(20.4697f, 17.4697f)
                curveTo(20.7626f, 17.1768f, 21.2374f, 17.1768f, 21.5303f, 17.4697f)
                curveTo(21.8232f, 17.7626f, 21.8232f, 18.2374f, 21.5303f, 18.5303f)
                lineTo(19.5303f, 20.5303f)
                curveTo(19.2374f, 20.8232f, 18.7626f, 20.8232f, 18.4697f, 20.5303f)
                lineTo(16.4697f, 18.5303f)
                curveTo(16.1768f, 18.2374f, 16.1768f, 17.7626f, 16.4697f, 17.4697f)
                curveTo(16.7626f, 17.1768f, 17.2374f, 17.1768f, 17.5303f, 17.4697f)
                lineTo(18.25f, 18.1893f)
