...
public val EssentionalUiGroup.AugmentedReality: ImageVector
    get() {
        ...
        _augmentedReality = Builder(name = "AugmentedReality", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = EvenOdd) {
                moveTo(8.5f, 7.25f)
                curveTo(8.8281f, 7.25f, 9.118f, 7.4632f, 9.2159f, 7.7763f)
                lineTo(11.7159f, 15.7763f)
                curveTo(11.8394f, 16.1717f, 11.6191f, 16.5923f, 11.2237f, 16.7159f)
                curveTo(10.8284f, 16.8394f, 10.4077f, 16.6191f, 10.2842f, 16.2237f)
                lineTo(9.5736f, 13.95f)
                horizontalLineTo(7.4264f)
                lineTo(6.7159f, 16.2237f)
                curveTo(6.5923f, 16.6191f, 6.1717f, 16.8394f, 5.7763f, 16.7159f)
                curveTo(5.3809f, 16.5923f, 5.1606f, 16.1717f, 5.2842f, 15.7763f)
                lineTo(7.7842f, 7.7763f)
                curveTo(7.882f, 7.4632f, 8.172f, 7.25f, 8.5f, 7.25f)
                close()
                moveTo(7.8952f, 12.45f)
                horizontalLineTo(9.1049f)
                lineTo(8.5f, 10.5145f)
                lineTo(7.8952f, 12.45f)
                close()
                moveTo(13.25f, 8.0f)
                curveTo(13.25f, 7.5858f, 13.5858f, 7.25f, 14.0f, 7.25f)
                horizontalLineTo(16.0f)
                curveTo(17.5188f, 7.25f, 18.75f, 8.4812f, 18.75f, 10.0f)
                curveTo(18.75f, 11.2469f, 17.9202f, 12.3f, 16.7826f, 12.637f)
                lineTo(18.636f, 15.6025f)
                curveTo(18.8555f, 15.9538f, 18.7488f, 16.4165f, 18.3975f, 16.636f)
                curveTo(18.0463f, 16.8555f, 17.5836f, 16.7488f, 17.364f, 16.3975f)
