    ...
    get() {
        ...
        _bookBookmarkMinimalistic = Builder(name = "BookBookmarkMinimalistic", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(3.25f, 18.5248f, 3.25f, 17.4225f, 3.25f, 16.0549f)
                ...
                close()
                moveTo(6.25f, 2.9603f)
                curveTo(5.8579f, 3.0649f, 5.6053f, 3.2127f, 5.409f, 3.409f)
                curveTo(5.1322f, 3.6858f, 4.9518f, 4.0743f, 4.8531f, 4.8081f)
                curveTo(4.7516f, 5.5635f, 4.75f, 6.5646f, 4.75f, 8.0f)
                verticalLineTo(15.9259f)
                curveTo(5.1022f, 15.6798f, 5.4992f, 15.4925f, 5.9272f, 15.3778f)
                curveTo(6.0305f, 15.3501f, 6.1375f, 15.3284f, 6.25f, 15.3114f)
                verticalLineTo(2.9603f)
                close()
                moveTo(7.75f, 2.7768f)
                ...
                curveTo(10.5011f, 18.6024f, 10.5041f, 18.6009f, 10.5081f, 18.5989f)
