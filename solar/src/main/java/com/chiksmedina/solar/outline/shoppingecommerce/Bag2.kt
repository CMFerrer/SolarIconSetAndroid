...
val ShoppingEcommerceGroup.Bag2: ImageVector
    get() {
        if (_bag2 != null) {
            return _bag2!!
        }
        _bag2 = Builder(
            name = "Bag2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                curveTo(7.6792f, 22.75f, 9.3973f, 22.75f, 11.5774f, 22.75f)
                ...
                close()
                moveTo(9.1233f, 10.2602f)
                curveTo(9.5319f, 10.3283f, 9.8079f, 10.7147f, 9.7398f, 11.1233f)
                lineTo(8.7398f, 17.1233f)
                curveTo(8.6717f, 17.5319f, 8.2853f, 17.8079f, 7.8767f, 17.7398f)
                curveTo(7.4681f, 17.6717f, 7.1921f, 17.2853f, 7.2602f, 16.8767f)
                lineTo(8.2602f, 10.8767f)
                curveTo(8.3283f, 10.4681f, 8.7147f, 10.1921f, 9.1233f, 10.2602f)
                close()
                moveTo(14.8767f, 10.2602f)
                curveTo(15.2853f, 10.1921f, 15.6717f, 10.4681f, 15.7398f, 10.8767f)
                lineTo(16.7398f, 16.8767f)
                curveTo(16.8079f, 17.2853f, 16.5319f, 17.6717f, 16.1233f, 17.7398f)
                curveTo(15.7147f, 17.8079f, 15.3283f, 17.5319f, 15.2602f, 17.1233f)
                lineTo(14.2602f, 11.1233f)
                curveTo(14.1921f, 10.7147f, 14.4681f, 10.3283f, 14.8767f, 10.2602f)
                close()
            }
        }
            .build()
