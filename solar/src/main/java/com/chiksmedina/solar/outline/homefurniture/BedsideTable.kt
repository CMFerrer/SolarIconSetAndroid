...
public val HomeFurnitureGroup.BedsideTable: ImageVector
    get() {
        if (_bedsideTable != null) {
            return _bedsideTable!!
        }
        _bedsideTable = Builder(name = "BedsideTable", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(22.6873f, 6.1838f, 22.7244f, 6.9671f, 22.7395f, 7.8743f)
                curveTo(22.7464f, 7.9152f, 22.75f, 7.9572f, 22.75f, 8.0f)
                curveTo(22.75f, 8.0352f, 22.7476f, 8.0699f, 22.7429f, 8.1039f)
                curveTo(22.75f, 8.6696f, 22.75f, 9.2818f, 22.75f, 9.9436f)
                verticalLineTo(12.0564f)
                curveTo(22.75f, 12.7182f, 22.75f, 13.3304f, 22.7429f, 13.8961f)
                curveTo(22.7476f, 13.9301f, 22.75f, 13.9648f, 22.75f, 14.0f)
                curveTo(22.75f, 14.0428f, 22.7464f, 14.0848f, 22.7395f, 14.1257f)
                curveTo(22.7244f, 15.0329f, 22.6873f, 15.8162f, 22.5969f, 16.489f)
                ...
                curveTo(1.3127f, 15.8162f, 1.2756f, 15.0329f, 1.2605f, 14.1257f)
                curveTo(1.2536f, 14.0848f, 1.25f, 14.0428f, 1.25f, 14.0f)
                curveTo(1.25f, 13.9648f, 1.2524f, 13.9301f, 1.2571f, 13.8961f)
                curveTo(1.25f, 13.3304f, 1.25f, 12.7182f, 1.25f, 12.0564f)
                ...
                curveTo(2.75f, 12.4459f, 2.7501f, 12.8616f, 2.752f, 13.25f)
                horizontalLineTo(21.248f)
                curveTo(21.2499f, 12.8616f, 21.25f, 12.4459f, 21.25f, 12.0f)
                verticalLineTo(10.0f)
                curveTo(21.25f, 9.5541f, 21.2499f, 9.1384f, 21.248f, 8.75f)
                horizontalLineTo(2.752f)
                close()
                moveTo(21.2239f, 7.25f)
                ...
                curveTo(21.1701f, 6.1563f, 21.2044f, 6.6633f, 21.2239f, 7.25f)
                close()
                moveTo(21.2239f, 14.75f)
                horizontalLineTo(2.7761f)
                curveTo(2.7956f, 15.3367f, 2.8299f, 15.8437f, 2.8898f, 16.2892f)
                ...
                curveTo(21.1701f, 15.8437f, 21.2044f, 15.3367f, 21.2239f, 14.75f)
                close()
            }
        }
        .build()
