...
public val UsersGroup.UserCross: ImageVector
    get() {
        if (_userCross != null) {
            return _userCross!!
        }
        _userCross = Builder(name = "UserCross", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.1968f, 14.1363f)
                curveTo(16.904f, 13.8434f, 16.4291f, 13.8434f, 16.1362f, 14.1363f)
                curveTo(15.8433f, 14.4292f, 15.8433f, 14.9041f, 16.1362f, 15.197f)
                lineTo(16.9394f, 16.0002f)
                lineTo(16.1365f, 16.803f)
                curveTo(15.8436f, 17.0959f, 15.8436f, 17.5708f, 16.1365f, 17.8637f)
                curveTo(16.4294f, 18.1565f, 16.9043f, 18.1565f, 17.1972f, 17.8637f)
                lineTo(18.0f, 17.0608f)
                lineTo(18.8029f, 17.8637f)
                curveTo(19.0957f, 18.1565f, 19.5706f, 18.1565f, 19.8635f, 17.8637f)
                curveTo(20.1564f, 17.5708f, 20.1564f, 17.0959f, 19.8635f, 16.803f)
                lineTo(19.0607f, 16.0002f)
                lineTo(19.8638f, 15.197f)
                curveTo(20.1567f, 14.9041f, 20.1567f, 14.4292f, 19.8638f, 14.1363f)
                curveTo(19.5709f, 13.8434f, 19.0961f, 13.8434f, 18.8032f, 14.1363f)
                lineTo(18.0f, 14.9395f)
                lineTo(17.1968f, 14.1363f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(12.0f, 12.25f)
                curveTo(12.9685f, 12.25f, 13.9019f, 12.3421f, 14.7747f, 12.5129f)
                curveTo(15.6217f, 11.7291f, 16.7549f, 11.25f, 18.0f, 11.25f)
                curveTo(20.6234f, 11.25f, 22.75f, 13.3766f, 22.75f, 16.0f)
                curveTo(22.75f, 17.7601f, 21.7927f, 19.2966f, 20.3704f, 20.1172f)
