    ...
    get() {
        ...
        _fileDownload = Builder(
            ...
            path(
                ...
                moveTo(7.9871f, 19.0472f)
                curveTo(8.2755f, 19.3177f, 8.7245f, 19.3177f, 9.013f, 19.0472f)
                lineTo(11.013f, 17.1722f)
                curveTo(11.3151f, 16.8889f, 11.3305f, 16.4143f, 11.0472f, 16.1121f)
                curveTo(10.7639f, 15.8099f, 10.2892f, 15.7946f, 9.9871f, 16.0779f)
                lineTo(9.25f, 16.7689f)
                verticalLineTo(13.5001f)
                curveTo(9.25f, 13.0858f, 8.9142f, 12.7501f, 8.5f, 12.7501f)
                curveTo(8.0858f, 12.7501f, 7.75f, 13.0858f, 7.75f, 13.5001f)
                verticalLineTo(16.7689f)
                lineTo(7.013f, 16.0779f)
                curveTo(6.7108f, 15.7946f, 6.2361f, 15.8099f, 5.9528f, 16.1121f)
                curveTo(5.6695f, 16.4143f, 5.6849f, 16.8889f, 5.9871f, 17.1722f)
                lineTo(7.9871f, 19.0472f)
                close()
            }
        }
            .build()
