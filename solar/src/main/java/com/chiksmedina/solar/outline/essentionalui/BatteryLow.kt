...
public val EssentionalUiGroup.BatteryLow: ImageVector
    get() {
        if (_batteryLow != null) {
            return _batteryLow!!
        }
        _batteryLow = Builder(name = "BatteryLow", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.4167f, 14.4608f, 6.4691f, 14.3135f, 6.5235f, 14.1012f)
                curveTo(6.6322f, 13.6772f, 6.75f, 12.9899f, 6.75f, 12.0f)
                curveTo(6.75f, 11.0101f, 6.6322f, 10.3228f, 6.5235f, 9.8988f)
                curveTo(6.4691f, 9.6865f, 6.4167f, 9.5392f, 6.3818f, 9.452f)
