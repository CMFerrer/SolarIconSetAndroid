...
public val EssentionalUiGroup.Explicit: ImageVector
    get() {
        if (_explicit != null) {
            return _explicit!!
        }
        _explicit = Builder(name = "Explicit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(10.0f, 6.25f)
                curveTo(9.0335f, 6.25f, 8.25f, 7.0335f, 8.25f, 8.0f)
                verticalLineTo(16.0f)
                curveTo(8.25f, 16.9665f, 9.0335f, 17.75f, 10.0f, 17.75f)
                horizontalLineTo(15.0f)
                curveTo(15.4142f, 17.75f, 15.75f, 17.4142f, 15.75f, 17.0f)
                curveTo(15.75f, 16.5858f, 15.4142f, 16.25f, 15.0f, 16.25f)
                horizontalLineTo(10.0f)
                curveTo(9.8619f, 16.25f, 9.75f, 16.1381f, 9.75f, 16.0f)
                ...
                verticalLineTo(8.0f)
                curveTo(9.75f, 7.8619f, 9.8619f, 7.75f, 10.0f, 7.75f)
                horizontalLineTo(15.0f)
