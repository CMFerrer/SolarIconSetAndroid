    ...
    get() {
        ...
        _widget2 = Builder(name = "Widget2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.2949f, 9.75f, 9.75f, 8.2949f, 9.75f, 6.5f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = EvenOdd) {
                moveTo(12.75f, 17.5f)
                curveTo(12.75f, 14.8767f, 14.8767f, 12.75f, 17.5f, 12.75f)
                curveTo(20.1234f, 12.75f, 22.25f, 14.8767f, 22.25f, 17.5f)
                curveTo(22.25f, 20.1234f, 20.1234f, 22.25f, 17.5f, 22.25f)
                curveTo(14.8767f, 22.25f, 12.75f, 20.1234f, 12.75f, 17.5f)
                close()
                moveTo(17.5f, 14.25f)
                curveTo(15.7051f, 14.25f, 14.25f, 15.7051f, 14.25f, 17.5f)
