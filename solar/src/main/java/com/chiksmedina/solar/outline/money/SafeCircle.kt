    ...
    get() {
        ...
        _safeCircle = Builder(name = "SafeCircle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.0f, 10.75f)
                curveTo(13.3096f, 10.75f, 12.75f, 11.3096f, 12.75f, 12.0f)
                curveTo(12.75f, 12.6904f, 13.3096f, 13.25f, 14.0f, 13.25f)
                curveTo(14.6904f, 13.25f, 15.25f, 12.6904f, 15.25f, 12.0f)
                curveTo(15.25f, 11.3096f, 14.6904f, 10.75f, 14.0f, 10.75f)
                close()
            }
        }
        .build()
