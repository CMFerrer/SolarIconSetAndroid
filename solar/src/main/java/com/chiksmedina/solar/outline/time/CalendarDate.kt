    ...
    get() {
        ...
        _calendarDate = Builder(name = "CalendarDate", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.25f, 14.0f)
                curveTo(12.25f, 13.0335f, 13.0335f, 12.25f, 14.0f, 12.25f)
                curveTo(14.9665f, 12.25f, 15.75f, 13.0335f, 15.75f, 14.0f)
                verticalLineTo(16.0f)
                curveTo(15.75f, 16.9665f, 14.9665f, 17.75f, 14.0f, 17.75f)
                curveTo(13.0335f, 17.75f, 12.25f, 16.9665f, 12.25f, 16.0f)
                verticalLineTo(14.0f)
                close()
            }
        }
