    ...
    get() {
        ...
        _cartCross = Builder(name = "CartCross", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0304f, 8.9699f)
                curveTo(11.7375f, 8.677f, 11.2626f, 8.677f, 10.9697f, 8.9699f)
                curveTo(10.6768f, 9.2628f, 10.6768f, 9.7376f, 10.9697f, 10.0305f)
                lineTo(11.9394f, 11.0002f)
                lineTo(10.9697f, 11.9699f)
                curveTo(10.6768f, 12.2628f, 10.6768f, 12.7376f, 10.9697f, 13.0305f)
                curveTo(11.2626f, 13.3234f, 11.7375f, 13.3234f, 12.0304f, 13.0305f)
                lineTo(13.0f, 12.0609f)
                lineTo(13.9697f, 13.0305f)
                curveTo(14.2626f, 13.3234f, 14.7375f, 13.3234f, 15.0304f, 13.0305f)
                curveTo(15.3232f, 12.7376f, 15.3232f, 12.2628f, 15.0304f, 11.9699f)
                lineTo(14.0607f, 11.0002f)
                lineTo(15.0304f, 10.0305f)
                curveTo(15.3232f, 9.7376f, 15.3232f, 9.2628f, 15.0304f, 8.9699f)
                curveTo(14.7375f, 8.677f, 14.2626f, 8.677f, 13.9697f, 8.9699f)
                lineTo(13.0f, 9.9395f)
                lineTo(12.0304f, 8.9699f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
