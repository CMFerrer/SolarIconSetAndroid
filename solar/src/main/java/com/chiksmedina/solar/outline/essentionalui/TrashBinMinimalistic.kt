    ...
    get() {
        ...
        _trashBinMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(11.0214f, 2.75f, 10.187f, 3.375f, 9.8778f, 4.2499f)
                curveTo(9.7397f, 4.6405f, 9.3112f, 4.8452f, 8.9207f, 4.7071f)
            ...
            path(
                ...
                curveTo(5.8874f, 8.0368f, 5.5301f, 7.7241f, 5.1168f, 7.7517f)
                curveTo(4.7035f, 7.7792f, 4.3908f, 8.1366f, 4.4183f, 8.5499f)
                lineTo(4.8818f, 15.5016f)
                curveTo(4.9673f, 16.7844f, 5.0363f, 17.8205f, 5.1983f, 18.6336f)
                curveTo(5.3667f, 19.4789f, 5.6531f, 20.185f, 6.2447f, 20.7384f)
                curveTo(6.8363f, 21.2919f, 7.5599f, 21.5307f, 8.4145f, 21.6425f)
                curveTo(9.2365f, 21.75f, 10.275f, 21.75f, 11.5606f, 21.75f)
                horizontalLineTo(12.4394f)
                curveTo(13.725f, 21.75f, 14.7634f, 21.75f, 15.5855f, 21.6425f)
                curveTo(16.4401f, 21.5307f, 17.1637f, 21.2919f, 17.7553f, 20.7384f)
                curveTo(18.3469f, 20.185f, 18.6333f, 19.4789f, 18.8017f, 18.6336f)
                curveTo(18.9637f, 17.8205f, 19.0327f, 16.7844f, 19.1182f, 15.5016f)
                lineTo(19.5817f, 8.5499f)
                curveTo(19.6092f, 8.1366f, 19.2965f, 7.7792f, 18.8832f, 7.7517f)
                ...
                curveTo(17.1942f, 19.025f, 17.0039f, 19.3873f, 16.7305f, 19.6431f)
                curveTo(16.4571f, 19.8988f, 16.0829f, 20.0647f, 15.3909f, 20.1552f)
                ...
                curveTo(7.917f, 20.0647f, 7.5429f, 19.8988f, 7.2695f, 19.6431f)
                curveTo(6.9961f, 19.3873f, 6.8057f, 19.025f, 6.6694f, 18.3405f)
            ...
            path(
                ...
                curveTo(9.8375f, 10.2125f, 10.2051f, 10.5132f, 10.2463f, 10.9254f)
                lineTo(10.7463f, 15.9254f)
                curveTo(10.7875f, 16.3375f, 10.4868f, 16.7051f, 10.0746f, 16.7463f)
                curveTo(9.6625f, 16.7875f, 9.2949f, 16.4868f, 9.2537f, 16.0746f)
                lineTo(8.7537f, 11.0746f)
                curveTo(8.7125f, 10.6625f, 9.0132f, 10.2949f, 9.4254f, 10.2537f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(15.2463f, 11.0746f)
                curveTo(15.2875f, 10.6625f, 14.9868f, 10.2949f, 14.5746f, 10.2537f)
                curveTo(14.1625f, 10.2125f, 13.7949f, 10.5132f, 13.7537f, 10.9254f)
                lineTo(13.2537f, 15.9254f)
                curveTo(13.2125f, 16.3375f, 13.5132f, 16.7051f, 13.9254f, 16.7463f)
                curveTo(14.3375f, 16.7875f, 14.7051f, 16.4868f, 14.7463f, 16.0746f)
                lineTo(15.2463f, 11.0746f)
                close()
            }
        }
            .build()
