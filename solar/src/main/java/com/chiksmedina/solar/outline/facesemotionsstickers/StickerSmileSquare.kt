    ...
    get() {
        ...
        _stickerSmileSquare = Builder(name = "StickerSmileSquare", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.7065f, 17.6845f, 14.9576f, 17.1816f, 15.2724f, 16.7269f)
                curveTo(14.3337f, 17.3721f, 13.2092f, 17.75f, 12.0f, 17.75f)
                ...
                curveTo(15.7327f, 15.7291f, 15.7748f, 15.9429f, 15.7365f, 16.1419f)
                curveTo(16.4015f, 15.4071f, 17.2544f, 14.8462f, 18.2232f, 14.5314f)
