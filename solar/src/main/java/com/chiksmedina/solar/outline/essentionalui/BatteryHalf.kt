...
public val EssentionalUiGroup.BatteryHalf: ImageVector
    get() {
        if (_batteryHalf != null) {
            return _batteryHalf!!
        }
        _batteryHalf = Builder(name = "BatteryHalf", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.4167f, 9.5392f, 6.4691f, 9.6865f, 6.5235f, 9.8988f)
                curveTo(6.6322f, 10.3228f, 6.75f, 11.0101f, 6.75f, 12.0f)
                curveTo(6.75f, 12.9899f, 6.6322f, 13.6772f, 6.5235f, 14.1012f)
                curveTo(6.4691f, 14.3135f, 6.4167f, 14.4608f, 6.3818f, 14.548f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(10.5f, 9.0f)
                curveTo(11.1556f, 8.6358f, 11.1555f, 8.6354f, 11.1556f, 8.6358f)
                lineTo(11.1564f, 8.6371f)
                ...
                curveTo(11.3334f, 9.0421f, 11.4059f, 9.251f, 11.4765f, 9.5262f)
                curveTo(11.6178f, 10.0772f, 11.75f, 10.8899f, 11.75f, 12.0f)
                curveTo(11.75f, 13.1101f, 11.6178f, 13.9228f, 11.4765f, 14.4738f)
                curveTo(11.4059f, 14.749f, 11.3334f, 14.9579f, 11.2745f, 15.1051f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.1659f, 15.9756f, 20.2038f, 15.3979f, 20.2246f, 14.7499f)
                curveTo(20.5874f, 14.7492f, 20.9197f, 14.744f, 21.1972f, 14.7067f)
                curveTo(21.5527f, 14.6589f, 21.9284f, 14.5465f, 22.2374f, 14.2374f)
                curveTo(22.5465f, 13.9284f, 22.6589f, 13.5527f, 22.7067f, 13.1972f)
                curveTo(22.7501f, 12.8744f, 22.7501f, 12.4776f, 22.75f, 12.0447f)
                verticalLineTo(11.9552f)
                curveTo(22.7501f, 11.5224f, 22.7501f, 11.1256f, 22.7067f, 10.8028f)
                curveTo(22.6589f, 10.4473f, 22.5465f, 10.0716f, 22.2374f, 9.7626f)
                curveTo(21.9284f, 9.4535f, 21.5527f, 9.3411f, 21.1972f, 9.2933f)
                curveTo(20.9197f, 9.256f, 20.5874f, 9.2508f, 20.2246f, 9.2501f)
                curveTo(20.2038f, 8.6021f, 20.1659f, 8.0244f, 20.0969f, 7.511f)
                ...
                close()
                moveTo(20.75f, 13.2406f)
                verticalLineTo(10.7594f)
                curveTo(20.845f, 10.7638f, 20.9259f, 10.7703f, 20.9973f, 10.7799f)
                curveTo(21.0939f, 10.7929f, 21.1423f, 10.8082f, 21.164f, 10.8172f)
                curveTo(21.1691f, 10.8192f, 21.1724f, 10.8209f, 21.1743f, 10.8219f)
                lineTo(21.1768f, 10.8232f)
                lineTo(21.1781f, 10.8257f)
                curveTo(21.1791f, 10.8276f, 21.1808f, 10.8309f, 21.1828f, 10.836f)
                curveTo(21.1918f, 10.8577f, 21.2071f, 10.9061f, 21.2201f, 11.0027f)
                curveTo(21.2484f, 11.2134f, 21.25f, 11.5074f, 21.25f, 12.0f)
                curveTo(21.25f, 12.4926f, 21.2484f, 12.7866f, 21.2201f, 12.9973f)
                curveTo(21.2071f, 13.0939f, 21.1918f, 13.1423f, 21.1828f, 13.164f)
                curveTo(21.1808f, 13.1691f, 21.1791f, 13.1724f, 21.1781f, 13.1743f)
                lineTo(21.1768f, 13.1768f)
                lineTo(21.1743f, 13.1781f)
                curveTo(21.1724f, 13.1791f, 21.1691f, 13.1808f, 21.164f, 13.1828f)
                curveTo(21.1423f, 13.1918f, 21.0939f, 13.2071f, 20.9973f, 13.2201f)
                curveTo(20.9259f, 13.2297f, 20.845f, 13.2362f, 20.75f, 13.2406f)
                close()
            }
        }
        .build()
