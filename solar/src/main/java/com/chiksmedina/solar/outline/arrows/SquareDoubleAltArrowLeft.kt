...
public val ArrowsGroup.SquareDoubleAltArrowLeft: ImageVector
    get() {
        if (_squareDoubleAltArrowLeft != null) {
            return _squareDoubleAltArrowLeft!!
        }
        _squareDoubleAltArrowLeft = Builder(name = "SquareDoubleAltArrowLeft", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.3232f, 8.7626f, 16.3232f, 9.2374f, 16.0303f, 9.5303f)
                lineTo(13.5607f, 12.0f)
                lineTo(16.0303f, 14.4697f)
                curveTo(16.3232f, 14.7626f, 16.3232f, 15.2374f, 16.0303f, 15.5303f)
                curveTo(15.7374f, 15.8232f, 15.2626f, 15.8232f, 14.9697f, 15.5303f)
                lineTo(11.9697f, 12.5303f)
                curveTo(11.6768f, 12.2374f, 11.6768f, 11.7626f, 11.9697f, 11.4697f)
                lineTo(14.9697f, 8.4697f)
