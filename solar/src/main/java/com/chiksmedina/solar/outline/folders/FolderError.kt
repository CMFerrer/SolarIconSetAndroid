...
public val FoldersGroup.FolderError: ImageVector
    get() {
        if (_folderError != null) {
            return _folderError!!
        }
        _folderError = Builder(name = "FolderError", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.5455f, 2.4848f, 10.7054f, 2.6448f, 10.9539f, 2.8933f)
                lineTo(11.5303f, 3.4697f)
                curveTo(12.376f, 4.3154f, 12.7012f, 4.6311f, 13.0767f, 4.8401f)
                ...
                curveTo(20.2054f, 5.4578f, 20.9203f, 5.6836f, 21.5077f, 6.2119f)
                ...
                curveTo(10.2625f, 11.1768f, 10.7374f, 11.1768f, 11.0303f, 11.4697f)
                lineTo(12.0f, 12.4394f)
                lineTo(12.9697f, 11.4697f)
                curveTo(13.2625f, 11.1768f, 13.7374f, 11.1768f, 14.0303f, 11.4697f)
                curveTo(14.3232f, 11.7626f, 14.3232f, 12.2375f, 14.0303f, 12.5303f)
                lineTo(13.0606f, 13.5f)
                lineTo(14.0303f, 14.4697f)
                curveTo(14.3232f, 14.7626f, 14.3232f, 15.2375f, 14.0303f, 15.5303f)
                curveTo(13.7374f, 15.8232f, 13.2625f, 15.8232f, 12.9697f, 15.5303f)
                lineTo(12.0f, 14.5607f)
                lineTo(11.0303f, 15.5303f)
                curveTo(10.7374f, 15.8232f, 10.2625f, 15.8232f, 9.9697f, 15.5303f)
                curveTo(9.6768f, 15.2375f, 9.6768f, 14.7626f, 9.9697f, 14.4697f)
                lineTo(10.9393f, 13.5f)
                lineTo(9.9697f, 12.5303f)
                curveTo(9.6768f, 12.2375f, 9.6768f, 11.7626f, 9.9697f, 11.4697f)
                close()
            }
        }
        .build()
