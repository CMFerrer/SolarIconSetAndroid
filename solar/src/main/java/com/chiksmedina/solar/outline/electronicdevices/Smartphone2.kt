    ...
    get() {
        ...
        _smartphone2 = Builder(name = "Smartphone2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 15.75f)
                curveTo(11.3096f, 15.75f, 10.75f, 16.3096f, 10.75f, 17.0f)
                curveTo(10.75f, 17.6904f, 11.3096f, 18.25f, 12.0f, 18.25f)
                curveTo(12.6904f, 18.25f, 13.25f, 17.6904f, 13.25f, 17.0f)
                curveTo(13.25f, 16.3096f, 12.6904f, 15.75f, 12.0f, 15.75f)
                close()
                moveTo(9.25f, 17.0f)
                curveTo(9.25f, 15.4812f, 10.4812f, 14.25f, 12.0f, 14.25f)
                curveTo(13.5188f, 14.25f, 14.75f, 15.4812f, 14.75f, 17.0f)
                curveTo(14.75f, 18.5188f, 13.5188f, 19.75f, 12.0f, 19.75f)
                curveTo(10.4812f, 19.75f, 9.25f, 18.5188f, 9.25f, 17.0f)
                close()
            }
        }
        .build()
