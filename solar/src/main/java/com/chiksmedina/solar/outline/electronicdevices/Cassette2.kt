...
public val ElectronicDevicesGroup.Cassette2: ImageVector
    get() {
        if (_cassette2 != null) {
            return _cassette2!!
        }
        _cassette2 = Builder(name = "Cassette2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.247f, 4.8841f, 18.2043f, 4.8787f, 18.161f, 4.8734f)
                lineTo(17.6614f, 6.2056f)
                curveTo(17.4381f, 6.8011f, 17.2492f, 7.305f, 17.0482f, 7.7009f)
                curveTo(16.8345f, 8.1219f, 16.5764f, 8.4859f, 16.1804f, 8.7603f)
                curveTo(15.7844f, 9.0347f, 15.353f, 9.1486f, 14.8838f, 9.2009f)
                curveTo(14.4425f, 9.25f, 13.9044f, 9.25f, 13.2684f, 9.25f)
                horizontalLineTo(10.7316f)
                curveTo(10.0956f, 9.25f, 9.5575f, 9.25f, 9.1162f, 9.2009f)
                curveTo(8.647f, 9.1486f, 8.2156f, 9.0347f, 7.8196f, 8.7603f)
                curveTo(7.4236f, 8.4859f, 7.1656f, 8.1219f, 6.9518f, 7.7009f)
                curveTo(6.7509f, 7.3051f, 6.5619f, 6.8012f, 6.3386f, 6.2056f)
                lineTo(5.839f, 4.8734f)
                curveTo(5.7958f, 4.8787f, 5.753f, 4.8841f, 5.7108f, 4.8898f)
                close()
                moveTo(7.4028f, 4.7714f)
                lineTo(7.7289f, 5.6411f)
                curveTo(7.9702f, 6.2846f, 8.1307f, 6.7094f, 8.2893f, 7.0219f)
                curveTo(8.4395f, 7.3177f, 8.5561f, 7.4457f, 8.674f, 7.5274f)
                curveTo(8.7919f, 7.6091f, 8.9527f, 7.6734f, 9.2824f, 7.7101f)
                curveTo(9.6307f, 7.7489f, 10.0848f, 7.75f, 10.772f, 7.75f)
                horizontalLineTo(13.228f)
                curveTo(13.9152f, 7.75f, 14.3692f, 7.7489f, 14.7176f, 7.7101f)
                curveTo(15.0473f, 7.6734f, 15.2081f, 7.6091f, 15.326f, 7.5274f)
                curveTo(15.4439f, 7.4457f, 15.5605f, 7.3177f, 15.7107f, 7.0219f)
                curveTo(15.8693f, 6.7094f, 16.0298f, 6.2846f, 16.2711f, 5.6411f)
                lineTo(16.5972f, 4.7714f)
                curveTo(15.8639f, 4.7505f, 15.0093f, 4.75f, 14.0f, 4.75f)
                horizontalLineTo(10.0f)
                curveTo(8.9907f, 4.75f, 8.1361f, 4.7505f, 7.4028f, 4.7714f)
                close()
                moveTo(5.25f, 13.75f)
                ...
                close()
                moveTo(8.25f, 12.25f)
                curveTo(7.4216f, 12.25f, 6.75f, 12.9216f, 6.75f, 13.75f)
                curveTo(6.75f, 14.5784f, 7.4216f, 15.25f, 8.25f, 15.25f)
                curveTo(9.0784f, 15.25f, 9.75f, 14.5784f, 9.75f, 13.75f)
                curveTo(9.75f, 12.9216f, 9.0784f, 12.25f, 8.25f, 12.25f)
                close()
            }
        }
        .build()
