    ...
    get() {
        ...
        _serverSquareCloud = Builder(name = "ServerSquareCloud", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.4142f, 20.25f, 13.75f, 20.5858f, 13.75f, 21.0f)
                curveTo(13.75f, 21.4142f, 13.4142f, 21.75f, 13.0f, 21.75f)
                ...
                close()
                moveTo(18.6667f, 15.75f)
                curveTo(18.0161f, 15.75f, 17.4167f, 16.3214f, 17.4167f, 17.1176f)
                curveTo(17.4167f, 17.1727f, 17.4196f, 17.2268f, 17.4253f, 17.2799f)
                curveTo(17.5456f, 17.3363f, 17.6599f, 17.4031f, 17.767f, 17.4791f)
                curveTo(18.105f, 17.7186f, 18.1847f, 18.1867f, 17.9452f, 18.5247f)
                curveTo(17.7057f, 18.8626f, 17.2376f, 18.9424f, 16.8997f, 18.7029f)
                curveTo(16.8191f, 18.6458f, 16.7305f, 18.6069f, 16.638f, 18.5876f)
                curveTo(16.5938f, 18.5784f, 16.5478f, 18.5735f, 16.5f, 18.5735f)
                curveTo(16.1256f, 18.5735f, 15.75f, 18.9079f, 15.75f, 19.4118f)
                curveTo(15.75f, 19.9157f, 16.1256f, 20.25f, 16.5f, 20.25f)
                horizontalLineTo(20.0f)
                curveTo(20.6505f, 20.25f, 21.25f, 19.6786f, 21.25f, 18.8824f)
                curveTo(21.25f, 18.258f, 20.8728f, 17.7594f, 20.3963f, 17.5848f)
                curveTo(20.2722f, 17.5394f, 20.1394f, 17.5147f, 20.0f, 17.5147f)
                curveTo(19.8579f, 17.5147f, 19.7224f, 17.5404f, 19.5962f, 17.5876f)
                curveTo(19.2083f, 17.7328f, 18.7761f, 17.536f, 18.6309f, 17.1481f)
                curveTo(18.4857f, 16.7601f, 18.6825f, 16.328f, 19.0705f, 16.1828f)
                curveTo(19.1988f, 16.1348f, 19.3315f, 16.0964f, 19.4677f, 16.0685f)
                curveTo(19.2454f, 15.8666f, 18.9617f, 15.75f, 18.6667f, 15.75f)
                close()
                moveTo(21.3208f, 16.3663f)
                curveTo(21.0086f, 15.1703f, 19.9636f, 14.25f, 18.6667f, 14.25f)
                curveTo(17.1081f, 14.25f, 15.9167f, 15.5749f, 15.9167f, 17.1176f)
                curveTo(15.9167f, 17.129f, 15.9167f, 17.1404f, 15.9169f, 17.1517f)
                curveTo(14.9353f, 17.4222f, 14.25f, 18.3594f, 14.25f, 19.4118f)
                curveTo(14.25f, 20.6622f, 15.2175f, 21.75f, 16.5f, 21.75f)
                horizontalLineTo(20.0f)
                curveTo(21.5586f, 21.75f, 22.75f, 20.4251f, 22.75f, 18.8824f)
                curveTo(22.75f, 17.8134f, 22.1848f, 16.8596f, 21.3208f, 16.3663f)
                close()
                moveTo(6.0f, 14.75f)
