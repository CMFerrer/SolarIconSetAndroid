    ...
    get() {
        ...
        _clapperboardPlay = Builder(
            ...
            path(
                ...
                close()
                moveTo(13.3682f, 11.9212f)
                lineTo(13.4699f, 11.9868f)
                curveTo(14.0897f, 12.3866f, 14.6263f, 12.7328f, 15.0004f, 13.0636f)
                curveTo(15.3983f, 13.4156f, 15.75f, 13.8686f, 15.75f, 14.5f)
                curveTo(15.75f, 15.1314f, 15.3983f, 15.5844f, 15.0004f, 15.9364f)
                curveTo(14.6263f, 16.2671f, 14.0897f, 16.6133f, 13.4699f, 17.0132f)
                lineTo(13.3682f, 17.0788f)
                curveTo(12.7421f, 17.4828f, 12.1979f, 17.834f, 11.7459f, 18.0347f)
                curveTo(11.2756f, 18.2435f, 10.673f, 18.394f, 10.0982f, 18.0289f)
                curveTo(9.5536f, 17.6828f, 9.3884f, 17.0922f, 9.3191f, 16.5722f)
                curveTo(9.2499f, 16.053f, 9.25f, 15.3674f, 9.25f, 14.5549f)
                verticalLineTo(14.4451f)
                curveTo(9.25f, 13.6326f, 9.2499f, 12.947f, 9.3191f, 12.4278f)
                curveTo(9.3884f, 11.9078f, 9.5536f, 11.3172f, 10.0982f, 10.9711f)
                curveTo(10.673f, 10.606f, 11.2756f, 10.7565f, 11.7459f, 10.9653f)
                curveTo(12.1979f, 11.166f, 12.7421f, 11.5172f, 13.3682f, 11.9212f)
                close()
                moveTo(10.8579f, 12.2517f)
                curveTo(10.8573f, 12.2509f, 10.862f, 12.2496f, 10.8737f, 12.2504f)
                curveTo(10.8644f, 12.2529f, 10.8585f, 12.2525f, 10.8579f, 12.2517f)
                close()
                moveTo(10.8971f, 12.2532f)
                curveTo(10.9373f, 12.2601f, 11.0119f, 12.2806f, 11.1372f, 12.3362f)
                curveTo(11.4688f, 12.4834f, 11.9134f, 12.7677f, 12.6073f, 13.2154f)
                curveTo(13.2907f, 13.6564f, 13.7285f, 13.9413f, 14.0066f, 14.1873f)
                curveTo(14.2627f, 14.4137f, 14.251f, 14.4932f, 14.25f, 14.4996f)
                curveTo(14.251f, 14.5061f, 14.2627f, 14.5863f, 14.0066f, 14.8127f)
                curveTo(13.7285f, 15.0587f, 13.2907f, 15.3436f, 12.6073f, 15.7846f)
                curveTo(11.9134f, 16.2323f, 11.4688f, 16.5166f, 11.1372f, 16.6638f)
                curveTo(11.0119f, 16.7194f, 10.9373f, 16.7399f, 10.8971f, 16.7468f)
                curveTo(10.8749f, 16.704f, 10.8362f, 16.6006f, 10.806f, 16.3741f)
                curveTo(10.7516f, 15.9662f, 10.75f, 15.3821f, 10.75f, 14.5f)
                curveTo(10.75f, 13.6179f, 10.7516f, 13.0338f, 10.806f, 12.6259f)
                curveTo(10.8362f, 12.3994f, 10.8749f, 12.296f, 10.8971f, 12.2532f)
                close()
                moveTo(10.8579f, 16.7483f)
                curveTo(10.8585f, 16.7475f, 10.8644f, 16.7472f, 10.8737f, 16.7496f)
                curveTo(10.862f, 16.7504f, 10.8573f, 16.7491f, 10.8579f, 16.7483f)
                close()
                moveTo(10.9101f, 16.7682f)
                curveTo(10.9135f, 16.7711f, 10.915f, 16.7731f, 10.9149f, 16.7733f)
                curveTo(10.9148f, 16.7736f, 10.9131f, 16.7722f, 10.9101f, 16.7682f)
                close()
                moveTo(10.9101f, 12.2318f)
                curveTo(10.9131f, 12.2278f, 10.9148f, 12.2264f, 10.9149f, 12.2267f)
                curveTo(10.915f, 12.2269f, 10.9135f, 12.2289f, 10.9101f, 12.2318f)
                close()
            }
        }
            .build()
