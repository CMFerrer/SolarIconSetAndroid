...
public val BusinessStatisticGroup.GraphDownNew: ImageVector
    get() {
        if (_graphDownNew != null) {
            return _graphDownNew!!
        }
        _graphDownNew = Builder(name = "GraphDownNew", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(6.4697f, 9.4697f)
                curveTo(6.7626f, 9.1768f, 7.2374f, 9.1768f, 7.5303f, 9.4697f)
                lineTo(9.8232f, 11.7626f)
                curveTo(9.9208f, 11.8602f, 10.0791f, 11.8602f, 10.1768f, 11.7626f)
                lineTo(11.7626f, 10.1768f)
                curveTo(12.446f, 9.4934f, 13.554f, 9.4934f, 14.2374f, 10.1768f)
                lineTo(16.25f, 12.1893f)
                verticalLineTo(11.5f)
                curveTo(16.25f, 11.0858f, 16.5858f, 10.75f, 17.0f, 10.75f)
                curveTo(17.4142f, 10.75f, 17.75f, 11.0858f, 17.75f, 11.5f)
                verticalLineTo(14.0f)
                curveTo(17.75f, 14.4142f, 17.4142f, 14.75f, 17.0f, 14.75f)
                horizontalLineTo(14.5f)
                curveTo(14.0858f, 14.75f, 13.75f, 14.4142f, 13.75f, 14.0f)
                curveTo(13.75f, 13.5858f, 14.0858f, 13.25f, 14.5f, 13.25f)
                horizontalLineTo(15.1893f)
                lineTo(13.1768f, 11.2374f)
                curveTo(13.0791f, 11.1398f, 12.9209f, 11.1398f, 12.8232f, 11.2374f)
                lineTo(11.2374f, 12.8232f)
                curveTo(10.554f, 13.5066f, 9.446f, 13.5066f, 8.7626f, 12.8232f)
                lineTo(6.4697f, 10.5303f)
                curveTo(6.1768f, 10.2374f, 6.1768f, 9.7626f, 6.4697f, 9.4697f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
