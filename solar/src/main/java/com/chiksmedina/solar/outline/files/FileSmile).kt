...
public val FilesGroup.`FileSmile)`: ImageVector
    get() {
        if (`_fileSmile)` != null) {
            return `_fileSmile)`!!
        }
        `_fileSmile)` = Builder(name = "FileSmile)", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.0f, 14.5001f)
                curveTo(18.0f, 15.3285f, 17.5523f, 16.0001f, 17.0f, 16.0001f)
                curveTo(16.4477f, 16.0001f, 16.0f, 15.3285f, 16.0f, 14.5001f)
                curveTo(16.0f, 13.6716f, 16.4477f, 13.0001f, 17.0f, 13.0001f)
                curveTo(17.5523f, 13.0001f, 18.0f, 13.6716f, 18.0f, 14.5001f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(8.376f, 17.084f)
                curveTo(8.6057f, 16.7394f, 9.0714f, 16.6462f, 9.416f, 16.876f)
                curveTo(10.9808f, 17.9192f, 13.0192f, 17.9192f, 14.584f, 16.876f)
                curveTo(14.9286f, 16.6462f, 15.3943f, 16.7394f, 15.624f, 17.084f)
                curveTo(15.8538f, 17.4287f, 15.7607f, 17.8943f, 15.416f, 18.1241f)
                curveTo(13.3474f, 19.5031f, 10.6526f, 19.5031f, 8.584f, 18.1241f)
                curveTo(8.2393f, 17.8943f, 8.1462f, 17.4287f, 8.376f, 17.084f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 14.5001f)
                curveTo(8.0f, 15.3285f, 7.5523f, 16.0001f, 7.0f, 16.0001f)
                curveTo(6.4477f, 16.0001f, 6.0f, 15.3285f, 6.0f, 14.5001f)
                curveTo(6.0f, 13.6716f, 6.4477f, 13.0001f, 7.0f, 13.0001f)
                curveTo(7.5523f, 13.0001f, 8.0f, 13.6716f, 8.0f, 14.5001f)
                close()
            }
        }
        .build()
