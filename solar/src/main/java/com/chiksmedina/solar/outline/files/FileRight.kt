...
val FilesGroup.FileRight: ImageVector
    get() {
        if (_fileRight != null) {
            return _fileRight!!
        }
        _fileRight = Builder(
            name = "FileRight", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                moveTo(11.5472f, 16.513f)
                curveTo(11.8176f, 16.2245f, 11.8176f, 15.7756f, 11.5472f, 15.4871f)
                lineTo(9.6721f, 13.4871f)
                curveTo(9.3889f, 13.1849f, 8.9142f, 13.1696f, 8.612f, 13.4529f)
                curveTo(8.3099f, 13.7362f, 8.2945f, 14.2108f, 8.5779f, 14.513f)
                lineTo(9.2688f, 15.25f)
                lineTo(6.0f, 15.2501f)
                curveTo(5.5858f, 15.2501f, 5.25f, 15.5858f, 5.25f, 16.0001f)
                curveTo(5.25f, 16.4143f, 5.5858f, 16.7501f, 6.0f, 16.7501f)
                horizontalLineTo(9.2688f)
                lineTo(8.5779f, 17.4871f)
                curveTo(8.2945f, 17.7893f, 8.3099f, 18.2639f, 8.612f, 18.5472f)
                curveTo(8.9142f, 18.8305f, 9.3889f, 18.8152f, 9.6721f, 18.513f)
