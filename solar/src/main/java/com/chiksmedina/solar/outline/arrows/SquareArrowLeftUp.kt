...
public val ArrowsGroup.SquareArrowLeftUp: ImageVector
    get() {
        if (_squareArrowLeftUp != null) {
            return _squareArrowLeftUp!!
        }
        _squareArrowLeftUp = Builder(name = "SquareArrowLeftUp", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.4216f, 9.1716f)
                curveTo(8.4216f, 8.7574f, 8.7574f, 8.4216f, 9.1716f, 8.4216f)
                horizontalLineTo(13.4142f)
                curveTo(13.8284f, 8.4216f, 14.1642f, 8.7574f, 14.1642f, 9.1716f)
                curveTo(14.1642f, 9.5858f, 13.8284f, 9.9216f, 13.4142f, 9.9216f)
                horizontalLineTo(10.9822f)
                lineTo(15.3588f, 14.2981f)
                curveTo(15.6517f, 14.591f, 15.6517f, 15.0659f, 15.3588f, 15.3588f)
                curveTo(15.0659f, 15.6517f, 14.591f, 15.6517f, 14.2981f, 15.3588f)
                lineTo(9.9216f, 10.9822f)
                verticalLineTo(13.4142f)
                curveTo(9.9216f, 13.8284f, 9.5858f, 14.1642f, 9.1716f, 14.1642f)
                curveTo(8.7574f, 14.1642f, 8.4216f, 13.8284f, 8.4216f, 13.4142f)
                verticalLineTo(9.1716f)
                close()
            }
        }
        .build()
