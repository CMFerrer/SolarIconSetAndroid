    ...
    get() {
        ...
        _plain3 = Builder(
            ...
            path(
                ...
                curveTo(8.7409f, 13.4206f, 9.1188f, 13.5464f, 9.4439f, 13.764f)
                curveTo(9.7572f, 13.9737f, 10.0263f, 14.2428f, 10.236f, 14.5561f)
                curveTo(10.4536f, 14.8812f, 10.5794f, 15.2592f, 10.7411f, 15.7453f)
                ...
                close()
                moveTo(17.6807f, 6.3253f)
                curveTo(17.9791f, 6.627f, 17.9764f, 7.1135f, 17.6747f, 7.4118f)
                lineTo(13.5771f, 11.4643f)
                curveTo(13.2754f, 11.7627f, 12.7889f, 11.76f, 12.4905f, 11.4583f)
                curveTo(12.1921f, 11.1566f, 12.1948f, 10.6701f, 12.4965f, 10.3718f)
                lineTo(16.5942f, 6.3193f)
                curveTo(16.8959f, 6.0209f, 17.3823f, 6.0236f, 17.6807f, 6.3253f)
                close()
            }
        }
            .build()
