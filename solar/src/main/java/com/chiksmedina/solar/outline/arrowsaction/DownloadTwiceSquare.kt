    ...
    get() {
        ...
        _downloadTwiceSquare = Builder(name = "DownloadTwiceSquare", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(16.25f, 7.0f)
                curveTo(16.25f, 6.5858f, 15.9142f, 6.25f, 15.5f, 6.25f)
                curveTo(15.0858f, 6.25f, 14.75f, 6.5858f, 14.75f, 7.0f)
                verticalLineTo(11.9285f)
                lineTo(13.5762f, 10.5199f)
                curveTo(13.311f, 10.2017f, 12.8381f, 10.1587f, 12.5199f, 10.4238f)
                curveTo(12.2017f, 10.689f, 12.1587f, 11.1619f, 12.4238f, 11.4801f)
                lineTo(14.9238f, 14.4801f)
                curveTo(15.0663f, 14.6511f, 15.2774f, 14.75f, 15.5f, 14.75f)
                curveTo(15.7226f, 14.75f, 15.9337f, 14.6511f, 16.0762f, 14.4801f)
                lineTo(18.5762f, 11.4801f)
                curveTo(18.8413f, 11.1619f, 18.7983f, 10.689f, 18.4801f, 10.4238f)
                curveTo(18.1619f, 10.1587f, 17.689f, 10.2017f, 17.4238f, 10.5199f)
