    ...
    get() {
        ...
        _cart2 = Builder(
            ...
            path(
                ...
                curveTo(3.1694f, 9.3299f, 3.5085f, 9.0627f, 3.896f, 8.8643f)
                lineTo(4.5239f, 6.5613f)
                curveTo(4.7609f, 5.6897f, 4.9332f, 5.0564f, 5.3001f, 4.5623f)
                curveTo(5.6638f, 4.0725f, 6.1581f, 3.6951f, 6.7262f, 3.473f)
                curveTo(7.2018f, 3.2871f, 7.7345f, 3.2557f, 8.4181f, 3.2508f)
                curveTo(8.6988f, 2.6591f, 9.3016f, 2.25f, 10.0f, 2.25f)
                horizontalLineTo(14.0f)
                curveTo(14.6984f, 2.25f, 15.3013f, 2.6591f, 15.582f, 3.2508f)
                curveTo(16.2655f, 3.2557f, 16.7983f, 3.2871f, 17.2738f, 3.473f)
                curveTo(17.842f, 3.6951f, 18.3362f, 4.0725f, 18.6999f, 4.5623f)
                curveTo(19.0669f, 5.0564f, 19.2391f, 5.6897f, 19.4762f, 6.5613f)
                lineTo(20.1041f, 8.8643f)
                curveTo(20.4915f, 9.0627f, 20.8306f, 9.33f, 21.1134f, 9.6922f)
                curveTo(21.7354f, 10.4888f, 21.8456f, 11.4377f, 21.7349f, 12.5261f)
                curveTo(21.6276f, 13.5822f, 21.2951f, 14.9121f, 20.8788f, 16.5769f)
                lineTo(20.8525f, 16.6824f)
                curveTo(20.5893f, 17.7352f, 20.3756f, 18.5901f, 20.1214f, 19.2572f)
                ...
                lineTo(12.0058f, 8.25f)
                curveTo(12.0022f, 8.25f, 11.9986f, 8.25f, 11.9951f, 8.25f)
                lineTo(9.6226f, 8.25f)
                ...
                close()
                moveTo(10.3987f, 9.75f)
                horizontalLineTo(9.6846f)
                curveTo(7.8923f, 9.75f, 6.6305f, 9.7519f, 5.6998f, 9.8865f)
                curveTo(5.5819f, 9.9036f, 5.4718f, 9.9224f, 5.369f, 9.9431f)
                lineTo(7.56f, 13.1565f)
                lineTo(10.3987f, 9.75f)
                close()
                moveTo(4.0389f, 10.655f)
                curveTo(3.7811f, 11.0086f, 3.6676f, 11.4919f, 3.7573f, 12.3744f)
                curveTo(3.8525f, 13.3099f, 4.1567f, 14.5345f, 4.5914f, 16.2733f)
                curveTo(4.6209f, 16.3913f, 4.6494f, 16.5054f, 4.6772f, 16.6159f)
                lineTo(6.5614f, 14.3548f)
                lineTo(4.0389f, 10.655f)
                close()
                moveTo(5.1596f, 18.38f)
                curveTo(5.1994f, 18.5018f, 5.2394f, 18.6159f, 5.2803f, 18.7231f)
                ...
                horizontalLineTo(10.5809f)
                lineTo(7.4401f, 15.6435f)
                lineTo(5.1596f, 18.38f)
                close()
                moveTo(13.4191f, 20.25f)
                lineTo(16.5725f, 15.625f)
                lineTo(18.8407f, 18.3791f)
                curveTo(18.8008f, 18.5013f, 18.7607f, 18.6156f, 18.7197f, 18.7231f)
                ...
                close()
                moveTo(19.3249f, 16.6075f)
                curveTo(19.352f, 16.4997f, 19.3798f, 16.3883f, 19.4086f, 16.2733f)
                curveTo(19.8433f, 14.5345f, 20.1475f, 13.3099f, 20.2426f, 12.3744f)
                curveTo(20.3323f, 11.492f, 20.2189f, 11.0086f, 19.9611f, 10.6551f)
                lineTo(17.4527f, 14.3341f)
                lineTo(19.3249f, 16.6075f)
                close()
                moveTo(18.6311f, 9.9431f)
                curveTo(18.5282f, 9.9224f, 18.4181f, 9.9036f, 18.3001f, 9.8865f)
                curveTo(17.3695f, 9.7519f, 16.1077f, 9.75f, 14.3153f, 9.75f)
                horizontalLineTo(13.6775f)
                lineTo(16.4595f, 13.1281f)
                lineTo(18.6311f, 9.9431f)
                close()
                moveTo(10.0f, 3.75f)
                ...
                close()
                moveTo(12.041f, 10.1224f)
                lineTo(15.5793f, 14.419f)
                lineTo(12.0f, 19.6686f)
                lineTo(8.4386f, 14.4452f)
                lineTo(12.041f, 10.1224f)
                close()
            }
        }
            .build()
