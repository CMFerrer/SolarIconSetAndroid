    ...
    get() {
        ...
        _listDownMinimalistic = Builder(name = "ListDownMinimalistic", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.8264f, 14.161f, 21.2999f, 14.1974f, 21.5694f, 14.5119f)
                curveTo(21.839f, 14.8264f, 21.8026f, 15.2999f, 21.4881f, 15.5694f)
                lineTo(17.9881f, 18.5694f)
                curveTo(17.7072f, 18.8102f, 17.2928f, 18.8102f, 17.0119f, 18.5694f)
                lineTo(13.5119f, 15.5694f)
