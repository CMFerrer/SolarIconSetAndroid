    ...
    get() {
        ...
        _login3 = Builder(
            ...
            path(
                ...
                moveTo(15.5303f, 12.5303f)
                curveTo(15.8232f, 12.2374f, 15.8232f, 11.7626f, 15.5303f, 11.4697f)
                lineTo(13.0303f, 8.9697f)
                curveTo(12.7374f, 8.6768f, 12.2626f, 8.6768f, 11.9697f, 8.9697f)
                curveTo(11.6768f, 9.2626f, 11.6768f, 9.7374f, 11.9697f, 10.0303f)
                lineTo(13.1893f, 11.25f)
                ...
                lineTo(11.9697f, 13.9697f)
                curveTo(11.6768f, 14.2626f, 11.6768f, 14.7374f, 11.9697f, 15.0303f)
                curveTo(12.2626f, 15.3232f, 12.7374f, 15.3232f, 13.0303f, 15.0303f)
            ...
            path(
                ...
                lineTo(7.25f, 8.0f)
                curveTo(7.25f, 8.4142f, 7.5858f, 8.75f, 8.0f, 8.75f)
                curveTo(8.4142f, 8.75f, 8.75f, 8.4142f, 8.75f, 8.0f)
                curveTo(8.75f, 6.5646f, 8.7516f, 5.5635f, 8.8532f, 4.8081f)
                curveTo(8.9518f, 4.0743f, 9.1322f, 3.6858f, 9.409f, 3.409f)
                curveTo(9.6858f, 3.1323f, 10.0743f, 2.9518f, 10.8081f, 2.8531f)
                curveTo(11.5635f, 2.7516f, 12.5646f, 2.75f, 14.0f, 2.75f)
                horizontalLineTo(15.0f)
                curveTo(16.4354f, 2.75f, 17.4365f, 2.7516f, 18.1919f, 2.8531f)
                curveTo(18.9257f, 2.9518f, 19.3142f, 3.1323f, 19.591f, 3.409f)
                curveTo(19.8678f, 3.6858f, 20.0482f, 4.0743f, 20.1469f, 4.8081f)
                curveTo(20.2484f, 5.5635f, 20.25f, 6.5646f, 20.25f, 8.0f)
                ...
                curveTo(12.5646f, 21.25f, 11.5635f, 21.2484f, 10.8081f, 21.1469f)
                curveTo(10.0743f, 21.0482f, 9.6858f, 20.8678f, 9.409f, 20.591f)
                curveTo(9.1322f, 20.3142f, 8.9518f, 19.9257f, 8.8532f, 19.1919f)
                curveTo(8.7516f, 18.4365f, 8.75f, 17.4354f, 8.75f, 16.0f)
                curveTo(8.75f, 15.5858f, 8.4142f, 15.25f, 8.0f, 15.25f)
                curveTo(7.5858f, 15.25f, 7.25f, 15.5858f, 7.25f, 16.0f)
                lineTo(7.25f, 16.0549f)
                close()
            }
        }
            .build()
