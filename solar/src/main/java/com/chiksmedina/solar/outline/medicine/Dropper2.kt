...
public val MedicineGroup.Dropper2: ImageVector
    get() {
        if (_dropper2 != null) {
            return _dropper2!!
        }
        _dropper2 = Builder(name = "Dropper2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(17.1752f, 10.1014f)
                curveTo(16.5324f, 9.4232f, 15.4676f, 9.4232f, 14.8248f, 10.1014f)
                curveTo(14.5172f, 10.426f, 14.1419f, 10.8566f, 13.8388f, 11.3157f)
                curveTo(13.5544f, 11.7466f, 13.25f, 12.3242f, 13.25f, 12.9166f)
                curveTo(13.25f, 14.4523f, 14.4527f, 15.7499f, 16.0f, 15.7499f)
                curveTo(17.5473f, 15.7499f, 18.75f, 14.4523f, 18.75f, 12.9166f)
                curveTo(18.75f, 12.3242f, 18.4456f, 11.7466f, 18.1612f, 11.3157f)
                curveTo(17.8581f, 10.8566f, 17.4828f, 10.426f, 17.1752f, 10.1014f)
                close()
                moveTo(15.9135f, 11.1333f)
                curveTo(15.9428f, 11.1024f, 15.9734f, 11.0928f, 16.0f, 11.0928f)
                curveTo(16.0266f, 11.0928f, 16.0572f, 11.1024f, 16.0865f, 11.1333f)
                curveTo(16.3651f, 11.4272f, 16.6744f, 11.7862f, 16.9093f, 12.1421f)
                curveTo(17.1629f, 12.5263f, 17.25f, 12.7891f, 17.25f, 12.9166f)
                curveTo(17.25f, 13.6821f, 16.6618f, 14.2499f, 16.0f, 14.2499f)
                curveTo(15.3382f, 14.2499f, 14.75f, 13.6821f, 14.75f, 12.9166f)
                curveTo(14.75f, 12.7891f, 14.8371f, 12.5263f, 15.0907f, 12.1421f)
                curveTo(15.3256f, 11.7862f, 15.6349f, 11.4272f, 15.9135f, 11.1333f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                close()
                moveTo(19.0f, 9.25f)
                horizontalLineTo(21.2482f)
                curveTo(21.244f, 8.6806f, 21.2299f, 8.2509f, 21.1835f, 7.9054f)
                ...
                curveTo(19.25f, 12.5858f, 19.5858f, 12.25f, 20.0f, 12.25f)
                horizontalLineTo(21.25f)
                verticalLineTo(10.75f)
                horizontalLineTo(19.0f)
                curveTo(18.5858f, 10.75f, 18.25f, 10.4142f, 18.25f, 10.0f)
                curveTo(18.25f, 9.5858f, 18.5858f, 9.25f, 19.0f, 9.25f)
                close()
            }
        }
        .build()
