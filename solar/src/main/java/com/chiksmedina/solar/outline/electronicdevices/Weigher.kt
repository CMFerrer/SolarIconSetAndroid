...
public val ElectronicDevicesGroup.Weigher: ImageVector
    get() {
        if (_weigher != null) {
            return _weigher!!
        }
        _weigher = Builder(name = "Weigher", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.7531f, 4.7808f)
                curveTo(10.9029f, 4.4225f, 13.0971f, 4.4225f, 15.2469f, 4.7808f)
                lineTo(15.6723f, 4.8517f)
                curveTo(17.404f, 5.1403f, 18.4255f, 6.9556f, 17.7735f, 8.5856f)
                lineTo(17.1079f, 10.2497f)
                curveTo(16.7328f, 11.1873f, 15.7228f, 11.7038f, 14.7431f, 11.4589f)
                curveTo(12.9421f, 11.0086f, 11.0579f, 11.0086f, 9.2569f, 11.4589f)
                curveTo(8.2772f, 11.7038f, 7.2672f, 11.1873f, 6.8921f, 10.2497f)
                lineTo(6.2265f, 8.5856f)
                curveTo(5.5745f, 6.9556f, 6.596f, 5.1403f, 8.3277f, 4.8517f)
                lineTo(8.7531f, 4.7808f)
                close()
                moveTo(15.0003f, 6.2604f)
                curveTo(13.0138f, 5.9293f, 10.9862f, 5.9293f, 8.9997f, 6.2604f)
                lineTo(8.5743f, 6.3313f)
                curveTo(7.7871f, 6.4625f, 7.3228f, 7.2876f, 7.6192f, 8.0285f)
                lineTo(8.2848f, 9.6926f)
                curveTo(8.3813f, 9.9338f, 8.6411f, 10.0666f, 8.8931f, 10.0036f)
                curveTo(9.0516f, 9.964f, 9.2107f, 9.9275f, 9.3703f, 9.894f)
                lineTo(8.7986f, 8.2994f)
                curveTo(8.6588f, 7.9095f, 8.8616f, 7.48f, 9.2515f, 7.3403f)
                curveTo(9.6414f, 7.2005f, 10.0708f, 7.4032f, 10.2106f, 7.7931f)
                lineTo(10.8835f, 9.6699f)
                curveTo(12.2954f, 9.5464f, 13.7228f, 9.6576f, 15.1069f, 10.0036f)
                curveTo(15.3589f, 10.0666f, 15.6187f, 9.9338f, 15.7152f, 9.6926f)
                lineTo(16.3808f, 8.0285f)
                curveTo(16.6772f, 7.2876f, 16.2128f, 6.4625f, 15.4257f, 6.3313f)
                lineTo(15.0003f, 6.2604f)
                close()
                moveTo(7.25f, 18.0f)
