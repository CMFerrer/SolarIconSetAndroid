...
public val ShoppingEcommerceGroup.Cart4: ImageVector
    get() {
        if (_cart4 != null) {
            return _cart4!!
        }
        _cart4 = Builder(name = "Cart4", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.3137f, 8.9256f, 20.4489f, 9.3881f, 20.3953f, 10.2502f)
                horizontalLineTo(3.6048f)
                curveTo(3.5512f, 9.3881f, 3.6864f, 8.9256f, 3.9612f, 8.5856f)
                curveTo(4.2408f, 8.2398f, 4.6745f, 8.0087f, 5.5584f, 7.8818f)
                curveTo(5.615f, 7.8737f, 5.6729f, 7.866f, 5.7321f, 7.8589f)
                close()
                moveTo(4.2885f, 14.1002f)
                curveTo(4.0915f, 13.1809f, 3.9267f, 12.4092f, 3.807f, 11.7502f)
                horizontalLineTo(20.1931f)
                curveTo(20.0734f, 12.4092f, 19.9086f, 13.1809f, 19.7116f, 14.1002f)
