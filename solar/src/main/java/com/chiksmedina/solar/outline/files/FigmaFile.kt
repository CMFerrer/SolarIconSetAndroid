...
public val FilesGroup.FigmaFile: ImageVector
    get() {
        if (_figmaFile != null) {
            return _figmaFile!!
        }
        _figmaFile = Builder(name = "FigmaFile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(4.25f, 11.5001f)
                curveTo(4.25f, 10.2574f, 5.2574f, 9.25f, 6.5f, 9.25f)
                horizontalLineTo(9.5f)
                curveTo(10.7426f, 9.25f, 11.75f, 10.2574f, 11.75f, 11.5001f)
                curveTo(11.75f, 12.0763f, 11.5334f, 12.602f, 11.1771f, 13.0001f)
                curveTo(11.5334f, 13.3981f, 11.75f, 13.9238f, 11.75f, 14.5001f)
                curveTo(11.75f, 15.7427f, 10.7426f, 16.7501f, 9.5f, 16.7501f)
                curveTo(9.237f, 16.7501f, 8.9846f, 16.7049f, 8.75f, 16.622f)
                verticalLineTo(17.5f)
                curveTo(8.75f, 18.7427f, 7.7426f, 19.75f, 6.5f, 19.75f)
                curveTo(5.2574f, 19.75f, 4.25f, 18.7427f, 4.25f, 17.5f)
                curveTo(4.25f, 16.9238f, 4.4666f, 16.3981f, 4.8229f, 16.0001f)
                curveTo(4.4666f, 15.602f, 4.25f, 15.0763f, 4.25f, 14.5001f)
                curveTo(4.25f, 13.9238f, 4.4666f, 13.3981f, 4.8229f, 13.0001f)
                curveTo(4.4666f, 12.602f, 4.25f, 12.0763f, 4.25f, 11.5001f)
                close()
                moveTo(6.5f, 13.7501f)
                curveTo(6.0858f, 13.7501f, 5.75f, 14.0858f, 5.75f, 14.5001f)
                curveTo(5.75f, 14.9143f, 6.0858f, 15.2501f, 6.5f, 15.2501f)
                horizontalLineTo(7.25f)
                verticalLineTo(13.7501f)
                horizontalLineTo(6.5f)
                close()
                moveTo(7.25f, 12.2501f)
                horizontalLineTo(6.5f)
                curveTo(6.0858f, 12.2501f, 5.75f, 11.9143f, 5.75f, 11.5001f)
                curveTo(5.75f, 11.0858f, 6.0858f, 10.7501f, 6.5f, 10.7501f)
                horizontalLineTo(7.25f)
                verticalLineTo(12.2501f)
                close()
                moveTo(9.5f, 12.2501f)
                curveTo(9.9142f, 12.2501f, 10.25f, 11.9143f, 10.25f, 11.5001f)
                curveTo(10.25f, 11.0858f, 9.9142f, 10.7501f, 9.5f, 10.7501f)
                horizontalLineTo(8.75f)
                verticalLineTo(12.2501f)
                horizontalLineTo(9.5f)
                close()
                moveTo(9.5f, 13.7501f)
                curveTo(9.0858f, 13.7501f, 8.75f, 14.0858f, 8.75f, 14.5001f)
                curveTo(8.75f, 14.9143f, 9.0858f, 15.2501f, 9.5f, 15.2501f)
                curveTo(9.9142f, 15.2501f, 10.25f, 14.9143f, 10.25f, 14.5001f)
                curveTo(10.25f, 14.0858f, 9.9142f, 13.7501f, 9.5f, 13.7501f)
                close()
                moveTo(7.25f, 16.7501f)
                horizontalLineTo(6.5f)
                curveTo(6.0858f, 16.7501f, 5.75f, 17.0858f, 5.75f, 17.5f)
                curveTo(5.75f, 17.9143f, 6.0858f, 18.25f, 6.5f, 18.25f)
                curveTo(6.9142f, 18.25f, 7.25f, 17.9143f, 7.25f, 17.5f)
