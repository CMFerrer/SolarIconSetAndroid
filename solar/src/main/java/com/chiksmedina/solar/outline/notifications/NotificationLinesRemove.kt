    ...
    get() {
        ...
        _notificationLinesRemove = Builder(name = "NotificationLinesRemove", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.1768f, 6.7626f, 16.1768f, 7.2374f, 16.4697f, 7.5303f)
                curveTo(16.7626f, 7.8232f, 17.2375f, 7.8232f, 17.5304f, 7.5303f)
                lineTo(19.5f, 5.5607f)
                lineTo(21.4696f, 7.5303f)
                curveTo(21.7625f, 7.8232f, 22.2374f, 7.8232f, 22.5303f, 7.5303f)
                curveTo(22.8232f, 7.2374f, 22.8232f, 6.7625f, 22.5303f, 6.4696f)
                lineTo(20.5607f, 4.5f)
                lineTo(22.5303f, 2.5303f)
                curveTo(22.8232f, 2.2375f, 22.8232f, 1.7626f, 22.5303f, 1.4697f)
                curveTo(22.2374f, 1.1768f, 21.7626f, 1.1768f, 21.4697f, 1.4697f)
                lineTo(19.5f, 3.4393f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.0393f, 3.829f, 1.634f, 4.969f, 1.4397f, 6.4137f)
                curveTo(1.25f, 7.8252f, 1.25f, 9.6342f, 1.25f, 11.9426f)
                verticalLineTo(12.0574f)
                curveTo(1.25f, 14.3658f, 1.25f, 16.1748f, 1.4397f, 17.5863f)
                curveTo(1.634f, 19.0311f, 2.0393f, 20.1711f, 2.9341f, 21.0659f)
                ...
                curveTo(21.9607f, 20.1711f, 22.366f, 19.0311f, 22.5603f, 17.5863f)
                ...
                curveTo(21.25f, 14.3782f, 21.2484f, 16.0865f, 21.0736f, 17.3864f)
                curveTo(20.9018f, 18.6648f, 20.5749f, 19.4356f, 20.0052f, 20.0052f)
                curveTo(19.4355f, 20.5749f, 18.6648f, 20.9018f, 17.3864f, 21.0737f)
                curveTo(16.0864f, 21.2484f, 14.3782f, 21.25f, 12.0f, 21.25f)
                curveTo(9.6218f, 21.25f, 7.9136f, 21.2484f, 6.6136f, 21.0737f)
                curveTo(5.3352f, 20.9018f, 4.5644f, 20.5749f, 3.9948f, 20.0052f)
                curveTo(3.4251f, 19.4356f, 3.0982f, 18.6648f, 2.9264f, 17.3864f)
                curveTo(2.7516f, 16.0865f, 2.75f, 14.3782f, 2.75f, 12.0f)
                curveTo(2.75f, 9.6218f, 2.7516f, 7.9136f, 2.9264f, 6.6136f)
                curveTo(3.0982f, 5.3352f, 3.4251f, 4.5645f, 3.9948f, 3.9948f)
                curveTo(4.5644f, 3.4252f, 5.3352f, 3.0983f, 6.6136f, 2.9264f)
...
private var _notificationLinesRemove: ImageVector? = null
