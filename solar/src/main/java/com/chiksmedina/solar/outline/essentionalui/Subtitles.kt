...
public val EssentionalUiGroup.Subtitles: ImageVector
    get() {
        if (_subtitles != null) {
            return _subtitles!!
        }
        _subtitles = Builder(name = "Subtitles", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.75f, 13.4142f, 18.4142f, 13.75f, 18.0f, 13.75f)
                horizontalLineTo(14.0f)
                curveTo(13.5858f, 13.75f, 13.25f, 13.4142f, 13.25f, 13.0f)
                curveTo(13.25f, 12.5858f, 13.5858f, 12.25f, 14.0f, 12.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(7.0f, 12.25f)
                curveTo(7.4142f, 12.25f, 7.75f, 12.5858f, 7.75f, 13.0f)
                curveTo(7.75f, 13.4142f, 7.4142f, 13.75f, 7.0f, 13.75f)
                horizontalLineTo(6.0f)
                curveTo(5.5858f, 13.75f, 5.25f, 13.4142f, 5.25f, 13.0f)
