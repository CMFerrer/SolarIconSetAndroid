...
public val EssentionalUiGroup.`T-shirt`: ImageVector
    get() {
        if (`_t-shirt` != null) {
            return `_t-shirt`!!
        }
        `_t-shirt` = Builder(name = "T-shirt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.2238f, 10.0f)
                curveTo(18.2265f, 9.5063f, 18.2438f, 9.2231f, 18.3547f, 8.9693f)
