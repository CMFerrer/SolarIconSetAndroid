    ...
    get() {
        ...
        _cartLarge2 = Builder(name = "CartLarge2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(16.9812f, 13.0f, 17.4609f, 13.0f, 17.8366f, 12.7523f)
                curveTo(18.2123f, 12.5045f, 18.4013f, 12.0636f, 18.7792f, 11.1818f)
                lineTo(19.2078f, 10.1818f)
                curveTo(20.0173f, 8.2929f, 20.4221f, 7.3485f, 19.9775f, 6.6743f)
                curveTo(19.5328f, 6.0f, 18.5054f, 6.0f, 16.4504f, 6.0f)
