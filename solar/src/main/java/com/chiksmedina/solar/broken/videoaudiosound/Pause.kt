    ...
    get() {
        ...
        _pause = Builder(name = "Pause", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(7.8856f, 22.0f, 8.8284f, 22.0f, 9.4142f, 21.4142f)
                curveTo(10.0f, 20.8284f, 10.0f, 19.8856f, 10.0f, 18.0f)
                verticalLineTo(6.0f)
                curveTo(10.0f, 4.1144f, 10.0f, 3.1716f, 9.4142f, 2.5858f)
                curveTo(8.8284f, 2.0f, 7.8856f, 2.0f, 6.0f, 2.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(16.1144f, 2.0f, 15.1716f, 2.0f, 14.5858f, 2.5858f)
                curveTo(14.0f, 3.1716f, 14.0f, 4.1144f, 14.0f, 6.0f)
                verticalLineTo(18.0f)
                curveTo(14.0f, 19.8856f, 14.0f, 20.8284f, 14.5858f, 21.4142f)
                curveTo(15.1716f, 22.0f, 16.1144f, 22.0f, 18.0f, 22.0f)
