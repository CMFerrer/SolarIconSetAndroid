    ...
    get() {
        ...
        _shop = Builder(name = "Shop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(20.5f, 11.0f)
                verticalLineTo(14.0f)
                curveTo(20.5f, 15.1698f, 20.5f, 16.1581f, 20.465f, 17.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                moveTo(9.5f, 2.0f)
                lineTo(8.8483f, 8.5174f)
                curveTo(8.6618f, 10.382f, 10.1261f, 12.0f, 12.0f, 12.0f)
                curveTo(13.874f, 12.0f, 15.3382f, 10.382f, 15.1518f, 8.5174f)
                lineTo(14.5f, 2.0f)
                moveTo(9.5f, 2.0f)
                ...
                lineTo(2.8f, 8.0f)
                moveTo(14.5f, 2.0f)
                horizontalLineTo(16.5823f)
                curveTo(17.4904f, 2.0f, 17.9444f, 2.0f, 18.3338f, 2.1068f)
                curveTo(19.1542f, 2.3317f, 19.8407f, 2.8944f, 20.2221f, 3.6548f)
                curveTo(20.4032f, 4.0157f, 20.4922f, 4.4609f, 20.6703f, 5.3513f)
                lineTo(21.2682f, 8.3409f)
                curveTo(21.6468f, 10.2339f, 20.1989f, 12.0f, 18.2685f, 12.0f)
                curveTo(16.6969f, 12.0f, 15.3809f, 10.8091f, 15.2245f, 9.2453f)
                lineTo(14.5f, 2.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
