    ...
    get() {
        ...
        _medalStar = Builder(name = "MedalStar", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(19.7943f, 11.0312f)
                curveTo(19.7943f, 9.9332f, 19.1944f, 8.9229f, 18.2305f, 8.3973f)
                lineTo(13.4362f, 5.7831f)
                curveTo(12.541f, 5.295f, 11.4591f, 5.295f, 10.5638f, 5.7831f)
                lineTo(5.7696f, 8.3973f)
                curveTo(4.8056f, 8.9229f, 4.2058f, 9.9332f, 4.2058f, 11.0312f)
                verticalLineTo(15.9688f)
                curveTo(4.2058f, 17.0668f, 4.8056f, 18.0771f, 5.7696f, 18.6027f)
                lineTo(10.5638f, 21.2169f)
                curveTo(11.4591f, 21.705f, 12.541f, 21.705f, 13.4362f, 21.2169f)
                lineTo(18.2305f, 18.6027f)
                curveTo(19.1944f, 18.0771f, 19.7943f, 17.0668f, 19.7943f, 15.9688f)
