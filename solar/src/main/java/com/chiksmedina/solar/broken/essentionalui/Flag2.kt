    ...
    get() {
        ...
        _flag2 = Builder(
            ...
            path(
                ...
                curveTo(9.1212f, 13.1758f, 10.8321f, 13.3328f, 12.3949f, 13.958f)
                ...
                curveTo(16.4732f, 9.7886f, 16.3024f, 9.5041f, 16.2619f, 9.1945f)
                curveTo(16.2451f, 9.0654f, 16.2451f, 8.9346f, 16.2619f, 8.8055f)
                curveTo(16.3024f, 8.4959f, 16.4732f, 8.2114f, 16.8147f, 7.6422f)
                lineTo(18.0932f, 5.5113f)
                curveTo(18.4278f, 4.9536f, 17.9211f, 4.2697f, 17.2901f, 4.4275f)
                curveTo(15.8013f, 4.7997f, 14.2331f, 4.6932f, 12.8082f, 4.1233f)
                lineTo(12.3949f, 3.958f)
                curveTo(10.8321f, 3.3328f, 9.1212f, 3.1758f, 7.4707f, 3.5059f)
                lineTo(5.0f, 4.0f)
                moveTo(5.0f, 14.0f)
