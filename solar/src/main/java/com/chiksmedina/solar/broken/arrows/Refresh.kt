    ...
    get() {
        ...
        _refresh = Builder(name = "Refresh", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.8931f, 3.6079f)
                curveTo(16.5403f, 3.3908f, 16.0784f, 3.5007f, 15.8613f, 3.8535f)
                curveTo(15.6442f, 4.2063f, 15.7541f, 4.6682f, 16.1069f, 4.8853f)
                lineTo(16.8931f, 3.6079f)
                close()
                moveTo(12.4633f, 3.7594f)
                curveTo(12.877f, 3.7797f, 13.2288f, 3.4607f, 13.2491f, 3.047f)
                curveTo(13.2694f, 2.6333f, 12.9504f, 2.2815f, 12.5367f, 2.2612f)
                lineTo(12.4633f, 3.7594f)
                close()
                ...
                curveTo(19.1441f, 5.3885f, 18.1143f, 4.3594f, 16.8931f, 3.6079f)
                lineTo(16.1069f, 4.8853f)
                curveTo(17.1287f, 5.5142f, 17.9899f, 6.3751f, 18.6156f, 7.3928f)
                lineTo(19.8934f, 6.6072f)
                close()
                moveTo(12.5367f, 2.2612f)
                curveTo(12.385f, 2.2538f, 12.2323f, 2.25f, 12.0789f, 2.25f)
                lineTo(12.0789f, 3.75f)
                curveTo(12.2078f, 3.75f, 12.336f, 3.7532f, 12.4633f, 3.7594f)
                lineTo(12.5367f, 2.2612f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                close()
                moveTo(11.5331f, 20.2423f)
                curveTo(11.1193f, 20.224f, 10.769f, 20.5447f, 10.7507f, 20.9585f)
                curveTo(10.7325f, 21.3723f, 11.0531f, 21.7226f, 11.4669f, 21.7408f)
                lineTo(11.5331f, 20.2423f)
                close()
                moveTo(7.1129f, 20.4296f)
                curveTo(7.4677f, 20.6433f, 7.9286f, 20.529f, 8.1424f, 20.1742f)
                curveTo(8.3562f, 19.8195f, 8.2419f, 19.3586f, 7.8871f, 19.1448f)
                lineTo(7.1129f, 20.4296f)
                close()
                ...
                close()
                moveTo(11.4669f, 21.7408f)
                curveTo(11.6047f, 21.7469f, 11.7433f, 21.75f, 11.8825f, 21.75f)
                lineTo(11.8825f, 20.25f)
                curveTo(11.7653f, 20.25f, 11.6488f, 20.2474f, 11.5331f, 20.2423f)
                lineTo(11.4669f, 21.7408f)
                close()
                moveTo(4.0412f, 17.3939f)
                curveTo(4.8057f, 18.6327f, 5.8611f, 19.6752f, 7.1129f, 20.4296f)
                lineTo(7.8871f, 19.1448f)
                curveTo(6.8387f, 18.5131f, 5.956f, 17.6405f, 5.3177f, 16.6061f)
