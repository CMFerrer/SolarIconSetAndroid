    ...
    get() {
        ...
        `_wi-fiRouterRound` = Builder(name = "Wi-fiRouterRound", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(4.2386f, 10.0f, 2.0f, 12.2386f, 2.0f, 15.0f)
                curveTo(2.0f, 17.7614f, 4.2386f, 20.0f, 7.0f, 20.0f)
                horizontalLineTo(17.0f)
                curveTo(19.7614f, 20.0f, 22.0f, 17.7614f, 22.0f, 15.0f)
                curveTo(22.0f, 13.8742f, 21.6279f, 12.8353f, 21.0f, 11.9995f)
            }
