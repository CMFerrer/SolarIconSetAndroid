    ...
    get() {
        ...
        _smartphoneRotateAngle = Builder(name = "SmartphoneRotateAngle", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.5f, 8.0f)
                curveTo(18.5f, 5.1716f, 18.5f, 3.7574f, 17.6213f, 2.8787f)
                curveTo(16.7426f, 2.0f, 15.3284f, 2.0f, 12.5f, 2.0f)
                horizontalLineTo(11.5f)
                curveTo(8.6716f, 2.0f, 7.2574f, 2.0f, 6.3787f, 2.8787f)
                curveTo(5.5f, 3.7574f, 5.5f, 5.1716f, 5.5f, 8.0f)
                verticalLineTo(16.0f)
                curveTo(5.5f, 16.355f, 5.5f, 16.6878f, 5.5017f, 17.0f)
                moveTo(18.4983f, 17.0f)
                curveTo(18.5f, 16.6878f, 18.5f, 16.355f, 18.5f, 16.0f)
