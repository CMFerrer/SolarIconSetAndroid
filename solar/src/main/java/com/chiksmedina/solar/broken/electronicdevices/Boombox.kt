...
public val ElectronicDevicesGroup.Boombox: ImageVector
    get() {
        if (_boombox != null) {
            return _boombox!!
        }
        _boombox = Builder(name = "Boombox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(21.4816f, 7.8247f, 21.7706f, 8.6999f, 21.8985f, 10.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.0f, 19.0f)
                curveTo(9.6568f, 19.0f, 11.0f, 17.6569f, 11.0f, 16.0f)
                curveTo(11.0f, 14.3431f, 9.6568f, 13.0f, 8.0f, 13.0f)
                curveTo(6.3432f, 13.0f, 5.0f, 14.3431f, 5.0f, 16.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                curveTo(12.7071f, 16.9497f, 12.7071f, 15.0502f, 13.8787f, 13.8786f)
                curveTo(15.0503f, 12.7071f, 16.9497f, 12.7071f, 18.1213f, 13.8786f)
                curveTo(19.2929f, 15.0502f, 19.2929f, 16.9497f, 18.1213f, 18.1213f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
