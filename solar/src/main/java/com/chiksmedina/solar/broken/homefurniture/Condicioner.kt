    ...
    get() {
        ...
        _condicioner = Builder(name = "Condicioner", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.0001f, 17.5f)
                lineTo(6.6934f, 17.9599f)
                curveTo(6.3044f, 18.5435f, 6.439f, 19.3292f, 7.0001f, 19.75f)
                curveTo(7.5611f, 20.1708f, 7.6957f, 20.9565f, 7.3067f, 21.5401f)
                lineTo(7.0001f, 22.0f)
                moveTo(12.0001f, 17.5f)
                lineTo(11.6935f, 17.9599f)
                curveTo(11.3044f, 18.5435f, 11.439f, 19.3292f, 12.0001f, 19.75f)
                curveTo(12.5611f, 20.1708f, 12.6957f, 20.9565f, 12.3067f, 21.5401f)
                lineTo(12.0001f, 22.0f)
                moveTo(17.0001f, 17.5f)
                lineTo(16.6935f, 17.9599f)
                curveTo(16.3044f, 18.5435f, 16.439f, 19.3292f, 17.0001f, 19.75f)
                curveTo(17.5611f, 20.1708f, 17.6957f, 20.9565f, 17.3067f, 21.5401f)
                lineTo(17.0001f, 22.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
