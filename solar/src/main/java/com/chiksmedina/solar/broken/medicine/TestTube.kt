    ...
    get() {
        ...
        _testTube = Builder(name = "TestTube", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(11.0558f, 19.5813f)
                curveTo(9.7158f, 21.8942f, 6.748f, 22.6867f, 4.4271f, 21.3513f)
                curveTo(2.1061f, 20.0159f, 1.3109f, 17.0584f, 2.6509f, 14.7455f)
                lineTo(3.9518f, 12.5f)
                moveTo(12.5511f, 17.0003f)
