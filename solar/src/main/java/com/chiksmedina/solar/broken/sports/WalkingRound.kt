    ...
    get() {
        ...
        _walkingRound = Builder(name = "WalkingRound", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.4848f, 18.1524f)
                curveTo(12.7378f, 18.4804f, 13.2088f, 18.5411f, 13.5367f, 18.2881f)
                curveTo(13.8647f, 18.0351f, 13.9254f, 17.5641f, 13.6724f, 17.2362f)
                lineTo(12.4848f, 18.1524f)
                close()
                moveTo(15.8869f, 20.1066f)
                curveTo(15.6339f, 19.7787f, 15.163f, 19.7179f, 14.835f, 19.9709f)
                curveTo(14.507f, 20.224f, 14.4463f, 20.6949f, 14.6993f, 21.0229f)
                lineTo(15.8869f, 20.1066f)
                close()
                ...
                lineTo(12.4848f, 18.1524f)
                lineTo(13.6724f, 17.2362f)
                lineTo(12.5652f, 15.8009f)
                lineTo(11.3775f, 16.7172f)
                close()
                moveTo(14.6993f, 21.0229f)
                lineTo(15.8066f, 22.4581f)
                lineTo(16.9942f, 21.5419f)
                lineTo(15.8869f, 20.1066f)
                lineTo(14.6993f, 21.0229f)
                close()
            }
        }
        .build()
