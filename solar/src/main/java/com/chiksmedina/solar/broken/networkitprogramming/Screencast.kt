    ...
    get() {
        ...
        _screencast = Builder(name = "Screencast", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(22.0f, 11.6508f, 22.0f, 11.3178f, 21.9991f, 11.0f)
                moveTo(2.0f, 8.5f)
                curveTo(2.0f, 8.0357f, 2.0f, 7.8035f, 2.0193f, 7.6079f)
                curveTo(2.2063f, 5.7088f, 3.7088f, 4.2063f, 5.6079f, 4.0193f)
                curveTo(5.8035f, 4.0f, 6.0357f, 4.0f, 6.5f, 4.0f)
                horizontalLineTo(14.0f)
                curveTo(17.7712f, 4.0f, 19.6569f, 4.0f, 20.8284f, 5.1716f)
                curveTo(21.298f, 5.6412f, 21.5794f, 6.2255f, 21.748f, 7.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
