    ...
    get() {
        ...
        _musicNotes = Builder(name = "MusicNotes", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.25f, 12.0004f)
                curveTo(21.25f, 12.4146f, 21.5858f, 12.7504f, 22.0f, 12.7504f)
                curveTo(22.4142f, 12.7504f, 22.75f, 12.4146f, 22.75f, 12.0004f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.0f, 5.0f)
                curveTo(8.7574f, 5.0f, 7.0f, 4.0711f, 7.0f, 2.0f)
            }
        }
        .build()
        return _musicNotes!!
