    ...
    get() {
        ...
        _stretching = Builder(name = "Stretching", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(8.5f, 13.9998f)
                lineTo(7.8859f, 13.401f)
                curveTo(7.1203f, 12.6546f, 7.3594f, 11.3696f, 8.3422f, 10.9483f)
                lineTo(10.798f, 9.8959f)
                curveTo(11.7878f, 9.4717f, 12.8889f, 10.1977f, 12.8889f, 11.2746f)
                verticalLineTo(13.895f)
                curveTo(12.8889f, 14.2369f, 12.8012f, 14.5731f, 12.6343f, 14.8715f)
                lineTo(11.9562f, 16.0835f)
            }
        }
        .build()
        return _stretching!!
