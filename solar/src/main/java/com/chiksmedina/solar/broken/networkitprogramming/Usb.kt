    ...
    get() {
        ...
        _usb = Builder(name = "Usb", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.25f, 6.5f)
                curveTo(11.25f, 6.9142f, 11.5858f, 7.25f, 12.0f, 7.25f)
                curveTo(12.4142f, 7.25f, 12.75f, 6.9142f, 12.75f, 6.5f)
                horizontalLineTo(11.25f)
                close()
                moveTo(12.75f, 9.75f)
                curveTo(12.75f, 9.3358f, 12.4142f, 9.0f, 12.0f, 9.0f)
                curveTo(11.5858f, 9.0f, 11.25f, 9.3358f, 11.25f, 9.75f)
