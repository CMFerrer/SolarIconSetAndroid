    ...
    get() {
        ...
        _flag = Builder(name = "Flag", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(18.5615f, 14.1096f, 19.0f, 13.548f, 19.0f, 12.9037f)
                verticalLineTo(5.5367f)
                curveTo(19.0f, 4.7561f, 18.2665f, 4.1834f, 17.5092f, 4.3727f)
                curveTo(15.878f, 4.7805f, 14.1597f, 4.6639f, 12.5986f, 4.0394f)
