    ...
    get() {
        ...
        _cassette2 = Builder(name = "Cassette2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(13.228f, 8.5f)
                curveTo(14.5688f, 8.5f, 15.2393f, 8.5f, 15.7532f, 8.1439f)
                curveTo(16.2671f, 7.7877f, 16.5025f, 7.16f, 16.9733f, 5.9045f)
                lineTo(17.5f, 4.5f)
                moveTo(6.5f, 4.5f)
                lineTo(7.0267f, 5.9045f)
                curveTo(7.4975f, 7.16f, 7.7329f, 7.7877f, 8.2468f, 8.1439f)
                curveTo(8.4591f, 8.291f, 8.6981f, 8.3773f, 9.0f, 8.428f)
            }
        }
        .build()
        return _cassette2!!
