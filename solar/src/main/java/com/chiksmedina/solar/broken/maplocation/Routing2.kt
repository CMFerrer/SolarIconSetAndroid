    ...
    get() {
        ...
        _routing2 = Builder(name = "Routing2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.8312f, 13.6327f)
                curveTo(11.1807f, 13.4104f, 11.2837f, 12.9468f, 11.0613f, 12.5973f)
                curveTo(10.8389f, 12.2479f, 10.3753f, 12.1449f, 10.0259f, 12.3673f)
                lineTo(10.8312f, 13.6327f)
                close()
                moveTo(13.1687f, 10.3673f)
                curveTo(12.8193f, 10.5896f, 12.7163f, 11.0532f, 12.9387f, 11.4027f)
                curveTo(13.161f, 11.7521f, 13.6246f, 11.8551f, 13.9741f, 11.6327f)
                lineTo(13.1687f, 10.3673f)
                close()
                ...
                verticalLineTo(5.75f)
                close()
                moveTo(10.0259f, 12.3673f)
                lineTo(6.3917f, 14.6799f)
                lineTo(7.197f, 15.9454f)
                lineTo(10.8312f, 13.6327f)
                lineTo(10.0259f, 12.3673f)
                close()
                moveTo(16.803f, 8.0546f)
                lineTo(13.1687f, 10.3673f)
                lineTo(13.9741f, 11.6327f)
                lineTo(17.6083f, 9.3201f)
