...
public val LikeGroup.HeartUnlock: ImageVector
    get() {
        if (_heartUnlock != null) {
            return _heartUnlock!!
        }
        _heartUnlock = Builder(name = "HeartUnlock", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.0f, 7.0f)
                curveTo(7.0f, 3.6863f, 8.9366f, 2.0f, 11.8718f, 2.0f)
                curveTo(13.7242f, 2.0f, 15.1788f, 2.6716f, 16.0f, 4.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.539f, 18.3638f)
                curveTo(7.215f, 18.1057f, 6.7432f, 18.159f, 6.485f, 18.483f)
                curveTo(6.2269f, 18.8069f, 6.2803f, 19.2788f, 6.6042f, 19.5369f)
                lineTo(7.539f, 18.3638f)
                close()
                moveTo(3.247f, 15.8789f)
                curveTo(3.4507f, 16.2395f, 3.9083f, 16.3667f, 4.2689f, 16.163f)
                curveTo(4.6295f, 15.9593f, 4.7567f, 15.5017f, 4.553f, 15.1411f)
                lineTo(3.247f, 15.8789f)
                close()
                ...
                curveTo(9.0015f, 19.4703f, 8.2771f, 18.9519f, 7.539f, 18.3638f)
                lineTo(6.6042f, 19.5369f)
                curveTo(7.352f, 20.1327f, 8.1449f, 20.7035f, 8.8105f, 21.2116f)
                lineTo(9.7206f, 20.0192f)
                close()
                moveTo(4.553f, 15.1411f)
                curveTo(4.0559f, 14.2611f, 3.75f, 13.2673f, 3.75f, 12.0992f)
                horizontalLineTo(2.25f)
                curveTo(2.25f, 13.5483f, 2.6342f, 14.7941f, 3.247f, 15.8789f)
                lineTo(4.553f, 15.1411f)
                close()
            }
        }
        .build()
