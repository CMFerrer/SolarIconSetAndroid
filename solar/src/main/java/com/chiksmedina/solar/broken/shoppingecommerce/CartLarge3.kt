    ...
    get() {
        ...
        _cartLarge3 = Builder(
            ...
            path(
                ...
                curveTo(18.7738f, 6.12f, 20.2906f, 6.12f, 20.7345f, 6.6971f)
                curveTo(21.1784f, 7.2742f, 21.0049f, 8.1437f, 20.6578f, 9.8827f)
                lineTo(20.158f, 12.3075f)
                curveTo(19.8429f, 13.8364f, 19.6853f, 14.6008f, 19.1336f, 15.0504f)
                curveTo(18.5819f, 15.5f, 17.8014f, 15.5f, 16.2404f, 15.5f)
