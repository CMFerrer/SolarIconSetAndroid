    ...
    get() {
        ...
        _whisk = Builder(name = "Whisk", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(9.8795f, 18.1467f)
                moveTo(6.8599f, 21.1662f)
                ...
                moveTo(20.5484f, 3.4515f)
                curveTo(19.9471f, 2.8503f, 18.7873f, 3.2069f, 17.5556f, 3.9351f)
                moveTo(10.0806f, 13.9191f)
                curveTo(8.8725f, 12.711f, 12.3364f, 8.4431f, 14.1069f, 6.6726f)
            }
        }
        .build()
        return _whisk!!
