    ...
    get() {
        ...
        _adhesivePlaster = Builder(name = "AdhesivePlaster", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(16.4289f, 10.5711f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.0f, 17.8579f)
                lineTo(9.071f, 20.7868f)
                curveTo(7.4534f, 22.4044f, 4.8308f, 22.4044f, 3.2132f, 20.7868f)
                curveTo(2.9711f, 20.5448f, 2.7653f, 20.2803f, 2.5957f, 20.0f)
                moveTo(6.1421f, 12.0f)
                lineTo(3.2132f, 14.9289f)
                curveTo(2.8907f, 15.2513f, 2.6326f, 15.6137f, 2.4387f, 16.0f)
                moveTo(12.0f, 6.1421f)
                lineTo(14.9289f, 3.2132f)
                curveTo(16.5465f, 1.5956f, 19.1691f, 1.5956f, 20.7867f, 3.2132f)
                curveTo(22.4044f, 4.8308f, 22.4044f, 7.4535f, 20.7867f, 9.0711f)
                lineTo(17.8578f, 12.0f)
            }
