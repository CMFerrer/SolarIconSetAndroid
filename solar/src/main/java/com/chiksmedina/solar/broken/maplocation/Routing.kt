    ...
    get() {
        ...
        _routing = Builder(name = "Routing", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.3358f, 18.25f, 13.0f, 18.5858f, 13.0f, 19.0f)
                curveTo(13.0f, 19.4142f, 13.3358f, 19.75f, 13.75f, 19.75f)
                ...
                close()
                moveTo(11.0f, 5.75f)
                curveTo(11.4142f, 5.75f, 11.75f, 5.4142f, 11.75f, 5.0f)
                curveTo(11.75f, 4.5858f, 11.4142f, 4.25f, 11.0f, 4.25f)
                verticalLineTo(5.75f)
                close()
                moveTo(15.0f, 4.25f)
                curveTo(14.5858f, 4.25f, 14.25f, 4.5858f, 14.25f, 5.0f)
