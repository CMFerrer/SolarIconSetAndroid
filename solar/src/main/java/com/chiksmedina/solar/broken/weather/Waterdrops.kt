    ...
    get() {
        ...
        _waterdrops = Builder(name = "Waterdrops", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(13.2618f, 3.2347f)
                curveTo(12.5678f, 2.5025f, 11.4322f, 2.5025f, 10.7382f, 3.2347f)
                curveTo(9.5659f, 4.4717f, 8.0f, 6.3934f, 8.0f, 7.8332f)
                curveTo(8.0f, 10.1344f, 9.7909f, 11.9999f, 12.0f, 11.9999f)
                curveTo(14.2091f, 11.9999f, 16.0f, 10.1344f, 16.0f, 7.8332f)
                curveTo(16.0f, 7.5693f, 15.9474f, 7.2891f, 15.8542f, 7.0f)
            }
        }
        .build()
        return _waterdrops!!
