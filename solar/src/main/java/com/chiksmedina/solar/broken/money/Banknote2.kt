    ...
    get() {
        ...
        _banknote2 = Builder(name = "Banknote2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.0003f, 20.0001f)
                horizontalLineTo(11.0003f)
                curveTo(8.1719f, 20.0001f, 6.7577f, 20.0001f, 5.879f, 19.1214f)
                curveTo(5.3891f, 18.6315f, 5.1723f, 17.9751f, 5.0764f, 17.0f)
                moveTo(21.1216f, 19.1214f)
                curveTo(22.0003f, 18.2427f, 22.0003f, 16.8285f, 22.0003f, 14.0001f)
                curveTo(22.0003f, 11.1716f, 22.0003f, 9.7574f, 21.1216f, 8.8787f)
                curveTo(20.6317f, 8.3889f, 19.9754f, 8.1721f, 19.0003f, 8.0762f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
