    ...
    get() {
        ...
        _ferrisWheel = Builder(name = "FerrisWheel", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.5001f, 22.0f)
                lineTo(15.1667f, 16.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(18.2305f, 6.3973f)
                curveTo(19.1944f, 6.9229f, 19.7943f, 7.9332f, 19.7943f, 9.0312f)
                verticalLineTo(13.9688f)
                curveTo(19.7943f, 15.0668f, 19.1944f, 16.0771f, 18.2305f, 16.6027f)
