    ...
    get() {
        ...
        _swimming = Builder(
            ...
            path(
                ...
                lineTo(9.8132f, 5.0549f)
                moveTo(15.5f, 11.5f)
                lineTo(12.2504f, 7.8171f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
            ...
            path(
                ...
                moveTo(12.0f, 21.0f)
                curveTo(9.4935f, 21.0f, 7.9181f, 19.6547f, 6.8665f, 18.3888f)
                curveTo(6.4272f, 17.8599f, 5.5862f, 17.867f, 5.2017f, 18.4323f)
                curveTo(4.5008f, 19.4629f, 3.684f, 20.4127f, 2.0f, 20.7859f)
                moveTo(22.0f, 20.7859f)
                curveTo(20.4123f, 20.4341f, 19.5955f, 19.5697f, 18.9199f, 18.6083f)
                curveTo(18.4965f, 18.0059f, 17.5655f, 18.0425f, 17.1055f, 18.6208f)
                curveTo(16.6953f, 19.1365f, 16.2063f, 19.6119f, 15.6148f, 20.0f)
            }
        }
            .build()
        return _swimming!!
