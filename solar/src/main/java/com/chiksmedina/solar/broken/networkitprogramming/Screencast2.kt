    ...
    get() {
        ...
        _screencast2 = Builder(
            ...
            path(
                ...
                curveTo(22.0f, 10.6508f, 22.0f, 10.3178f, 21.9991f, 10.0f)
                moveTo(4.0f, 18.4151f)
                curveTo(3.6865f, 18.2627f, 3.4137f, 18.0706f, 3.1716f, 17.8284f)
                ...
                curveTo(21.298f, 4.6412f, 21.5794f, 5.2255f, 21.748f, 6.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
