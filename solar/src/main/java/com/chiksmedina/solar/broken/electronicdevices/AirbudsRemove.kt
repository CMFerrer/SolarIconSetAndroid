    ...
    get() {
        ...
        _airbudsRemove = Builder(name = "AirbudsRemove", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(6.0f, 12.7477f, 5.5523f, 12.3f, 5.0f, 12.3f)
                curveTo(3.3431f, 12.3f, 2.0f, 10.9569f, 2.0f, 9.3f)
                verticalLineTo(7.1875f)
                curveTo(2.0f, 7.0134f, 2.0f, 6.9264f, 2.0036f, 6.8528f)
                curveTo(2.0793f, 5.3117f, 3.3117f, 4.0793f, 4.8528f, 4.0036f)
                curveTo(4.9264f, 4.0f, 5.0134f, 4.0f, 5.1875f, 4.0f)
                curveTo(5.4777f, 4.0f, 5.6227f, 4.0f, 5.7453f, 4.006f)
                curveTo(8.3139f, 4.1322f, 10.3678f, 6.1861f, 10.494f, 8.7547f)
                curveTo(10.5f, 8.8773f, 10.5f, 9.0223f, 10.5f, 9.3125f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.0003f, 19.0f)
                lineTo(19.0f, 17.0f)
                moveTo(18.9997f, 19.0f)
                lineTo(17.0f, 17.0f)
            }
        }
        .build()
