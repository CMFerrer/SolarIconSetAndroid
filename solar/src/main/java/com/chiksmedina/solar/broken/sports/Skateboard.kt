    ...
    get() {
        ...
        _skateboard = Builder(name = "Skateboard", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(2.0f, 7.0f)
                lineTo(2.8125f, 8.2188f)
                curveTo(3.5544f, 9.3316f, 4.8033f, 10.0f, 6.1407f, 10.0f)
                horizontalLineTo(12.0f)
                moveTo(22.0f, 7.0f)
                lineTo(21.1875f, 8.2188f)
                curveTo(20.4456f, 9.3316f, 19.1967f, 10.0f, 17.8593f, 10.0f)
