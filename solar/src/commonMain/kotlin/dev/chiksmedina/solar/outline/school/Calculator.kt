    ...
    get() {
        ...
        _calculator = Builder(
            ...
            path(
                ...
                curveTo(7.0f, 16.4477f, 7.4477f, 16.0f, 8.0f, 16.0f)
                curveTo(8.5523f, 16.0f, 9.0f, 16.4477f, 9.0f, 17.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(
                ...
                curveTo(15.0f, 16.4477f, 15.4477f, 16.0f, 16.0f, 16.0f)
                curveTo(16.5523f, 16.0f, 17.0f, 16.4477f, 17.0f, 17.0f)
                close()
            }
        }
            .build()
