    ...
    get() {
        ...
        _lockKeyhole = Builder(
            ...
            path(
                ...
                moveTo(9.25f, 16.0f)
                curveTo(9.25f, 14.4812f, 10.4812f, 13.25f, 12.0f, 13.25f)
                curveTo(13.5188f, 13.25f, 14.75f, 14.4812f, 14.75f, 16.0f)
                curveTo(14.75f, 17.5188f, 13.5188f, 18.75f, 12.0f, 18.75f)
                curveTo(10.4812f, 18.75f, 9.25f, 17.5188f, 9.25f, 16.0f)
                close()
                moveTo(12.0f, 14.75f)
                curveTo(11.3096f, 14.75f, 10.75f, 15.3096f, 10.75f, 16.0f)
                curveTo(10.75f, 16.6904f, 11.3096f, 17.25f, 12.0f, 17.25f)
                curveTo(12.6904f, 17.25f, 13.25f, 16.6904f, 13.25f, 16.0f)
                curveTo(13.25f, 15.3096f, 12.6904f, 14.75f, 12.0f, 14.75f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
