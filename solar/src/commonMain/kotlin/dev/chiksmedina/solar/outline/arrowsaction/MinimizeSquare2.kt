    ...
    get() {
        ...
        _minimizeSquare2 = Builder(
            ...
            path(
                ...
                curveTo(6.75f, 10.0858f, 7.0858f, 9.75f, 7.5f, 9.75f)
                horizontalLineTo(8.6893f)
                lineTo(6.4697f, 7.5303f)
                curveTo(6.1768f, 7.2374f, 6.1768f, 6.7626f, 6.4697f, 6.4697f)
                curveTo(6.7626f, 6.1768f, 7.2374f, 6.1768f, 7.5303f, 6.4697f)
                lineTo(9.75f, 8.6893f)
                verticalLineTo(7.5f)
                curveTo(9.75f, 7.0858f, 10.0858f, 6.75f, 10.5f, 6.75f)
                curveTo(10.9142f, 6.75f, 11.25f, 7.0858f, 11.25f, 7.5f)
                verticalLineTo(10.5f)
                curveTo(11.25f, 10.9142f, 10.9142f, 11.25f, 10.5f, 11.25f)
                horizontalLineTo(7.5f)
                close()
            }
            path(
                ...
                moveTo(17.5303f, 17.5303f)
                curveTo(17.8232f, 17.2374f, 17.8232f, 16.7626f, 17.5303f, 16.4697f)
                lineTo(15.3107f, 14.25f)
                horizontalLineTo(16.5f)
                curveTo(16.9142f, 14.25f, 17.25f, 13.9142f, 17.25f, 13.5f)
                curveTo(17.25f, 13.0858f, 16.9142f, 12.75f, 16.5f, 12.75f)
                horizontalLineTo(13.5f)
                curveTo(13.0858f, 12.75f, 12.75f, 13.0858f, 12.75f, 13.5f)
                verticalLineTo(16.5f)
                curveTo(12.75f, 16.9142f, 13.0858f, 17.25f, 13.5f, 17.25f)
                curveTo(13.9142f, 17.25f, 14.25f, 16.9142f, 14.25f, 16.5f)
                verticalLineTo(15.3107f)
                lineTo(16.4697f, 17.5303f)
                curveTo(16.7626f, 17.8232f, 17.2374f, 17.8232f, 17.5303f, 17.5303f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
