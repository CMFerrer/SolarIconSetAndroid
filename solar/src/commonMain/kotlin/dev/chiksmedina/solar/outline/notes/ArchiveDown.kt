    ...
    get() {
        ...
        _archiveDown = Builder(
            ...
            path(
                ...
                lineTo(14.4425f, 12.1649f)
                curveTo(14.7196f, 11.8571f, 15.1938f, 11.8321f, 15.5017f, 12.1092f)
                curveTo(15.8096f, 12.3863f, 15.8346f, 12.8605f, 15.5575f, 13.1684f)
                lineTo(12.5575f, 16.5017f)
                curveTo(12.4152f, 16.6598f, 12.2126f, 16.75f, 12.0f, 16.75f)
                curveTo(11.7874f, 16.75f, 11.5848f, 16.6598f, 11.4425f, 16.5017f)
                lineTo(8.4425f, 13.1684f)
                curveTo(8.1654f, 12.8605f, 8.1904f, 12.3863f, 8.4983f, 12.1092f)
                curveTo(8.8062f, 11.8321f, 9.2804f, 11.8571f, 9.5575f, 12.1649f)
                lineTo(11.25f, 14.0455f)
                verticalLineTo(7.75f)
                horizontalLineTo(4.25f)
                close()
                moveTo(20.0f, 6.25f)
                curveTo(20.4926f, 6.25f, 20.7866f, 6.2484f, 20.9973f, 6.2201f)
                curveTo(21.0939f, 6.2071f, 21.1423f, 6.1918f, 21.164f, 6.1828f)
                curveTo(21.1691f, 6.1808f, 21.1724f, 6.1792f, 21.1743f, 6.1782f)
                lineTo(21.1768f, 6.1768f)
                lineTo(21.1781f, 6.1743f)
                curveTo(21.1792f, 6.1724f, 21.1808f, 6.1691f, 21.1828f, 6.164f)
                curveTo(21.1918f, 6.1423f, 21.2071f, 6.0939f, 21.2201f, 5.9973f)
                curveTo(21.2484f, 5.7866f, 21.25f, 5.4926f, 21.25f, 5.0f)
                curveTo(21.25f, 4.5074f, 21.2484f, 4.2134f, 21.2201f, 4.0027f)
                curveTo(21.2071f, 3.9061f, 21.1918f, 3.8577f, 21.1828f, 3.836f)
                curveTo(21.1808f, 3.8309f, 21.1792f, 3.8276f, 21.1781f, 3.8257f)
                lineTo(21.1768f, 3.8232f)
                lineTo(21.1743f, 3.8219f)
                curveTo(21.1724f, 3.8209f, 21.1691f, 3.8192f, 21.164f, 3.8172f)
                curveTo(21.1423f, 3.8082f, 21.0939f, 3.7929f, 20.9973f, 3.7799f)
                curveTo(20.7866f, 3.7516f, 20.4926f, 3.75f, 20.0f, 3.75f)
                horizontalLineTo(4.0f)
                curveTo(3.5074f, 3.75f, 3.2134f, 3.7516f, 3.0027f, 3.7799f)
                curveTo(2.9061f, 3.7929f, 2.8577f, 3.8082f, 2.836f, 3.8172f)
                curveTo(2.8309f, 3.8192f, 2.8276f, 3.8209f, 2.8257f, 3.8219f)
                lineTo(2.8232f, 3.8232f)
                lineTo(2.8219f, 3.8257f)
                curveTo(2.8209f, 3.8276f, 2.8192f, 3.8309f, 2.8172f, 3.836f)
                curveTo(2.8082f, 3.8577f, 2.7929f, 3.9061f, 2.7799f, 4.0027f)
                curveTo(2.7516f, 4.2134f, 2.75f, 4.5074f, 2.75f, 5.0f)
                curveTo(2.75f, 5.4926f, 2.7516f, 5.7866f, 2.7799f, 5.9973f)
                curveTo(2.7929f, 6.0939f, 2.8082f, 6.1423f, 2.8172f, 6.164f)
                curveTo(2.8192f, 6.1691f, 2.8209f, 6.1724f, 2.8219f, 6.1743f)
                lineTo(2.8232f, 6.1768f)
                lineTo(2.8257f, 6.1782f)
                curveTo(2.8276f, 6.1792f, 2.8309f, 6.1808f, 2.836f, 6.1828f)
                curveTo(2.8577f, 6.1918f, 2.9061f, 6.2071f, 3.0027f, 6.2201f)
                curveTo(3.2134f, 6.2484f, 3.5074f, 6.25f, 4.0f, 6.25f)
