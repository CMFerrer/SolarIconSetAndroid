    ...
    get() {
        ...
        _musicLibrary2 = Builder(
            ...
            path(
                ...
                moveTo(12.0f, 9.75f)
                curveTo(12.4142f, 9.75f, 12.75f, 10.0858f, 12.75f, 10.5f)
                curveTo(12.75f, 11.0386f, 13.0654f, 11.6006f, 13.5835f, 12.0603f)
                curveTo(14.1145f, 12.5314f, 14.6946f, 12.75f, 15.0f, 12.75f)
                curveTo(15.4142f, 12.75f, 15.75f, 13.0858f, 15.75f, 13.5f)
                curveTo(15.75f, 13.9142f, 15.4142f, 14.25f, 15.0f, 14.25f)
                curveTo(14.2617f, 14.25f, 13.4202f, 13.8634f, 12.75f, 13.3197f)
                verticalLineTo(17.0f)
                curveTo(12.75f, 18.2427f, 11.7426f, 19.25f, 10.5f, 19.25f)
                curveTo(9.2574f, 19.25f, 8.25f, 18.2427f, 8.25f, 17.0f)
                curveTo(8.25f, 15.7574f, 9.2574f, 14.75f, 10.5f, 14.75f)
                curveTo(10.763f, 14.75f, 11.0154f, 14.7951f, 11.25f, 14.878f)
                verticalLineTo(10.5f)
                curveTo(11.25f, 10.0858f, 11.5858f, 9.75f, 12.0f, 9.75f)
                close()
                moveTo(11.25f, 17.0f)
