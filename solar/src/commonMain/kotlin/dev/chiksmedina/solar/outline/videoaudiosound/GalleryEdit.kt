    ...
    get() {
        ...
        _galleryEdit = Builder(
            ...
            path(
                ...
                moveTo(18.4488f, 1.988f)
                curveTo(19.4327f, 1.004f, 21.0281f, 1.004f, 22.012f, 1.988f)
                curveTo(22.996f, 2.9719f, 22.996f, 4.5672f, 22.012f, 5.5512f)
                lineTo(17.7604f, 9.8029f)
                curveTo(17.7502f, 9.8131f, 17.7401f, 9.8231f, 17.7302f, 9.833f)
                curveTo(17.4994f, 10.0639f, 17.3387f, 10.2246f, 17.1585f, 10.3652f)
                curveTo(16.9467f, 10.5304f, 16.7174f, 10.6721f, 16.4749f, 10.7877f)
                curveTo(16.2686f, 10.886f, 16.053f, 10.9578f, 15.7433f, 11.061f)
                curveTo(15.73f, 11.0655f, 15.7165f, 11.07f, 15.7028f, 11.0745f)
                lineTo(13.8653f, 11.687f)
                curveTo(13.4243f, 11.834f, 12.9381f, 11.7192f, 12.6094f, 11.3905f)
                curveTo(12.2808f, 11.0619f, 12.166f, 10.5757f, 12.313f, 10.1347f)
                lineTo(12.9255f, 8.2972f)
                curveTo(12.93f, 8.2835f, 12.9345f, 8.27f, 12.939f, 8.2567f)
                curveTo(13.0422f, 7.947f, 13.114f, 7.7314f, 13.2123f, 7.5251f)
                curveTo(13.3279f, 7.2825f, 13.4696f, 7.0533f, 13.6348f, 6.8415f)
                curveTo(13.7753f, 6.6613f, 13.9361f, 6.5006f, 14.167f, 6.2698f)
                curveTo(14.1769f, 6.2599f, 14.1869f, 6.2498f, 14.1971f, 6.2396f)
                lineTo(18.4488f, 1.988f)
                close()
                moveTo(20.9514f, 3.0486f)
                curveTo(20.5532f, 2.6505f, 19.9076f, 2.6505f, 19.5094f, 3.0486f)
                lineTo(19.3777f, 3.1804f)
                curveTo(19.3829f, 3.1966f, 19.3885f, 3.2133f, 19.3944f, 3.2305f)
                curveTo(19.4762f, 3.4661f, 19.6315f, 3.7784f, 19.9265f, 4.0735f)
                curveTo(20.2216f, 4.3685f, 20.5339f, 4.5238f, 20.7695f, 4.6056f)
                curveTo(20.7867f, 4.6115f, 20.8034f, 4.6171f, 20.8196f, 4.6223f)
                lineTo(20.9514f, 4.4905f)
                curveTo(21.3495f, 4.0924f, 21.3495f, 3.4468f, 20.9514f, 3.0486f)
                close()
                moveTo(19.6857f, 5.7562f)
                curveTo(19.4193f, 5.6068f, 19.1372f, 5.4054f, 18.8659f, 5.1341f)
                curveTo(18.5946f, 4.8628f, 18.3932f, 4.5807f, 18.2438f, 4.3143f)
                lineTo(15.2578f, 7.3003f)
                curveTo(14.9856f, 7.5725f, 14.8944f, 7.6655f, 14.8176f, 7.764f)
                curveTo(14.7193f, 7.8899f, 14.6351f, 8.0262f, 14.5664f, 8.1704f)
                curveTo(14.5127f, 8.2831f, 14.4702f, 8.4063f, 14.3485f, 8.7715f)
                lineTo(14.1232f, 9.4474f)
                lineTo(14.5526f, 9.8768f)
                lineTo(15.2284f, 9.6515f)
                curveTo(15.5937f, 9.5297f, 15.7169f, 9.4873f, 15.8296f, 9.4336f)
                curveTo(15.9738f, 9.3649f, 16.11f, 9.2807f, 16.236f, 9.1824f)
                curveTo(16.3344f, 9.1056f, 16.4275f, 9.0144f, 16.6997f, 8.7422f)
                lineTo(19.6857f, 5.7562f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
