    ...
    get() {
        ...
        _dropper3 = Builder(
            ...
            path(
                ...
                moveTo(17.1752f, 8.6015f)
                curveTo(16.5324f, 7.9233f, 15.4676f, 7.9233f, 14.8248f, 8.6015f)
                curveTo(14.5172f, 8.926f, 14.1419f, 9.3567f, 13.8388f, 9.8158f)
                curveTo(13.5544f, 10.2467f, 13.25f, 10.8243f, 13.25f, 11.4167f)
                curveTo(13.25f, 12.9523f, 14.4527f, 14.25f, 16.0f, 14.25f)
                curveTo(17.5473f, 14.25f, 18.75f, 12.9523f, 18.75f, 11.4167f)
                curveTo(18.75f, 10.8243f, 18.4456f, 10.2467f, 18.1612f, 9.8158f)
                curveTo(17.8581f, 9.3567f, 17.4828f, 8.926f, 17.1752f, 8.6015f)
                close()
                moveTo(15.9135f, 9.6334f)
                curveTo(15.9428f, 9.6025f, 15.9734f, 9.5928f, 16.0f, 9.5928f)
                curveTo(16.0266f, 9.5928f, 16.0572f, 9.6025f, 16.0865f, 9.6334f)
                curveTo(16.3651f, 9.9273f, 16.6744f, 10.2863f, 16.9093f, 10.6422f)
                curveTo(17.1629f, 11.0263f, 17.25f, 11.2891f, 17.25f, 11.4167f)
                curveTo(17.25f, 12.1822f, 16.6618f, 12.75f, 16.0f, 12.75f)
                curveTo(15.3382f, 12.75f, 14.75f, 12.1822f, 14.75f, 11.4167f)
                curveTo(14.75f, 11.2891f, 14.8371f, 11.0263f, 15.0907f, 10.6422f)
                curveTo(15.3256f, 10.2863f, 15.6349f, 9.9273f, 15.9135f, 9.6334f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(14.0f, 15.25f)
                curveTo(13.5858f, 15.25f, 13.25f, 15.5858f, 13.25f, 16.0f)
            ...
            path(
                ...
                curveTo(22.7501f, 8.3003f, 22.75f, 9.0495f, 22.75f, 9.948f)
                ...
                curveTo(15.25f, 20.9972f, 15.25f, 20.9944f, 15.25f, 20.9917f)
                curveTo(15.2501f, 20.9867f, 15.2502f, 20.9817f, 15.2504f, 20.9767f)
                ...
                close()
                moveTo(11.1161f, 7.1161f)
                curveTo(11.2464f, 6.9858f, 11.4439f, 6.8786f, 11.9054f, 6.8165f)
                curveTo(12.3884f, 6.7516f, 13.036f, 6.75f, 14.0f, 6.75f)
                horizontalLineTo(18.0f)
                curveTo(18.964f, 6.75f, 19.6116f, 6.7516f, 20.0946f, 6.8165f)
                curveTo(20.5561f, 6.8786f, 20.7536f, 6.9858f, 20.8839f, 7.1161f)
                curveTo(21.0142f, 7.2464f, 21.1214f, 7.4439f, 21.1835f, 7.9054f)
                curveTo(21.2484f, 8.3884f, 21.25f, 9.036f, 21.25f, 10.0f)
                verticalLineTo(16.5069f)
                curveTo(21.25f, 16.9528f, 21.062f, 17.3781f, 20.7323f, 17.6783f)
                curveTo(18.0499f, 20.1199f, 13.9502f, 20.1199f, 11.2677f, 17.6783f)
                curveTo(10.938f, 17.3781f, 10.75f, 16.9528f, 10.75f, 16.5069f)
                verticalLineTo(10.0f)
                curveTo(10.75f, 9.036f, 10.7516f, 8.3884f, 10.8165f, 7.9054f)
                curveTo(10.8786f, 7.4439f, 10.9858f, 7.2464f, 11.1161f, 7.1161f)
                close()
            }
        }
            .build()
