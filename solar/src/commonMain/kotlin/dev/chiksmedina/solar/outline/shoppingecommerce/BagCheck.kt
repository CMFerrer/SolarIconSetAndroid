    ...
    get() {
        ...
        _bagCheck = Builder(
            ...
            path(
                ...
                close()
                moveTo(14.4983f, 11.9394f)
                curveTo(14.8079f, 12.2146f, 14.8357f, 12.6887f, 14.5606f, 12.9983f)
                lineTo(11.8939f, 15.9983f)
                curveTo(11.7612f, 16.1475f, 11.5745f, 16.2377f, 11.3751f, 16.2488f)
                curveTo(11.1757f, 16.26f, 10.9801f, 16.1911f, 10.8316f, 16.0575f)
                lineTo(9.4983f, 14.8575f)
                curveTo(9.1904f, 14.5804f, 9.1654f, 14.1062f, 9.4425f, 13.7983f)
                curveTo(9.7196f, 13.4904f, 10.1938f, 13.4654f, 10.5017f, 13.7425f)
                lineTo(11.2741f, 14.4377f)
                lineTo(13.4394f, 12.0017f)
                curveTo(13.7146f, 11.6921f, 14.1887f, 11.6643f, 14.4983f, 11.9394f)
                close()
            }
        }
            .build()
