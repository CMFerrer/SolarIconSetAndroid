    ...
    get() {
        ...
        _linkMinimalistic2 = Builder(
            ...
            path(
                ...
                moveTo(14.6928f, 9.3071f)
                curveTo(14.9857f, 9.6f, 14.9857f, 10.0748f, 14.6928f, 10.3677f)
                lineTo(10.3677f, 14.6928f)
                curveTo(10.0748f, 14.9857f, 9.6f, 14.9857f, 9.3071f, 14.6928f)
                curveTo(9.0142f, 14.3999f, 9.0142f, 13.9251f, 9.3071f, 13.6322f)
                lineTo(13.6322f, 9.3071f)
                curveTo(13.9251f, 9.0142f, 14.3999f, 9.0142f, 14.6928f, 9.3071f)
                close()
            }
        }
            .build()
