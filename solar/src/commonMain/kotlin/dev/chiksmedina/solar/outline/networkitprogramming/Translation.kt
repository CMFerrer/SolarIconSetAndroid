    ...
    get() {
        ...
        _translation = Builder(
            ...
            path(
                ...
                curveTo(8.6125f, 15.7282f, 8.6325f, 16.2027f, 8.3522f, 16.5076f)
                curveTo(8.0718f, 16.8126f, 7.5974f, 16.8325f, 7.2924f, 16.5522f)
                curveTo(6.0397f, 15.4007f, 5.25f, 13.7824f, 5.25f, 11.9823f)
            ...
            path(
                ...
                curveTo(18.75f, 13.7568f, 17.9825f, 15.3549f, 16.7604f, 16.5031f)
                curveTo(16.4586f, 16.7867f, 15.9839f, 16.7719f, 15.7003f, 16.47f)
                curveTo(15.4167f, 16.1682f, 15.4315f, 15.6935f, 15.7333f, 15.4099f)
                curveTo(16.6778f, 14.5225f, 17.25f, 13.3108f, 17.25f, 11.9823f)
            ...
            path(
                ...
                curveTo(10.4812f, 9.2501f, 9.25f, 10.4813f, 9.25f, 12.0001f)
                curveTo(9.25f, 13.5188f, 10.4812f, 14.7501f, 12.0f, 14.7501f)
                curveTo(13.5188f, 14.7501f, 14.75f, 13.5188f, 14.75f, 12.0001f)
                curveTo(14.75f, 10.4813f, 13.5188f, 9.2501f, 12.0f, 9.2501f)
                close()
                moveTo(10.75f, 12.0001f)
                curveTo(10.75f, 11.3097f, 11.3096f, 10.7501f, 12.0f, 10.7501f)
                curveTo(12.6904f, 10.7501f, 13.25f, 11.3097f, 13.25f, 12.0001f)
                curveTo(13.25f, 12.6904f, 12.6904f, 13.2501f, 12.0f, 13.2501f)
                curveTo(11.3096f, 13.2501f, 10.75f, 12.6904f, 10.75f, 12.0001f)
                close()
            }
        }
            .build()
