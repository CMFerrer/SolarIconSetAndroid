...
val FoldersGroup.FolderCheck: ImageVector
    get() {
        if (_folderCheck != null) {
            return _folderCheck!!
        }
        _folderCheck = Builder(
            name = "FolderCheck", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(
                ...
                close()
                moveTo(14.4983f, 11.4395f)
                curveTo(14.8078f, 11.7146f, 14.8357f, 12.1887f, 14.5605f, 12.4983f)
                lineTo(11.8939f, 15.4983f)
                curveTo(11.7515f, 15.6584f, 11.5475f, 15.75f, 11.3333f, 15.75f)
                curveTo(11.1191f, 15.75f, 10.9151f, 15.6584f, 10.7728f, 15.4983f)
                lineTo(9.4394f, 13.9983f)
                curveTo(9.1642f, 13.6887f, 9.1921f, 13.2146f, 9.5017f, 12.9395f)
                curveTo(9.8113f, 12.6643f, 10.2854f, 12.6922f, 10.5605f, 13.0017f)
                lineTo(11.3333f, 13.8711f)
                lineTo(13.4394f, 11.5017f)
                curveTo(13.7146f, 11.1922f, 14.1887f, 11.1643f, 14.4983f, 11.4395f)
                close()
            }
        }
            .build()
