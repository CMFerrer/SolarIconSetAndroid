    ...
    get() {
        ...
        _clipboardList = Builder(
            ...
            path(
                ...
                horizontalLineTo(7.5f)
                curveTo(7.9142f, 16.75f, 8.25f, 17.0858f, 8.25f, 17.5f)
                curveTo(8.25f, 17.9142f, 7.9142f, 18.25f, 7.5f, 18.25f)
                horizontalLineTo(7.0f)
                curveTo(6.5858f, 18.25f, 6.25f, 17.9142f, 6.25f, 17.5f)
                close()
                moveTo(9.75f, 17.5f)
                curveTo(9.75f, 17.0858f, 10.0858f, 16.75f, 10.5f, 16.75f)
                horizontalLineTo(17.0f)
                curveTo(17.4142f, 16.75f, 17.75f, 17.0858f, 17.75f, 17.5f)
                curveTo(17.75f, 17.9142f, 17.4142f, 18.25f, 17.0f, 18.25f)
                horizontalLineTo(10.5f)
                curveTo(10.0858f, 18.25f, 9.75f, 17.9142f, 9.75f, 17.5f)
                close()
            }
        }
            .build()
