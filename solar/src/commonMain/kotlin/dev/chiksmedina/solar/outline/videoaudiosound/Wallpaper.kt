    ...
    get() {
        ...
        _wallpaper = Builder(
            ...
            path(
                ...
                lineTo(4.25f, 14.8166f)
                curveTo(4.25f, 14.8161f, 4.25f, 14.8156f, 4.25f, 14.8151f)
                lineTo(4.25f, 7.9451f)
                curveTo(4.25f, 6.9005f, 4.25f, 6.0107f, 4.3019f, 5.2623f)
                close()
                moveTo(5.75f, 15.1209f)
                ...
                curveTo(17.743f, 20.439f, 17.8659f, 20.2533f, 17.9622f, 19.9952f)
                lineTo(16.0804f, 18.0092f)
                curveTo(15.577f, 17.478f, 14.8816f, 17.4416f, 14.352f, 17.8781f)
                lineTo(14.1322f, 18.0591f)
                curveTo(13.216f, 18.8142f, 11.9548f, 18.6658f, 11.1952f, 17.7751f)
                lineTo(8.0344f, 14.0687f)
                curveTo(7.6843f, 13.6583f, 7.1851f, 13.6485f, 6.8278f, 14.0152f)
                lineTo(5.75f, 15.1209f)
                close()
                moveTo(18.2292f, 18.0961f)
                lineTo(17.1692f, 16.9775f)
                curveTo(16.1406f, 15.892f, 14.5546f, 15.7673f, 13.398f, 16.7205f)
                lineTo(13.1783f, 16.9016f)
                curveTo(12.9228f, 17.1121f, 12.5897f, 17.0987f, 12.3365f, 16.8018f)
                lineTo(9.1757f, 13.0954f)
                curveTo(8.2639f, 12.0263f, 6.7392f, 11.957f, 5.7536f, 12.9682f)
                lineTo(5.75f, 12.9719f)
                verticalLineTo(8.0f)
                curveTo(5.75f, 6.5646f, 5.7516f, 5.5635f, 5.8532f, 4.8081f)
                curveTo(5.9518f, 4.0743f, 6.1323f, 3.6858f, 6.409f, 3.409f)
                curveTo(6.6858f, 3.1323f, 7.0744f, 2.9518f, 7.8081f, 2.8531f)
                curveTo(8.5635f, 2.7516f, 9.5646f, 2.75f, 11.0f, 2.75f)
                horizontalLineTo(13.0f)
                curveTo(14.4354f, 2.75f, 15.4366f, 2.7516f, 16.1919f, 2.8531f)
                ...
                verticalLineTo(16.0f)
                curveTo(18.25f, 16.8326f, 18.2495f, 17.519f, 18.2292f, 18.0961f)
                close()
                ...
                curveTo(14.9142f, 7.25f, 15.25f, 6.9142f, 15.25f, 6.5f)
                curveTo(15.25f, 6.0858f, 14.9142f, 5.75f, 14.5f, 5.75f)
                close()
                moveTo(12.25f, 6.5f)
                curveTo(12.25f, 5.2574f, 13.2574f, 4.25f, 14.5f, 4.25f)
                curveTo(15.7427f, 4.25f, 16.75f, 5.2574f, 16.75f, 6.5f)
                curveTo(16.75f, 7.7426f, 15.7427f, 8.75f, 14.5f, 8.75f)
                curveTo(13.2574f, 8.75f, 12.25f, 7.7426f, 12.25f, 6.5f)
                close()
            }
        }
            .build()
