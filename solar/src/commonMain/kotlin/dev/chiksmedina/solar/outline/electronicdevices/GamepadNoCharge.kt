    ...
    get() {
        ...
        _gamepadNoCharge = Builder(
            ...
            path(
                ...
                curveTo(16.931f, 19.75f, 15.9367f, 18.2615f, 15.6886f, 17.4714f)
                curveTo(15.5645f, 17.0762f, 15.7843f, 16.6553f, 16.1795f, 16.5312f)
                curveTo(16.5747f, 16.4071f, 16.9956f, 16.6269f, 17.1197f, 17.0221f)
                curveTo(17.2387f, 17.4008f, 17.7859f, 18.25f, 18.9733f, 18.25f)
                ...
                curveTo(6.2141f, 18.25f, 6.7613f, 17.4008f, 6.8803f, 17.0221f)
                curveTo(7.0044f, 16.6269f, 7.4253f, 16.4071f, 7.8205f, 16.5312f)
                curveTo(8.2157f, 16.6553f, 8.4355f, 17.0762f, 8.3114f, 17.4714f)
                curveTo(8.0633f, 18.2615f, 7.069f, 19.75f, 5.0267f, 19.75f)
                ...
                close()
                moveTo(9.4697f, 17.5303f)
                curveTo(9.1768f, 17.2374f, 9.1768f, 16.7626f, 9.4697f, 16.4697f)
                curveTo(9.7626f, 16.1768f, 10.2374f, 16.1768f, 10.5303f, 16.4697f)
                lineTo(12.0f, 17.9393f)
                lineTo(13.4697f, 16.4697f)
                curveTo(13.7626f, 16.1768f, 14.2374f, 16.1768f, 14.5303f, 16.4697f)
                curveTo(14.8232f, 16.7626f, 14.8232f, 17.2374f, 14.5303f, 17.5303f)
                lineTo(13.0607f, 19.0f)
                lineTo(14.5303f, 20.4697f)
                curveTo(14.8232f, 20.7626f, 14.8232f, 21.2374f, 14.5303f, 21.5303f)
                curveTo(14.2374f, 21.8232f, 13.7626f, 21.8232f, 13.4697f, 21.5303f)
                lineTo(12.0f, 20.0607f)
                lineTo(10.5303f, 21.5303f)
                curveTo(10.2374f, 21.8232f, 9.7626f, 21.8232f, 9.4697f, 21.5303f)
                curveTo(9.1768f, 21.2374f, 9.1768f, 20.7626f, 9.4697f, 20.4697f)
                lineTo(10.9393f, 19.0f)
                lineTo(9.4697f, 17.5303f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
