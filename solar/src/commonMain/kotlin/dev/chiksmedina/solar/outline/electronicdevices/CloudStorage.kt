    ...
    get() {
        ...
        _cloudStorage = Builder(
            ...
            path(
                ...
                close()
                moveTo(11.4506f, 13.25f)
                horizontalLineTo(12.5494f)
                curveTo(13.2142f, 13.25f, 13.7871f, 13.2499f, 14.2458f, 13.3116f)
                curveTo(14.7375f, 13.3777f, 15.2087f, 13.5268f, 15.591f, 13.909f)
                curveTo(15.9732f, 14.2913f, 16.1223f, 14.7625f, 16.1884f, 15.2542f)
                curveTo(16.2501f, 15.7129f, 16.25f, 16.2858f, 16.25f, 16.9506f)
                verticalLineTo(19.0494f)
                curveTo(16.25f, 19.7142f, 16.2501f, 20.2871f, 16.1884f, 20.7458f)
                curveTo(16.1223f, 21.2375f, 15.9732f, 21.7087f, 15.591f, 22.091f)
                curveTo(15.2087f, 22.4732f, 14.7375f, 22.6223f, 14.2458f, 22.6884f)
                curveTo(13.7871f, 22.7501f, 13.2142f, 22.75f, 12.5494f, 22.75f)
                horizontalLineTo(11.4506f)
                curveTo(10.7858f, 22.75f, 10.2129f, 22.7501f, 9.7542f, 22.6884f)
                curveTo(9.2625f, 22.6223f, 8.7913f, 22.4732f, 8.409f, 22.091f)
                curveTo(8.0268f, 21.7087f, 7.8777f, 21.2375f, 7.8116f, 20.7458f)
                curveTo(7.7499f, 20.2871f, 7.75f, 19.7142f, 7.75f, 19.0494f)
                verticalLineTo(16.9506f)
                curveTo(7.75f, 16.2858f, 7.7499f, 15.7129f, 7.8116f, 15.2542f)
                curveTo(7.8777f, 14.7625f, 8.0268f, 14.2913f, 8.409f, 13.909f)
                curveTo(8.7913f, 13.5268f, 9.2625f, 13.3777f, 9.7542f, 13.3116f)
                curveTo(10.2129f, 13.2499f, 10.7858f, 13.25f, 11.4506f, 13.25f)
                close()
                moveTo(9.954f, 14.7982f)
                curveTo(9.6287f, 14.842f, 9.5268f, 14.9126f, 9.4697f, 14.9697f)
                curveTo(9.4126f, 15.0268f, 9.342f, 15.1287f, 9.2982f, 15.454f)
                curveTo(9.2516f, 15.8009f, 9.25f, 16.2717f, 9.25f, 17.0f)
                verticalLineTo(19.0f)
                curveTo(9.25f, 19.7283f, 9.2516f, 20.1991f, 9.2982f, 20.546f)
                curveTo(9.342f, 20.8713f, 9.4126f, 20.9732f, 9.4697f, 21.0303f)
                curveTo(9.5268f, 21.0874f, 9.6287f, 21.158f, 9.954f, 21.2018f)
                curveTo(10.3009f, 21.2484f, 10.7717f, 21.25f, 11.5f, 21.25f)
                horizontalLineTo(12.5f)
                curveTo(13.2283f, 21.25f, 13.6991f, 21.2484f, 14.046f, 21.2018f)
                curveTo(14.3713f, 21.158f, 14.4732f, 21.0874f, 14.5303f, 21.0303f)
                curveTo(14.5874f, 20.9732f, 14.658f, 20.8713f, 14.7018f, 20.546f)
                curveTo(14.7484f, 20.1991f, 14.75f, 19.7283f, 14.75f, 19.0f)
                verticalLineTo(17.0f)
                curveTo(14.75f, 16.2717f, 14.7484f, 15.8009f, 14.7018f, 15.454f)
                curveTo(14.658f, 15.1287f, 14.5874f, 15.0268f, 14.5303f, 14.9697f)
                curveTo(14.4732f, 14.9126f, 14.3713f, 14.842f, 14.046f, 14.7982f)
                curveTo(13.6991f, 14.7516f, 13.2283f, 14.75f, 12.5f, 14.75f)
                horizontalLineTo(11.5f)
                curveTo(10.7717f, 14.75f, 10.3009f, 14.7516f, 9.954f, 14.7982f)
                close()
                moveTo(10.25f, 18.0f)
