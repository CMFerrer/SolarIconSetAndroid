    ...
    get() {
        ...
        _boxMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(4.1561f, 19.2263f, 4.9923f, 19.6651f, 6.0372f, 20.2134f)
                lineTo(8.1049f, 21.2985f)
                ...
                lineTo(3.6605f, 6.9917f)
                curveTo(3.8396f, 6.8158f, 4.0613f, 6.6408f, 4.3435f, 6.4523f)
                curveTo(4.9155f, 6.0703f, 5.6811f, 5.6675f, 6.7708f, 5.0956f)
