    ...
    get() {
        ...
        _fileRight = Builder(
            ...
            path(
                ...
                moveTo(11.5472f, 15.487f)
                curveTo(11.8176f, 15.7755f, 11.8176f, 16.2245f, 11.5472f, 16.513f)
                lineTo(9.6721f, 18.513f)
                curveTo(9.3889f, 18.8151f, 8.9142f, 18.8305f, 8.612f, 18.5472f)
                curveTo(8.3099f, 18.2639f, 8.2945f, 17.7892f, 8.5779f, 17.487f)
                lineTo(9.2688f, 16.75f)
                ...
                lineTo(8.5779f, 14.513f)
                curveTo(8.2945f, 14.2108f, 8.3099f, 13.7361f, 8.612f, 13.4528f)
                curveTo(8.9142f, 13.1696f, 9.3889f, 13.1849f, 9.6721f, 13.487f)
                lineTo(11.5472f, 15.487f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
