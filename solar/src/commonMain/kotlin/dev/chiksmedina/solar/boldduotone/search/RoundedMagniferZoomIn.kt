    ...
    get() {
        ...
        _roundedMagniferZoomIn = Builder(
            ...
            path(
                ...
                moveTo(11.156f, 8.0244f)
                curveTo(11.5552f, 8.0244f, 11.8789f, 8.3481f, 11.8789f, 8.7473f)
                verticalLineTo(10.4341f)
                horizontalLineTo(13.5656f)
                curveTo(13.9648f, 10.4341f, 14.2885f, 10.7577f, 14.2885f, 11.1569f)
                curveTo(14.2885f, 11.5562f, 13.9648f, 11.8798f, 13.5656f, 11.8798f)
                horizontalLineTo(11.8789f)
                verticalLineTo(13.5666f)
                curveTo(11.8789f, 13.9658f, 11.5552f, 14.2895f, 11.156f, 14.2895f)
                curveTo(10.7567f, 14.2895f, 10.4331f, 13.9658f, 10.4331f, 13.5666f)
                verticalLineTo(11.8798f)
                horizontalLineTo(8.7463f)
                curveTo(8.3471f, 11.8798f, 8.0234f, 11.5562f, 8.0234f, 11.1569f)
                curveTo(8.0234f, 10.7577f, 8.3471f, 10.4341f, 8.7463f, 10.4341f)
                horizontalLineTo(10.4331f)
                verticalLineTo(8.7473f)
                curveTo(10.4331f, 8.3481f, 10.7567f, 8.0244f, 11.156f, 8.0244f)
                close()
            }
        }
            .build()
