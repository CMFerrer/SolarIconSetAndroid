    ...
    get() {
        ...
        _gamepadNoCharge = Builder(
            ...
            path(
                ...
                curveTo(17.0336f, 18.2953f, 16.6737f, 17.9471f, 16.3139f, 17.599f)
                curveTo(15.8693f, 17.1688f, 15.4249f, 16.7389f, 14.8888f, 16.4609f)
                ...
                curveTo(8.5751f, 16.7389f, 8.1307f, 17.1688f, 7.6861f, 17.599f)
                curveTo(7.3263f, 17.9471f, 6.9664f, 18.2953f, 6.5576f, 18.5632f)
            ...
            path(
                ...
                moveTo(10.4697f, 17.4697f)
                curveTo(10.7626f, 17.1768f, 11.2374f, 17.1768f, 11.5303f, 17.4697f)
                lineTo(12.0f, 17.9393f)
                lineTo(12.4697f, 17.4697f)
                curveTo(12.7626f, 17.1768f, 13.2374f, 17.1768f, 13.5303f, 17.4697f)
                curveTo(13.8232f, 17.7626f, 13.8232f, 18.2374f, 13.5303f, 18.5303f)
                lineTo(13.0607f, 19.0f)
                lineTo(13.5303f, 19.4697f)
                curveTo(13.8232f, 19.7626f, 13.8232f, 20.2374f, 13.5303f, 20.5303f)
                curveTo(13.2374f, 20.8232f, 12.7626f, 20.8232f, 12.4697f, 20.5303f)
                lineTo(12.0f, 20.0607f)
                lineTo(11.5303f, 20.5303f)
                curveTo(11.2374f, 20.8232f, 10.7626f, 20.8232f, 10.4697f, 20.5303f)
                curveTo(10.1768f, 20.2374f, 10.1768f, 19.7626f, 10.4697f, 19.4697f)
                lineTo(10.9393f, 19.0f)
                lineTo(10.4697f, 18.5303f)
                curveTo(10.1768f, 18.2374f, 10.1768f, 17.7626f, 10.4697f, 17.4697f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
