    ...
    get() {
        ...
        _translation = Builder(
            ...
            path(
                ...
                moveTo(8.3092f, 7.4875f)
                curveTo(8.5923f, 7.79f, 8.5765f, 8.2646f, 8.2741f, 8.5476f)
                curveTo(7.3252f, 9.4356f, 6.75f, 10.6502f, 6.75f, 11.9822f)
                curveTo(6.75f, 13.3297f, 7.3387f, 14.5572f, 8.3076f, 15.4478f)
                ...
                curveTo(5.25f, 10.203f, 6.0215f, 8.6012f, 7.2492f, 7.4524f)
                curveTo(7.5516f, 7.1694f, 8.0262f, 7.1851f, 8.3092f, 7.4875f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.8f, strokeAlpha
                ...
                curveTo(16.0292f, 7.2262f, 16.5039f, 7.2157f, 16.8033f, 7.502f)
                curveTo(18.0005f, 8.6471f, 18.75f, 10.2286f, 18.75f, 11.9822f)
                curveTo(18.75f, 13.7568f, 17.9825f, 15.3548f, 16.7604f, 16.503f)
                curveTo(16.4586f, 16.7866f, 15.9839f, 16.7718f, 15.7003f, 16.47f)
                curveTo(15.4167f, 16.1681f, 15.4315f, 15.6935f, 15.7333f, 15.4098f)
                curveTo(16.6778f, 14.5225f, 17.25f, 13.3107f, 17.25f, 11.9822f)
                curveTo(17.25f, 10.6691f, 16.6911f, 9.4704f, 15.7664f, 8.586f)
