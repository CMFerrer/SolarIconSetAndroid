    ...
    get() {
        ...
        _dumbbells = Builder(
            ...
            path(
                ...
                moveTo(7.7612f, 19.925f)
                lineTo(7.0692f, 17.1586f)
                curveTo(6.908f, 16.5142f, 6.8274f, 16.1919f, 6.8621f, 15.9095f)
                curveTo(6.9084f, 15.533f, 7.0924f, 15.1916f, 7.3737f, 14.9604f)
                curveTo(7.5847f, 14.787f, 7.8855f, 14.7006f, 8.4872f, 14.5279f)
                curveTo(9.0889f, 14.3552f, 9.3897f, 14.2689f, 9.6533f, 14.3061f)
                curveTo(10.0049f, 14.3556f, 10.3236f, 14.5528f, 10.5395f, 14.8541f)
                curveTo(10.7013f, 15.08f, 10.8685f, 15.7481f, 11.0297f, 16.3926f)
                lineTo(17.0021f, 14.6784f)
                curveTo(16.8408f, 14.0339f, 16.6737f, 13.3659f, 16.7084f, 13.0835f)
                curveTo(16.7547f, 12.707f, 16.9387f, 12.3656f, 17.22f, 12.1344f)
                curveTo(17.431f, 11.961f, 17.7318f, 11.8746f, 18.3335f, 11.7019f)
                curveTo(18.9352f, 11.5292f, 19.236f, 11.4429f, 19.4997f, 11.4801f)
                curveTo(19.8512f, 11.5296f, 20.17f, 11.7268f, 20.3858f, 12.0281f)
                curveTo(20.5477f, 12.254f, 20.6283f, 12.5763f, 20.7895f, 13.2208f)
                lineTo(21.4815f, 15.9871f)
                curveTo(21.6428f, 16.6316f, 21.7234f, 16.9539f, 21.6887f, 17.2363f)
                curveTo(21.6424f, 17.6128f, 21.4584f, 17.9542f, 21.1771f, 18.1854f)
                curveTo(20.9661f, 18.3588f, 20.6653f, 18.4451f, 20.0636f, 18.6178f)
                lineTo(20.0636f, 18.6178f)
                lineTo(20.0636f, 18.6178f)
                curveTo(19.4619f, 18.7905f, 19.161f, 18.8769f, 18.8974f, 18.8397f)
                curveTo(18.5459f, 18.7901f, 18.2271f, 18.593f, 18.0113f, 18.2917f)
                curveTo(17.8494f, 18.0657f, 17.6823f, 17.3977f, 17.5211f, 16.7532f)
                lineTo(11.5487f, 18.4673f)
                curveTo(11.7099f, 19.1118f, 11.877f, 19.7799f, 11.8423f, 20.0623f)
                curveTo(11.796f, 20.4388f, 11.612f, 20.7802f, 11.3307f, 21.0114f)
                curveTo(11.1197f, 21.1848f, 10.8189f, 21.2711f, 10.2172f, 21.4438f)
                lineTo(10.2172f, 21.4438f)
                lineTo(10.2172f, 21.4438f)
                curveTo(9.6155f, 21.6165f, 9.3147f, 21.7029f, 9.0511f, 21.6657f)
                curveTo(8.6995f, 21.6161f, 8.3808f, 21.419f, 8.1649f, 21.1177f)
                curveTo(8.003f, 20.8917f, 7.9224f, 20.5695f, 7.7612f, 19.925f)
                close()
            }
        }
            .build()
