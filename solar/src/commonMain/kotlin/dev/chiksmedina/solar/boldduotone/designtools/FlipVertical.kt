    ...
    get() {
        ...
        _flipVertical = Builder(
            ...
            path(
                ...
                curveTo(4.1843f, 22.0f, 3.3332f, 22.0f, 3.054f, 21.4576f)
                curveTo(2.7749f, 20.9152f, 3.2696f, 20.2226f, 4.2589f, 18.8375f)
                lineTo(5.3884f, 17.2563f)
                curveTo(5.8283f, 16.6404f, 6.0483f, 16.3325f, 6.3713f, 16.1662f)
                curveTo(6.6943f, 16.0f, 7.0728f, 16.0f, 7.8296f, 16.0f)
                horizontalLineTo(16.1705f)
                curveTo(16.9273f, 16.0f, 17.3057f, 16.0f, 17.6288f, 16.1662f)
                curveTo(17.9518f, 16.3325f, 18.1718f, 16.6404f, 18.6117f, 17.2563f)
                lineTo(19.7411f, 18.8375f)
                curveTo(20.7305f, 20.2226f, 21.2251f, 20.9152f, 20.946f, 21.4576f)
                curveTo(20.6669f, 22.0f, 19.8158f, 22.0f, 18.1136f, 22.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                lineTo(5.8864f, 2.0f)
                curveTo(4.1843f, 2.0f, 3.3332f, 2.0f, 3.054f, 2.5424f)
                curveTo(2.7749f, 3.0848f, 3.2696f, 3.7774f, 4.2589f, 5.1625f)
                lineTo(5.3884f, 6.7437f)
                curveTo(5.8283f, 7.3596f, 6.0483f, 7.6675f, 6.3713f, 7.8337f)
                curveTo(6.6943f, 8.0f, 7.0728f, 8.0f, 7.8296f, 8.0f)
                lineTo(16.1705f, 8.0f)
                curveTo(16.9273f, 8.0f, 17.3057f, 8.0f, 17.6288f, 7.8337f)
                curveTo(17.9518f, 7.6675f, 18.1718f, 7.3596f, 18.6117f, 6.7437f)
                lineTo(19.7411f, 5.1625f)
                curveTo(20.7305f, 3.7774f, 21.2251f, 3.0848f, 20.946f, 2.5424f)
                curveTo(20.6669f, 2.0f, 19.8158f, 2.0f, 18.1136f, 2.0f)
                close()
            }
            path(
