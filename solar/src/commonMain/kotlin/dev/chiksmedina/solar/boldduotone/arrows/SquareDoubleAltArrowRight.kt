...
val ArrowsGroup.SquareDoubleAltArrowRight: ImageVector
    get() {
        if (_squareDoubleAltArrowRight != null) {
            return _squareDoubleAltArrowRight!!
        }
        _squareDoubleAltArrowRight = Builder(
            name = "SquareDoubleAltArrowRight", defaultWidth =
