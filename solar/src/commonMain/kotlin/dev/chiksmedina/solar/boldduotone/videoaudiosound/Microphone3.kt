    ...
    get() {
        ...
        _microphone3 = Builder(
            ...
            path(
                ...
                moveTo(13.0f, 8.5f)
                curveTo(13.4142f, 8.5f, 13.75f, 8.1642f, 13.75f, 7.75f)
                curveTo(13.75f, 7.3358f, 13.4142f, 7.0f, 13.0f, 7.0f)
                horizontalLineTo(11.0f)
                curveTo(10.5858f, 7.0f, 10.25f, 7.3358f, 10.25f, 7.75f)
                curveTo(10.25f, 8.1642f, 10.5858f, 8.5f, 11.0f, 8.5f)
                horizontalLineTo(13.0f)
                close()
            }
        }
