    ...
    get() {
        ...
        _hashtagChat = Builder(
            ...
            path(
                ...
                curveTo(15.9754f, 20.8808f, 15.8702f, 20.7032f, 15.7014f, 20.605f)
                curveTo(15.5325f, 20.5068f, 15.32f, 20.5031f, 14.8948f, 20.4958f)
                curveTo(14.2671f, 20.4849f, 13.8734f, 20.4465f, 13.5433f, 20.3097f)
                curveTo(12.9307f, 20.056f, 12.444f, 19.5693f, 12.1903f, 18.9567f)
                curveTo(12.0f, 18.4973f, 12.0f, 17.9149f, 12.0f, 16.75f)
                verticalLineTo(16.25f)
                curveTo(12.0f, 14.6133f, 12.0f, 13.7949f, 12.3684f, 13.1938f)
                curveTo(12.5745f, 12.8574f, 12.8574f, 12.5745f, 13.1938f, 12.3684f)
                curveTo(13.7949f, 12.0f, 14.6133f, 12.0f, 16.25f, 12.0f)
                horizontalLineTo(17.75f)
                curveTo(19.3867f, 12.0f, 20.2051f, 12.0f, 20.8062f, 12.3684f)
                curveTo(21.1426f, 12.5745f, 21.4255f, 12.8574f, 21.6316f, 13.1938f)
                curveTo(22.0f, 13.7949f, 22.0f, 14.6133f, 22.0f, 16.25f)
                verticalLineTo(16.75f)
                curveTo(22.0f, 17.9149f, 22.0f, 18.4973f, 21.8097f, 18.9567f)
                curveTo(21.556f, 19.5693f, 21.0693f, 20.056f, 20.4567f, 20.3097f)
                curveTo(20.1266f, 20.4465f, 19.7329f, 20.4849f, 19.1052f, 20.4958f)
                curveTo(18.68f, 20.5031f, 18.4674f, 20.5068f, 18.2986f, 20.605f)
            ...
            path(
                ...
                horizontalLineTo(17.9034f)
                lineTo(17.2784f, 11.9999f)
                horizontalLineTo(16.25f)
                curveTo(16.0635f, 11.9999f, 15.8876f, 11.9999f, 15.7215f, 12.0005f)
                lineTo(16.3466f, 9.75f)
                horizontalLineTo(8.9034f)
                lineTo(7.3756f, 15.2499f)
                horizontalLineTo(12.0044f)
                curveTo(12.0f, 15.5454f, 12.0f, 15.8764f, 12.0f, 16.25f)
            ...
            path(
                ...
                lineTo(14.9184f, 20.4961f)
                curveTo(14.9106f, 20.496f, 14.9027f, 20.4958f, 14.8948f, 20.4957f)
                curveTo(14.2671f, 20.4849f, 13.8734f, 20.4464f, 13.5433f, 20.3097f)
                curveTo(13.5042f, 20.2935f, 13.4656f, 20.2764f, 13.4276f, 20.2583f)
                close()
            }
        }
            .build()
