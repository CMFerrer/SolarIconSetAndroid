    ...
    get() {
        ...
        _chatSquareLike = Builder(
            ...
            path(
                ...
                curveTo(9.6633f, 13.3304f, 7.5f, 11.4674f, 7.5f, 9.7148f)
                curveTo(7.5f, 7.0376f, 9.9751f, 6.0381f, 12.0f, 8.1061f)
                curveTo(14.0249f, 6.0381f, 16.5f, 7.0376f, 16.5f, 9.7148f)
                curveTo(16.5f, 11.4674f, 14.3367f, 13.3304f, 13.0099f, 14.3082f)
                curveTo(12.5558f, 14.643f, 12.3287f, 14.8103f, 12.0f, 14.8103f)
                curveTo(11.6713f, 14.8103f, 11.4442f, 14.643f, 10.9901f, 14.3082f)
                close()
            }
        }
            .build()
