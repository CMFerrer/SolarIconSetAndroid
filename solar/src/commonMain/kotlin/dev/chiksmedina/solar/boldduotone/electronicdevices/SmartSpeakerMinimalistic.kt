    ...
    get() {
        ...
        _smartSpeakerMinimalistic = Builder(
            ...
            path(
                ...
                lineTo(8.426f, 21.7472f)
                curveTo(8.9206f, 21.8088f, 9.168f, 21.8396f, 9.415f, 21.8654f)
                curveTo(11.1335f, 22.0449f, 12.866f, 22.0449f, 14.5845f, 21.8654f)
                curveTo(14.8315f, 21.8396f, 15.0789f, 21.8088f, 15.5735f, 21.7472f)
            ...
            path(
                ...
                moveTo(7.4816f, 5.425f)
                curveTo(7.164f, 5.1591f, 6.691f, 5.2009f, 6.425f, 5.5185f)
                curveTo(6.1591f, 5.836f, 6.2009f, 6.3091f, 6.5185f, 6.575f)
                curveTo(7.3804f, 7.2969f, 9.3439f, 8.25f, 12.0f, 8.25f)
                curveTo(14.6562f, 8.25f, 16.6196f, 7.2969f, 17.4816f, 6.575f)
                curveTo(17.7991f, 6.3091f, 17.841f, 5.836f, 17.575f, 5.5185f)
                curveTo(17.3091f, 5.2009f, 16.836f, 5.1591f, 16.5185f, 5.425f)
                curveTo(15.9413f, 5.9084f, 14.3238f, 6.75f, 12.0f, 6.75f)
                curveTo(9.6762f, 6.75f, 8.0587f, 5.9084f, 7.4816f, 5.425f)
                close()
            }
        }
            .build()
