    ...
    get() {
        ...
        _ovenMittsMinimalistic = Builder(
            ...
            path(
                ...
                moveTo(7.0409f, 12.8602f)
                curveTo(6.7448f, 12.5706f, 6.2699f, 12.576f, 5.9803f, 12.8722f)
                curveTo(5.6908f, 13.1683f, 5.6961f, 13.6432f, 5.9923f, 13.9328f)
                lineTo(10.2748f, 18.1199f)
                curveTo(10.571f, 18.4095f, 11.0458f, 18.4041f, 11.3354f, 18.108f)
                curveTo(11.625f, 17.8118f, 11.6196f, 17.337f, 11.3235f, 17.0474f)
                lineTo(7.0409f, 12.8602f)
                close()
            }
        }
            .build()
