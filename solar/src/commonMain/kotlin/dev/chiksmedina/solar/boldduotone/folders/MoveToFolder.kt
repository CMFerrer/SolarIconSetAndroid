    ...
    get() {
        ...
        _moveToFolder = Builder(
            ...
            path(
                ...
                curveTo(22.0f, 9.1655f, 22.0f, 7.8493f, 21.2306f, 6.9938f)
                curveTo(21.1598f, 6.9151f, 21.0849f, 6.8402f, 21.0062f, 6.7695f)
                curveTo(20.1507f, 6.0f, 18.8345f, 6.0f, 16.2021f, 6.0f)
                horizontalLineTo(15.8284f)
                curveTo(14.6748f, 6.0f, 14.0979f, 6.0f, 13.5604f, 5.8468f)
                curveTo(13.2651f, 5.7626f, 12.9805f, 5.6447f, 12.7121f, 5.4954f)
                curveTo(12.2237f, 5.2237f, 11.8158f, 4.8158f, 11.0f, 4.0f)
                lineTo(10.4498f, 3.4497f)
                curveTo(10.1763f, 3.1763f, 10.0396f, 3.0396f, 9.896f, 2.9205f)
                curveTo(9.2765f, 2.407f, 8.5167f, 2.0923f, 7.7156f, 2.0174f)
                curveTo(7.5298f, 2.0f, 7.3364f, 2.0f, 6.9498f, 2.0f)
                curveTo(6.0672f, 2.0f, 5.626f, 2.0f, 5.2584f, 2.0694f)
                curveTo(3.6403f, 2.3746f, 2.3747f, 3.6403f, 2.0694f, 5.2584f)
                curveTo(2.0f, 5.6259f, 2.0f, 6.0672f, 2.0f, 6.9497f)
                lineTo(2.0f, 14.0f)
                lineTo(2.0f, 14.2501f)
                lineTo(2.0056f, 15.7501f)
                curveTo(2.0332f, 18.3859f, 2.1972f, 19.8541f, 3.1716f, 20.8284f)
                curveTo(4.3432f, 22.0f, 6.2288f, 22.0f, 10.0f, 22.0f)
                horizontalLineTo(14.0f)
                curveTo(17.7713f, 22.0f, 19.6569f, 22.0f, 20.8284f, 20.8284f)
            ...
            path(
                ...
                moveTo(9.3162f, 11.3935f)
                curveTo(8.9812f, 11.1499f, 8.5121f, 11.2239f, 8.2685f, 11.5589f)
                curveTo(8.0248f, 11.8939f, 8.0989f, 12.363f, 8.4339f, 12.6066f)
                lineTo(10.6936f, 14.2501f)
                horizontalLineTo(2.0f)
                lineTo(2.0056f, 15.7501f)
                horizontalLineTo(10.6936f)
                lineTo(8.4339f, 17.3935f)
                curveTo(8.0989f, 17.6371f, 8.0248f, 18.1062f, 8.2685f, 18.4412f)
