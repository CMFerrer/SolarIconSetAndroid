    ...
    get() {
        ...
        _smartVacuumCleaner2 = Builder(
            ...
            path(
                ...
                curveTo(22.8232f, 22.2374f, 22.8232f, 21.7626f, 22.5303f, 21.4697f)
                lineTo(19.0f, 17.9393f)
            ...
            path(
                ...
                curveTo(14.25f, 9.9926f, 13.2426f, 11.0f, 12.0f, 11.0f)
            ...
            path(
                ...
                curveTo(6.4771f, 1.5f, 2.0f, 5.9771f, 2.0f, 11.5f)
                curveTo(2.0f, 17.0228f, 6.4771f, 21.5f, 12.0f, 21.5f)
                close()
                moveTo(8.25f, 8.75f)
