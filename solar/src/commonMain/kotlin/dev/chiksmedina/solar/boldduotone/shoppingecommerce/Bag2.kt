    ...
    get() {
        ...
        _bag2 = Builder(
            ...
            path(
                ...
                moveTo(8.2598f, 10.8768f)
                curveTo(8.3279f, 10.4682f, 8.7143f, 10.1922f, 9.1229f, 10.2603f)
                curveTo(9.5315f, 10.3284f, 9.8075f, 10.7148f, 9.7394f, 11.1234f)
                lineTo(8.7394f, 17.1234f)
                curveTo(8.6713f, 17.532f, 8.2849f, 17.808f, 7.8763f, 17.7399f)
                curveTo(7.4678f, 17.6718f, 7.1917f, 17.2854f, 7.2598f, 16.8768f)
                lineTo(8.2598f, 10.8768f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(14.8766f, 10.2603f)
                curveTo(15.2851f, 10.1922f, 15.6716f, 10.4682f, 15.7397f, 10.8768f)
                lineTo(16.7397f, 16.8768f)
                curveTo(16.8078f, 17.2854f, 16.5317f, 17.6718f, 16.1232f, 17.7399f)
                curveTo(15.7146f, 17.808f, 15.3282f, 17.532f, 15.2601f, 17.1234f)
                lineTo(14.2601f, 11.1234f)
                curveTo(14.192f, 10.7148f, 14.468f, 10.3284f, 14.8766f, 10.2603f)
                close()
            }
        }
            .build()
