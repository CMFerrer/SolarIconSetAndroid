    ...
    get() {
        ...
        _printer = Builder(
            ...
            path(
                ...
                moveTo(15.0f, 17.5f)
                curveTo(15.4142f, 17.5f, 15.75f, 17.1642f, 15.75f, 16.75f)
                curveTo(15.75f, 16.3358f, 15.4142f, 16.0f, 15.0f, 16.0f)
                horizontalLineTo(9.0f)
                curveTo(8.5858f, 16.0f, 8.25f, 16.3358f, 8.25f, 16.75f)
                curveTo(8.25f, 17.1642f, 8.5858f, 17.5f, 9.0f, 17.5f)
                horizontalLineTo(15.0f)
                close()
            }
            path(
                ...
                moveTo(13.0f, 20.5f)
                curveTo(13.4142f, 20.5f, 13.75f, 20.1642f, 13.75f, 19.75f)
                curveTo(13.75f, 19.3358f, 13.4142f, 19.0f, 13.0f, 19.0f)
                horizontalLineTo(9.0f)
                curveTo(8.5858f, 19.0f, 8.25f, 19.3358f, 8.25f, 19.75f)
                curveTo(8.25f, 20.1642f, 8.5858f, 20.5f, 9.0f, 20.5f)
                horizontalLineTo(13.0f)
                close()
            }
            path(
