    ...
    get() {
        ...
        _cart2 = Builder(
            ...
            path(
                ...
                moveTo(4.6477f, 9.1176f)
                lineTo(7.504f, 13.2237f)
                lineTo(11.2321f, 8.75f)
                horizontalLineTo(12.768f)
                lineTo(16.496f, 13.2237f)
                lineTo(19.3612f, 9.1049f)
                curveTo(19.8682f, 9.2758f, 20.2525f, 9.5288f, 20.5452f, 9.9038f)
                curveTo(20.5608f, 9.9237f, 20.576f, 9.9438f, 20.5908f, 9.9641f)
                lineTo(17.4919f, 14.4187f)
                lineTo(19.8842f, 17.2894f)
                curveTo(19.7012f, 17.9881f, 19.5369f, 18.5409f, 19.3443f, 18.9846f)
                lineTo(16.6036f, 15.6958f)
                lineTo(13.0876f, 20.75f)
                horizontalLineTo(10.9125f)
                lineTo(7.3965f, 15.6958f)
                lineTo(4.686f, 18.9483f)
                curveTo(4.4963f, 18.5019f, 4.3332f, 17.947f, 4.1508f, 17.2476f)
                lineTo(6.5082f, 14.4187f)
                lineTo(3.4319f, 9.9966f)
                curveTo(3.4539f, 9.9653f, 3.4768f, 9.9343f, 3.5007f, 9.9038f)
                curveTo(3.7862f, 9.538f, 4.159f, 9.2882f, 4.6477f, 9.1176f)
                close()
                moveTo(12.0f, 19.6867f)
                lineTo(8.3924f, 14.5007f)
                lineTo(12.0f, 10.1715f)
                lineTo(15.6077f, 14.5007f)
                lineTo(12.0f, 19.6867f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
