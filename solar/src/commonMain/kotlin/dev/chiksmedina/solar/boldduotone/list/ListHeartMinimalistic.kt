    ...
    get() {
        ...
        _listHeartMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(13.0f, 13.4674f, 15.1633f, 15.3304f, 16.4901f, 16.3082f)
                curveTo(16.9442f, 16.643f, 17.1713f, 16.8103f, 17.5f, 16.8103f)
                curveTo(17.8287f, 16.8103f, 18.0558f, 16.643f, 18.5099f, 16.3083f)
                curveTo(19.8367f, 15.3304f, 22.0f, 13.4674f, 22.0f, 11.7148f)
                curveTo(22.0f, 9.0376f, 19.5249f, 8.0381f, 17.5f, 10.1062f)
