    ...
    get() {
        ...
        _settings = Builder(
            ...
            path(
                ...
                moveTo(15.5227f, 12.0f)
                curveTo(15.5227f, 13.6569f, 14.1694f, 15.0f, 12.4999f, 15.0f)
                curveTo(10.8304f, 15.0f, 9.477f, 13.6569f, 9.477f, 12.0f)
                curveTo(9.477f, 10.3431f, 10.8304f, 9.0f, 12.4999f, 9.0f)
                curveTo(14.1694f, 9.0f, 15.5227f, 10.3431f, 15.5227f, 12.0f)
                close()
            }
        }
            .build()
