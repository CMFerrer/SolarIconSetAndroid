    ...
    get() {
        ...
        _shieldNetwork = Builder(
            ...
            path(
                ...
                moveTo(6.6877f, 9.7996f)
                curveTo(6.3987f, 10.4972f, 6.25f, 11.2449f, 6.25f, 12.0f)
                curveTo(6.25f, 12.7551f, 6.3987f, 13.5028f, 6.6877f, 14.2004f)
                curveTo(6.9767f, 14.8981f, 7.4002f, 15.5319f, 7.9341f, 16.0659f)
                curveTo(8.4681f, 16.5998f, 9.1019f, 17.0233f, 9.7996f, 17.3123f)
                curveTo(10.4972f, 17.6013f, 11.2449f, 17.75f, 12.0f, 17.75f)
                curveTo(12.7551f, 17.75f, 13.5028f, 17.6013f, 14.2004f, 17.3123f)
                curveTo(14.8981f, 17.0233f, 15.5319f, 16.5998f, 16.0659f, 16.0659f)
                curveTo(16.5998f, 15.5319f, 17.0233f, 14.8981f, 17.3123f, 14.2004f)
                curveTo(17.6013f, 13.5028f, 17.75f, 12.7551f, 17.75f, 12.0f)
                curveTo(17.75f, 11.2449f, 17.6013f, 10.4972f, 17.3123f, 9.7996f)
                curveTo(17.0233f, 9.1019f, 16.5998f, 8.4681f, 16.0659f, 7.9341f)
                curveTo(15.5319f, 7.4002f, 14.8981f, 6.9767f, 14.2004f, 6.6877f)
                curveTo(13.5028f, 6.3987f, 12.7551f, 6.25f, 12.0f, 6.25f)
                curveTo(11.2449f, 6.25f, 10.4972f, 6.3987f, 9.7996f, 6.6877f)
                curveTo(9.1019f, 6.9767f, 8.4681f, 7.4002f, 7.9341f, 7.9341f)
                curveTo(7.4002f, 8.4681f, 6.9767f, 9.1019f, 6.6877f, 9.7996f)
                close()
                ...
                close()
                moveTo(9.4123f, 9.964f)
                curveTo(9.3436f, 10.379f, 9.2964f, 10.811f, 9.2713f, 11.25f)
                horizontalLineTo(7.8167f)
                curveTo(7.8705f, 10.9502f, 7.9564f, 10.6563f, 8.0735f, 10.3736f)
                curveTo(8.2871f, 9.858f, 8.6002f, 9.3894f, 8.9948f, 8.9948f)
                curveTo(9.2449f, 8.7447f, 9.5247f, 8.5273f, 9.8274f, 8.3473f)
                curveTo(9.6479f, 8.8331f, 9.5089f, 9.3811f, 9.4123f, 9.964f)
                close()
