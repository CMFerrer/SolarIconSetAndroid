    ...
    get() {
        ...
        _treadmillRound = Builder(
            ...
            path(
                ...
                moveTo(11.7885f, 9.763f)
                curveTo(11.9195f, 9.3701f, 12.3442f, 9.1577f, 12.7372f, 9.2887f)
                curveTo(13.5569f, 9.5619f, 14.4431f, 9.5619f, 15.2628f, 9.2887f)
                curveTo(15.6558f, 9.1577f, 16.0805f, 9.3701f, 16.2115f, 9.763f)
                curveTo(16.3425f, 10.156f, 16.1301f, 10.5807f, 15.7372f, 10.7117f)
                curveTo(14.6096f, 11.0876f, 13.3904f, 11.0876f, 12.2628f, 10.7117f)
                curveTo(11.8699f, 10.5807f, 11.6575f, 10.156f, 11.7885f, 9.763f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(7.5303f, 13.4699f)
                curveTo(7.8232f, 13.7628f, 7.8232f, 14.2376f, 7.5303f, 14.5305f)
                curveTo(6.4292f, 15.6316f, 4.9359f, 16.2502f, 3.3787f, 16.2502f)
                horizontalLineTo(3.0f)
                curveTo(2.5858f, 16.2502f, 2.25f, 15.9144f, 2.25f, 15.5002f)
                curveTo(2.25f, 15.086f, 2.5858f, 14.7502f, 3.0f, 14.7502f)
                horizontalLineTo(3.3787f)
                curveTo(4.538f, 14.7502f, 5.6499f, 14.2897f, 6.4697f, 13.4699f)
                curveTo(6.7626f, 13.177f, 7.2374f, 13.177f, 7.5303f, 13.4699f)
                close()
            }
        }
            .build()
