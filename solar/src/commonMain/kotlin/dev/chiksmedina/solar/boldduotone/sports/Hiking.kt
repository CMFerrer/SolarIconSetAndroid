    ...
    get() {
        ...
        _hiking = Builder(
            ...
            path(
                ...
                curveTo(9.6564f, 10.8935f, 9.6812f, 10.6394f, 9.8033f, 10.3722f)
                ...
                curveTo(12.2836f, 9.5166f, 12.2916f, 9.5186f, 12.3005f, 9.521f)
                curveTo(12.3051f, 9.5223f, 12.3156f, 9.5252f, 12.3286f, 9.5293f)
                ...
                curveTo(14.1147f, 10.4526f, 14.2517f, 10.5668f, 14.4711f, 10.7496f)
                lineTo(14.4831f, 10.7597f)
                lineTo(14.5645f, 10.8275f)
                curveTo(15.213f, 11.3679f, 15.3971f, 11.5072f, 15.5713f, 11.5708f)
                curveTo(15.8482f, 11.6718f, 16.1518f, 11.6718f, 16.4287f, 11.5708f)
                ...
                close()
                moveTo(12.3696f, 10.9465f)
                curveTo(12.3696f, 10.9465f, 12.3719f, 10.9456f, 12.375f, 10.9444f)
                curveTo(12.3668f, 10.9476f, 12.3633f, 10.9488f, 12.3696f, 10.9465f)
                close()
                moveTo(11.829f, 9.5473f)
                lineTo(11.8311f, 9.5465f)
                curveTo(11.8355f, 9.5447f, 11.8443f, 9.5414f, 11.8379f, 9.5438f)
                curveTo(11.8379f, 9.5438f, 11.8337f, 9.5454f, 11.829f, 9.5473f)
                close()
            }
            path(
                ...
                moveTo(8.7115f, 9.763f)
                curveTo(8.8425f, 10.156f, 8.6301f, 10.5807f, 8.2372f, 10.7117f)
                lineTo(6.5652f, 11.269f)
                curveTo(6.0784f, 11.4313f, 5.75f, 11.8869f, 5.75f, 12.4f)
                curveTo(5.75f, 12.4838f, 5.7973f, 12.5603f, 5.8722f, 12.5978f)
                lineTo(8.3354f, 13.8294f)
                curveTo(8.7059f, 14.0146f, 8.8561f, 14.4651f, 8.6708f, 14.8356f)
                curveTo(8.4856f, 15.2061f, 8.0351f, 15.3563f, 7.6646f, 15.171f)
                lineTo(5.2014f, 13.9394f)
                curveTo(4.6183f, 13.6479f, 4.25f, 13.0519f, 4.25f, 12.4f)
                curveTo(4.25f, 11.2412f, 4.9915f, 10.2125f, 6.0908f, 9.846f)
                lineTo(7.7628f, 9.2887f)
                curveTo(8.1558f, 9.1577f, 8.5805f, 9.3701f, 8.7115f, 9.763f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(9.416f, 16.8762f)
                curveTo(9.7607f, 17.1059f, 9.8538f, 17.5716f, 9.624f, 17.9162f)
                lineTo(6.624f, 22.4162f)
                curveTo(6.3943f, 22.7609f, 5.9286f, 22.854f, 5.584f, 22.6242f)
                curveTo(5.2393f, 22.3945f, 5.1462f, 21.9288f, 5.376f, 21.5842f)
                lineTo(8.376f, 17.0842f)
                curveTo(8.6057f, 16.7395f, 9.0714f, 16.6464f, 9.416f, 16.8762f)
                close()
            }
        }
            .build()
