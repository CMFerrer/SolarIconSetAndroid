    ...
    get() {
        ...
        _facemaskCircle = Builder(
            ...
            path(
                ...
                moveTo(21.8241f, 13.8779f)
                lineTo(17.7122f, 15.5224f)
                lineTo(17.3323f, 20.4611f)
                curveTo(19.6317f, 19.009f, 21.2982f, 16.6455f, 21.8241f, 13.8779f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(6.6681f, 20.4611f)
                lineTo(6.2895f, 15.539f)
                lineTo(2.2119f, 14.0565f)
                curveTo(2.7744f, 16.7471f, 4.4182f, 19.0404f, 6.6681f, 20.4611f)
                close()
            }
        }
            .build()
