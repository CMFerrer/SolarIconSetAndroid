    ...
    get() {
        ...
        _widget2 = Builder(
            ...
            path(
                ...
                moveTo(12.7319f, 17.3658f)
                curveTo(12.7319f, 14.8065f, 14.8067f, 12.7317f, 17.3661f, 12.7317f)
                curveTo(19.9254f, 12.7317f, 22.0002f, 14.8065f, 22.0002f, 17.3658f)
                curveTo(22.0002f, 19.9252f, 19.9254f, 22.0f, 17.3661f, 22.0f)
                curveTo(14.8067f, 22.0f, 12.7319f, 19.9252f, 12.7319f, 17.3658f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
