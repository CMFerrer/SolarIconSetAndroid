...
val SettingsFineTuningGroup.TuningSquare: ImageVector
    get() {
        if (_tuningSquare != null) {
            return _tuningSquare!!
        }
        _tuningSquare = Builder(
            name = "TuningSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(
                ...
                moveTo(16.0f, 16.75f)
                curveTo(17.5188f, 16.75f, 18.75f, 15.5188f, 18.75f, 14.0f)
                curveTo(18.75f, 12.4812f, 17.5188f, 11.25f, 16.0f, 11.25f)
                curveTo(14.4812f, 11.25f, 13.25f, 12.4812f, 13.25f, 14.0f)
                curveTo(13.25f, 15.5188f, 14.4812f, 16.75f, 16.0f, 16.75f)
                close()
                moveTo(16.0f, 15.25f)
            ...
            path(
                ...
                moveTo(10.75f, 10.0f)
                curveTo(10.75f, 8.4812f, 9.5188f, 7.25f, 8.0f, 7.25f)
                curveTo(6.4812f, 7.25f, 5.25f, 8.4812f, 5.25f, 10.0f)
                curveTo(5.25f, 11.5188f, 6.4812f, 12.75f, 8.0f, 12.75f)
                curveTo(9.5188f, 12.75f, 10.75f, 11.5188f, 10.75f, 10.0f)
                close()
                moveTo(9.25f, 10.0f)
