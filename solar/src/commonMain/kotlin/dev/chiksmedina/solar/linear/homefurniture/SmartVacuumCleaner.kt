    ...
    get() {
        ...
        _smartVacuumCleaner = Builder(
            ...
            path(
                ...
                moveTo(7.4996f, 20.7361f)
                curveTo(6.9688f, 21.2111f, 6.2679f, 21.5f, 5.4996f, 21.5f)
                curveTo(3.8427f, 21.5f, 2.4996f, 20.1569f, 2.4996f, 18.5f)
                curveTo(2.4996f, 17.7316f, 2.7884f, 17.0308f, 3.2635f, 16.5f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
