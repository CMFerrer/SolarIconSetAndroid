    ...
    get() {
        ...
        _printer2 = Builder(
            ...
            path(
                ...
                close()
                moveTo(18.75f, 15.0f)
                curveTo(18.75f, 14.5858f, 18.4142f, 14.25f, 18.0f, 14.25f)
                curveTo(17.5858f, 14.25f, 17.25f, 14.5858f, 17.25f, 15.0f)
                horizontalLineTo(18.75f)
                close()
                moveTo(6.75f, 15.0f)
                curveTo(6.75f, 14.5858f, 6.4142f, 14.25f, 6.0f, 14.25f)
                curveTo(5.5858f, 14.25f, 5.25f, 14.5858f, 5.25f, 15.0f)
