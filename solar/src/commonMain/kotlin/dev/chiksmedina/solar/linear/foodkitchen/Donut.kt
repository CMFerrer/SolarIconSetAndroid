    ...
    get() {
        ...
        _donut = Builder(
            ...
            path(
                ...
                moveTo(14.0f, 14.2236f)
                curveTo(14.4713f, 14.6389f, 15.0875f, 15.0f, 15.8053f, 15.0f)
            ...
            path(
                ...
                moveTo(16.6499f, 8.9766f)
                lineTo(16.7162f, 10.3893f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
            ...
            path(
                ...
                moveTo(5.6649f, 12.6412f)
                lineTo(6.5001f, 11.5f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                ...
                moveTo(3.6827f, 10.3498f)
                lineTo(3.6041f, 8.9378f)
            }
        }
            .build()
        return _donut!!
