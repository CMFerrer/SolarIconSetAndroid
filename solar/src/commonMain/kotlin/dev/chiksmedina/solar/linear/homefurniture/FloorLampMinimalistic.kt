    ...
    get() {
        ...
        _floorLampMinimalistic = Builder(
            ...
            path(
                ...
                moveTo(12.0f, 8.0f)
                curveTo(14.3368f, 8.0f, 16.2992f, 6.7176f, 16.8475f, 4.9845f)
                curveTo(17.014f, 4.4579f, 16.5523f, 4.0f, 16.0f, 4.0f)
                horizontalLineTo(8.0f)
                curveTo(7.4477f, 4.0f, 6.986f, 4.4579f, 7.1526f, 4.9845f)
                curveTo(7.7009f, 6.7176f, 9.6632f, 8.0f, 12.0f, 8.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
