    ...
    get() {
        ...
        _stationMinimalistic = Builder(
            ...
            path(
                ...
                moveTo(8.9878f, 12.0045f)
                curveTo(8.2527f, 11.2422f, 7.8f, 10.2017f, 7.8f, 9.0547f)
                curveTo(7.8f, 6.717f, 9.6804f, 4.8219f, 12.0f, 4.8219f)
                curveTo(14.3196f, 4.8219f, 16.2f, 6.717f, 16.2f, 9.0547f)
                curveTo(16.2f, 10.1855f, 15.76f, 11.2127f, 15.0432f, 11.972f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
