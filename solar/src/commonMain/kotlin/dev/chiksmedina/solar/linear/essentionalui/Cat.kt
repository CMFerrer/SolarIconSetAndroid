    ...
    get() {
        ...
        _cat = Builder(
            ...
            path(
                ...
                curveTo(12.826f, 16.1725f, 12.4649f, 16.3124f, 12.0195f, 16.3124f)
                curveTo(11.5741f, 16.3124f, 11.2131f, 16.1725f, 11.2131f, 15.9999f)
                curveTo(11.2131f, 15.8273f, 11.5741f, 15.6874f, 12.0195f, 15.6874f)
                curveTo(12.4649f, 15.6874f, 12.826f, 15.8273f, 12.826f, 15.9999f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(15.5f, 14.0252f, 15.2834f, 14.375f, 15.0162f, 14.375f)
                curveTo(14.7489f, 14.375f, 14.5323f, 14.0252f, 14.5323f, 13.5938f)
                curveTo(14.5323f, 13.1623f, 14.7489f, 12.8125f, 15.0162f, 12.8125f)
