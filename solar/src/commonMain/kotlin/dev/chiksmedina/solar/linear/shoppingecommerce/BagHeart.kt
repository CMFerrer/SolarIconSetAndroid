    ...
    get() {
        ...
        _bagHeart = Builder(
            ...
            path(
                ...
                curveTo(16.826f, 22.0f, 19.0587f, 22.0f, 20.2583f, 20.5545f)
                moveTo(3.7417f, 20.5545f)
                curveTo(2.542f, 19.1091f, 2.9535f, 16.9146f, 3.7764f, 12.5257f)
                curveTo(4.3616f, 9.4045f, 4.6543f, 7.8439f, 5.7652f, 6.922f)
                moveTo(3.7417f, 20.5545f)
                curveTo(3.7417f, 20.5545f, 3.7417f, 20.5545f, 3.7417f, 20.5545f)
                close()
                moveTo(20.2583f, 20.5545f)
                curveTo(21.4579f, 19.1091f, 21.0465f, 16.9146f, 20.2236f, 12.5257f)
                curveTo(19.6383f, 9.4045f, 19.3457f, 7.8439f, 18.2348f, 6.922f)
                moveTo(20.2583f, 20.5545f)
                curveTo(20.2583f, 20.5545f, 20.2583f, 20.5545f, 20.2583f, 20.5545f)
                close()
                moveTo(18.2348f, 6.922f)
                curveTo(17.1239f, 6.0f, 15.5361f, 6.0f, 12.3606f, 6.0f)
                horizontalLineTo(11.6394f)
                curveTo(8.4638f, 6.0f, 6.876f, 6.0f, 5.7652f, 6.922f)
                moveTo(18.2348f, 6.922f)
                curveTo(18.2348f, 6.922f, 18.2348f, 6.922f, 18.2348f, 6.922f)
                close()
