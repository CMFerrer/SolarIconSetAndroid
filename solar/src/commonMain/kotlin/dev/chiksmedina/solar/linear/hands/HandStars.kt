package dev.chiksmedina.solar.linear.hands
...
import dev.chiksmedina.solar.linear.HandsGroup

val HandsGroup.HandStars: ImageVector
    get() {
        if (_handStars != null) {
            return _handStars!!
        }
        _handStars = Builder(
            name = "HandStars", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                curveTo(18.1206f, 8.8938f, 17.953f, 8.6977f, 18.0115f, 8.5096f)
