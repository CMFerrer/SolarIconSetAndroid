    ...
    get() {
        ...
        _penNewSquare = Builder(
            ...
            path(
                ...
                lineTo(8.0381f, 15.0229f)
                curveTo(7.9492f, 15.2897f, 8.0186f, 15.5837f, 8.2174f, 15.7826f)
                curveTo(8.4163f, 15.9814f, 8.7104f, 16.0508f, 8.9771f, 15.9619f)
                lineTo(10.1f, 15.5876f)
                lineTo(11.8354f, 15.0091f)
                curveTo(12.3775f, 14.8284f, 12.6485f, 14.7381f, 12.9035f, 14.6166f)
                curveTo(13.2043f, 14.4732f, 13.4886f, 14.2975f, 13.7513f, 14.0926f)
                curveTo(13.9741f, 13.9188f, 14.1761f, 13.7168f, 14.5801f, 13.3128f)
                lineTo(20.5449f, 7.3479f)
                lineTo(21.1938f, 6.6991f)
                curveTo(22.2687f, 5.6241f, 22.2687f, 3.8812f, 21.1938f, 2.8062f)
                curveTo(20.1188f, 1.7313f, 18.3759f, 1.7313f, 17.3009f, 2.8062f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
