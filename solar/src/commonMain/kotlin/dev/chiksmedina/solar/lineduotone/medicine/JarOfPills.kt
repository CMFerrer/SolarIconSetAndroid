    ...
    get() {
        ...
        _jarOfPills = Builder(
            ...
            path(
                ...
                lineTo(7.9043f, 5.8765f)
                curveTo(8.4469f, 5.4425f, 8.7181f, 5.2255f, 9.0395f, 5.1127f)
                curveTo(9.361f, 5.0f, 9.7083f, 5.0f, 10.4031f, 5.0f)
                horizontalLineTo(13.6427f)
                curveTo(14.3438f, 5.0f, 14.6943f, 5.0f, 15.0182f, 5.1147f)
                curveTo(15.3421f, 5.2293f, 15.6146f, 5.4499f, 16.1595f, 5.891f)
                lineTo(18.5168f, 7.7993f)
                curveTo(19.455f, 8.5588f, 20.0f, 9.7013f, 20.0f, 10.9083f)
                ...
                curveTo(4.0f, 9.7074f, 4.5524f, 8.5581f, 5.5012f, 7.799f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
