    ...
    get() {
        ...
        _monitorCamera = Builder(
            ...
            path(
                ...
                moveTo(19.0f, 3.75f)
                lineTo(20.6154f, 3.0769f)
                curveTo(21.2416f, 2.816f, 21.5547f, 2.6855f, 21.7774f, 2.834f)
                curveTo(22.0f, 2.9824f, 22.0f, 3.3216f, 22.0f, 4.0f)
                verticalLineTo(6.0f)
                curveTo(22.0f, 6.6784f, 22.0f, 7.0176f, 21.7774f, 7.166f)
                curveTo(21.5547f, 7.3145f, 21.2416f, 7.184f, 20.6154f, 6.9231f)
                lineTo(19.0f, 6.25f)
            ...
            path(
                ...
                verticalLineTo(9.5f)
                curveTo(2.0f, 6.2125f, 2.0f, 4.5688f, 2.908f, 3.4624f)
                curveTo(3.0742f, 3.2599f, 3.2599f, 3.0742f, 3.4624f, 2.908f)
                curveTo(4.5688f, 2.0f, 6.2125f, 2.0f, 9.5f, 2.0f)
            }
        }
            .build()
        return _monitorCamera!!
