package dev.chiksmedina.solar.lineduotone.folders
...
import dev.chiksmedina.solar.lineduotone.FoldersGroup
    ...
    get() {
        ...
        _folderFavouriteBookmark = Builder(
            ...
            path(
                ...
                curveTo(18.0f, 11.1429f, 18.0f, 11.2879f, 17.9051f, 11.3465f)
                curveTo(17.8103f, 11.4051f, 17.6806f, 11.3403f, 17.4211f, 11.2106f)
                lineTo(16.1789f, 10.5894f)
                curveTo(16.0911f, 10.5456f, 16.0472f, 10.5236f, 16.0f, 10.5236f)
                curveTo(15.9528f, 10.5236f, 15.9089f, 10.5456f, 15.8211f, 10.5894f)
                lineTo(14.5789f, 11.2106f)
                curveTo(14.3194f, 11.3403f, 14.1897f, 11.4051f, 14.0949f, 11.3465f)
                curveTo(14.0f, 11.2879f, 14.0f, 11.1429f, 14.0f, 10.8528f)
                verticalLineTo(6.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
