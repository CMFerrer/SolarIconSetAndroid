    ...
    get() {
        ...
        _headphonesSquare = Builder(
            ...
            path(
                ...
                curveTo(21.0f, 8.2503f, 21.0f, 6.3754f, 20.0451f, 5.0611f)
                curveTo(19.7367f, 4.6366f, 19.3634f, 4.2633f, 18.9389f, 3.9549f)
                curveTo(17.6246f, 3.0f, 15.7497f, 3.0f, 12.0f, 3.0f)
                curveTo(11.2645f, 3.0f, 10.6011f, 3.0f, 10.0f, 3.0072f)
                moveTo(3.0f, 18.0f)
                verticalLineTo(12.0f)
                curveTo(3.0f, 8.2503f, 3.0f, 6.3754f, 3.9549f, 5.0611f)
                curveTo(4.2633f, 4.6366f, 4.6366f, 4.2633f, 5.0611f, 3.9549f)
                curveTo(5.3438f, 3.7495f, 5.6524f, 3.5883f, 6.0f, 3.4618f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
