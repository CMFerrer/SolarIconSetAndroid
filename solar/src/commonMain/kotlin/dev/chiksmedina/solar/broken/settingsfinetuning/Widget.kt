    ...
    get() {
        ...
        _widget = Builder(
            ...
            path(
                ...
                curveTo(8.3856f, 2.5f, 9.3285f, 2.5f, 9.9143f, 3.0858f)
                curveTo(10.5f, 3.6716f, 10.5f, 4.6144f, 10.5f, 6.5f)
                curveTo(10.5f, 8.3856f, 10.5f, 9.3284f, 9.9143f, 9.9142f)
                curveTo(9.3285f, 10.5f, 8.3856f, 10.5f, 6.5f, 10.5f)
            ...
            path(
                ...
                curveTo(15.6144f, 13.5f, 14.6716f, 13.5f, 14.0858f, 14.0858f)
                curveTo(13.5f, 14.6716f, 13.5f, 15.6144f, 13.5f, 17.5f)
                curveTo(13.5f, 19.3856f, 13.5f, 20.3284f, 14.0858f, 20.9142f)
                curveTo(14.6716f, 21.5f, 15.6144f, 21.5f, 17.5f, 21.5f)
