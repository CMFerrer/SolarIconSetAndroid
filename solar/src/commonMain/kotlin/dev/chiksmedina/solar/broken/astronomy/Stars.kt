    ...
    get() {
        ...
        _stars = Builder(
            ...
            path(
                ...
                moveTo(5.8046f, 13.5087f)
                curveTo(5.2521f, 15.5982f, 4.9758f, 16.6429f, 5.5097f, 17.2192f)
                curveTo(6.0436f, 17.7955f, 7.0341f, 17.5217f, 9.015f, 16.9741f)
                lineTo(9.9909f, 16.5f)
                moveTo(17.048f, 7.5097f)
