    ...
    get() {
        ...
        _bugMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(19.0f, 16.9587f, 18.1955f, 18.7295f, 16.899f, 20.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
            ...
            path(
                ...
                moveTo(20.4999f, 7.0f)
                lineTo(18.7021f, 7.7191f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
            ...
            path(
                ...
                moveTo(20.5f, 19.0002f)
                lineTo(18.5f, 18.2002f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                ...
                moveTo(3.5f, 19.0002f)
                lineTo(5.5f, 18.2002f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
