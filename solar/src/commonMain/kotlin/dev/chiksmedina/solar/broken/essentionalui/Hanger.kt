    ...
    get() {
        ...
        _hanger = Builder(
            ...
            path(
                ...
                lineTo(16.0f, 12.6666f)
                moveTo(11.8015f, 10.6299f)
                curveTo(11.076f, 10.6383f, 10.3534f, 10.855f, 9.751f, 11.2787f)
                lineTo(2.6553f, 16.27f)
                curveTo(1.3832f, 17.1648f, 2.0872f, 19.0f, 3.7025f, 19.0f)
                horizontalLineTo(20.2975f)
                curveTo(21.9305f, 19.0f, 22.6234f, 17.1315f, 21.317f, 16.2509f)
