    ...
    get() {
        ...
        _moonFog = Builder(
            ...
            path(
                ...
                close()
                moveTo(20.4806f, 15.6997f)
                curveTo(20.3148f, 16.0793f, 20.4881f, 16.5214f, 20.8676f, 16.6873f)
                curveTo(21.2472f, 16.8531f, 21.6893f, 16.6798f, 21.8552f, 16.3003f)
                lineTo(20.4806f, 15.6997f)
                close()
                moveTo(2.1448f, 16.3003f)
                curveTo(2.3107f, 16.6798f, 2.7528f, 16.8531f, 3.1324f, 16.6873f)
                curveTo(3.5119f, 16.5214f, 3.6852f, 16.0793f, 3.5194f, 15.6997f)
                lineTo(2.1448f, 16.3003f)
                close()
