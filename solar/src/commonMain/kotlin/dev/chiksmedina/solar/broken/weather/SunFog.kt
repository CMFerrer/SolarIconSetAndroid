    ...
    get() {
        ...
        _sunFog = Builder(
            ...
            path(
                ...
                moveTo(10.0f, 6.3414f)
                curveTo(10.6256f, 6.1203f, 11.2987f, 6.0f, 12.0f, 6.0f)
                curveTo(15.3137f, 6.0f, 18.0f, 8.6863f, 18.0f, 12.0f)
                curveTo(18.0f, 13.5217f, 17.4335f, 14.911f, 16.5f, 15.9687f)
                horizontalLineTo(7.5f)
                curveTo(6.5665f, 14.911f, 6.0f, 13.5217f, 6.0f, 12.0f)
                curveTo(6.0f, 11.2987f, 6.1203f, 10.6256f, 6.3414f, 10.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
