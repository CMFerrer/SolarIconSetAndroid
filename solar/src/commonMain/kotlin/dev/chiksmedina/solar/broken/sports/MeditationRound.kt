    ...
    get() {
        ...
        _meditationRound = Builder(
            ...
            path(
                ...
                curveTo(18.0f, 13.7872f, 17.9613f, 13.4321f, 17.8876f, 13.0894f)
                moveTo(3.0f, 17.0f)
                lineTo(4.1577f, 16.61f)
                curveTo(4.3849f, 16.5335f, 4.601f, 16.4267f, 4.8002f, 16.2925f)
                lineTo(4.9015f, 16.2243f)
                curveTo(5.5878f, 15.762f, 6.0f, 14.9837f, 6.0f, 14.1502f)
                curveTo(6.0f, 11.713f, 7.7437f, 9.6331f, 10.1228f, 9.2325f)
                lineTo(11.0136f, 9.0824f)
                curveTo(11.5f, 9.0f, 12.5f, 8.9999f, 12.9864f, 9.0824f)
                lineTo(13.8772f, 9.2325f)
                curveTo(14.2705f, 9.2987f, 14.6464f, 9.4108f, 15.0f, 9.5629f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
