    ...
    get() {
        ...
        _chatSquareCode = Builder(
            ...
            path(
                ...
                close()
                moveTo(3.0735f, 15.6264f)
                curveTo(2.915f, 15.2437f, 2.4763f, 15.062f, 2.0936f, 15.2205f)
                curveTo(1.7109f, 15.379f, 1.5292f, 15.8177f, 1.6877f, 16.2004f)
            ...
            path(
                ...
                moveTo(8.4999f, 7.8301f)
                lineTo(8.3284f, 8.0016f)
                curveTo(6.995f, 9.335f, 6.3284f, 10.0017f, 6.3284f, 10.8301f)
                curveTo(6.3284f, 11.6585f, 6.995f, 12.3252f, 8.3284f, 13.6585f)
                lineTo(8.4999f, 13.8301f)
            }
        }
            .build()
        return _chatSquareCode!!
