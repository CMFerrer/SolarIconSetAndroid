    ...
    get() {
        ...
        _monitorSmartphone = Builder(
            ...
            path(
                ...
                curveTo(3.6412f, 2.702f, 4.2255f, 2.4206f, 5.0f, 2.252f)
                moveTo(22.0f, 8.5f)
                curveTo(22.0f, 6.1654f, 22.0f, 4.9981f, 21.5277f, 4.1144f)
                curveTo(21.1548f, 3.4167f, 20.5833f, 2.8452f, 19.8856f, 2.4723f)
                curveTo(19.0019f, 2.0f, 17.8346f, 2.0f, 15.5f, 2.0f)
