    ...
    get() {
        ...
        _globus = Builder(
            ...
            path(
                ...
                curveTo(15.8429f, 20.0f, 19.4247f, 17.5418f, 21.0576f, 14.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
            ...
            path(
                ...
                moveTo(5.9365f, 13.5f)
                curveTo(5.3409f, 12.4704f, 5.0f, 11.275f, 5.0f, 10.0f)
                ...
                curveTo(10.725f, 17.0f, 9.5296f, 16.6591f, 8.5f, 16.0635f)
            }
        }
            .build()
        return _globus!!
