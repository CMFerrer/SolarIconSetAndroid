    ...
    get() {
        ...
        _socket = Builder(
            ...
            path(
                ...
                moveTo(6.5845f, 9.413f)
                curveTo(6.8705f, 8.8143f, 7.2614f, 8.2532f, 7.7573f, 7.7574f)
                curveTo(10.1004f, 5.4142f, 13.8994f, 5.4142f, 16.2426f, 7.7574f)
                curveTo(18.5857f, 10.1005f, 18.5857f, 13.8995f, 16.2426f, 16.2426f)
                curveTo(13.8994f, 18.5858f, 10.1004f, 18.5858f, 7.7573f, 16.2426f)
                curveTo(7.2614f, 15.7468f, 6.8705f, 15.1857f, 6.5845f, 14.587f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
