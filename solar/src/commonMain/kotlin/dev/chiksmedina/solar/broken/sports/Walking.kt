    ...
    get() {
        ...
        _walking = Builder(
            ...
            path(
                ...
                curveTo(11.411f, 18.6538f, 11.874f, 18.7594f, 12.2247f, 18.539f)
                curveTo(12.5754f, 18.3185f, 12.6809f, 17.8555f, 12.4605f, 17.5048f)
                ...
                close()
                moveTo(14.0924f, 20.1008f)
                curveTo(13.872f, 19.7502f, 13.409f, 19.6446f, 13.0583f, 19.865f)
                curveTo(12.7076f, 20.0855f, 12.602f, 20.5485f, 12.8225f, 20.8992f)
                lineTo(14.0924f, 20.1008f)
                close()
                ...
                close()
                moveTo(12.8225f, 20.8992f)
                lineTo(13.7654f, 22.3992f)
                lineTo(15.0354f, 21.6008f)
                lineTo(14.0924f, 20.1008f)
                lineTo(12.8225f, 20.8992f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
