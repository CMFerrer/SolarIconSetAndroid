    ...
    get() {
        ...
        _sliderMinimalisticHorizontal = Builder(
            ...
            path(
                ...
                moveTo(16.0f, 5.8461f)
                curveTo(18.8284f, 5.8461f, 20.2426f, 5.8461f, 21.1213f, 6.7474f)
                curveTo(22.0f, 7.6486f, 22.0f, 9.099f, 22.0f, 12.0f)
                curveTo(22.0f, 14.901f, 22.0f, 16.3514f, 21.1213f, 17.2526f)
                curveTo(20.2426f, 18.1538f, 18.8284f, 18.1538f, 16.0f, 18.1538f)
                lineTo(8.0f, 18.1538f)
                curveTo(5.1716f, 18.1538f, 3.7574f, 18.1538f, 2.8787f, 17.2526f)
                curveTo(2.0f, 16.3514f, 2.0f, 14.901f, 2.0f, 12.0f)
                curveTo(2.0f, 9.099f, 2.0f, 7.6486f, 2.8787f, 6.7474f)
                curveTo(3.7574f, 5.8461f, 5.1716f, 5.8461f, 8.0f, 5.8461f)
                lineTo(16.0f, 5.8461f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
