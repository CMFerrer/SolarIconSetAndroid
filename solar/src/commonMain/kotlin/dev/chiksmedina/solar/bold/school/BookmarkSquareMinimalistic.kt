    ...
    get() {
        ...
        _bookmarkSquareMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(4.1485f, 2.7804f, 5.0273f, 2.4159f, 6.25f, 2.2216f)
                lineTo(6.25f, 8.831f)
                curveTo(6.25f, 9.2986f, 6.25f, 9.6821f, 6.2674f, 9.9839f)
                curveTo(6.2845f, 10.2816f, 6.3215f, 10.5899f, 6.4437f, 10.8652f)
                curveTo(6.8851f, 11.859f, 7.9741f, 12.3949f, 9.0309f, 12.1383f)
                curveTo(9.3236f, 12.0673f, 9.5904f, 11.9084f, 9.8367f, 11.7404f)
                curveTo(10.0864f, 11.57f, 10.3903f, 11.336f, 10.7608f, 11.0508f)
                lineTo(10.7793f, 11.0365f)
                curveTo(11.2487f, 10.6751f, 11.3808f, 10.5804f, 11.5019f, 10.5277f)
                curveTo(11.8196f, 10.3897f, 12.1804f, 10.3897f, 12.4981f, 10.5277f)
                curveTo(12.6192f, 10.5804f, 12.7513f, 10.6751f, 13.2207f, 11.0365f)
                lineTo(13.2392f, 11.0508f)
                curveTo(13.6097f, 11.336f, 13.9136f, 11.57f, 14.1633f, 11.7404f)
                curveTo(14.4096f, 11.9084f, 14.6764f, 12.0673f, 14.9691f, 12.1383f)
                curveTo(16.0259f, 12.3949f, 17.1149f, 11.859f, 17.5563f, 10.8652f)
                curveTo(17.6786f, 10.5899f, 17.7155f, 10.2816f, 17.7326f, 9.9839f)
                curveTo(17.75f, 9.6821f, 17.75f, 9.2986f, 17.75f, 8.831f)
                verticalLineTo(2.2216f)
                curveTo(18.9727f, 2.4159f, 19.8515f, 2.7804f, 20.5355f, 3.4645f)
