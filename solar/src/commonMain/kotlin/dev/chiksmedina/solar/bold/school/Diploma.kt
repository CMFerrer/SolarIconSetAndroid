    ...
    get() {
        ...
        _diploma = Builder(
            ...
            path(
                ...
                curveTo(20.645f, 17.5977f, 20.0113f, 17.8158f, 19.0802f, 17.9156f)
                curveTo(19.0062f, 17.8157f, 18.9362f, 17.737f, 18.8862f, 17.6821f)
                curveTo(18.7701f, 17.5544f, 18.6228f, 17.4092f, 18.48f, 17.2684f)
                lineTo(16.987f, 15.7962f)
                lineTo(16.4357f, 15.2377f)
                curveTo(16.0733f, 13.1151f, 14.2255f, 11.5f, 12.0001f, 11.5f)
                curveTo(9.7746f, 11.5f, 7.9268f, 13.1151f, 7.5645f, 15.2377f)
                lineTo(7.0131f, 15.7962f)
                lineTo(5.5202f, 17.2683f)
                curveTo(5.3774f, 17.4091f, 5.2301f, 17.5543f, 5.1139f, 17.6821f)
                curveTo(5.064f, 17.737f, 4.9939f, 17.8157f, 4.9199f, 17.9156f)
                curveTo(3.9888f, 17.8158f, 3.355f, 17.5977f, 2.8787f, 17.1213f)
