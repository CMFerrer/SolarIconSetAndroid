    ...
    get() {
        ...
        _sunset = Builder(
            ...
            path(
                ...
                curveTo(18.75f, 8.5256f, 16.125f, 5.6643f, 12.75f, 5.2912f)
                verticalLineTo(9.1892f)
                lineTo(13.4697f, 8.4696f)
                curveTo(13.7626f, 8.1767f, 14.2374f, 8.1767f, 14.5303f, 8.4696f)
                curveTo(14.8232f, 8.7625f, 14.8232f, 9.2373f, 14.5303f, 9.5302f)
                lineTo(12.5303f, 11.5302f)
                curveTo(12.2374f, 11.8231f, 11.7626f, 11.8231f, 11.4697f, 11.5302f)
                lineTo(9.4697f, 9.5302f)
                curveTo(9.1768f, 9.2373f, 9.1768f, 8.7625f, 9.4697f, 8.4696f)
                curveTo(9.7626f, 8.1767f, 10.2374f, 8.1767f, 10.5303f, 8.4696f)
                lineTo(11.25f, 9.1892f)
                verticalLineTo(5.2912f)
                curveTo(7.875f, 5.6643f, 5.25f, 8.5256f, 5.25f, 12.0f)
                close()
            }
        }
            .build()
