    ...
    get() {
        ...
        _trellis = Builder(
            ...
            path(
                ...
                close()
                moveTo(11.0303f, 6.4697f)
                curveTo(11.3232f, 6.7626f, 11.3232f, 7.2374f, 11.0303f, 7.5303f)
                lineTo(10.0303f, 8.5303f)
                curveTo(9.7374f, 8.8232f, 9.2626f, 8.8232f, 8.9697f, 8.5303f)
                curveTo(8.6768f, 8.2374f, 8.6768f, 7.7626f, 8.9697f, 7.4697f)
                lineTo(9.9697f, 6.4697f)
                curveTo(10.2626f, 6.1768f, 10.7374f, 6.1768f, 11.0303f, 6.4697f)
                close()
                moveTo(14.0303f, 7.4697f)
                curveTo(14.3232f, 7.7626f, 14.3232f, 8.2374f, 14.0303f, 8.5303f)
                lineTo(11.0303f, 11.5303f)
                curveTo(10.7374f, 11.8232f, 10.2626f, 11.8232f, 9.9697f, 11.5303f)
                curveTo(9.6768f, 11.2374f, 9.6768f, 10.7626f, 9.9697f, 10.4697f)
                lineTo(12.9697f, 7.4697f)
                curveTo(13.2626f, 7.1768f, 13.7374f, 7.1768f, 14.0303f, 7.4697f)
                close()
                moveTo(15.0303f, 10.4697f)
                curveTo(15.3232f, 10.7626f, 15.3232f, 11.2374f, 15.0303f, 11.5303f)
                lineTo(14.0303f, 12.5303f)
                curveTo(13.7374f, 12.8232f, 13.2626f, 12.8232f, 12.9697f, 12.5303f)
                curveTo(12.6768f, 12.2374f, 12.6768f, 11.7626f, 12.9697f, 11.4697f)
