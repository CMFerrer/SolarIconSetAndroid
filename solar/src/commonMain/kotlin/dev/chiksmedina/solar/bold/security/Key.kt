    ...
    get() {
        ...
        _key = Builder(
            ...
            path(
                ...
                close()
                moveTo(15.681f, 10.4889f)
                curveTo(16.8984f, 10.4889f, 17.8853f, 9.506f, 17.8853f, 8.2935f)
                curveTo(17.8853f, 7.081f, 16.8984f, 6.0981f, 15.681f, 6.0981f)
                curveTo(14.4635f, 6.0981f, 13.4766f, 7.081f, 13.4766f, 8.2935f)
                curveTo(13.4766f, 9.506f, 14.4635f, 10.4889f, 15.681f, 10.4889f)
                close()
            }
        }
            .build()
