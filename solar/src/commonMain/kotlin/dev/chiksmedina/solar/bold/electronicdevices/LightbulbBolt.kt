    ...
    get() {
        ...
        _lightbulbBolt = Builder(
            ...
            path(
                ...
                curveTo(14.9108f, 16.8864f, 14.9133f, 16.8834f, 14.9192f, 16.8766f)
                ...
                close()
                moveTo(12.6105f, 8.1765f)
                curveTo(12.9169f, 8.4004f, 12.9878f, 8.8362f, 12.769f, 9.1497f)
                lineTo(11.591f, 10.8372f)
                horizontalLineTo(12.9934f)
                curveTo(13.2488f, 10.8372f, 13.4828f, 10.9833f, 13.5996f, 11.2156f)
                curveTo(13.7165f, 11.448f, 13.6966f, 11.7277f, 13.5482f, 11.9404f)
                lineTo(11.6001f, 14.7311f)
                curveTo(11.3813f, 15.0446f, 10.9554f, 15.1173f, 10.649f, 14.8933f)
                curveTo(10.3426f, 14.6693f, 10.2716f, 14.2336f, 10.4905f, 13.9201f)
                lineTo(11.6685f, 12.2326f)
                horizontalLineTo(10.2661f)
                curveTo(10.0107f, 12.2326f, 9.7767f, 12.0865f, 9.6599f, 11.8541f)
                curveTo(9.543f, 11.6218f, 9.5628f, 11.342f, 9.7113f, 11.1294f)
                lineTo(11.6593f, 8.3387f)
                curveTo(11.8782f, 8.0251f, 12.304f, 7.9525f, 12.6105f, 8.1765f)
                close()
            }
        }
            .build()
