    ...
    get() {
        ...
        _ranking = Builder(
            ...
            path(
                ...
                curveTo(14.4142f, 10.0f, 15.1213f, 10.0f, 15.5607f, 10.4393f)
                curveTo(16.0f, 10.8787f, 16.0f, 11.5858f, 16.0f, 13.0f)
                verticalLineTo(19.0f)
                curveTo(16.0f, 17.5858f, 16.0f, 16.8787f, 16.4393f, 16.4393f)
                curveTo(16.8787f, 16.0f, 17.5858f, 16.0f, 19.0f, 16.0f)
                curveTo(20.4142f, 16.0f, 21.1213f, 16.0f, 21.5607f, 16.4393f)
                curveTo(22.0f, 16.8787f, 22.0f, 17.5858f, 22.0f, 19.0f)
                verticalLineTo(22.0f)
                horizontalLineTo(16.0f)
                horizontalLineTo(8.0f)
                horizontalLineTo(2.0f)
                curveTo(2.0f, 20.5858f, 2.0f, 19.8787f, 2.4393f, 19.4393f)
                curveTo(2.8787f, 19.0f, 3.5858f, 19.0f, 5.0f, 19.0f)
                curveTo(6.4142f, 19.0f, 7.1213f, 19.0f, 7.5607f, 19.4393f)
                curveTo(8.0f, 19.8787f, 8.0f, 20.5858f, 8.0f, 22.0f)
                verticalLineTo(13.0f)
                curveTo(8.0f, 11.5858f, 8.0f, 10.8787f, 8.4393f, 10.4393f)
                curveTo(8.8787f, 10.0f, 9.5858f, 10.0f, 11.0f, 10.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
