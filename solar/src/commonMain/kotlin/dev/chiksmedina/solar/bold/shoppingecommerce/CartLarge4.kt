    ...
    get() {
        ...
        _cartLarge4 = Builder(
            ...
            path(
                ...
                close()
                moveTo(10.2395f, 8.875f)
                curveTo(10.1703f, 8.4666f, 9.7831f, 8.1916f, 9.3747f, 8.2608f)
                curveTo(8.9663f, 8.33f, 8.6913f, 8.7171f, 8.7605f, 9.1255f)
                lineTo(9.2887f, 12.2434f)
                curveTo(9.3579f, 12.6518f, 9.7451f, 12.9267f, 10.1535f, 12.8576f)
                curveTo(10.5619f, 12.7884f, 10.8368f, 12.4012f, 10.7677f, 11.9928f)
                lineTo(10.2395f, 8.875f)
                close()
                moveTo(15.6536f, 8.2608f)
                curveTo(15.2452f, 8.1916f, 14.858f, 8.4666f, 14.7889f, 8.875f)
                lineTo(14.2607f, 11.9928f)
                curveTo(14.1915f, 12.4012f, 14.4665f, 12.7884f, 14.8749f, 12.8576f)
                curveTo(15.2833f, 12.9267f, 15.6704f, 12.6518f, 15.7396f, 12.2434f)
                lineTo(16.2678f, 9.1255f)
                curveTo(16.337f, 8.7171f, 16.062f, 8.33f, 15.6536f, 8.2608f)
                close()
