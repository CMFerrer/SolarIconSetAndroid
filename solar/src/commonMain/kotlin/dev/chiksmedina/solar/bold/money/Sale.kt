    ...
    get() {
        ...
        _sale = Builder(
            ...
            path(
                ...
                close()
                moveTo(15.8309f, 8.1696f)
                curveTo(16.1487f, 8.4874f, 16.1487f, 9.0027f, 15.8309f, 9.3206f)
                lineTo(9.32f, 15.8314f)
                curveTo(9.0022f, 16.1493f, 8.4869f, 16.1493f, 8.1691f, 15.8314f)
                curveTo(7.8512f, 15.5136f, 7.8512f, 14.9983f, 8.1691f, 14.6805f)
                lineTo(14.6799f, 8.1696f)
                curveTo(14.9978f, 7.8518f, 15.5131f, 7.8518f, 15.8309f, 8.1696f)
                close()
                moveTo(15.798f, 14.7134f)
                curveTo(15.798f, 15.3127f, 15.3122f, 15.7985f, 14.7129f, 15.7985f)
                curveTo(14.1135f, 15.7985f, 13.6277f, 15.3127f, 13.6277f, 14.7134f)
                curveTo(13.6277f, 14.1141f, 14.1135f, 13.6282f, 14.7129f, 13.6282f)
                curveTo(15.3122f, 13.6282f, 15.798f, 14.1141f, 15.798f, 14.7134f)
                close()
                moveTo(9.2871f, 10.3728f)
                curveTo(9.8864f, 10.3728f, 10.3723f, 9.887f, 10.3723f, 9.2877f)
                curveTo(10.3723f, 8.6883f, 9.8864f, 8.2025f, 9.2871f, 8.2025f)
                curveTo(8.6878f, 8.2025f, 8.202f, 8.6883f, 8.202f, 9.2877f)
                curveTo(8.202f, 9.887f, 8.6878f, 10.3728f, 9.2871f, 10.3728f)
                close()
            }
        }
            .build()
