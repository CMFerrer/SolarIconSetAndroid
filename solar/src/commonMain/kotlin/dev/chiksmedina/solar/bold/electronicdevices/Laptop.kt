    ...
    get() {
        ...
        _laptop = Builder(
            ...
            path(
                ...
                curveTo(2.5421f, 16.4048f, 2.5643f, 16.3818f, 2.6088f, 16.3359f)
            ...
            path(
                ...
                horizontalLineTo(15.6471f)
                curveTo(17.5327f, 3.0f, 18.4755f, 3.0f, 19.0613f, 3.5858f)
                curveTo(19.6471f, 4.1716f, 19.6471f, 5.1144f, 19.6471f, 7.0f)
                verticalLineTo(14.0f)
                horizontalLineTo(4.3529f)
                verticalLineTo(7.0f)
                close()
                moveTo(12.0f, 6.5f)
                curveTo(12.4142f, 6.5f, 12.75f, 6.1642f, 12.75f, 5.75f)
                curveTo(12.75f, 5.3358f, 12.4142f, 5.0f, 12.0f, 5.0f)
                curveTo(11.5858f, 5.0f, 11.25f, 5.3358f, 11.25f, 5.75f)
                curveTo(11.25f, 6.1642f, 11.5858f, 6.5f, 12.0f, 6.5f)
                close()
            }
        }
            .build()
