    ...
    get() {
        ...
        _waterdrops = Builder(
            ...
            path(
                ...
                curveTo(2.0f, 16.3934f, 3.5659f, 14.4717f, 4.7382f, 13.2347f)
                curveTo(5.4322f, 12.5025f, 6.5678f, 12.5025f, 7.2618f, 13.2347f)
                curveTo(8.4341f, 14.4717f, 10.0f, 16.3934f, 10.0f, 17.8332f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.0f, 16.3934f, 15.5659f, 14.4717f, 16.7382f, 13.2347f)
                curveTo(17.4322f, 12.5025f, 18.5678f, 12.5025f, 19.2618f, 13.2347f)
                curveTo(20.4341f, 14.4717f, 22.0f, 16.3934f, 22.0f, 17.8332f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
