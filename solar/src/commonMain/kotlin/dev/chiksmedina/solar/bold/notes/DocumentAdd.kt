    ...
    get() {
        ...
        _documentAdd = Builder(
            ...
            path(
                ...
                curveTo(20.9812f, 19.6756f, 20.9997f, 17.8316f, 21.0f, 14.1801f)
                lineTo(18.1817f, 16.9984f)
                curveTo(17.9119f, 17.2683f, 17.691f, 17.4894f, 17.4415f, 17.6841f)
                curveTo(17.1491f, 17.9121f, 16.8328f, 18.1076f, 16.4981f, 18.2671f)
                curveTo(16.2124f, 18.4032f, 15.9159f, 18.502f, 15.5538f, 18.6225f)
                lineTo(13.2421f, 19.3931f)
                curveTo(12.4935f, 19.6426f, 11.6682f, 19.4478f, 11.1102f, 18.8898f)
                curveTo(10.5523f, 18.3318f, 10.3574f, 17.5065f, 10.607f, 16.7579f)
                lineTo(10.8805f, 15.9375f)
                lineTo(11.3556f, 14.5121f)
                lineTo(11.3775f, 14.4463f)
                curveTo(11.4981f, 14.0842f, 11.5968f, 13.7876f, 11.7329f, 13.5019f)
                curveTo(11.8924f, 13.1672f, 12.0879f, 12.8509f, 12.316f, 12.5586f)
                curveTo(12.5106f, 12.309f, 12.7317f, 12.0881f, 13.0017f, 11.8183f)
                lineTo(17.0081f, 7.8119f)
                lineTo(18.12f, 6.7f)
                lineTo(18.2472f, 6.5728f)
                curveTo(18.9626f, 5.8574f, 19.9003f, 5.4998f, 20.838f, 5.5f)
                curveTo(20.6867f, 4.4694f, 20.3941f, 3.7373f, 19.8284f, 3.1716f)
