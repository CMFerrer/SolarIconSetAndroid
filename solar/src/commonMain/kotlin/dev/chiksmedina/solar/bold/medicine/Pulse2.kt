    ...
    get() {
        ...
        _pulse2 = Builder(
            ...
            path(
                ...
                curveTo(5.8298f, 15.7641f, 5.6973f, 15.75f, 5.0f, 15.75f)
                horizontalLineTo(2.0437f)
                curveTo(2.1409f, 18.0904f, 2.4543f, 19.5253f, 3.4645f, 20.5355f)
                curveTo(4.9289f, 22.0f, 7.286f, 22.0f, 12.0f, 22.0f)
                curveTo(16.714f, 22.0f, 19.0711f, 22.0f, 20.5355f, 20.5355f)
                curveTo(21.5458f, 19.5253f, 21.8591f, 18.0904f, 21.9563f, 15.75f)
                close()
            }
        }
            .build()
