    ...
    get() {
        ...
        _alignLeft = Builder(
            ...
            path(
                ...
                curveTo(7.522f, 5.3326f, 7.3326f, 5.522f, 7.201f, 5.75f)
                curveTo(7.0f, 6.0981f, 7.0f, 6.5654f, 7.0f, 7.5f)
                curveTo(7.0f, 8.4346f, 7.0f, 8.9019f, 7.201f, 9.25f)
                curveTo(7.3326f, 9.478f, 7.522f, 9.6674f, 7.75f, 9.799f)
                curveTo(8.0981f, 10.0f, 8.5654f, 10.0f, 9.5f, 10.0f)
                lineTo(18.5f, 10.0f)
                curveTo(19.4346f, 10.0f, 19.9019f, 10.0f, 20.25f, 9.799f)
                curveTo(20.478f, 9.6674f, 20.6674f, 9.478f, 20.799f, 9.25f)
                curveTo(21.0f, 8.9019f, 21.0f, 8.4346f, 21.0f, 7.5f)
                curveTo(21.0f, 6.5654f, 21.0f, 6.0981f, 20.799f, 5.75f)
