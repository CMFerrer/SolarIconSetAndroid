    ...
    get() {
        ...
        _galleryCircle = Builder(
            ...
            path(
                ...
                moveTo(19.9999f, 17.6001f)
                lineTo(17.7764f, 15.599f)
                curveTo(16.7368f, 14.6634f, 15.1887f, 14.5702f, 14.0445f, 15.3744f)
                lineTo(13.7463f, 15.5839f)
                curveTo(12.9511f, 16.1428f, 11.8693f, 16.0491f, 11.1821f, 15.3618f)
                lineTo(6.8924f, 11.0721f)
                curveTo(6.0362f, 10.2159f, 4.6627f, 10.1702f, 3.7515f, 10.9675f)
                lineTo(2.281f, 12.2542f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
