    ...
    get() {
        ...
        _chart = Builder(
            ...
            path(
                ...
                moveTo(9.0f, 22.0f)
                verticalLineTo(5.0f)
                curveTo(9.0f, 3.5858f, 9.0f, 2.8787f, 9.4393f, 2.4393f)
                curveTo(9.8787f, 2.0f, 10.5858f, 2.0f, 12.0f, 2.0f)
                curveTo(13.4142f, 2.0f, 14.1213f, 2.0f, 14.5607f, 2.4393f)
                curveTo(15.0f, 2.8787f, 15.0f, 3.5858f, 15.0f, 5.0f)
                verticalLineTo(5.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
