    ...
    get() {
        ...
        _starsLine = Builder(
            ...
            path(
                ...
                moveTo(14.5f, 22.0f)
                curveTo(14.5f, 20.8748f, 14.6709f, 19.4838f, 15.1281f, 18.0f)
                moveTo(22.0f, 9.5f)
                curveTo(19.8009f, 10.7828f, 18.2063f, 12.3567f, 17.0685f, 14.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(5.0001f, 13.2681f)
                curveTo(5.0001f, 13.2681f, 5.6497f, 14.0159f, 6.2227f, 14.1694f)
                curveTo(6.7957f, 14.3229f, 7.7322f, 14.0001f, 7.7322f, 14.0001f)
                curveTo(7.7322f, 14.0001f, 6.9843f, 14.6497f, 6.8308f, 15.2227f)
                curveTo(6.6773f, 15.7957f, 7.0001f, 16.7322f, 7.0001f, 16.7322f)
                curveTo(7.0001f, 16.7322f, 6.3505f, 15.9843f, 5.7775f, 15.8308f)
                curveTo(5.2046f, 15.6773f, 4.2681f, 16.0001f, 4.2681f, 16.0001f)
                curveTo(4.2681f, 16.0001f, 5.0159f, 15.3505f, 5.1694f, 14.7775f)
                curveTo(5.3229f, 14.2046f, 5.0001f, 13.2681f, 5.0001f, 13.2681f)
                close()
            }
        }
            .build()
