    ...
    get() {
        ...
        _ssdSquare = Builder(
            ...
            path(
                ...
                lineTo(5.0f, 5.1177f)
                close()
                moveTo(21.1312f, 15.1645f)
                curveTo(21.2465f, 15.5624f, 21.6625f, 15.7914f, 22.0603f, 15.6761f)
                curveTo(22.4581f, 15.5608f, 22.6872f, 15.1448f, 22.5719f, 14.7469f)
                lineTo(21.1312f, 15.1645f)
                close()
                moveTo(1.4281f, 14.7469f)
                curveTo(1.3128f, 15.1448f, 1.5419f, 15.5608f, 1.9397f, 15.6761f)
                curveTo(2.3375f, 15.7914f, 2.7535f, 15.5624f, 2.8688f, 15.1645f)
                ...
                close()
                moveTo(21.1461f, 9.8279f)
                curveTo(21.0308f, 9.4301f, 20.6148f, 9.201f, 20.217f, 9.3163f)
                curveTo(19.8191f, 9.4317f, 19.5901f, 9.8476f, 19.7054f, 10.2455f)
                lineTo(21.1461f, 9.8279f)
                close()
                moveTo(18.6361f, 6.5562f)
                curveTo(18.7514f, 6.954f, 19.1674f, 7.1831f, 19.5652f, 7.0678f)
                curveTo(19.9631f, 6.9524f, 20.1921f, 6.5365f, 20.0768f, 6.1386f)
                lineTo(18.6361f, 6.5562f)
                close()
                moveTo(12.0f, 20.25f)
                curveTo(11.5858f, 20.25f, 11.25f, 20.5858f, 11.25f, 21.0f)
                curveTo(11.25f, 21.4142f, 11.5858f, 21.75f, 12.0f, 21.75f)
                verticalLineTo(20.25f)
                close()
                moveTo(8.0f, 21.75f)
                curveTo(8.4142f, 21.75f, 8.75f, 21.4142f, 8.75f, 21.0f)
                curveTo(8.75f, 20.5858f, 8.4142f, 20.25f, 8.0f, 20.25f)
                ...
                lineTo(2.4557f, 13.3329f)
                close()
                moveTo(19.7054f, 10.2455f)
                lineTo(21.1312f, 15.1645f)
                lineTo(22.5719f, 14.7469f)
                lineTo(21.1461f, 9.8279f)
                lineTo(19.7054f, 10.2455f)
                close()
                moveTo(18.2796f, 5.3264f)
                lineTo(18.6361f, 6.5562f)
                lineTo(20.0768f, 6.1386f)
                lineTo(19.7204f, 4.9089f)
