    ...
    get() {
        ...
        _alignVerticalCenter = Builder(
            ...
            path(
                ...
                curveTo(8.4346f, 5.0f, 8.9019f, 5.0f, 9.25f, 5.201f)
                curveTo(9.478f, 5.3326f, 9.6674f, 5.522f, 9.799f, 5.75f)
                curveTo(10.0f, 6.0981f, 10.0f, 6.5654f, 10.0f, 7.5f)
                lineTo(10.0f, 16.5f)
                curveTo(10.0f, 17.4346f, 10.0f, 17.9019f, 9.799f, 18.25f)
                curveTo(9.6674f, 18.478f, 9.478f, 18.6674f, 9.25f, 18.799f)
                curveTo(8.9019f, 19.0f, 8.4346f, 19.0f, 7.5f, 19.0f)
                curveTo(6.5654f, 19.0f, 6.0981f, 19.0f, 5.75f, 18.799f)
