    ...
    get() {
        ...
        _bicycling = Builder(
            ...
            path(
                ...
                moveTo(12.0f, 18.0f)
                lineTo(12.0572f, 17.6416f)
                curveTo(12.2918f, 16.172f, 12.4091f, 15.4373f, 12.081f, 14.8374f)
                curveTo(11.7529f, 14.2375f, 11.0709f, 13.9399f, 9.707f, 13.3448f)
                lineTo(8.2312f, 12.7009f)
                curveTo(7.1987f, 12.2503f, 6.6824f, 12.025f, 6.5535f, 11.5703f)
                curveTo(6.5026f, 11.3909f, 6.5218f, 11.2103f, 6.6031f, 11.0005f)
            }
        }
            .build()
        return _bicycling!!
