    ...
    get() {
        ...
        _serverSquareCloud = Builder(
            ...
            path(
                ...
                moveTo(10.0f, 3.75f)
                curveTo(10.4142f, 3.75f, 10.75f, 3.4142f, 10.75f, 3.0f)
                curveTo(10.75f, 2.5858f, 10.4142f, 2.25f, 10.0f, 2.25f)
                verticalLineTo(3.75f)
                close()
                moveTo(14.0f, 2.25f)
                curveTo(13.5858f, 2.25f, 13.25f, 2.5858f, 13.25f, 3.0f)
                curveTo(13.25f, 3.4142f, 13.5858f, 3.75f, 14.0f, 3.75f)
