    ...
    get() {
        ...
        _pills2 = Builder(
            ...
            path(
                ...
                curveTo(14.4408f, 21.5118f, 15.7204f, 22.0f, 17.0f, 22.0f)
                moveTo(12.0f, 17.0f)
                curveTo(12.0f, 15.7204f, 12.4882f, 14.4408f, 13.4645f, 13.4645f)
                curveTo(15.4171f, 11.5118f, 18.5829f, 11.5118f, 20.5355f, 13.4645f)
                curveTo(21.5118f, 14.4408f, 22.0f, 15.7204f, 22.0f, 17.0f)
                moveTo(12.0f, 17.0f)
