    ...
    get() {
        ...
        _keySquare2 = Builder(
            ...
            path(
                ...
                moveTo(2.0f, 11.9899f)
                curveTo(2.0f, 16.7087f, 2.0f, 19.0681f, 3.4659f, 20.5341f)
                curveTo(4.9319f, 22.0f, 7.2913f, 22.0f, 12.0101f, 22.0f)
                curveTo(16.7288f, 22.0f, 19.0882f, 22.0f, 20.5542f, 20.5341f)
                curveTo(21.6692f, 19.419f, 21.9361f, 17.787f, 22.0f, 14.993f)
                moveTo(9.007f, 2.0f)
                curveTo(6.213f, 2.0639f, 4.581f, 2.3308f, 3.4659f, 3.4458f)
                curveTo(2.4891f, 4.4226f, 2.1632f, 5.7961f, 2.0545f, 8.0f)
            }
        }
            .build()
        return _keySquare2!!
