    ...
    get() {
        ...
        _treadmill = Builder(
            ...
            path(
                ...
                moveTo(11.2878f, 21.9996f)
                horizontalLineTo(3.0868f)
                curveTo(2.4866f, 21.9996f, 2.0f, 21.513f, 2.0f, 20.9128f)
                curveTo(2.0f, 20.3848f, 2.3794f, 19.9332f, 2.8995f, 19.8422f)
                lineTo(19.0559f, 17.0148f)
                curveTo(20.5926f, 16.7459f, 22.0f, 17.9284f, 22.0f, 19.4884f)
                curveTo(22.0f, 20.8753f, 20.8757f, 21.9996f, 19.4888f, 21.9996f)
            ...
            path(
                ...
                close()
                moveTo(19.2425f, 14.1061f)
                curveTo(19.301f, 13.696f, 19.0161f, 13.3161f, 18.6061f, 13.2575f)
                curveTo(18.196f, 13.199f, 17.8161f, 13.4839f, 17.7575f, 13.8939f)
                lineTo(19.2425f, 14.1061f)
                close()
                moveTo(18.3885f, 9.8541f)
                curveTo(18.327f, 10.2638f, 18.6093f, 10.6457f, 19.0189f, 10.7071f)
                curveTo(19.4286f, 10.7685f, 19.8104f, 10.4863f, 19.8719f, 10.0767f)
                lineTo(18.3885f, 9.8541f)
                close()
                ...
                lineTo(20.7302f, 6.4891f)
                close()
                moveTo(18.7425f, 17.6061f)
                lineTo(19.2425f, 14.1061f)
                lineTo(17.7575f, 13.8939f)
                lineTo(17.2575f, 17.3939f)
                lineTo(18.7425f, 17.6061f)
                close()
                moveTo(19.8719f, 10.0767f)
                lineTo(20.0333f, 9.0003f)
                lineTo(18.5499f, 8.7778f)
                lineTo(18.3885f, 9.8541f)
                lineTo(19.8719f, 10.0767f)
                close()
            }
        }
            .build()
