    ...
    get() {
        ...
        _mapPointSearch = Builder(
            ...
            path(
                ...
                moveTo(12.0f, 6.25f)
                curveTo(9.9289f, 6.25f, 8.25f, 7.9289f, 8.25f, 10.0f)
                curveTo(8.25f, 12.0711f, 9.9289f, 13.75f, 12.0f, 13.75f)
                curveTo(12.7651f, 13.75f, 13.4774f, 13.5203f, 14.0706f, 13.1268f)
                lineTo(14.9681f, 14.0293f)
                curveTo(15.2602f, 14.323f, 15.7351f, 14.3243f, 16.0288f, 14.0322f)
                curveTo(16.3225f, 13.7401f, 16.3238f, 13.2652f, 16.0317f, 12.9715f)
                lineTo(15.1304f, 12.0653f)
                curveTo(15.5217f, 11.4731f, 15.75f, 10.7628f, 15.75f, 10.0f)
                curveTo(15.75f, 7.9289f, 14.0711f, 6.25f, 12.0f, 6.25f)
                close()
                moveTo(12.0f, 7.75f)
