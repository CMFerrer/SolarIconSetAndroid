    ...
    get() {
        ...
        _folderWithFiles = Builder(
            ...
            path(
                ...
                moveTo(19.9998f, 6.2375f)
                curveTo(19.9989f, 5.9402f, 19.9947f, 5.7626f, 19.9744f, 5.6084f)
                curveTo(19.7971f, 4.2622f, 18.7378f, 3.2029f, 17.3916f, 3.0257f)
                curveTo(17.1967f, 3.0f, 16.9645f, 3.0f, 16.5f, 3.0f)
                horizontalLineTo(9.988f)
                curveTo(10.1039f, 3.1039f, 10.2345f, 3.2345f, 10.4498f, 3.4497f)
                lineTo(11.0f, 4.0f)
                curveTo(11.8158f, 4.8158f, 12.2237f, 5.2237f, 12.7122f, 5.4954f)
                curveTo(12.9805f, 5.6447f, 13.2651f, 5.7626f, 13.5604f, 5.8468f)
                curveTo(14.0979f, 6.0f, 14.6748f, 6.0f, 15.8285f, 6.0f)
                horizontalLineTo(16.2021f)
                curveTo(17.9811f, 6.0f, 19.159f, 6.0f, 19.9998f, 6.2375f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
