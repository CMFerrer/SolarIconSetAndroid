    ...
    get() {
        ...
        _airbudsCaseOpen = Builder(
            ...
            path(
                ...
                moveTo(14.0f, 13.75f)
                curveTo(15.5188f, 13.75f, 16.75f, 12.5188f, 16.75f, 11.0f)
                horizontalLineTo(15.25f)
                curveTo(15.25f, 11.6904f, 14.6904f, 12.25f, 14.0f, 12.25f)
                horizontalLineTo(10.0f)
                curveTo(9.3096f, 12.25f, 8.75f, 11.6904f, 8.75f, 11.0f)
                horizontalLineTo(7.25f)
                curveTo(7.25f, 12.5188f, 8.4812f, 13.75f, 10.0f, 13.75f)
                horizontalLineTo(14.0f)
                close()
            }
            path(
