    ...
    get() {
        ...
        _stickerSmileCircle2 = Builder(
            ...
            path(
                ...
                curveTo(12.1964f, 16.25f, 12.39f, 16.2365f, 12.5799f, 16.2103f)
                curveTo(12.512f, 16.3666f, 12.4495f, 16.5259f, 12.3928f, 16.688f)
                curveTo(12.2801f, 17.0101f, 12.1998f, 17.3546f, 12.1425f, 17.7482f)
                curveTo(12.0951f, 17.7494f, 12.0476f, 17.75f, 12.0f, 17.75f)
