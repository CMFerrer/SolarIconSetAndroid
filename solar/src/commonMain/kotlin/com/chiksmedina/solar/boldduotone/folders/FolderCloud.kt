    ...
    get() {
        ...
        _folderCloud = Builder(
            ...
            path(
                ...
                moveTo(16.0f, 13.8824f)
                curveTo(16.0f, 15.0519f, 14.9767f, 16.0f, 13.7143f, 16.0f)
                horizontalLineTo(9.7143f)
                curveTo(8.7675f, 16.0f, 8.0f, 15.2889f, 8.0f, 14.4118f)
                curveTo(8.0f, 13.5346f, 8.7675f, 12.8235f, 9.7143f, 12.8235f)
                curveTo(9.8279f, 12.8235f, 9.939f, 12.8338f, 10.0465f, 12.8533f)
                ...
                curveTo(15.3572f, 12.1676f, 16.0f, 12.9554f, 16.0f, 13.8824f)
                close()
            }
        }
            .build()
