    ...
    get() {
        ...
        _magicStick3 = Builder(
            ...
            path(
                ...
                curveTo(5.4442f, 9.4962f, 5.9869f, 10.013f, 6.0f, 9.9999f)
                lineTo(10.0f, 5.9999f)
                curveTo(10.0131f, 5.9868f, 9.4963f, 5.4441f, 9.51f, 5.4323f)
            ...
            path(
                ...
                moveTo(10.5676f, 6.49f)
                curveTo(10.5557f, 6.5037f, 10.0128f, 5.9867f, 9.9998f, 5.9998f)
                lineTo(5.9998f, 9.9998f)
                curveTo(5.9867f, 10.0128f, 6.5037f, 10.5558f, 6.4899f, 10.5677f)
                lineTo(16.0775f, 20.1553f)
                curveTo(17.2035f, 21.2814f, 19.0292f, 21.2814f, 20.1552f, 20.1553f)
                curveTo(21.2813f, 19.0293f, 21.2813f, 17.2036f, 20.1552f, 16.0776f)
                lineTo(10.5676f, 6.49f)
                close()
            }
        }
            .build()
