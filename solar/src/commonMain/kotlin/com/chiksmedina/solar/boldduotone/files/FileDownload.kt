    ...
    get() {
        ...
        _fileDownload = Builder(
            ...
            path(
                ...
                curveTo(5.6849f, 16.8889f, 5.6695f, 16.4142f, 5.9528f, 16.112f)
                curveTo(6.2361f, 15.8099f, 6.7108f, 15.7945f, 7.013f, 16.0778f)
                lineTo(7.75f, 16.7688f)
                verticalLineTo(13.5f)
                curveTo(7.75f, 13.0858f, 8.0858f, 12.75f, 8.5f, 12.75f)
                curveTo(8.9142f, 12.75f, 9.25f, 13.0858f, 9.25f, 13.5f)
                lineTo(9.25f, 16.7688f)
                lineTo(9.9871f, 16.0778f)
                curveTo(10.2892f, 15.7945f, 10.7639f, 15.8099f, 11.0472f, 16.112f)
                curveTo(11.3305f, 16.4142f, 11.3151f, 16.8889f, 11.013f, 17.1722f)
