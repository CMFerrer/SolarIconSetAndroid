    ...
    get() {
        ...
        _folderCheck = Builder(
            ...
            path(
                ...
                curveTo(14.8079f, 11.7146f, 14.8358f, 12.1887f, 14.5606f, 12.4983f)
                ...
                lineTo(9.4395f, 13.9983f)
                curveTo(9.1643f, 13.6887f, 9.1922f, 13.2146f, 9.5017f, 12.9395f)
                curveTo(9.8113f, 12.6643f, 10.2854f, 12.6921f, 10.5606f, 13.0017f)
                lineTo(11.3333f, 13.8711f)
                lineTo(13.4395f, 11.5017f)
                curveTo(13.7146f, 11.1921f, 14.1887f, 11.1643f, 14.4983f, 11.4395f)
                close()
            }
        }
            .build()
