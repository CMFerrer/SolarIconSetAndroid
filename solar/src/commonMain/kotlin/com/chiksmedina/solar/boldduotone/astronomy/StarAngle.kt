    ...
    get() {
        ...
        _starAngle = Builder(
            ...
            path(
                ...
                moveTo(10.9176f, 6.5746f)
                curveTo(10.7621f, 5.9061f, 10.6304f, 5.34f, 10.4875f, 4.8955f)
                lineTo(17.1212f, 6.8198f)
                curveTo(17.1651f, 6.8325f, 17.279f, 6.8828f, 17.4367f, 7.296f)
                curveTo(17.5907f, 7.6998f, 17.73f, 8.2935f, 17.9304f, 9.1547f)
                lineTo(18.0504f, 9.6706f)
                curveTo(18.0769f, 9.7853f, 18.1022f, 9.8948f, 18.1293f, 9.9986f)
                lineTo(12.1172f, 8.3334f)
                lineTo(11.8136f, 8.1605f)
                curveTo(11.3841f, 7.9159f, 11.3051f, 7.859f, 11.2496f, 7.7815f)
                curveTo(11.1877f, 7.6951f, 11.1504f, 7.575f, 11.0286f, 7.0516f)
                lineTo(10.9176f, 6.5746f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(14.3426f, 9.9874f)
                lineTo(19.3504f, 11.3744f)
                lineTo(19.654f, 11.5473f)
                curveTo(20.3606f, 11.9498f, 20.8368f, 12.2227f, 21.147f, 12.4714f)
                curveTo(21.4441f, 12.7094f, 21.4952f, 12.8515f, 21.4997f, 12.9725f)
                curveTo(21.5043f, 13.0998f, 21.4579f, 13.2596f, 21.1723f, 13.546f)
                curveTo(20.8785f, 13.8407f, 20.4209f, 14.1823f, 19.7488f, 14.6817f)
                lineTo(19.3498f, 14.9781f)
                curveTo(19.1612f, 15.1179f, 18.9905f, 15.2444f, 18.8468f, 15.386f)
                lineTo(12.0421f, 13.4121f)
                lineTo(12.4008f, 13.1456f)
                curveTo(13.0314f, 12.6771f, 13.5501f, 12.2917f, 13.9028f, 11.938f)
                curveTo(14.27f, 11.5697f, 14.5409f, 11.1546f, 14.5214f, 10.6217f)
                curveTo(14.5126f, 10.3825f, 14.4474f, 10.1737f, 14.3426f, 9.9874f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.5f, strokeAlpha
                ...
                moveTo(11.3743f, 14.2596f)
                lineTo(18.3867f, 16.2937f)
                curveTo(18.3575f, 16.4351f, 18.3343f, 16.587f, 18.3092f, 16.7512f)
                lineTo(18.2282f, 17.2778f)
                curveTo(18.151f, 17.7786f, 18.0372f, 18.2246f, 17.9163f, 18.6025f)
                curveTo(17.7033f, 19.2683f, 17.6487f, 19.3608f, 17.4887f, 19.4527f)
                curveTo(17.4199f, 19.4922f, 17.3551f, 19.5095f, 17.2195f, 19.4942f)
                curveTo(17.0535f, 19.4755f, 16.8408f, 19.4156f, 16.4777f, 19.3103f)
                lineTo(10.6832f, 17.6294f)
                curveTo(10.7527f, 17.4828f, 10.8078f, 17.326f, 10.8545f, 17.1663f)
                curveTo(10.9996f, 16.6694f, 11.1041f, 15.9909f, 11.233f, 15.1542f)
                lineTo(11.3081f, 14.666f)
                curveTo(11.3349f, 14.4924f, 11.356f, 14.3612f, 11.3743f, 14.2596f)
                close()
            }
            path(
