    ...
    get() {
        ...
        _command = Builder(
            ...
            path(
                ...
                moveTo(19.0f, 8.0005f)
                lineTo(16.0f, 8.0f)
                lineTo(16.0005f, 5.0f)
                curveTo(16.0007f, 3.3432f, 17.3441f, 2.0002f, 19.0009f, 2.0005f)
                curveTo(20.6578f, 2.0008f, 22.0007f, 3.3441f, 22.0005f, 5.001f)
                curveTo(22.0002f, 6.6578f, 20.6569f, 8.0007f, 19.0f, 8.0005f)
                close()
                moveTo(8.0005f, 8.0f)
                lineTo(8.0f, 5.0f)
