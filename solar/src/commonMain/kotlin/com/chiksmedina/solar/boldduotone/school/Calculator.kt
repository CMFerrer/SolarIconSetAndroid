    ...
    get() {
        ...
        _calculator = Builder(
            ...
            path(
                ...
                moveTo(8.0f, 14.0f)
                curveTo(8.5523f, 14.0f, 9.0f, 13.5523f, 9.0f, 13.0f)
                curveTo(9.0f, 12.4477f, 8.5523f, 12.0f, 8.0f, 12.0f)
                curveTo(7.4477f, 12.0f, 7.0f, 12.4477f, 7.0f, 13.0f)
                curveTo(7.0f, 13.5523f, 7.4477f, 14.0f, 8.0f, 14.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(
                ...
                moveTo(16.0f, 14.0f)
                curveTo(16.5523f, 14.0f, 17.0f, 13.5523f, 17.0f, 13.0f)
                curveTo(17.0f, 12.4477f, 16.5523f, 12.0f, 16.0f, 12.0f)
                curveTo(15.4477f, 12.0f, 15.0f, 12.4477f, 15.0f, 13.0f)
                curveTo(15.0f, 13.5523f, 15.4477f, 14.0f, 16.0f, 14.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
