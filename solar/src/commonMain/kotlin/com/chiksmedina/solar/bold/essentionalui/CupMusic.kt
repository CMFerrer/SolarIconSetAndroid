    ...
    get() {
        ...
        _cupMusic = Builder(
            ...
            path(
                ...
                curveTo(10.7641f, 9.2666f, 10.3164f, 9.7143f, 10.3164f, 10.2666f)
            ...
            path(
                ...
                close()
                moveTo(13.5f, 4.75f)
                curveTo(13.5f, 4.3358f, 13.1642f, 4.0f, 12.75f, 4.0f)
                curveTo(12.3358f, 4.0f, 12.0f, 4.3358f, 12.0f, 4.75f)
                verticalLineTo(8.128f)
                curveTo(11.7654f, 8.0451f, 11.513f, 8.0f, 11.25f, 8.0f)
                curveTo(10.0074f, 8.0f, 9.0f, 9.0074f, 9.0f, 10.25f)
                curveTo(9.0f, 11.4926f, 10.0074f, 12.5f, 11.25f, 12.5f)
                curveTo(12.4926f, 12.5f, 13.5f, 11.4926f, 13.5f, 10.25f)
                verticalLineTo(7.2002f)
                curveTo(13.875f, 7.3919f, 14.2999f, 7.5f, 14.75f, 7.5f)
            ...
            path(
                ...
                curveTo(2.4144f, 10.2302f, 2.7906f, 10.4392f, 3.543f, 10.8572f)
