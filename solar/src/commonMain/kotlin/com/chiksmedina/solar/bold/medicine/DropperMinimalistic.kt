    ...
    get() {
        ...
        _dropperMinimalistic = Builder(
            ...
            path(
                ...
                curveTo(18.9166f, 5.0881f, 18.9881f, 5.8531f, 18.9983f, 7.25f)
                horizontalLineTo(17.0f)
                curveTo(16.5858f, 7.25f, 16.25f, 7.5858f, 16.25f, 8.0f)
                curveTo(16.25f, 8.4142f, 16.5858f, 8.75f, 17.0f, 8.75f)
                horizontalLineTo(19.0f)
                ...
                close()
                moveTo(12.0f, 14.0f)
                curveTo(13.1046f, 14.0f, 14.0f, 13.0673f, 14.0f, 11.9167f)
                curveTo(14.0f, 11.1968f, 13.217f, 10.2359f, 12.6309f, 9.6174f)
                curveTo(12.2839f, 9.2513f, 11.7161f, 9.2513f, 11.3691f, 9.6174f)
                curveTo(10.783f, 10.2359f, 10.0f, 11.1968f, 10.0f, 11.9167f)
                curveTo(10.0f, 13.0673f, 10.8954f, 14.0f, 12.0f, 14.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
