    ...
    get() {
        ...
        _folder2 = Builder(
            ...
            path(
                ...
                horizontalLineTo(21.9531f)
                curveTo(21.8809f, 8.2012f, 21.6973f, 7.5128f, 21.2305f, 6.9938f)
                ...
                curveTo(22.0f, 11.4227f, 21.9978f, 10.75f, 21.9978f, 10.75f)
                close()
            }
        }
            .build()
