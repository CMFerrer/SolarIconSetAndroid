    ...
    get() {
        ...
        _hanger = Builder(
            ...
            path(
                ...
                curveTo(13.3836f, 9.1733f, 13.3589f, 9.1976f, 13.3349f, 9.2214f)
                curveTo(13.1678f, 9.3867f, 13.0204f, 9.5362f, 12.8942f, 9.6846f)
                curveTo(12.8069f, 9.7872f, 12.7398f, 9.878f, 12.6892f, 9.9589f)
                curveTo(13.2576f, 10.0668f, 13.8097f, 10.2856f, 14.3038f, 10.6187f)
                ...
                curveTo(9.856f, 10.2879f, 10.4658f, 10.0483f, 11.0933f, 9.9425f)
                curveTo(11.1987f, 9.4365f, 11.4862f, 9.0248f, 11.7515f, 8.7128f)
                curveTo(11.9234f, 8.5107f, 12.1114f, 8.3218f, 12.2799f, 8.1551f)
                curveTo(12.3076f, 8.1277f, 12.3347f, 8.101f, 12.3612f, 8.0749f)
                ...
                curveTo(12.9827f, 11.5371f, 12.3996f, 11.373f, 11.8102f, 11.3799f)
                ...
                curveTo(2.9021f, 17.9775f, 3.1999f, 18.25f, 3.7026f, 18.25f)
