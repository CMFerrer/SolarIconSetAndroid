    ...
    get() {
        ...
        _fire = Builder(
            ...
            path(
                ...
                curveTo(10.1113f, 21.8742f, 8.0f, 21.064f, 8.0f, 18.4442f)
                curveTo(8.0f, 16.3949f, 9.4951f, 15.0085f, 10.631f, 14.3346f)
                curveTo(10.9365f, 14.1533f, 11.2941f, 14.3887f, 11.2941f, 14.7439f)
                verticalLineTo(15.3331f)
                curveTo(11.2941f, 15.784f, 11.4685f, 16.4889f, 11.8836f, 16.9714f)
                curveTo(12.3534f, 17.5174f, 13.0429f, 16.9454f, 13.0985f, 16.2273f)
                curveTo(13.1161f, 16.0008f, 13.3439f, 15.8564f, 13.5401f, 15.9711f)
                curveTo(14.1814f, 16.3459f, 15.0f, 17.1465f, 15.0f, 18.4442f)
                curveTo(15.0f, 20.4922f, 13.871f, 21.4343f, 12.8324f, 21.8013f)
                close()
            }
        }
            .build()
