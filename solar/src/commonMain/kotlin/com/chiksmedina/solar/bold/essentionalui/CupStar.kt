    ...
    get() {
        ...
        _cupStar = Builder(
            ...
            path(
                ...
                curveTo(6.15f, 15.4851f, 5.2117f, 10.0544f, 5.0391f, 5.7065f)
                ...
                close()
                moveTo(12.9524f, 6.1989f)
                lineTo(12.8541f, 6.0225f)
                curveTo(12.4741f, 5.3408f, 12.2841f, 5.0f, 12.0f, 5.0f)
                curveTo(11.7159f, 5.0f, 11.5259f, 5.3408f, 11.1459f, 6.0225f)
                lineTo(11.0476f, 6.1989f)
                curveTo(10.9397f, 6.3926f, 10.8857f, 6.4894f, 10.8015f, 6.5533f)
                curveTo(10.7173f, 6.6172f, 10.6125f, 6.641f, 10.4028f, 6.6884f)
                lineTo(10.2119f, 6.7316f)
                curveTo(9.474f, 6.8986f, 9.105f, 6.982f, 9.0172f, 7.2643f)
                curveTo(8.9295f, 7.5466f, 9.181f, 7.8407f, 9.684f, 8.429f)
                lineTo(9.8142f, 8.5812f)
                curveTo(9.9571f, 8.7483f, 10.0286f, 8.8319f, 10.0608f, 8.9353f)
                curveTo(10.0929f, 9.0387f, 10.0821f, 9.1502f, 10.0605f, 9.3733f)
                lineTo(10.0408f, 9.5763f)
                curveTo(9.9648f, 10.3612f, 9.9267f, 10.7536f, 10.1565f, 10.9281f)
                curveTo(10.3864f, 11.1025f, 10.7318f, 10.9435f, 11.4227f, 10.6254f)
                lineTo(11.6014f, 10.5431f)
                curveTo(11.7978f, 10.4527f, 11.8959f, 10.4075f, 12.0f, 10.4075f)
                curveTo(12.1041f, 10.4075f, 12.2022f, 10.4527f, 12.3986f, 10.5431f)
                lineTo(12.5773f, 10.6254f)
                curveTo(13.2682f, 10.9435f, 13.6136f, 11.1025f, 13.8435f, 10.9281f)
                curveTo(14.0733f, 10.7536f, 14.0352f, 10.3612f, 13.9592f, 9.5763f)
                lineTo(13.9395f, 9.3733f)
                curveTo(13.9179f, 9.1502f, 13.9071f, 9.0387f, 13.9392f, 8.9353f)
                curveTo(13.9714f, 8.8319f, 14.0429f, 8.7483f, 14.1858f, 8.5812f)
                lineTo(14.316f, 8.429f)
                curveTo(14.819f, 7.8407f, 15.0706f, 7.5466f, 14.9828f, 7.2643f)
                curveTo(14.895f, 6.982f, 14.526f, 6.8986f, 13.7881f, 6.7316f)
                lineTo(13.5972f, 6.6884f)
                curveTo(13.3875f, 6.641f, 13.2827f, 6.6172f, 13.1985f, 6.5533f)
                curveTo(13.1143f, 6.4894f, 13.0603f, 6.3926f, 12.9524f, 6.1989f)
                close()
            }
        }
            .build()
