    ...
    get() {
        ...
        _playStream = Builder(
            ...
            path(
                ...
                moveTo(13.6563f, 10.4512f)
                curveTo(14.5521f, 11.1088f, 15.0f, 11.4376f, 15.0f, 12.0001f)
                curveTo(15.0f, 12.5625f, 14.5521f, 12.8913f, 13.6563f, 13.549f)
                curveTo(13.4091f, 13.7305f, 13.1638f, 13.9014f, 12.9384f, 14.0439f)
                curveTo(12.7407f, 14.1688f, 12.5168f, 14.2981f, 12.2849f, 14.425f)
                curveTo(11.3913f, 14.9141f, 10.9444f, 15.1586f, 10.5437f, 14.8879f)
                curveTo(10.1429f, 14.6171f, 10.1065f, 14.0503f, 10.0337f, 12.9167f)
                curveTo(10.0131f, 12.5961f, 10.0f, 12.2818f, 10.0f, 12.0001f)
                curveTo(10.0f, 11.7183f, 10.0131f, 11.404f, 10.0337f, 11.0834f)
                curveTo(10.1065f, 9.9498f, 10.1429f, 9.383f, 10.5437f, 9.1123f)
                curveTo(10.9444f, 8.8415f, 11.3913f, 9.0861f, 12.2849f, 9.5751f)
                curveTo(12.5168f, 9.702f, 12.7407f, 9.8313f, 12.9384f, 9.9563f)
                curveTo(13.1638f, 10.0987f, 13.4091f, 10.2696f, 13.6563f, 10.4512f)
                close()
            }
        }
            .build()
