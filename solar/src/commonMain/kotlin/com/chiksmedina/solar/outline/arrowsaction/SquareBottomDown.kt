    ...
    get() {
        ...
        _squareBottomDown = Builder(
            ...
            path(
                ...
                horizontalLineTo(4.8107f)
                lineTo(11.5303f, 13.5303f)
                curveTo(11.8232f, 13.2374f, 11.8232f, 12.7626f, 11.5303f, 12.4697f)
                curveTo(11.2374f, 12.1768f, 10.7626f, 12.1768f, 10.4697f, 12.4697f)
                lineTo(3.75f, 19.1893f)
                verticalLineTo(15.0f)
                curveTo(3.75f, 14.5858f, 3.4142f, 14.25f, 3.0f, 14.25f)
                curveTo(2.5858f, 14.25f, 2.25f, 14.5858f, 2.25f, 15.0f)
                verticalLineTo(21.0f)
                curveTo(2.25f, 21.4142f, 2.5858f, 21.75f, 3.0f, 21.75f)
