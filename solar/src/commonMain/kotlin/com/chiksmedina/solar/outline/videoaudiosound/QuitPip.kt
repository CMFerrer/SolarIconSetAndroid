    ...
    get() {
        ...
        _quitPip = Builder(
            ...
            path(
                ...
                curveTo(21.5858f, 11.75f, 21.25f, 11.4142f, 21.25f, 11.0f)
                ...
                curveTo(11.4142f, 20.25f, 11.75f, 20.5858f, 11.75f, 21.0f)
                curveTo(11.75f, 21.4142f, 11.4142f, 21.75f, 11.0f, 21.75f)
                ...
                close()
                moveTo(6.75f, 7.5f)
                curveTo(6.75f, 7.0858f, 7.0858f, 6.75f, 7.5f, 6.75f)
                horizontalLineTo(10.5f)
                curveTo(10.9142f, 6.75f, 11.25f, 7.0858f, 11.25f, 7.5f)
                curveTo(11.25f, 7.9142f, 10.9142f, 8.25f, 10.5f, 8.25f)
                horizontalLineTo(9.3107f)
                lineTo(12.0303f, 10.9697f)
                curveTo(12.3232f, 11.2626f, 12.3232f, 11.7374f, 12.0303f, 12.0303f)
                curveTo(11.7374f, 12.3232f, 11.2626f, 12.3232f, 10.9697f, 12.0303f)
                lineTo(8.25f, 9.3107f)
                verticalLineTo(10.5f)
                curveTo(8.25f, 10.9142f, 7.9142f, 11.25f, 7.5f, 11.25f)
                curveTo(7.0858f, 11.25f, 6.75f, 10.9142f, 6.75f, 10.5f)
                verticalLineTo(7.5f)
                close()
                moveTo(16.948f, 12.25f)
                ...
                curveTo(16.0495f, 21.75f, 15.3003f, 21.7501f, 14.7055f, 21.6701f)
                curveTo(14.0777f, 21.5857f, 13.5109f, 21.4f, 13.0555f, 20.9445f)
                curveTo(12.6f, 20.4891f, 12.4143f, 19.9223f, 12.3299f, 19.2945f)
                curveTo(12.2499f, 18.6997f, 12.25f, 17.9505f, 12.25f, 17.052f)
                verticalLineTo(16.948f)
                curveTo(12.25f, 16.0495f, 12.2499f, 15.3003f, 12.3299f, 14.7055f)
                curveTo(12.4143f, 14.0777f, 12.6f, 13.5109f, 13.0555f, 13.0555f)
                curveTo(13.5109f, 12.6f, 14.0777f, 12.4143f, 14.7055f, 12.3299f)
                curveTo(15.3003f, 12.2499f, 16.0495f, 12.25f, 16.948f, 12.25f)
                close()
                moveTo(14.9054f, 13.8165f)
                curveTo(14.4439f, 13.8786f, 14.2464f, 13.9858f, 14.1161f, 14.1161f)
                curveTo(13.9858f, 14.2464f, 13.8786f, 14.4439f, 13.8165f, 14.9054f)
                curveTo(13.7516f, 15.3884f, 13.75f, 16.036f, 13.75f, 17.0f)
                curveTo(13.75f, 17.964f, 13.7516f, 18.6116f, 13.8165f, 19.0946f)
                curveTo(13.8786f, 19.5561f, 13.9858f, 19.7536f, 14.1161f, 19.8839f)
                curveTo(14.2464f, 20.0142f, 14.4439f, 20.1214f, 14.9054f, 20.1835f)
                curveTo(15.3884f, 20.2484f, 16.036f, 20.25f, 17.0f, 20.25f)
                ...
                curveTo(16.036f, 13.75f, 15.3884f, 13.7516f, 14.9054f, 13.8165f)
                close()
            }
        }
            .build()
