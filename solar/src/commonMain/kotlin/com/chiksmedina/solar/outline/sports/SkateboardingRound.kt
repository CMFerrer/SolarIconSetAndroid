...
val SportsGroup.SkateboardingRound: ImageVector
    get() {
        if (_skateboardingRound != null) {
            return _skateboardingRound!!
        }
        _skateboardingRound = Builder(
            name = "SkateboardingRound", defaultWidth = 24.0.dp,
            ...
            path(
                ...
                moveTo(19.0f, 2.75f)
                curveTo(18.3097f, 2.75f, 17.75f, 3.3096f, 17.75f, 4.0f)
                curveTo(17.75f, 4.6904f, 18.3097f, 5.25f, 19.0f, 5.25f)
                curveTo(19.6904f, 5.25f, 20.25f, 4.6904f, 20.25f, 4.0f)
                curveTo(20.25f, 3.3096f, 19.6904f, 2.75f, 19.0f, 2.75f)
                close()
                moveTo(16.25f, 4.0f)
                curveTo(16.25f, 2.4812f, 17.4812f, 1.25f, 19.0f, 1.25f)
                curveTo(20.5188f, 1.25f, 21.75f, 2.4812f, 21.75f, 4.0f)
                curveTo(21.75f, 5.5188f, 20.5188f, 6.75f, 19.0f, 6.75f)
                curveTo(17.4812f, 6.75f, 16.25f, 5.5188f, 16.25f, 4.0f)
                close()
                ...
                lineTo(14.3551f, 7.5842f)
                curveTo(14.5138f, 7.4255f, 14.462f, 7.1568f, 14.2558f, 7.0685f)
                ...
                close()
                moveTo(15.75f, 10.0f)
                curveTo(15.75f, 9.5858f, 16.0858f, 9.25f, 16.5f, 9.25f)
                horizontalLineTo(19.5f)
                curveTo(19.9142f, 9.25f, 20.25f, 9.5858f, 20.25f, 10.0f)
                curveTo(20.25f, 10.4142f, 19.9142f, 10.75f, 19.5f, 10.75f)
                horizontalLineTo(16.5f)
                curveTo(16.0858f, 10.75f, 15.75f, 10.4142f, 15.75f, 10.0f)
                close()
                moveTo(11.5303f, 13.4697f)
                curveTo(11.8232f, 13.7626f, 11.8232f, 14.2374f, 11.5303f, 14.5303f)
                lineTo(10.909f, 15.1516f)
                curveTo(10.8843f, 15.1764f, 10.8598f, 15.201f, 10.8355f, 15.2253f)
                curveTo(10.476f, 15.5859f, 10.157f, 15.9059f, 9.7397f, 16.0787f)
                curveTo(9.3224f, 16.2516f, 8.8706f, 16.2509f, 8.3615f, 16.2501f)
                curveTo(8.327f, 16.2501f, 8.2923f, 16.25f, 8.2574f, 16.25f)
                ...
                curveTo(8.9317f, 14.75f, 9.0599f, 14.7367f, 9.1657f, 14.6929f)
                curveTo(9.2715f, 14.6491f, 9.3715f, 14.5678f, 9.8484f, 14.091f)
                lineTo(10.4697f, 13.4697f)
