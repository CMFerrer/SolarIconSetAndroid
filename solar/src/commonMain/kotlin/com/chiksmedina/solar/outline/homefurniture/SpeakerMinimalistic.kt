    ...
    get() {
        ...
        _speakerMinimalistic = Builder(
            ...
            path(
                ...
                close()
                moveTo(12.0f, 10.75f)
                curveTo(10.2051f, 10.75f, 8.75f, 12.2051f, 8.75f, 14.0f)
                curveTo(8.75f, 15.7949f, 10.2051f, 17.25f, 12.0f, 17.25f)
                curveTo(13.7949f, 17.25f, 15.25f, 15.7949f, 15.25f, 14.0f)
                curveTo(15.25f, 12.2051f, 13.7949f, 10.75f, 12.0f, 10.75f)
                close()
                moveTo(7.25f, 14.0f)
                curveTo(7.25f, 11.3766f, 9.3766f, 9.25f, 12.0f, 9.25f)
                curveTo(14.6234f, 9.25f, 16.75f, 11.3766f, 16.75f, 14.0f)
                curveTo(16.75f, 16.6234f, 14.6234f, 18.75f, 12.0f, 18.75f)
                curveTo(9.3766f, 18.75f, 7.25f, 16.6234f, 7.25f, 14.0f)
                close()
            }
        }
            .build()
