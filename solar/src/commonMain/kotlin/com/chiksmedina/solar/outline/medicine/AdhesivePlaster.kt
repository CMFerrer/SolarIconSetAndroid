    ...
    get() {
        ...
        _adhesivePlaster = Builder(
            ...
            path(
                ...
                moveTo(14.3986f, 2.6829f)
                curveTo(16.3091f, 0.7724f, 19.4066f, 0.7724f, 21.3171f, 2.6829f)
                curveTo(23.2276f, 4.5934f, 23.2276f, 7.6909f, 21.3171f, 9.6014f)
                lineTo(18.9185f, 12.0f)
                lineTo(21.3171f, 14.3986f)
                curveTo(23.2276f, 16.3091f, 23.2276f, 19.4066f, 21.3171f, 21.3171f)
                curveTo(19.4066f, 23.2276f, 16.3091f, 23.2276f, 14.3986f, 21.3171f)
                lineTo(12.0f, 18.9185f)
                lineTo(9.6014f, 21.3171f)
                curveTo(7.6909f, 23.2276f, 4.5934f, 23.2276f, 2.6829f, 21.3171f)
                curveTo(0.7724f, 19.4066f, 0.7724f, 16.3091f, 2.6829f, 14.3986f)
                lineTo(5.0815f, 12.0f)
                lineTo(2.6829f, 9.6014f)
                curveTo(0.7724f, 7.6909f, 0.7724f, 4.5934f, 2.6829f, 2.6829f)
                curveTo(4.5934f, 0.7724f, 7.6909f, 0.7724f, 9.6014f, 2.6829f)
                lineTo(12.0f, 5.0815f)
                lineTo(14.3986f, 2.6829f)
                close()
                moveTo(20.2565f, 15.4593f)
                curveTo(21.5812f, 16.784f, 21.5812f, 18.9318f, 20.2565f, 20.2565f)
                curveTo(18.9318f, 21.5812f, 16.784f, 21.5812f, 15.4593f, 20.2565f)
                lineTo(3.7435f, 8.5407f)
                curveTo(2.4188f, 7.216f, 2.4188f, 5.0682f, 3.7435f, 3.7435f)
                curveTo(5.0682f, 2.4188f, 7.216f, 2.4188f, 8.5407f, 3.7435f)
                lineTo(20.2565f, 15.4593f)
                close()
                moveTo(20.2565f, 8.5407f)
                lineTo(17.8579f, 10.9393f)
                lineTo(13.0607f, 6.1421f)
                lineTo(15.4593f, 3.7435f)
                curveTo(16.784f, 2.4188f, 18.9318f, 2.4188f, 20.2565f, 3.7435f)
                curveTo(21.5812f, 5.0683f, 21.5812f, 7.216f, 20.2565f, 8.5407f)
                close()
                moveTo(3.7435f, 15.4593f)
                lineTo(6.1421f, 13.0607f)
                lineTo(10.9393f, 17.8579f)
                lineTo(8.5407f, 20.2565f)
                curveTo(7.216f, 21.5812f, 5.0683f, 21.5812f, 3.7435f, 20.2565f)
                curveTo(2.4188f, 18.9318f, 2.4188f, 16.784f, 3.7435f, 15.4593f)
                close()
            }
        }
            .build()
