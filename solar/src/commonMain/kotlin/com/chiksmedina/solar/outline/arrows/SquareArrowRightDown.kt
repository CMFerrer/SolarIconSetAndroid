...
val ArrowsGroup.SquareArrowRightDown: ImageVector
    get() {
        if (_squareArrowRightDown != null) {
            return _squareArrowRightDown!!
        }
        _squareArrowRightDown = Builder(
            name = "SquareArrowRightDown", defaultWidth = 24.0.dp,
            ...
            path(
                ...
                close()
                moveTo(8.6412f, 8.6412f)
                curveTo(8.9341f, 8.3483f, 9.409f, 8.3483f, 9.7019f, 8.6412f)
                lineTo(14.0784f, 13.0178f)
                verticalLineTo(10.5858f)
                curveTo(14.0784f, 10.1716f, 14.4142f, 9.8358f, 14.8284f, 9.8358f)
                curveTo(15.2426f, 9.8358f, 15.5784f, 10.1716f, 15.5784f, 10.5858f)
                verticalLineTo(14.8284f)
                curveTo(15.5784f, 15.2426f, 15.2426f, 15.5784f, 14.8284f, 15.5784f)
                horizontalLineTo(10.5858f)
                curveTo(10.1716f, 15.5784f, 9.8358f, 15.2426f, 9.8358f, 14.8284f)
                curveTo(9.8358f, 14.4142f, 10.1716f, 14.0784f, 10.5858f, 14.0784f)
