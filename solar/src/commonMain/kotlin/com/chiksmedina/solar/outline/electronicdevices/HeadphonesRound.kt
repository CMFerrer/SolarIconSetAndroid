    ...
    get() {
        ...
        _headphonesRound = Builder(
            ...
            path(
                ...
                curveTo(19.7437f, 11.5584f, 20.0031f, 11.632f, 20.2462f, 11.7485f)
                curveTo(20.1133f, 7.3085f, 16.4722f, 3.75f, 12.0f, 3.75f)
                curveTo(7.5278f, 3.75f, 3.8867f, 7.3085f, 3.7538f, 11.7485f)
                curveTo(3.9969f, 11.632f, 4.2563f, 11.5584f, 4.53f, 11.5042f)
