...
val ArrowsActionGroup.DownloadSquare: ImageVector
    get() {
        if (_downloadSquare != null) {
            return _downloadSquare!!
        }
        _downloadSquare = Builder(
            name = "DownloadSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(
                ...
                curveTo(12.3897f, 14.671f, 12.1989f, 14.75f, 12.0f, 14.75f)
                curveTo(11.8011f, 14.75f, 11.6103f, 14.671f, 11.4697f, 14.5303f)
