    ...
    get() {
        ...
        _boombox = Builder(
            ...
            path(
                ...
                close()
                moveTo(7.25f, 13.878f)
                curveTo(6.3761f, 14.1869f, 5.75f, 15.0203f, 5.75f, 16.0f)
                curveTo(5.75f, 17.2426f, 6.7574f, 18.25f, 8.0f, 18.25f)
                curveTo(9.2426f, 18.25f, 10.25f, 17.2426f, 10.25f, 16.0f)
                curveTo(10.25f, 15.0203f, 9.6239f, 14.1869f, 8.75f, 13.878f)
                ...
                close()
                moveTo(4.25f, 16.0f)
                curveTo(4.25f, 13.9289f, 5.9289f, 12.25f, 8.0f, 12.25f)
                curveTo(10.0711f, 12.25f, 11.75f, 13.9289f, 11.75f, 16.0f)
                curveTo(11.75f, 18.0711f, 10.0711f, 19.75f, 8.0f, 19.75f)
                curveTo(5.9289f, 19.75f, 4.25f, 18.0711f, 4.25f, 16.0f)
                close()
                moveTo(16.9701f, 13.9692f)
                curveTo(16.1338f, 13.5697f, 15.1017f, 13.7163f, 14.409f, 14.409f)
                curveTo(13.5303f, 15.2877f, 13.5303f, 16.7123f, 14.409f, 17.591f)
                curveTo(15.2877f, 18.4697f, 16.7123f, 18.4697f, 17.591f, 17.591f)
                curveTo(18.2837f, 16.8983f, 18.4303f, 15.8662f, 18.0308f, 15.0299f)
                lineTo(17.2374f, 15.8232f)
                curveTo(16.9445f, 16.1161f, 16.4697f, 16.1161f, 16.1768f, 15.8232f)
                curveTo(15.8839f, 15.5303f, 15.8839f, 15.0555f, 16.1768f, 14.7626f)
                lineTo(16.9701f, 13.9692f)
                close()
                moveTo(13.3484f, 13.3484f)
                curveTo(14.8128f, 11.8839f, 17.1872f, 11.8839f, 18.6517f, 13.3484f)
                curveTo(20.1161f, 14.8128f, 20.1161f, 17.1872f, 18.6517f, 18.6517f)
                curveTo(17.1872f, 20.1161f, 14.8128f, 20.1161f, 13.3484f, 18.6517f)
                curveTo(11.8839f, 17.1872f, 11.8839f, 14.8128f, 13.3484f, 13.3484f)
                close()
            }
        }
            .build()
