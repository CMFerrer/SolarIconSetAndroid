    ...
    get() {
        ...
        _galleryRemove = Builder(
            ...
            path(
                ...
                moveTo(15.4696f, 1.4697f)
                curveTo(15.7625f, 1.1768f, 16.2374f, 1.1768f, 16.5303f, 1.4697f)
                lineTo(19.0f, 3.9393f)
                lineTo(21.4696f, 1.4697f)
                curveTo(21.7625f, 1.1768f, 22.2374f, 1.1768f, 22.5303f, 1.4697f)
                curveTo(22.8232f, 1.7626f, 22.8232f, 2.2375f, 22.5303f, 2.5303f)
                lineTo(20.0606f, 5.0f)
                lineTo(22.5303f, 7.4696f)
                curveTo(22.8232f, 7.7625f, 22.8232f, 8.2374f, 22.5303f, 8.5303f)
                curveTo(22.2374f, 8.8232f, 21.7625f, 8.8232f, 21.4696f, 8.5303f)
                lineTo(19.0f, 6.0607f)
                lineTo(16.5303f, 8.5303f)
                curveTo(16.2374f, 8.8232f, 15.7626f, 8.8232f, 15.4697f, 8.5303f)
                curveTo(15.1768f, 8.2374f, 15.1768f, 7.7626f, 15.4697f, 7.4697f)
                lineTo(17.9393f, 5.0f)
                lineTo(15.4696f, 2.5303f)
                curveTo(15.1767f, 2.2374f, 15.1767f, 1.7626f, 15.4696f, 1.4697f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
