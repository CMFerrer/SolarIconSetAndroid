    ...
    get() {
        ...
        _runningRound = Builder(
            ...
            path(
                ...
                curveTo(8.2139f, 6.9645f, 7.9442f, 7.0835f, 7.6807f, 7.2143f)
                curveTo(7.2427f, 7.4317f, 6.8172f, 7.6737f, 6.4064f, 7.9391f)
                curveTo(6.1593f, 8.0987f, 5.9192f, 8.2697f, 5.439f, 8.6117f)
                lineTo(4.0f, 9.6364f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
