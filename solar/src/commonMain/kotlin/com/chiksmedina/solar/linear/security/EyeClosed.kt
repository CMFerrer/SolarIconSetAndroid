    ...
    get() {
        ...
        _eyeClosed = Builder(
            ...
            path(
                ...
                close()
                moveTo(4.4697f, 10.5985f)
                lineTo(2.9697f, 12.0985f)
                lineTo(4.0303f, 13.1592f)
                lineTo(5.5303f, 11.6592f)
                lineTo(4.4697f, 10.5985f)
                close()
            }
        }
            .build()
