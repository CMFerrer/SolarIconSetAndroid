    ...
    get() {
        ...
        _floorLamp = Builder(
            ...
            path(
                ...
                moveTo(12.0f, 7.0f)
                curveTo(13.313f, 7.0f, 14.4289f, 6.1565f, 14.8356f, 4.9819f)
                curveTo(15.0163f, 4.46f, 14.5523f, 4.0f, 14.0f, 4.0f)
                horizontalLineTo(10.0f)
                curveTo(9.4477f, 4.0f, 8.9837f, 4.46f, 9.1644f, 4.9819f)
                curveTo(9.571f, 6.1565f, 10.687f, 7.0f, 12.0f, 7.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
            ...
            path(
                ...
                curveTo(6.4778f, 10.9505f, 6.5001f, 10.9208f, 6.5218f, 10.8909f)
                moveTo(2.7793f, 10.6844f)
