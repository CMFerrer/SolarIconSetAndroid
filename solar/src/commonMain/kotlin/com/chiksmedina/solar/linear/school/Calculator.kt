    ...
    get() {
        ...
        _calculator = Builder(
            ...
            path(
                ...
                moveTo(4.318f, 20.5355f)
                curveTo(5.636f, 22.0f, 7.7574f, 22.0f, 12.0f, 22.0f)
                curveTo(16.2426f, 22.0f, 18.364f, 22.0f, 19.682f, 20.5355f)
                curveTo(21.0f, 19.0711f, 21.0f, 16.714f, 21.0f, 12.0f)
                curveTo(21.0f, 7.286f, 21.0f, 4.9289f, 19.682f, 3.4645f)
                curveTo(18.364f, 2.0f, 16.2426f, 2.0f, 12.0f, 2.0f)
                curveTo(7.7574f, 2.0f, 5.636f, 2.0f, 4.318f, 3.4645f)
                curveTo(3.0f, 4.9289f, 3.0f, 7.286f, 3.0f, 12.0f)
                curveTo(3.0f, 16.714f, 3.0f, 19.0711f, 4.318f, 20.5355f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
