    ...
    get() {
        ...
        _washingMachineMinimalistic = Builder(
            ...
            path(
                ...
                moveTo(17.0f, 14.0f)
                curveTo(17.0f, 16.7614f, 14.7614f, 19.0f, 12.0f, 19.0f)
                curveTo(9.2386f, 19.0f, 7.0f, 16.7614f, 7.0f, 14.0f)
            ...
            path(
                ...
                moveTo(7.2342f, 14.3624f)
                curveTo(8.0887f, 14.7895f, 9.0674f, 15.5209f, 10.724f, 15.8195f)
                curveTo(13.0859f, 16.2453f, 12.8501f, 14.1706f, 15.2121f, 14.5961f)
                curveTo(15.9323f, 14.7258f, 16.4181f, 14.9452f, 16.7616f, 15.1805f)
            }
        }
            .build()
        return _washingMachineMinimalistic!!
