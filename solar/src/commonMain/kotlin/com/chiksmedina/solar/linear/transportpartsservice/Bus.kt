...
val TransportPartsServiceGroup.Bus: ImageVector
    get() {
        if (_bus != null) {
            return _bus!!
        }
        _bus = Builder(
            name = "Bus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(
                ...
                horizontalLineTo(8.5f)
                curveTo(9.0523f, 22.0f, 9.5f, 21.5523f, 9.5f, 21.0f)
            ...
            path(
                ...
                curveTo(14.9477f, 22.0f, 14.5f, 21.5523f, 14.5f, 21.0f)
                verticalLineTo(20.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF1C274C)),
                ...
                curveTo(22.0f, 11.3148f, 21.8518f, 11.6111f, 21.6f, 11.8f)
                lineTo(20.0f, 13.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF1C274C)),
