    ...
    get() {
        ...
        _smartphoneVibration = Builder(
            ...
            path(
                ...
                moveTo(22.0f, 6.0f)
                lineTo(21.2236f, 7.5528f)
                curveTo(21.0829f, 7.8343f, 21.0829f, 8.1657f, 21.2236f, 8.4472f)
                lineTo(21.7764f, 9.5528f)
                curveTo(21.9172f, 9.8343f, 21.9172f, 10.1657f, 21.7764f, 10.4472f)
                lineTo(21.2236f, 11.5528f)
                curveTo(21.0829f, 11.8343f, 21.0829f, 12.1657f, 21.2236f, 12.4472f)
                lineTo(21.7764f, 13.5528f)
                curveTo(21.9172f, 13.8343f, 21.9172f, 14.1657f, 21.7764f, 14.4472f)
                lineTo(21.2236f, 15.5528f)
                curveTo(21.0829f, 15.8343f, 21.0829f, 16.1657f, 21.2236f, 16.4472f)
                lineTo(22.0f, 18.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
