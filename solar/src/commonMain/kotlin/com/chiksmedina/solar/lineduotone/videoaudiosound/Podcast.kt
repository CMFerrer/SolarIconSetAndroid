    ...
    get() {
        ...
        _podcast = Builder(
            ...
            path(
                ...
                moveTo(4.1538f, 16.0f)
                curveTo(5.1734f, 16.0f, 6.0f, 15.1734f, 6.0f, 14.1538f)
                verticalLineTo(10.0f)
                curveTo(6.0f, 6.6863f, 8.6862f, 4.0f, 11.9999f, 4.0f)
                curveTo(15.3136f, 4.0f, 17.9999f, 6.6863f, 17.9999f, 10.0f)
                verticalLineTo(14.1538f)
                curveTo(17.9999f, 15.1734f, 18.8265f, 16.0f, 19.8461f, 16.0f)
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
